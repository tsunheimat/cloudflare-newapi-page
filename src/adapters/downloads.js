...
function htmlPage(title, body, { status = 200, headers: extraHeaders = undefined } = {}) {
  const styleNonce = crypto.randomUUID().replace(/-/g, '');
