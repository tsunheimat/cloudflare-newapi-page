const e = {
  ...
  "，时间：": ",time:",
  "，点击更新": ", click Update",
  "。在契约恢复之前无法生成视频。": ". Video generation stays disabled until the contract is available.",
  "（共 {{total}} 个，省略 {{omit}} 个）": "(Total {{total}}, {{omit}} omitted)",
  ...
  "{{mode}}下最多添加 {{limit}} 张参考图": "At most {{limit}} reference images are supported in {{mode}}",
  "{{mode}}下至少需要 {{limit}} 张参考图": "At least {{limit}} reference images are required in {{mode}}",
  "{{n}} 分钟前": "{{n}}m ago",
  "{{n}} 天前": "{{n}}d ago",
  "{{n}} 小时前": "{{n}}h ago",
  "{{n}} 秒前": "{{n}}s ago",
  "{{n}}s 后刷新": "Refresh in {{n}}s",
  "{{name}} ID": "{{name}} ID",
  ...
  "{{name}} 围绕企业级使用场景构建安全机制，关注数据传输安全、访问权限可控和调用行为可追溯，帮助团队在使用 AI 能力时保持清晰、可控和可信。": "{{name}} builds a security mechanism around enterprise-level usage scenarios, focusing on data transmission security, controllable access permissions, and traceability of calling behaviors to help teams stay clear, controllable, and trustworthy when using AI capabilities.",
  "{{name}} 希望访问你的账号": "{{name}} wants to access your account",
  ...
  "{{percent}}% of official": "{{percent}}% of official",
  "{{ratio}} · 分组倍率": "{{ratio}} · group ratio",
  "{{ratioType}} {{ratio}}": "{{ratioType}} {{ratio}}",
  "{{ratioType}} {{ratio}}x": "{{ratioType}} {{ratio}}x",
  "{{up}}/{{total}} 个模型运行正常": "{{up}}/{{total}} models operational",
  "「有参考影片」指请求里带了参考/输入影片；生成结果本身是影片并不会选中该费率。最终结算以上游返回的 usage.completion_tokens 为准。": '"With reference video" means the request carried a reference/input video. The generated output being a video does not select that rate. Final settlement uses the upstream usage.completion_tokens.',
  ...
  "/ 1M 影片补全 tokens": "/ 1M video completion tokens",
  ...
  "$/次": "$/time",
  "0 - 最低": "0 - Lowest",
  "0 表示不设上限": "0 means no upper limit",
  "0 表示不限": "0 means unlimited",
  "0 表示无限次": "0 means unlimited times",
  ...
  "1h缓存创建价格：{{symbol}}{{price}} / 1M tokens": "1h cache creation price: {{symbol}}{{price}} / 1M tokens",
  "1M图片输入": "1M image input",
  "1M缓存创建": "1M cache creation",
  "1M输入（不含缓存）": "1M input (excluding cache)",
  "1M输入（含缓存）": "1M input (including cache)",
  "1M输出": "1M output",
  "2 - 低": "2 - Low",
  "2:3 竖向": "2:3 Portrait",
  ...
  "30天": "30d",
  "32位密钥，敏感信息不显示": "32-bit key, sensitive information is not displayed",
  "360智脑": "360 AI Brain",
  ...
  "anthropic-beta JSON 示例": "anthropopic-beta JSON example",
  "API Key": "API Key",
  ...
  "API 密钥": "API Key",
  "API 密钥 (沙盒)": "API Key (Sandbox)",
  "API 密钥 (生产)": "API key (production)",
  "API 密钥（测试环境）": "API key (test environment)",
  "API 密钥（生产环境）": "API key (production environment)",
  "API 指南": "API guide",
  "API 文档": "API Documentation",
  "API 私钥": "API private key",
  "API 私钥（测试环境）": "API private key (test environment)",
  "API 私钥（生产环境）": "API private key (production environment)",
  ...
  "CC Switch": "CC Switch",
  "CC Switch 配置": "CC Switch configuration",
  ...
  "DALL·E 3 横向": "DALL·E 3 Landscape",
  ...
  "ICP/EDI经营许可证编号": "ICP/EDI Business License Number",
  ...
  "JSON 必须是对象": "JSON must be an object",
  "JSON 文本": "JSON Text",
  ...
  "reCAPTCHA 校验初始化失败，请刷新页面后重试": "reCAPTCHA verification initialization failed, please refresh the page and try again",
  "Recharge Quota": "Recharge Quota",
  "Request ID": "Request ID",
  "RSA 私钥 (沙盒)": "RSA private key (sandbox)",
  "RSA 私钥 (生产)": "RSA private key (production)",
  ...
  "Token 类型": "Token Type",
  "TokenRouter项目仓库地址：": "TokenRouter project warehouse address:",
  ...
  "Waffo API 参数，可空，例如：CREDITCARD,DEBITCARD（最多64位）": "Waffo API parameters, can be empty, for example: CREDITCARD, DEBITCARD (up to 64 bits)",
  "Waffo API 参数，可空（最多64位）": "Waffo API parameters, can be empty (up to 64 bits)",
  "Waffo Pancake": "Waffo Pancake",
  "Waffo Pancake 设置": "Waffo Pancake Settings",
  "Waffo 充值": "Waffo recharge",
  "Waffo 充值的最低数量，默认 1": "Minimum amount of Waffo recharge, default 1",
  "Waffo 公钥 (沙盒)": "Waffo public key (sandbox)",
  "Waffo 公钥 (生产)": "Waffo public key (production)",
  "Waffo 公钥（测试环境）": "Waffo public key (test environment)",
  "Waffo 公钥（生产环境）": "Waffo public key (production environment)",
  "Waffo 商户 ID": "Waffo Merchant ID",
  "Waffo 当前使用 USD 结算": "Waffo currently uses USD settlement",
  "Waffo 是一个支付聚合平台，支持多种支付方式。": "Waffo is a payment aggregation platform that supports multiple payment methods.",
  "Waffo 设置": "Waffo settings",
  ...
  "Webhook 公钥": "Webhook public key",
  "Webhook 公钥（测试环境）": "Webhook public key (test environment)",
  "Webhook 公钥（生产环境）": "Webhook public key (production environment)",
  ...
  Worker密钥: "Worker Key",
  'X 也可以小于 1，当折扣用。想做"只给输出加价"或"额外加固定费用"，请直接写完整计费公式。': 'X can also be less than 1, used as a discount. If you want to "only add a price to the output" or "add an additional fixed fee", please directly write the complete billing formula.',
  一个平台管理多种企业服务: "Manage enterprise services in one platform",
  一个月: "A month",
  一天: "One day",
  一小时: "One hour",
  一次性余额充值: "One-time balance top-up",
  "一次性支付，付款后自动返回": "One-time payment, automatically returned after payment",
  ...
  一键全开: "Draw all",
  一键全开失败: "Draw all failed",
  一键全开结果: "Draw all summary",
  "一键填充到 FluentRead": "One-click fill to FluentRead",
  "三种操作的区别：": "Differences between the three operations:",
  上一个表单块: "Previous form block",
  上一步: "Previous",
  上一页: "Previous",
  "上传 PNG/JPG/SVG 图片，建议尺寸 ≤ 128×128px": "Upload PNG/JPG/SVG images, recommended size ≤ 128×128px",
  上传参考图: "Upload reference image",
  上传后将在这里预览参考图: "The reference image will be previewed here after upload",
  上传图片: "Upload pictures",
  上传失败: "Upload failed",
  上传微信群二维码图片: "Upload WeChat group QR code image",
  "上次保存: ": "Last saved: ",
  上次检测到可加入模型: "Last detected joinable model",
  上次检测时间: "Last detection time",
  上游价格同步: "Upstream price synchronization",
  上游倍率同步: "Upstream ratio synchronization",
  上游已删除的模型: "Upstream deleted model",
  ...
  下午好: "Good afternoon",
  下单地址: "Order address",
  下单总数: "Total number of orders",
  下单数: "Number of orders",
  下载: "download",
  下载文件: "Download file",
  下载日志: "Download Logs",
  下载管理员发布的安装包和资料: "Download the installation package and information released by the administrator",
  ...
  "下面是带注释的示例，仅用于参考；实际保存时请删除注释。": "The following is an annotated example for reference only; please remove the annotations when actually saving.",
  ...
  不提供: "Not offered",
  不支持: "Not supported",
  不支持的分辨率: "Unsupported resolutions",
  不支持的块类型: "Unsupported block",
  "不是合法的 JSON 字符串": "Not a valid JSON string",
  不更改: "Not change",
  不符合返利条件: "Not eligible for a rebate",
  不设上限: "No upper limit",
  ...
  为默认价格: "is the default price",
  主导航: "Main navigation",
  主模型: "Primary Model",
  主页链接填: "Enter homepage link",
  之前的所有日志: "All previous logs",
  事件自动化和回调管理: "Event automation and callback management",
  ...
  仅提交已勾选: "Submit only checked",
  仅支持: "Only supports",
  "仅支持 JPEG / PNG / WebP 格式的图片": "Only JPEG / PNG / WebP images are supported",
  ...
  仅支持上传图片文件: "Only supports uploading image files",
  仅显示已绑定: "Show bound only",
  仅显示矛盾倍率: "Only show conflicting ratios",
  仅检测上游模型更新: "Only detect upstream model updates",
  ...
  仅用钱包: "Wallet only",
  "仅管理员可用。开启后，当系统定时检测全部渠道发现上游模型变更或检测异常时，将按你选择的通知方式发送汇总通知；渠道或模型过多时会自动省略部分明细。": "Available only to administrators. After turning it on, when the system regularly detects all channels and discovers upstream model changes or detection anomalies, it will send summary notifications according to the notification method you choose; if there are too many channels or models, some details will be automatically omitted.",
  "仅统计成功充值订单，按完成时间归档。": "Only successful recharge orders are counted and archived according to completion time.",
  仅自己: "only myself",
  ...
  今日盈利: "Today profit",
  今日调用: "Calls Today",
  仍有未处理项: "There are still unprocessed items",
  "从 0.5 降到 0.3": "reduced from 0.5 to 0.3",
  "从侧边栏选择页面，或使用 Ctrl/Cmd+K 搜索。": "Choose a page from the sidebar, or search with Ctrl/Cmd+K.",
  ...
  从接入到规模化调用: "From access to large-scale calls",
  "从模型接入到稳定调用，从权限管理到成本优化，构建可持续的 AI 调用基础设施。": "From model access to stable calling, from permission management to cost optimization, build a sustainable AI calling infrastructure.",
  ...
  付款完成后将自动回到账户页: "After payment is completed, you will automatically return to the account page",
  付费用户: "paying user",
  代理佣金已扣减: "Agency commission has been deducted",
  代理分销: "Distribution agent",
  "代理分销信息加载中...": "Agent distribution information is loading...",
  "代理分销比例不能大于 100": "The agent distribution ratio cannot be greater than 100",
  "代理分销比例不能小于 0": "Agent distribution ratio cannot be less than 0",
  代理分销默认配置: "Agent distribution default configuration",
  代理地址: "Proxy address",
  代理已启用: "proxy enabled",
  代理设置: "Proxy Settings",
  "代理邀请码、邀请用户和佣金流水": "Agent invitation code, invited users and commission flow",
  代码已复制到剪贴板: "Code copied to clipboard",
  代码示例: "Code samples",
  "代表你发起 AI 请求（费用记在你的账户）": "Make AI requests on your behalf (fees charged to your account)",
  令牌: "Tokens",
  "令牌 / 密钥": "Token / key",
  ...
  令牌数据可能已过期: "Token data may be stale",
  ...
  "价格为参考估算，实际计费以模型、渠道为准": "Prices are reference estimates; actual billing depends on the model and channel.",
  价格可视化对比: "Price visual comparison",
  价格摘要: "Price Summary",
  ...
  "企业级稳定，高可用运行": "Enterprise-Grade Stability, High Availability",
  ...
  优化链路支撑业务运行: "Optimize links to support business operations",
  优惠: "Discount",
  ...
  余额地址: "Balance address",
  余额返利: "Balance rebate",
  "余额返利直接返到邀请人的钱包余额；套餐返利会正常执行套餐分组升级": "The balance rebate will be directly returned to the inviter's wallet balance; the package rebate will be upgraded to the package group normally.",
  "余额返利直接返到邀请人钱包；套餐返利会按套餐自身规则执行分组升级": "The balance rebate will be returned directly to the inviter's wallet; the package rebate will be grouped and upgraded according to the package's own rules.",
  作废: "Invalidate",
  作废于: "Invalidated at",
  ...
  "你可以随时在「个人设置 - 已授权应用」中解除该应用的授权。": 'You can deauthorize the application at any time in "Personal Settings - Authorized Applications".',
  "你还没有处理{{type}}模型（{{count}}个）。是否仅提交当前已勾选内容？_one": "You have not processed {{type}} models ({{count}}) yet. Do you want to submit only the currently checked content?",
  "你还没有处理{{type}}模型（{{count}}个）。是否仅提交当前已勾选内容？_other": "You have not processed {{type}} models ({{count}}) yet. Do you want to submit only the currently checked content?",
  你还没有授权任何应用: "You haven't authorized any apps yet",
  佣金余额: "Commission balance",
  "佣金支出 / 净流入": "Commission expense / net inflow",
  佣金流水: "Commission history",
  佣金订单数: "Number of commission orders",
  ...
  使用尾帧图时必须同时提供首帧图: "A last-frame image requires a first-frame image",
  使用日志: "Usage Logs",
  使用模式: "Usage mode",
  使用系统默认比例: "Use system default scale",
  ...
  "例如 0.5 或 2": "For example 0.5 or 2",
  "例如 10 表示新用户首充成功后，代理可获得实付金额的 10%": "For example, 10 means that after a new user successfully deposits for the first time, the agent will receive 10% of the actual payment amount.",
  "例如 901": "For example 901",
  "例如 anthropic-beta": "For example anthropopic-beta",
  "例如 https://docs.newapi.pro": "E.g., https://docs.newapi.pro",
  "例如 https://example.com/api/mch/balance": "For example https://example.com/api/mch/balance",
  "例如 https://example.com/api/pay/query": "For example https://example.com/api/pay/query",
  "例如 https://example.com/api/pay/unifiedorder": "For example https://example.com/api/pay/unifiedorder",
  "例如 https://example.com/api/waffo/webhook": "For example https://example.com/api/waffo/webhook",
  "例如 https://example.com/console/topup": "For example https://example.com/console/topup",
  "例如 M1776096808": "For example M1776096808",
  "例如 service_tier": "For example service_tier",
  "例如：": "For example:",
  ...
  "例如：Credit Card": "For example: Credit Card",
  "例如：email": "e.g.: email",
  ...
  "例如：MER_xxx": "For example: MER_xxx",
  "例如：name、full_name": "e.g.: name, full_name",
  "例如：nginx:latest": "e.g.: nginx:latest",
  "例如：preferred_username、login": "e.g.: preferred_username, login",
  "例如：preview": "e.g.: preview",
  "例如：price_xxx": "For example: price_xxx",
  "例如：prod_6I8rBerHpPxyoiU9WK4kot": "e.g.: prod_6I8rBerHpPxyoiU9WK4kot",
  "例如：PROD_xxx": "For example: PROD_xxx",
  "例如：sk_xxx 或 rk_xxx，留空表示保持当前不变": "For example: sk_xxx or rk_xxx, leave blank to keep the current value unchanged",
  "例如：STO_xxx": "For example: STO_xxx",
  "例如：sub、id、data.user.id": "e.g.: sub, id, data.user.id",
  "例如：whsec_xxx，留空表示保持当前不变": "For example: whsec_xxx, leave it blank to keep the current value unchanged",
  ...
  "例如：清理工具参数，避免上游校验错误": "For example: Clean tool parameters to avoid upstream verification errors",
  "例如：该请求不满足准入策略": "e.g.: This request does not meet the admission policy",
  "例如：违规": "For example: Violation",
  ...
  保存代理分销默认配置: "Save agent distribution default configuration",
  保存修改: "Save changes",
  保存内容审查配置: "Save content review configuration",
  保存分组倍率设置: "Save group ratio settings",
  保存分组相关设置: "Save Group Related Settings",
  "保存后不会回显，请填写当前环境对应的 API 私钥": "It will not be echoed after saving. Please fill in the API private key corresponding to the current environment.",
  "保存后不会回显，请填写当前环境对应的 Stripe API 密钥": "It will not be echoed after saving. Please fill in the Stripe API key corresponding to the current environment.",
  "保存后不会回显，请填写测试环境对应的 API 密钥": "It will not be echoed after saving. Please fill in the API key corresponding to the test environment.",
  "保存后不会回显，请填写测试环境对应的 API 私钥": "It will not be echoed after saving. Please fill in the API private key corresponding to the test environment.",
  "保存后不会回显，请填写生产环境对应的 API 密钥": "It will not be echoed after saving. Please fill in the API key corresponding to the production environment.",
  "保存后不会回显，请填写生产环境对应的 API 私钥": "It will not be echoed after saving. Please fill in the API private key corresponding to the production environment.",
  ...
  "保护密钥、数据和权限边界": "Protect keys, data and permission boundaries",
  保持登录: "stay logged in",
  "保持登录状态（可刷新访问）": "Stay logged in (refresh access available)",
  保留: "kept",
  ...
  信息: "Info",
  "信息不足，无法给出预估（缺少画面尺寸或该分辨率未配置价格）": "Not enough information for an estimate (missing frame size, or no price configured for this resolution)",
  ...
  "允许的时长范围：{{min}} - {{max}} 秒": "Allowed duration: {{min}} - {{max}} seconds",
  允许的端口: "Allowed Ports",
  ...
  元: "CNY",
  充值: "Top Up",
  充值与佣金金额趋势: "Trends in recharge and commission amounts",
  "充值价格（x元/美金）": "Top Up price (x yuan/dollar)",
  "充值价格必须大于 0": "The recharge price must be greater than 0",
  充值价格显示: "Top Up price",
  充值分组倍率: "Top Up group ratio",
  "充值分组倍率不是合法的 JSON 字符串": "Top Up group ratio is not a valid JSON string",
  充值发放: "Top-up rule",
  充值完成后跳回的页面: "The page to jump back to after the recharge is completed",
  充值总额: "Total recharge",
  "充值成功，额度已到账": "The recharge was successful and the amount has been received.",
  充值数量: "Top Up quantity",
  "充值数量，最低 ": "Top Up quantity, minimum",
  充值数量不能大于: "The recharge amount cannot be greater than",
  ...
  充值类型: "Recharge type",
  "充值类计划对每次充值生效，订阅类计划仅首次生效": "Recharge plans apply to every recharge; subscription plans apply on the first payment only",
  充值订单: "Top-up orders",
  充值记录和状态查询: "Recharge records and status inquiry",
  充值账单: "Top Up Bills",
  ...
  兑换码统计: "Redemption Code Statistics",
  兑换额度: "Redeem",
  兜底档: "Fallback",
  入账时间: "Entry time",
  "全场景适配 · 赋能多元业务发展": "Fit for Every Scenario · Powering Diverse Business Growth",
  ...
  全局系统提示词拼接: "Global system prompt word splicing",
  全局系统提示词豁免: "Global system prompt exemption",
  全局设置: "Global Settings",
  全平台: "All platforms",
  "全方位安全，合规可控": "All-Round Security and Compliance",
  全选: "Select all",
  全选当前列表模型: "Select all current list models",
  全部: "All",
  全部供应商: "All vendors",
  全部分组: "All groups",
  ...
  全部标签: "All tags",
  全部模型: "All Models",
  全部正常运行: "All systems operational",
  ...
  全部类型: "All types",
  全部退出: "Sign out all",
  "全面适配 Web 开发、小程序、APP、政企系统、第三方平台对接等各类场景，支持多协议与多数据格式，无缝衔接各类业务系统。": "Fully adapted to web development, mini programs, mobile apps, government/enterprise systems, and third-party integrations, with multi-protocol and multi-format support for seamless connection to any business system.",
  公告: "Announcement",
  公告内容: "Notice Content",
  ...
  关于项目: "About Project",
  "关键字(ID、名称或卡密)": "Keyword (ID, name, or code)",
  关键调用链路可审计: "Key call links are auditable",
  关闭: "Close",
  关闭侧边栏: "Close sidebar",
  关闭公告: "Close Notice",
  ...
  内容: "Content",
  内容审查结果: "Content review results",
  内容审查配置: "Content moderation configuration",
  ...
  "内置接口鉴权、访问限流、异常拦截、数据加密等多重安全机制，精准拦截恶意请求，规范接口访问规则，全方位守护企业接口数据与业务安全。": "Built-in authentication, rate limiting, anomaly interception, and data encryption precisely block malicious requests, standardize API access rules, and protect enterprise API data and business security end to end.",
  "内联图片总大小不能超过 {{limit}}": "Inline images may not exceed {{limit}} in total",
  "内联图片总大小不能超过 45 MB": "Inline images must total 45 MB or less",
  最优可用: "Best available",
  最低: "lowest",
  最低充值数量: "Minimum recharge amount",
  "最低充值数量必须大于 0": "The minimum recharge amount must be greater than 0",
  最低充值美元数量: "Minimum recharge dollar amount",
  "最低充值美元数量必须大于 0": "Minimum recharge dollar amount must be greater than 0",
  "最低实付金额（元）": "Minimum actual payment amount (yuan)",
  最低开票金额: "Minimum invoiceable amount",
  最后使用时间: "Last used time",
  最后更新: "Last Updated",
  最后登录: "last login",
  最后请求: "Last request",
  "最多上传 {{count}} 张参考图_one": "Up to {{count}} reference pictures can be uploaded",
  "最多上传 {{count}} 张参考图_other": "Up to {{count}} reference pictures can be uploaded",
  最多只能指定一张尾帧图: "Only one last-frame image can be selected",
  最多只能指定一张首帧图: "Only one first-frame image can be selected",
  "最多添加 {{limit}} 个参考视频": "You can add up to {{limit}} reference videos",
  "最多添加 {{limit}} 个参考音频": "You can add up to {{limit}} reference audio tracks",
  "最多添加 {{limit}} 张参考图": "You can add up to {{limit}} reference images",
  最大GPU数量: "Max Number of GPUs",
  最大可用: "Max Available",
  最大条目数: "Max Entries",
  最大赠送额度: "Maximum gift amount",
  最大返利金额: "Maximum rebate amount",
  最小充值金额: "Minimum recharge amount",
  最终抵扣: "Final Deduction",
  "最近 {{n}} 次检测": "Last {{n}} checks",
  最近一次: "Last",
  最近一次结果: "Latest result",
  最近事件: "Recent Events",
  最近充值: "Recent recharge",
  最近延迟: "Latest latency",
  最近更新: "Latest updates",
  最近检测: "Last checked",
  最近活动: "Recent activities",
  最高优先级: "highest priority",
  最高充值不能小于最低充值: "The maximum recharge cannot be less than the minimum recharge",
  "最高实付金额（元）": "Maximum actual payment amount (yuan)",
  最高档: "Highest Tier",
  写: "Write",
  准入策略: "Admission Policy",
  "准入策略 JSON（可选）": "Admission Policy JSON (optional)",
  "准备中...": "Preparing...",
  准备好后开始抽奖: "Draw when you are ready",
  准备完成初始化: "Ready to complete initialization",
  减少: "Subtract",
  减少敏感配置暴露: "Reduce sensitive configuration exposure",
  "减少重复开发，快速进入生产环境": "Reduce repeated development and quickly enter the production environment",
  凭证已刷新: "Credentials Refreshed",
  函数: "Functions",
  分佣比例: "commission ratio",
  分佣订单数: "Number of commission orders",
  ...
  分组价格: "Group price",
  "分组价格 = 官方价格 × 分组倍率 ÷ 7": "Group price = official price × group ratio ÷ 7",
  分组倍率: "Group ratio",
  "分组倍率 {{ratio}} × 换算 {{rate}} = 相对官方价 {{effective}}": "Group ratio {{ratio}} × conversion {{rate}} = {{effective}} of official price",
  ...
  分组维度收入: "Group dimension income",
  分组维度消耗: "Grouping dimension consumption",
  分组设置: "Group settings",
  ...
  "删除后无法恢复，且无返利记录的计划才允许删除": "Deletion cannot be restored and plans with no rebate records are allowed to be deleted.",
  ...
  "删除已选 {{selected}} / {{total}}": "Delete selected {{selected}} / {{total}}",
  ...
  功能特性: "Features",
  加价: "Markup",
  "加价 {{percent}}%": "Markup {{percent}}%",
  加入渠道: "Join Channel",
  加入预填组: "Join Pre-filled Group",
  加密存储: "Encrypted Storage",
  加赠: "Extra gift",
  "加载中...": "Loading...",
  加载令牌失败: "Failed to load tokens",
  加载价格配置失败: "Failed to load price configuration",
  ...
  加载抽奖券失败: "Failed to load tickets",
  加载抽奖记录失败: "Failed to load draw records",
  加载抽奖页面失败: "Failed to load the lottery page",
  加载数据分析失败: "Failed to load data analysis",
  "加载日志中...": "Loading logs...",
  加载日志失败: "Failed to load log",
  加载模型价格失败: "Failed to load model pricing",
  ...
  加载邀请信息失败: "Failed to load invitation information",
  ...
  匹配模式: "match pattern",
  匹配类型: "Matching type",
  "区分邀请返利与代理分销带来的充值与激励支出。": "Distinguish between invitation rebates and recharges and incentive expenditures brought by agency distribution.",
  区域: "Region",
  升级分组: "Upgrade Group",
  协助码: "Assistance code",
  ...
  单位地址: "Address",
  单位电话: "Phone",
  "单张图片上限 {{limit}}": "Single image limit: {{limit}}",
  "单张图片大小不能超过 {{limit}}": "A single image may not exceed {{limit}}",
  "单张图片大小不能超过 10 MB": "Each image must be 10 MB or smaller",
  单条影片价格预估: "Per-video price estimate",
  占比: "Proportion",
  卡片视图: "Card view",
  危险: "Danger",
  "历史数据已自动按年/月/日/小时汇总，今日尾段实时计算。": "Historical data is automatically aggregated by year, month, day, and hour, while today's trailing window is calculated in real time.",
  历史消耗: "Consumption",
  原价: "Original price",
  ...
  参与次数: "Number of participations",
  参与限制: "Participation restrictions",
  参数: "parameter",
  参数传递: "In Parameters",
  参数值: "Parameter value",
  参数覆盖: "Parameters override",
  "参数覆盖 JSON 已复制": "Parameter override JSON copied",
  参数覆盖已复制: "Parameter override copied",
  ...
  参数覆盖详情: "Parameter coverage details",
  参数配置: "Parameter Configuration",
  参数配置有误: "Invalid parameter configuration",
  参数错误: "Parameter Error",
  参照生视频: "Reference video generation",
  参考图: "Reference image",
  "参考图（可选，最多 {{count}} 张）_one": "Reference pictures (optional, up to {{count}} pictures)",
  "参考图（可选，最多 {{count}} 张）_other": "Reference pictures (optional, up to {{count}} pictures)",
  "参考图（可选）": "Reference image (optional)",
  "参考图已上传，本次将调用图生视频流程": "A reference image has been uploaded. This request will use the image-to-video flow.",
  "参考影片时长（秒）": "Reference video duration (seconds)",
  参考生成: "Reference generation",
  "参考视频（可选）": "Reference videos (optional)",
  "参考视频链接（https）": "Reference video link (https)",
  "参考视频链接必须是 https 链接": "Reference video links must use https",
  参考素材上限: "Reference media limits",
  参考素材生视频: "Reference media to video",
  "参考音频（可选）": "Reference audio (optional)",
  "参考音频链接（https）": "Reference audio link (https)",
  "参考音频链接必须是 https 链接": "Reference audio links must use https",
  参考音频需要与参考图或参考视频一起使用: "A reference audio must accompany a reference image or video",
  友情链接: "Friendly links",
  发布日期: "Publish Date",
  发布时间: "Publish Time",
  发放奖励: "Distribute rewards",
  ...
  可信: "Reliable",
  "可勾选需要执行的变更：新增会加入渠道模型列表，删除会从渠道模型列表移除。": "You can check the changes that need to be performed: adding will be added to the channel model list, and deleting will be removed from the channel model list.",
  可参与次数: "Number of times you can participate",
  "可参与次数按“单个邀请人”累计命中的不同被邀请用户数计算": 'The number of times that can be participated is calculated based on the number of different invited users that are hit by the "single inviter".',
  可否选取: "Selectable",
  "可在设置页面设置关于内容，支持 HTML & Markdown": "The About content can be set on the settings page, supporting HTML & Markdown",
  "可填写打款渠道、流水号或备注": "You can fill in the payment channel, serial number or remarks",
  "可手动填写，多个 scope 用空格分隔": "Can be filled in manually, separate multiple scopes with spaces",
  可用: "Available",
  可用令牌分组: "Available token groups",
  可用佣金: "Available commissions",
  ...
  可用图片模型: "Available picture models",
  可用性: "Availability",
  可用抽奖券: "Available tickets",
  可用数量: "Available Quantity",
  可用模型: "Available models",
  可用视频模型: "Available video models",
  ...
  "可选，填写图片 URL": "Optional, fill in the image URL",
  "可选，用于复现结果": "Optional, for reproducibility",
  "可选，用于记录用途": "Optional, for logging purposes",
  ...
  可选值: "Optional value",
  可配置独立密钥管理: "Configurable independent key management",
  "各渠道成功率 / 失败率": "Success rate/failure rate of each channel",
  各渠道消耗额度: "Consumption quota of each channel",
  "合计：{{total}}": "Total: {{total}}",
  "合计：文字部分 {{textTotal}} + 音频部分 {{audioTotal}} = {{total}}": "Total: text {{textTotal}} + audio {{audioTotal}} = {{total}}",
  "同一用户可以有多条记录，同一个模型出现在多条记录里也会正常生效。": "The same user can have multiple records, and the same model will take effect normally if it appears in multiple records.",
  "同优先级下，充值按更高金额门槛命中；套餐按更贵的触发套餐命中。": "Under the same priority, the recharge will be hit according to the higher amount threshold; the package will be hit according to the more expensive trigger package.",
  同官方价: "Official price",
  同时满足: "all must match",
  ...
  同步端点: "Sync Endpoints",
  同步返回地址: "Synchronous return address",
  名称: "Name",
  "名称+密钥": "Name + key",
  ...
  启用: "Enable",
  "启用 BLG 支付": "Enable BLG payments",
  "启用 Prompt 检查": "Enable Prompt check",
  "启用 Waffo": "Enable Waffo",
  "启用 Waffo Pancake": "Enable Waffo Pancake",
  ...
  启用全部: "Enable all",
  启用后会按测试环境保存这组配置: "After enabling, this set of configurations will be saved according to the test environment.",
  ...
  "启用后将使用 Waffo 沙盒环境": "When enabled, the Waffo sandbox environment will be used",
  启用图片生成审查: "Enable image generation review",
  ...
  启用文本生成内容审查: "Enable text generation content review",
  ...
  "启用首充赠送时，赠送比例必须大于 0": "When enabling first deposit bonus, the bonus ratio must be greater than 0",
  启用首次充值赠送: "Enable first recharge bonus",
  ...
  "命中多个充值门槛时，会按更高门槛的计划优先": "When multiple recharge thresholds are hit, the plan with the higher threshold will be given priority.",
  命中档位: "Matched Tier",
  命中活动: "hit activity",
  命中率: "Hit Rate",
  ...
  回调通知地址: "Callback notification address",
  团队与项目权限细分: "Team and project permission breakdown",
  固定价格: "Fixed Price",
  ...
  "国家/地区信息将用于适用法律法规、监管要求、平台合规策略及模型服务范围的判定。": "Country/region information will be used to determine applicable laws and regulations, regulatory requirements, platform compliance strategies and model service scope.",
  "国家/地区信息已更新": "Country information updated",
  "国家/地区变更保存后将即时用于模型服务范围判定；提交不真实、不完整或无法核验的信息，平台可依据规则及适用法律法规采取进一步限制措施。": "Once the country/region change is saved, it will be used immediately to determine the scope of the model service; if you submit untrue, incomplete or unverifiable information, the platform may take further restrictive measures in accordance with the rules and applicable laws and regulations.",
  "图 {{images}} / 视频 {{videos}} / 音频 {{audios}}": "Images {{images}} / videos {{videos}} / audios {{audios}}",
  ...
  "图标文件不能超过 100KB，请压缩后重新上传": "The icon file cannot exceed 100KB, please compress it and re-upload it.",
  图混合: "Blend",
  "图片/音频价格（可选）": "Picture/audio price (optional)",
  图片倍率: "Picture magnification",
  ...
  "图片生成审查（作用于 /pg 和 /v1 的 images/generations、images/edits）": "Image generation review (images/generations, images/edits for /pg and /v1)",
  图片生成模型: "Image generation model",
  "图片生成调用：{{symbol}}{{price}} / 1次": "Image generation call: {{symbol}}{{price}} / 1 time",
  图片编辑完成: "Picture editing completed",
  图片设置: "Image settings",
  "图片读取失败，请重试": "Failed to read the image, please try again",
  ...
  图片输入倍率: "Image input magnification",
  ...
  图生文: "Describe",
  图生视频: "Image to Video",
  "在 Stripe 后台创建价格后获得": "Obtained after creating a price in Stripe backend",
  ...
  在线充值活动: "Online recharge activities",
  ...
  "填写后覆盖当前测试环境 API 密钥，留空表示保持当前不变": "After filling in, overwrite the current test environment API key. Leave it blank to keep the current one unchanged.",
  "填写后覆盖当前测试环境 Webhook 公钥，留空表示保持当前不变": "After filling in, overwrite the current test environment Webhook public key. Leave it blank to keep the current one unchanged.",
  "填写后覆盖当前测试环境私钥，留空表示保持当前不变": "After filling in, it will overwrite the current test environment private key. Leave it blank to keep the current one unchanged.",
  "填写后覆盖当前生产环境 API 密钥，留空表示保持当前不变": "After filling in, overwrite the current production environment API key. Leave it blank to keep the current one unchanged.",
  "填写后覆盖当前生产环境 Webhook 公钥，留空表示保持当前不变": "After filling in, it will overwrite the current production environment Webhook public key. Leave it blank to keep the current one unchanged.",
  "填写后覆盖当前生产环境私钥，留空表示保持当前不变": "After filling in, it will overwrite the current production environment private key. Leave it blank to keep the current one unchanged.",
  "填写后覆盖当前私钥，留空表示保持当前不变": "After filling in, overwrite the current private key. Leave it blank to keep the current one unchanged.",
  "填写带https的域名，逗号分隔": "Fill in domains with https, separated by commas",
  "填写平台域名，例如：www.tokenrouter.tech": "Fill in the platform domain name, for example: www.tokenrouter.tech",
  "填写服务器地址后自动生成：": "Auto-generated after entering server address: ",
  "填写测试环境 Waffo 公钥，Base64 或 PEM 内容均可": "Fill in the test environment Waffo public key, Base64 or PEM content can be used",
  "填写生产环境 Waffo 公钥，Base64 或 PEM 内容均可": "Fill in the production environment Waffo public key, Base64 or PEM content can be used",
  ...
  处理上游模型更新: "Handle upstream model updates",
  处理中: "Processing",
  处理代理提现: "Process agent withdrawals",
  处理全部渠道上游更新: "Handle all channel upstream updates",
  处理提现: "Processing withdrawals",
  备份支持: "Backup support",
  备份状态: "Backup state",
  备注: "Remark",
  "备注（选填）": "Note (optional)",
  ...
  复充: "Recharge",
  复充佣金: "Recharge commission",
  复充分成比例: "Fully proportional",
  复充指该被邀请用户首充之后的后续成功充值订单: "Recharge refers to subsequent successful recharge orders after the invited user’s first recharge.",
  复制: "Copy",
  复制代码: "Copy code",
  复制令牌: "Copy token",
  复制令牌失败: "Failed to copy token",
  "复制以下提示词发送给 LLM（如 ChatGPT / Claude），让它帮你设计计费表达式": "Copy the following prompt words and send it to LLM (such as ChatGPT / Claude) and let it help you design the billing expression",
  复制全部: "Copy all",
  复制名称: "Copy name",
  复制失败: "Copy failed",
  ...
  外部平台来源管理: "External platform source management",
  多个命令用空格分隔: "Multiple commands separated by spaces",
  多场景兼容适配: "Multi-Scenario Compatibility",
  ...
  天前: "days ago",
  失败: "Failed",
  "失败/过期单数": "Failed/expired odd number",
  失败原因: "Failure Reason",
  ...
  奖项: "Prize",
  套餐: "Plan",
  套餐信息无效: "Package information is invalid",
  套餐副标题: "Plan Subtitle",
  套餐名称: "Plan Name",
  套餐标题: "Plan Title",
  ...
  "如果你对接的是上游One API或者TokenRouter等转发项目，请使用OpenAI类型，不要使用此类型，除非你知道你在做什么。": "If you are connecting to upstream One API or forwarding projects such as TokenRouter, please use the OpenAI type. Do not use this type unless you know what you are doing.",
  ...
  "如果这里没有你想要的令牌，请点击右上角的「快速创建令牌」新建。": 'If the token you want is not here, please click "Quickly Create Token" in the upper right corner to create a new one.',
  ...
  安全: "Safety",
  安全与权限难管理: "Security and permissions are difficult to manage",
  安全修复: "Security fixes",
  安全合规可控: "Security compliance controllable",
  安全提醒: "Security reminder",
  "安全是 {{name}} 的基础能力，而不是附加功能。": "Security is the basic capability of {{name}}, not an additional feature.",
  ...
  完成: "Complete",
  "完成从原型验证到生产部署的完整 AI 接口调用流程。": "Complete the complete AI interface calling process from prototype verification to production deployment.",
  ...
  "实付金额：": "Actual payment amount: ",
  "实付金额（{{currency}}） = 官方价格（USD） × 分组倍率 × 当前换算（{{rate}} {{currency}}/USD）": "Amount payable ({{currency}}) = official price (USD) × group ratio × current conversion ({{rate}} {{currency}}/USD)",
  "实时记录接口调用次数、响应状态、异常日志等数据，可视化看板直观展示运行状态，助力快速排查问题、持续优化业务。": "Call counts, response statuses, and error logs are recorded in real time, with visual dashboards that surface system health at a glance to speed up troubleshooting and continuous optimization.",
  实时调用监控统计: "Real-Time Call Monitoring",
  实际: "Actual",
  "实际下载尺寸以模型或渠道返回的图片为准，NewAPI 不会压缩或重绘图片": "The actual downloaded size is determined by the image returned by the model or channel; NewAPI does not compress or redraw images.",
  "实际尺寸：{{size}}": "Actual size: {{size}}",
  "实际尺寸：加载后显示": "Actual size: shown after loading",
  实际模型: "Actual model",
  实际环境: "Actual Env",
  实际用量: "Actual usage",
  ...
  实际额度: "Actual Quota",
  "审查失败时放行（fallback）": "Release when review fails (fallback)",
  审计信息: "Audit Info",
  客服协助: "Support assistance",
  "客服协助功能当前未开放，暂时无法在网站提交请求，请留意后续开放通知。": "Support assistance is currently unavailable, so new requests cannot be submitted on the website. Please watch for an availability notice.",
  ...
  密钥隔离: "Key isolation",
  "密钥隔离、权限管控、日志追踪": "Key isolation, permission control, log tracking",
  "密钥隔离、权限配置、日志审计": "Key isolation, permission configuration, log audit",
  密钥预览: "Key preview",
  ...
  对外运营模式: "Default mode",
  对应代理分销已入账佣金: "Commissions have been recorded for corresponding agent distribution",
  ...
  封禁结束时间必须晚于当前时间: "Ban end time must be later than current time",
  ...
  "将令牌配置到 CC Switch": "Configure token to CC Switch",
  将使用匹配分组: "Match grouping will be used",
  将删除: "Deleting",
  ...
  "将把当前编辑中的模型 {{name}} 的价格配置，批量应用到已勾选的 {{count}} 个模型。_one": "The price configuration of the currently edited model {{name}} will be applied to the selected {{count}} models in batches.",
  "将把当前编辑中的模型 {{name}} 的价格配置，批量应用到已勾选的 {{count}} 个模型。_other": "The price configuration of the currently edited model {{name}} will be applied to the selected {{count}} models in batches.",
  ...
  "将立即退出除当前设备外的所有登录，其它设备需要重新登录。": "This will immediately sign out every login except the current device; other devices must sign in again.",
  ...
  小计: "Subtotal",
  尚未使用: "Not used yet",
  尚未获取该模型的能力契约: "This model's capability contract has not been loaded yet",
  尺寸: "Size",
  尾帧: "Last frame",
  "局部重绘-提交": "Vary Region",
  ...
  工具标识: "Tool ID",
  工具调用定价: "Tool call pricing",
  工单管理: "Work order management",
  左侧边栏个人设置: "Personal settings in left sidebar",
  "已上传参考图，本次将调用图片编辑接口": "The reference image has been uploaded. This time the image editing interface will be called.",
  ...
  已产生佣金: "Commission has been generated",
  ...
  "已切换至最优倍率视图，每个模型使用其最低倍率分组": "Switched to optimal magnification view, each model is grouped using its lowest magnification",
  已初始化: "Initialized",
  已删除: "Deleted",
  ...
  "已加载 {{loaded}}/{{total}} 个分组": "Loaded {{loaded}}/{{total}} groups",
  已勾选: "Selected",
  "已勾选 {{count}} 个模型": "{{count}} models selected",
  "已勾选 {{count}} 个模型_one": "{{count}} models checked",
  "已勾选 {{count}} 个模型_other": "{{count}} models checked",
  ...
  已处理: "Resolved",
  "已处理上游模型更新：加入 {{added}} 个，删除 {{removed}} 个，本次忽略 {{ignored}} 个，当前已忽略模型 {{totalIgnored}} 个": "Upstream model updates processed: {{added}} added, {{removed}} deleted, {{ignored}} ignored this time, {{totalIgnored}} models currently ignored",
  已备份: "Backed up",
  已复制: "Copied",
  ...
  "已将模型 {{name}} 的价格配置批量应用到 {{count}} 个模型_one": "Price configuration for model {{name}} has been batch applied to {{count}} models",
  "已将模型 {{name}} 的价格配置批量应用到 {{count}} 个模型_other": "Price configuration for model {{name}} has been batch applied to {{count}} models",
  已开启: "Enabled",
  ...
  "已批量处理上游模型更新：渠道 {{channels}} 个，加入 {{added}} 个，删除 {{removed}} 个，失败 {{fails}} 个": "Upstream model updates have been processed in batches: channels {{channels}}, added {{added}}, deleted {{removed}}, failed {{fails}}",
  已拉取: "Pulled",
  已拒绝: "Rejected",
  已授权应用: "Authorized application",
  已提交: "Submitted",
  "已提交，等待操作员核对": "Submitted — waiting for an operator to check it",
  已提出修改要求: "Change requested",
  已提现佣金: "Withdrawal commission",
  已支付金额: "Amount Paid",
  "已新增 {{count}} 个模型：{{list}}_one": "Added {{count}} model: {{list}}",
  "已新增 {{count}} 个模型：{{list}}_other": "Added {{count}} models: {{list}}",
  "已显示缓存状态，正在刷新": "Showing cached status while refreshing",
  ...
  已服务: "Served",
  已注销: "Logged out",
  已消耗额度: "Quota consumed",
  "已消费，但暂未命中返利计划": "Has spent, but no rebate plan matched yet",
  已消费用户数: "Number of users who have consumed",
  已添加: "Added",
  ...
  "已清理 {{count}} 个日志文件，释放 {{size}}_one": "Cleaned {{count}} log files, freed {{size}}",
  "已清理 {{count}} 个日志文件，释放 {{size}}_other": "Cleaned {{count}} log files, freed {{size}}",
  已清空: "Cleared",
  ...
  已运行时间: "Uptime",
  已返利: "Rewarded",
  已返利人数: "Number of people who have received rebates",
  已退出其他设备: "Signed out other devices",
  已退出该会话: "Exited this session",
  已退出该设备: "Device signed out",
  已退款: "Refunded",
  "已退款但已开票，需人工核对": "Refunded but invoiced; manual review required",
  "已选分组（拖拽调整优先级）": "Selected group (drag and drop to adjust priority)",
  ...
  已邀请人数: "Number of people invited",
  ...
  平台: "platform",
  平台价格数据格式不正确: "The platform price data format is incorrect",
  平台地址格式不正确: "The platform address format is incorrect",
  "平台将在合规审核通过后予以处理；审核完成前，原登记信息持续有效。提交不真实、不完整或无法核验的材料，平台有权驳回申请，并依据平台规则及适用法律法规采取进一步限制措施。": "The platform will handle the matter after passing the compliance review; until the review is completed, the original registration information will remain valid. If you submit untrue, incomplete or unverifiable materials, the platform has the right to reject the application and take further restrictive measures in accordance with the platform rules and applicable laws and regulations.",
  平均: "average",
  平均RPM: "Average RPM",
  平均TPM: "Average TPM",
  平均延迟: "Avg Latency",
  "平均延迟 (7天)": "Avg latency (7d)",
  平移: "Pan",
  年: "year",
  幸运转盘: "Lucky Wheel",
  应付金额: "Amount Due",
  ...
  "开启后，图片生成页面仅会展示此模型，不再依赖模型名称关键字判断": "When enabled, the image generation page will only show this model and will no longer rely on model-name keyword matching.",
  ...
  "开启后，视频生成页面仅会展示此模型，不再依赖模型名称关键字判断": "When enabled, the video generation page will only show this model and will no longer rely on model-name keyword matching.",
  ...
  开启后检测到新增模型会自动加入当前渠道模型列表: "After opening, new models detected will be automatically added to the current channel model list.",
  开启后由后端定时任务检测该渠道上游模型变化: "After it is enabled, the back-end scheduled task will detect changes in the upstream model of the channel.",
  开启后由模型同时生成配音与音效: "When enabled, the model also generates voice-over and sound effects",
  "开启后该渠道不会参与任何并发竞速，但在竞速全部失败时仍可作为兜底通道被尝试": "When enabled, this channel will not participate in any channel race, but it can still be tried as a fallback channel after all racing channels fail",
  开启后该渠道的请求不会被注入全局系统提示词: "When enabled, requests through this channel will not be injected with the global system prompt",
  ...
  异步回调地址: "Asynchronous callback address",
  张图片: " images",
  弱变换: "High Variation",
  ...
  "当前代理分销仅针对新用户通过代理邀请码注册后产生的钱包充值订单生效，购买套餐不参与该分销。": "The current agent distribution is only effective for wallet recharge orders generated by new users after registering with the agent invitation code. Purchase of packages does not participate in this distribution.",
  "当前代理资格已停用，仅保留历史佣金与流水展示，后续不会再产生新的分销收益": "The current agent qualification has been deactivated, only historical commissions and flow displays will be retained, and no new distribution income will be generated in the future.",
  当前令牌没有相容分组: "The selected token has no compatible group",
  当前价格: "current price",
  当前余额: "Current balance",
  当前值: "Current value",
  "当前值不是合法 JSON，无法格式化": "Current value is not valid JSON, cannot format",
  当前充值已满足活动条件: "The current recharge has met the activity conditions",
  当前充值暂未满足活动条件: "The current recharge does not meet the activity conditions yet",
  当前入口状态: "Current entry status",
  ...
  "当前分组暂无可用模型，请切换分组或联系管理员配置": "There are currently no models available in the current group. Please switch groups or contact the administrator for configuration.",
  当前分组没有可用的图片模型: "There are no image models available for the current group",
  当前分组没有可用的视频模型: "No available video models in the current group",
  当前剩余: "Currently Remaining",
  "当前参数覆盖不是合法的 JSON": "Current parameter override is not valid JSON",
  当前参考素材组合不被该模型支持: "This model does not support the current combination of reference media",
  当前可提现佣金: "Current commission available for withdrawal",
  当前周期: "current period",
  当前周期暂无成功充值: "There is no successful recharge in the current cycle.",
  "当前尺寸：{{size}}": "Current size: {{size}}",
  当前提示: "Current Notes",
  ...
  当前时间: "Current time",
  当前暂无可抽奖项: "No prizes available",
  当前暂无可用邀请福利: "There are currently no invitation benefits available.",
  "当前未启用，需要时再打开即可。": "This field is currently disabled. Enable it when needed.",
  当前来源汇率: "Current source exchange rate",
  "当前查看的分组为：{{group}}，{{comparison}}": "Current group: {{group}} — {{comparison}}",
  ...
  当前状态: "Current Status",
  "当前环境共用同一商户 ID": "The current environments share the same merchant ID",
  "当前用户将继承后台代理分销的默认首充/复充比例。": "The current user will inherit the default first recharge/recharge ratio of the backend agent distribution.",
  当前登录账号: "Current login account",
  当前登记地区: "Current registration area",
  当前盈利: "current profit",
  当前绑定: "Bound",
  ...
  "当前账号未开通代理分销，管理员启用后会在这里展示邀请码、分销用户与佣金流水": "The current account has not activated agency distribution. After the administrator activates it, the invitation code, distribution users and commission flow will be displayed here.",
  "当前账户暂不支持用户自行变更国家/地区信息。如确需申请变更，请通过工单提交正式申请，并提供足以证明您当前实际所在国家/地区或主体归属地的真实、完整、有效佐证材料。": "The current account does not allow users to change country/region information on their own. If you really need to apply for a change, please submit a formal application through a work order and provide true, complete, and valid supporting materials that are sufficient to prove your current actual country/region or subject's place of residence.",
  当前账户未开通代理分销: "The current account has not opened agent distribution",
  当前跟随系统: "Currently following system",
  当前邀请福利: "Current invitation benefits",
  "当前金额未达到 Waffo Pancake 的最低充值要求": "The current amount does not meet the minimum recharge requirement of Waffo Pancake",
  当前额度: "Current quota",
  ...
  "当用户请求中已有系统提示词时，会优先拼接此内容；当用户未提供系统提示词时，会自动注入该内容": "When there is a system prompt word in the user's request, this content will be spliced ​​first; when the user does not provide a system prompt word, the content will be automatically injected.",
  ...
  "影片补全 tokens": "video completion tokens",
  影片计费: "Video billing",
  待使用收益: "Proceeds to be used",
  待处理: "Pending",
  待支付单数: "Number of orders to be paid",
  待部署: "Pending Deployment",
  待首单消费: "Awaiting first purchase",
  微信: "WeChat",
  ...
  微信扫码支付: "WeChat scan code payment",
  微信扫码登录: "WeChat scan code to log in",
  微信支付: "WeChat Pay",
  微信群: "WeChat Group",
  微信群二维码: "WeChat group QR code",
  微信群二维码图片链接: "WeChat group QR code image URL",
  ...
  快速创建令牌: "Quick create token",
  "快速响应，高效运行": "Fast response, efficient operation",
  快速开始: "Quick Start",
  "快速开始、API 参考、整合教学与控制台指南。": "Quick start, API reference, integrated tutorial and console guide.",
  快速选择: "Quick Select",
  忽略: "Ignore",
  "思考中...": "Thinking...",
  ...
  "总体成功率 / 失败率": "Overall success rate/failure rate",
  ...
  "您可以在此自行更新国家/地区信息；如未填写，则默认视为未申报。请确保所填信息真实、准确、有效。": "You can update your country/region information here; if not filled in, it will be deemed undeclared by default. Please ensure that the information you fill in is true, accurate and valid.",
  ...
  成功充值次数: "Number of successful recharges",
  "成功兑换额度：": "Successful redemption amount:",
  成功单数: "Success odd number",
  成功后切换亲和: "Switch Affinity on Success",
  成功时自动启用通道: "Enable channel when successful",
  成功率: "success rate",
  成本不可控: "Cost is uncontrollable",
  成本优化: "cost optimization",
  我: "Me",
  我们的使命: "our mission",
  我们解决什么问题: "What problem do we solve?",
  ...
  手动输入: "Manual input",
  手机号: "Phone number",
  手机号或用户名: "Mobile phone number or username",
  "手机号绑定成功！": "Mobile phone number bound successfully!",
  打开: "Open",
  "打开 CC Switch": "Open CC Switch",
  打开侧边栏: "Open sidebar",
  打开导航菜单: "Open navigation menu",
  打开授权页面: "Open Authorization Page",
  打开文档导航: "Open docs navigation",
  扣费: "Charge",
  "执行 GC": "Run GC",
  执行中: "processing",
  扩展价格: "Additional Pricing",
  扫描二维码: "Scan QR code",
  "扫码加入微信群，与大家一起交流使用经验": "Scan the QR code to join the WeChat group and share usage tips.",
  ...
  "批量检测完成：渠道 {{channels}} 个，新增 {{add}} 个，删除 {{remove}} 个，失败 {{fails}} 个": "Batch detection completed: {{channels}} channels, {{add}} added, {{remove}} deleted, {{fails}} failed",
  ...
  抽奖券说明: "Lottery Rules",
  抽奖失败: "Draw failed",
  "抽奖成功，获得": "Draw succeeded; you received",
  抽奖概览: "Lottery overview",
  抽奖活动: "Sweepstakes",
  抽奖活动未开启: "Lottery is not enabled",
  "抽奖活动火热进行中，充值之余别忘了参与抽奖赢取奖励！": "The lottery is live — top up and don't forget to join and win rewards!",
  抽奖记录: "Draw records",
  "拉取中...": "Pulling...",
  拉取价格: "pull price",
  拉取平台价格失败: "Failed to pull platform price",
  拉取新模型: "Pull New Model",
  拉取模型: "Pull Model",
  拉取进度: "Pull Progress",
  拉新贡献: "new contribution",
  拒绝: "reject",
  "拒绝提示模板（可选）": "Rejection Prompt Template (optional)",
  拦截原因: "Block Reason",
  "拦截返回消息（inject_message）": "Intercept return messages (inject_message)",
  "按 1 美元对应的站内价格填写": "Fill in the site price corresponding to 1 USD",
  "按 Cron 表达式定时执行 JS 自动化脚本": "Execute JS automation scripts regularly based on Cron expressions",
  按K显示单位: "Display in K",
  "按上游 usage.completion_tokens 结算": "Settled on the upstream usage.completion_tokens",
  按下单数与已成功订单数计算: "Calculation of number of pressed orders and number of successful orders",
  按价格字段筛选: "Filter by price field",
  按价格设置: "Set by price",
  按倍率类型筛选: "Filter by ratio type",
  按倍率设置: "Set by ratio",
  按分组与模型估算输入输出成本: "Estimating input and output costs by group and model",
  按后续成功充值实付金额计算: "Calculated based on actual payment amount after successful recharge",
  按国家或地区限制模型可见性与调用权限: "Restrict model visibility and calling permissions by country or region",
  按完成支付时间落在当前周期内统计: "Statistics based on payment completion time falling within the current cycle",
  "按实付人民币校验，填 0 表示不限制": "Verify based on actual payment in RMB, fill in 0 to indicate no limit",
  "按应用、令牌、模型的顺序选择后，将配置导入 CC Switch。": "Select an app, token, and models, then import the configuration into CC Switch.",
  "按当前用户分组归档成功充值收入。": "Archive successful recharge income by current user group.",
  按成功充值订单口径统计: "Statistics based on successful recharge orders",
  "按成功日志与错误日志的数量口径计算。": "Calculated based on the number of success logs and error logs.",
  "按成功消费日志汇总各渠道的额度消耗。": "Summarize the quota consumption of each channel according to the successful consumption log.",
  "按成功消费日志统计模型调用次数。": "Count the number of model calls based on successful consumption logs.",
  "按所选日期范围联动查看模型调用、延迟、分组收入、拉新贡献和缓存效率。": "View model calls, delays, grouped revenue, new contribution and cache efficiency by the selected date range.",
  按新用户首次充值实付金额计算: "Calculated based on the actual amount paid by a new user for the first recharge",
  "按日志中的分组字段统计各分组消耗额度。": "The consumption quota of each group is calculated according to the group field in the log.",
  "按日志响应时间计算各渠道平均延迟和长尾延迟。": "Calculate the average delay and long-tail delay of each channel based on the log response time.",
  "按日期连续展示当前周期的消费走势。": "Continuously displays the consumption trend of the current period by date.",
  按模型倍率和分组倍率折算: "Converted according to model magnification and grouping magnification",
  按次: "Per request",
  ...
  "按次：{{symbol}}{{price}} * {{ratioType}}：{{ratio}} = {{symbol}}{{total}}": "Per request: {{symbol}}{{price}} * {{ratioType}}: {{ratio}} = {{symbol}}{{total}}",
  按次价格: "Pay-per-view price",
  按次计费: "Pay per request",
  "按消费 / 错误日志去重统计": "Deduplication statistics by consumption/error log",
  "按消费日志中的缓存命中 token 统计": "Statistics based on cache hit tokens in consumption logs",
  按消费日志口径统计: "Statistics by consumption log caliber",
  "按消费日志统计缓存命中、缓存创建与节省额度。": "Statistics on cache hits, cache creation and savings based on consumption logs.",
  "按渠道聚合成功与错误请求，查看稳定性差异。": "Aggregate successful and error requests by channel to view stability differences.",
  "按照如下格式输入：AccessKey|SecretAccessKey|Region": "Enter in the format: AccessKey|SecretAccessKey|Region",
  按用户创建和首次支付时间统计: "Statistics by user creation and first payment time",
  "按真实概率抽奖，未配置满 100% 的部分会自动计入无奖区。": "Results follow actual probabilities; unassigned probability becomes the miss segment.",
  "按近几天代理用户的下单与支付结果生成统计视图，成功率按下单数与成功单数计算": "Generate a statistical view based on the order and payment results of agent users in recent days. The success rate is calculated by the number of orders placed and the number of successful orders.",
  "按选定周期内的成功消费额度排序。": "Sort by successful consumption amount in the selected period.",
  按量: "According to quantity",
  按量计费: "Pay as you go",
  "按量计费下需要先填写输入价格，才能保存其它价格项。": "For per-token billing, fill in the input price before saving other price fields.",
  "按页面显示额度判断，保存时自动换算，0 表示不限制": "Judgment based on the amount displayed on the page, automatically converted when saving, 0 means no limit",
  "按页面显示额度封顶，保存时自动换算，0 表示不限制": "The amount is capped according to the page display, automatically converted when saving, 0 means no limit",
  ...
  "授权范围 (Scopes)": "Scopes",
  授权请求已失效: "Authorization request has expired",
  排序: "Sort Order",
  排队中: "Queuing",
  接受未设置价格模型: "Accept models without price settings",
  接口凭证: "Interface credentials",
  接口密钥已过期: "API key has expired",
  接收上游模型更新通知: "Receive upstream model update notifications",
  接收发票邮箱: "Invoice recipient email",
  "控制代理资格、分销比例以及查看当前佣金汇总": "Control agent qualifications, distribution ratios, and view current commission summaries",
  控制台: "Console",
  控制台区域: "Console Area",
  ...
  描述: "Description",
  "描述你要生成的画面，例如：赛博朋克城市夜景，霓虹灯，电影感，超清细节": "Describe the scene you want to generate, for example: cyberpunk city night scene, neon lights, cinematic feel, ultra-clear details",
  "描述你要生成的视频，例如：镜头缓慢推进雨夜街道，一只橘猫回头望向镜头，电影感光影": "Describe the video you want to generate, for example: a slow push-in on a rainy street, an orange cat looking back at the camera, cinematic lighting",
  提交: "Submit",
  提交和跟进自己的工单: "Submit and follow up on your own work orders",
  ...
  提升: "Promote",
  提现扣减: "Cash withdrawal deduction",
  提现流水号: "Withdrawal serial number",
  ...
  搜索文档: "Search docs",
  "搜索文档、接口路径、模型名…": "Search documents, interface paths, model names...",
  "搜索文档内容…": "Search documentation…",
  搜索无结果: "No results found",
  搜索日志内容: "Search log content",
  搜索条件: "Search Conditions",
  "搜索标题、正文、接口路径…": "Search titles, body, endpoint paths…",
  搜索模型: "Search models",
  "搜索模型...": "Search models...",
  ...
  "搜索用户名、邮箱或来源订单号": "Search username, email or source order number",
  "搜索用户名、邮箱或订单号": "Search for username, email or order number",
  搜索结果: "Search results",
  搜索聊天应用名称: "Search chat app name",
  "搜索规则（描述 / 类型 / 路径 / 来源 / 目标）": "Search rules (description / type / path / source / target)",
  ...
  "支付处理中，可稍后刷新订阅状态": "Payment is being processed. Subscription status can be refreshed later.",
  "支付处理中，可稍后在充值记录查看状态": "Payment is being processed, you can check the status in the recharge record later.",
  支付失败: "Payment failed",
  "支付失败，请重新发起充值": "Payment failed, please recharge",
  "支付失败，请重新发起购买": "Payment failed, please re-initiate purchase",
  支付完成单数: "Number of payment completed",
  "支付完成后用户跳转的页面，留空则自动使用 服务器地址 + /console/topup": "The page that the user jumps to after payment is completed. If left blank, the server address + /console/topup will be automatically used.",
  支付宝: "Alipay",
  支付宝扫码支付: "Alipay scan code payment",
  支付成功率: "Payment success rate",
  支付方式: "Payment method",
  支付方式分布: "Payment method distribution",
  支付方式名称: "Pay Method Name",
  支付方式名称不能为空: "Payment method name cannot be empty",
  支付方式图标: "Payment method icon",
  支付方式类型: "Pay Method Type",
  支付方式设置: "Payment method settings",
  支付方式颜色: "Payment method color",
  支付时间: "Paid at",
  支付渠道: "Payment Channels",
  支付设置: "Payment",
  支付请求失败: "Payment request failed",
  支付返回地址: "Return URL",
  支付通道不存在: "Payment channel does not exist",
  支付金额: "Paid amount",
  支持: "Supported",
  ...
  "支持使用 {prompt} 占位原始提示词": "Support the use of {prompt} placeholder original prompt word",
  ...
  支持备份: "Supported",
  "支持多个标记，使用换行、逗号、分号或竖线分隔。模型输出包含任一标记时将记录审查结果。": "Multiple tags are supported, separated by newline, comma, semicolon or vertical bar. Review results are logged when the model output contains either flag.",
  ...
  "支持文生视频、首尾帧、参考图与参考视频/音频": "Supports text-to-video, first/last frames, reference images, videos and audio",
  支持的分辨率: "Supported resolutions",
  支持的图像模型: "Supported image models",
  支持的时长: "Supported durations",
  支持的生成模式: "Supported generation modes",
  "支持的生成模式：{{modes}}": "Supported generation modes: {{modes}}",
  支持的画面比例: "Supported aspect ratios",
  支持的输出格式: "Supported output formats",
  "支持精确匹配；使用 regex: 开头可按正则匹配。": "Supports exact matching. Use a regex: prefix for regex matching.",
  "支持自定义请求限流、频率控制、黑白名单配置，灵活管控接口访问流量，避免恶意请求与突发流量冲击，保障业务有序平稳运行。": "Configure rate limits, frequency control, and black/white lists to flexibly govern API traffic, absorb malicious requests and traffic bursts, and keep the business running smoothly and in order.",
  ...
  收起登录会话: "Collapse login session",
  放大: "Upscalers",
  放大编辑: "Expand editor",
  政企项目系统集成: "Gov & Enterprise Systems",
  ...
  "文+图生图": "Text + pictures produce pictures",
  文件上传: "File upload",
  ...
  文心一言: "ERNIE Bot",
  "文本生成内容审查（命中输出标记时记录审查结果）": "Text generation content review (review results recorded when output flags are hit)",
  文档: "Documentation",
  文档中心: "Documentation Center",
  文档加载失败: "Failed to load documentation",
  文档地址: "Document Link",
  文档导航: "Docs navigation",
  文档搜索加载失败: "Failed to load documentation search",
  文档目录: "Docs menu",
  文档空间: "Spaces",
  文档翻页导航: "Docs page navigation",
  文生图: "Vincentian picture",
  文生视频: "Text-to-video",
  新增: "added",
  "新增 / 首充 / 活跃用户趋势": "New/First Deposit/Active User Trends",
  "新增 / 首充用户": "New/first deposit user",
  "新增 Key 来源": "Add Key Source",
  新增供应商: "Add vendor",
  新增失败: "Failed to add",
  新增对比项: "Add comparison items",
  新增封禁: "Add new ban",
  新增封禁记录: "Add ban record",
  "新增已选 {{selected}} / {{total}}": "Add selected {{selected}} / {{total}}",
  新增平台对比: "Added platform comparison",
  新增成功: "Added successfully",
  新增支付方式: "Add new payment method",
  新增条件: "Add Condition",
  新增模型: "Add new model",
  新增用户: "Add new user",
  "新增用户按创建时间统计，首充用户按首次支付时间统计，活跃用户按日志去重统计。": "New users are counted based on creation time, first-time deposit users are counted based on first payment time, and active users are counted based on log deduplication.",
  新增规则: "Add Rule",
  新增订阅: "Add subscription",
  新增邀请计划: "Add invitation plan",
  新密码: "New Password",
  ...
  "无法加载文档内容，请稍后重试": "Unable to load documentation content, please try again later",
  "无法发起 Passkey 注册": "Unable to initiate Passkey registration",
  "无法复制到剪贴板，请手动复制": "Unable to copy to clipboard, please copy manually",
  "无法复制到剪贴板，请重试": "Could not copy to the clipboard. Please try again.",
  "无法构建搜索索引，请稍后重试": "Could not build the search index. Please try again later.",
  无法添加图片: "Unable to add image",
  无法获取容器详情: "Unable to get container details",
  "无法获取模型 {{model}} 的能力契约，暂时无法生成": "The capability contract for {{model}} is unavailable, so generation is disabled",
  无法获取用户信息: "Unable to obtain user information",
  无法读取剪贴板: "Cannot read clipboard",
  无生效: "No active",
  无结果: "No results",
  无说明: "No description",
  无输入影片: "No input video",
  无邀请人: "No Inviter",
  无限: "Unlimited",
  无限制: "Unlimited",
  ...
  "时长必须在 {{min}} - {{max}} 秒之间": "Duration must be between {{min}} and {{max}} seconds",
  时间: "Time",
  ...
  易支付设置: "Easy payment settings",
  星期: "Weekday",
  昨天充值: "Recharge yesterday",
  是: "Yes",
  ...
  是否检测上游模型更新: "Whether to detect upstream model updates",
  "是否确认充值？": "Confirm the recharge?",
  是否自动同步上游模型更新: "Whether to automatically synchronize upstream model updates",
  ...
  显示调试: "Show debug",
  晚上好: "Good evening",
  "普通按量/按次直接填价格就行；如果价格要跟请求参数或请求头联动，请切到表达式/阶梯计费。": "Normally, just fill in the price directly by volume/per time; if the price needs to be linked to request parameters or request headers, please switch to Expression/Ladder Billing.",
  ...
  暂无抽奖券: "No tickets",
  "暂无支付方式，点击上方按钮新增": "There is no payment method yet, click the button above to add",
  暂无数据: "No data",
  "暂无数据，点击下方按钮添加键值对": "No data, click the button below to add key-value pairs",
  "暂无文档 Space。管理员可在控制台文档工作室创建并发布。": "No document Space yet. Administrators can create and publish documents in the console document studio.",
  暂无日志: "No logs",
  暂无日志可下载: "No logs available to download",
  暂无日志可复制: "No logs available to copy",
  暂无机密环境变量: "No secret environment variables",
  暂无模型: "No models",
  暂无模型封禁记录: "There is currently no model ban record",
  ...
  暂无相容模型: "No compatible model yet",
  ...
  暂无赠送日志: "No gift log yet",
  暂无邀请码: "No invitation code yet",
  暂无邀请计划: "No invitation plan yet",
  暂无邀请链接: "No invitation link yet",
  暂无项目: "No projects",
  暂无预填组: "No prefilled groups",
  暂时还没有代理佣金流水: "There is no agency commission flow yet",
  暂时还没有代理充值流水: "There is no agent recharge flow yet",
  暂时还没有代理邀请用户: "There is no agent to invite users yet",
  暂时还没有邀请用户: "No users have been invited yet",
  暂时还没有邀请额度流水: "There is no invitation quota transfer yet.",
  ...
  更新: "Update",
  "更新 BLG 支付设置": "Update BLG payment settings",
  "更新 Creem 设置": "Update Creem Settings",
  "更新 Stripe 设置": "Update Stripe settings",
  "更新 Waffo Pancake 设置": "Update Waffo Pancake settings",
  "更新 Waffo 设置": "Update Waffo settings",
  ...
  更新全局系统提示词拼接: "Update global system prompt word splicing",
  ...
  有效至: "Valid until",
  "有输入/参考影片": "Input/reference video",
  ...
  "未上传参考图时，默认调用文生图接口": "When no reference picture is uploaded, the Vincent picture interface is called by default.",
  "未上传参考图时，默认调用文生视频流程": "When no reference image is uploaded, the text-to-video flow is used by default.",
  未中: "Miss",
  未中奖: "Miss",
  未中奖次数: "Misses",
  未产生佣金: "No commission accrued",
  未使用: "Unused",
  ...
  未开始: "Not Started",
  未开票: "Not invoiced",
  未找到匹配的文档: "No matching documents found",
  未找到匹配的模型: "No matching model found",
  未找到可用的容器访问地址: "No available container access address found",
  "未找到差异化价格，无需同步": "Differentiated price not found, no synchronization required",
  ...
  未被配置的概率区间: "Unassigned probability segment",
  未设置: "Not set",
  未设置价格: "Price not set",
  未设置价格模型: "Models without price settings",
  未设置倍率模型: "Models without ratio settings",
  未设置路径: "No path configured",
  未请求任何额外权限: "No additional permissions requested",
  未返回该模型的能力契约: "No capability contract was returned for this model",
  未配置模型: "No model configured",
  未配置的模型列表: "Models not configured",
  未首单消费: "Not the first purchase",
  本地: "Local",
  本地数据存储: "Local data storage",
  本地计费: "Local billing",
  本月获得: "This month",
  "本次未中奖，再接再厉": "No luck this time. Try again!",
  "本次未中奖，再试一次": "Missed this time, try again",
  本站: "This site",
  "本站来源使用该汇率，外部平台可在下方单独配置。": "The source of this site uses this exchange rate, and external platforms can be configured separately below.",
  "本站汇率（CNY/USD）": "Exchange rate on this site (CNY/USD)",
  "本设备：手机指纹/面容，外接：USB安全密钥": "Built-in: phone fingerprint/face, External: USB security key",
  本设备内置: "Built-in device",
  本页暂无目录: "No headings on this page",
  本页目录: "On this page",
  ...
  来源订单号: "Source order number",
  "来自模型重定向，尚未加入模型列表": "From model redirect, not yet added to the model list",
  "来自能力契约 {{profile}} 修订 {{revision}}": "From capability contract {{profile}} revision {{revision}}",
  "某些配置更改可能需要几分钟才能生效。": "Some configuration changes may take a few minutes to take effect.",
  查单地址: "Check address",
  查看: "Open",
  "查看 Codex 帐号信息与用量": "View Codex account information and usage",
  "查看 JSON 示例": "View JSON example",
  查看你可使用的分组: "See which groups you can use",
  查看你可使用的模型: "View the models available to you",
  查看关联部署: "View Associated Deployment",
  查看和筛选充值记录: "View and filter recharge records",
  查看图片: "View pictures",
  查看图片和文本审查结果: "View image and text review results",
  查看图片和文本的审查记录: "View review history for images and text",
  查看密钥: "View key",
  查看并退出你账户当前的登录设备: "View and sign out the devices currently logged in to your account",
  查看开票: "View invoice",
  查看当前可用的所有模型: "View all available models",
  "查看当前邀请福利，管理邀请列表，并追踪邀请额度流水": "View current invitation benefits, manage invitation lists, and track invitation quota flow",
  "查看所有可用的AI模型供应商，包括众多知名供应商的模型。": "View all available AI model suppliers, including models from many well-known suppliers.",
  "查看抽奖券、参与抽奖和中奖记录": "View raffle tickets, participate in raffles and win records",
  查看接口文档: "View interface documentation",
  查看日志: "View Logs",
  查看来源: "View source",
  查看渠道密钥: "View channel key",
  查看登录会话: "View login session",
  查看示例: "View Example",
  查看该应用对你账户的用量: "View the usage of this app on your account",
  查看详情: "View Details",
  "查看邀请码、邀请用户、充值流水和佣金流水": "Check the invitation code, invited users, recharge flow and commission flow",
  查询: "Query",
  查询视频任务状态失败: "Failed to query video task status",
  标准价格: "Standard price",
  标签: "Label",
  ...
  核对中: "Under review",
  "核心优势 · 为什么选择 {{name}}": "Core Strengths · Why Choose {{name}}",
  ...
  "根据相关法律法规，您所在的国家/地区不受支持，我们无法为您提供相关服务。": "According to relevant laws and regulations, your country/region is not supported and we are unable to provide you with related services.",
  格式: "Format",
  格式化: "Format",
  ...
  检测全部渠道上游更新: "Detect all channel upstream updates",
  ...
  "检测完成：新增 {{add}} 个，删除 {{remove}} 个": "Detection completed: {{add}} added, {{remove}} deleted",
  检测超时: "Probe timed out",
  概率: "Probability",
  概览: "Overview",
  模型: "Model",
  "模型 {{model}} 的能力契约不可用": "The capability contract for {{model}} is unavailable",
  ...
  "模型价格：{{symbol}}{{price}} / 次": "Model price: {{symbol}}{{price}} / request",
  模型价格数据可能已过期: "Model pricing data may be stale",
  模型价格未配置: "Model Price Not Configured",
  模型优化提示词: "Model optimization prompt words",
  模型倍率: "Model ratio",
  ...
  模型可用区: "Model available area",
  模型名称: "Model Name",
  模型名称已存在: "Model name already exists",
  模型固定价格: "Model price per call",
  模型图标: "Model icon",
  "模型地址 BaseURL": "Model address BaseURL",
  "模型定价，需要登录访问": "Model pricing, requires login to access",
  模型定价设置: "Model Pricing",
  模型封禁: "Model ban",
  模型广场: "Model Marketplace",
  模型广场尚未配置可用的供应商和分组: "No provider and group with available models have been configured for the marketplace",
  ...
  模型版本: "Model version",
  模型状态: "Model Status",
  模型状态页未启用: "The model status page is not enabled",
  ...
  模型组: "Model group",
  模型缓存倍率: "Model cache magnification",
  ...
  欧元: "EUR",
  止: "To",
  正则替换: "Regular replacement",
  正在加载分组计价规则: "Loading group pricing rule",
  "正在加载可用部署位置...": "Loading available deployment locations...",
  "正在加载模型...": "Loading model...",
  "正在加载模型能力契约，请稍候": "Loading the model capability contract, please wait",
  "正在加载模型能力契约...": "Loading the model capability contract...",
  "正在加载签到状态...": "Loading check-in status...",
  "正在同步上游价格，请稍候": "Synchronizing upstream prices, please wait.",
  "正在同步价格，请稍候": "Synchronizing prices, please wait.",
  "正在处理，请稍候": "Processing, please wait.",
  "正在处理大内容...": "Processing large content...",
  "正在批量处理，请稍候": "Batch processing in progress, please wait.",
  "正在批量检测，请稍候": "Batch testing is in progress, please wait.",
  "正在抽奖...": "Drawing...",
  正在提交: "Submitting",
  "正在构建搜索索引…": "Building search index…",
  "正在构造请求体预览...": "Constructing request body preview...",
  "正在检测，请稍候": "Detecting, please wait.",
  "正在测试第 ${current} - ${end} 个模型 (共 ${total} 个)": "Testing model ${current} - ${end} (total ${total})",
  "正在生成 ({{seconds}} s)": "Generating ({{seconds}} s)",
  ...
  "此授权请求已失效或过期，请返回应用重新发起授权": "This authorization request has expired or expired. Please return to the app to re-initiate authorization.",
  ...
  此支付方式最高充值金额为: "The maximum recharge amount for this payment method is",
  ...
  "每个充值单位对应的 USD 金额，默认 1.0": "USD amount corresponding to each recharge unit, default 1.0",
  ...
  "每个对比项都可选择来源（本站/外部平台），再分别选择分组和模型进行可视化对比。各来源按自己的汇率计算。": "You can select the source (this site/external platform) for each comparison item, and then select groups and models for visual comparison. Each source calculates its own exchange rate.",
  "每个档位可设置 0~2 个条件（对 len、p 和 c），最后一档为兜底档无需条件。len 为输入上下文总长度（含缓存），推荐用于阶梯条件。": "Each gear can set 0~2 conditions (for len, p and c), and the last gear is the bottom gear without conditions. len is the total length of the input context (including cache), which is recommended for ladder conditions.",
  ...
  每个模型使用其最低可用分组倍率: "Each model uses its lowest available group ratio",
  ...
  每位邀请人可参与: "Each inviter can participate",
  每周: "Weekly",
  每天: "Daily",
  每容器GPU数: "GPUs per Container",
  "每日仅可签到一次，请勿重复签到": "Only one check-in per day, please do not check in repeatedly",
  每日充值金额: "Daily recharge amount",
  每日支付成功率: "Daily payment success rate",
  每日消耗额度: "Daily consumption quota",
  每日签到: "Daily Check-in",
  ...
  "比较模型价格，按供应商、分组和能力快速找到适合你的模型。": "Compare model pricing and quickly find the right model by provider, group, and capability.",
  永不过期: "Never expires",
  永久: "permanent",
  ...
  活动: "Activity",
  活动优惠以支付完成时系统配置为准: "Event discounts are subject to system configuration when payment is completed.",
  活动到期时间: "Activity expiration time",
  活跃: "active",
  活跃文件: "Active Files",
  活跃用户: "active users",
  ...
  测活: "Health Check",
  测试: "Test",
  "测试 Webhook 公钥": "Test webhook public key",
  测试中: "Testing",
  "测试中...": "Testing...",
  ...
  "测试环境 Webhook 验签公钥 Base64": "Test environment Webhook signature verification public key Base64",
  ...
  消耗额度: "Used Quota",
  消费: "Consume",
  消费后即可获得返利: "Rebate is granted after the invitee spends",
  深色: "Dark",
  深色模式: "Dark Mode",
  添加: "Add",
  "添加 (+:)": "Add (+:)",
  ...
  "渠道平均响应 / P95 / P99": "Channel average response / P95 / P99",
  ...
  "满足条件时，整单价格乘以 X；如果有多条同时命中，会继续相乘。": "When the conditions are met, the entire order price is multiplied by X; if there are multiple hits at the same time, the multiplication will continue.",
  演示站点: "Demo Site",
  ...
  点击处理删除模型: "Click Process to delete the model",
  点击处理新增模型: "Click to process the new model",
  ...
  现在: "Now",
  "生产 Webhook 公钥": "Produce webhook public key",
  生产环境: "production environment",
  "生产环境 RSA 私钥 Base64 (PKCS#8 DER)": "Production RSA private key Base64 (PKCS#8 DER)",
  "生产环境 Waffo API 密钥": "Production Waffo API key",
  "生产环境 Waffo 公钥 Base64 (X.509 DER)": "Production Waffo public key Base64 (X.509 DER)",
  "生产环境 Webhook 验签公钥 Base64": "Production environment Webhook signature verification public key Base64",
  生成: "Generation",
  生成令牌: "Generate Token",
  ...
  生成配置链接失败: "Failed to create configuration link",
  生成音乐: "generate music",
  生成音频: "Generate audio",
  生效: "Active",
  生效中: "Taking effect",
  "用于“1M输入（含缓存）”估算，示例：0.95。": 'For "1M input (including cache)" estimate, example: 0.95.',
  "用于API调用的身份验证令牌，请妥善保管": "Authentication token for API calls, please keep it safe",
  用于切换当前下单和回调校验所使用的环境: "Used to switch the environment used for current order placement and callback verification",
  用于唯一标识用户的字段路径: "Field path for uniquely identifying users",
  "用于校验 Stripe Webhook 签名，保存后不会回显": "Used to verify Stripe Webhook signature, will not be echoed after saving",
  "用于校验测试环境的 Waffo Pancake Webhook 签名": "Waffo Pancake Webhook signature for verifying test environment",
  "用于校验测试环境的 Waffo 回调签名": "Waffo callback signature used to verify test environment",
  "用于校验生产环境的 Waffo Pancake Webhook 签名": "Waffo Pancake Webhook signature verification for production environments",
  "用于校验生产环境的 Waffo 回调签名": "Waffo callback signature for verifying production environment",
  ...
  用户单次最少可充值的美元数量: "The minimum amount of US dollars that a user can recharge at a time",
  ...
  用户名称: "User Name",
  "用户在充值页面看到的支付方式名称，例如：Credit Card": "The name of the payment method that users see on the recharge page, for example: Credit Card",
  用户工单处理: "User work order processing",
  ...
  "用户消耗排名 Top 10": "Top 10 user consumption rankings",
  ...
  "用量统计、模型选择、成本优化": "Usage statistics, model selection, cost optimization",
  用量范围: "Usage Range",
  ...
  申请编号: "Request ID",
  "画面 {{width}}×{{height}}，计费时长 {{seconds}} 秒，预估影片补全 tokens {{tokens}}": "Frame {{width}}×{{height}}, billed duration {{seconds}}s, estimated video completion tokens {{tokens}}",
  "画面 {{width}}×{{height}}，预估影片补全 tokens {{tokens}}": "Frame {{width}}×{{height}}, estimated video completion tokens {{tokens}}",
  画面比例: "Aspect ratio",
  界面语言和其他个人偏好: "Interface language and other personal preferences",
  留空使用系统临时目录: "Leave empty to use system temp directory",
  "留空则使用 /console/topup?show_history=true": "Leave blank to use /console/topup?show_history=true",
  留空则使用账号绑定的邮箱: "If left blank, the email address bound to the account will be used",
  留空则使用默认回调地址: "Leave blank to use the default callback address",
  ...
  "留空则自动使用 服务器地址 + /api/waffo/webhook": "Leave blank to automatically use the server address + /api/waffo/webhook",
  留空则自动使用当前站点的默认充值页地址: "If left blank, the default recharge page address of the current site will be automatically used.",
  ...
  "留空时默认使用服务器地址作为回调地址，填写后将覆盖默认值": "If left blank, the server address will be used as the callback address by default. Filling in will overwrite the default value.",
  "留空表示保留当前密钥，仅在需要更换时重新填写": "Leave it blank to keep the current key and only refill it if you need to change it.",
  留空表示长期有效: "Leave blank to indicate long-term validity",
  "登 录": "Log In",
  登录: "Sign in",
  登录会话: "Login session",
  登录你的账号: "Log in to your account",
  ...
  相关: "Related",
  相关产品入口: "Related product entrance",
  相关文档: "Related docs",
  ...
  "确定要仅检测全部渠道上游模型更新吗？（不执行新增/删除）": "Are you sure you want to detect only all channel upstream model updates? (Add/delete will not be performed)",
  ...
  "确定要对全部渠道执行上游模型更新吗？": "Are you sure you want to perform an upstream model update for all channels?",
  ...
  "确认删除该邀请计划？": "Confirm to delete this invitation plan?",
  "确认删除这条模型封禁记录？": "Are you sure to delete this model ban record?",
  确认取消密码登录: "Confirm cancel password login",
  "确认后会从可提现佣金扣减，并累计到已提现佣金，同时写入代理佣金流水。": "After confirmation, it will be deducted from the withdrawable commission and accumulated to the withdrawable commission, and written into the agency commission flow.",
  确认启用: "Confirm Enable",
  确认密码: "Confirm Password",
  确认导入配置: "Confirm import configuration",
  确认延长: "Confirm Extension",
  确认延长容器时长: "Confirm Container Duration Extension",
  确认扣减: "Confirm deduction",
  ...
  确认解除授权: "Confirm deauthorization",
  确认设置并完成初始化: "Confirm settings and complete initialization",
  确认退出该会话: "Confirm to exit this session",
  确认退出该设备: "Sign out this device?",
  ...
  "示例：claude-opus-4-8 输入价，官方 ￥35.00，Claude lite（特价） ￥3.50": "Example: claude-opus-4-8 input price — official ¥35.00; Claude lite (special price) ¥3.50",
  "示例：官方 {{officialPrice}} × {{groupRatio}} × {{rate}} {{currency}}/USD = {{payable}}": "Example: official {{officialPrice}} × {{groupRatio}} × {{rate}} {{currency}}/USD = {{payable}}",
  "示例：官方 {{officialPrice}} × {{groupRatio}} × {{rate}} {{currency}}/USD = {{payable}}（优惠 {{adjustmentPercent}}%）": "Example: official {{officialPrice}} × {{groupRatio}} × {{rate}} {{currency}}/USD = {{payable}} ({{adjustmentPercent}}% discount)",
  "示例：官方 {{officialPrice}} × {{groupRatio}} × {{rate}} {{currency}}/USD = {{payable}}（加价 {{adjustmentPercent}}%）": "Example: official {{officialPrice}} × {{groupRatio}} × {{rate}} {{currency}}/USD = {{payable}} ({{adjustmentPercent}}% markup)",
  视频: "Video",
  视频Remix: "Video remix",
  视频不可用: "Video unavailable",
  视频任务已提交: "Video task submitted",
  "视频任务已提交，系统会每 5 秒自动查询一次结果": "The video task has been submitted. The system will automatically poll every 5 seconds.",
  "视频已完成，但未返回可播放地址": "The video has completed, but no playable URL was returned.",
  ...
  等待首单消费后判定返利: "Wait for the rebate to be determined after the first purchase.",
  筛选: "Filter",
  ...
  "简化接口调用，赋能业务高效运转": "Simplify API calls and power efficient business operations",
  ...
  管理员可视化报表中心: "Administrator Visual Report Center",
  管理员尚未配置需要展示的分组: "The administrator has not configured any groups to display yet",
  管理员尚未配置需要展示的套餐: "The administrator has not configured the packages that need to be displayed",
  管理员尚未配置需要展示的模型: "The administrator has not configured the model that needs to be displayed",
  管理员暂时未设置任何关于内容: "The administrator has not set any custom About content yet",
  管理员暂未配置微信群二维码: "The admin has not configured the WeChat group QR code yet.",
  ...
  管理员未开启支付宝充值: "The administrator has not enabled Alipay recharge.",
  "管理员未开启支付宝充值！": "The administrator has not enabled Alipay recharge!",
  "管理员未开启聚合支付！": "The administrator has not enabled aggregate payment!",
  ...
  管理已获得你账户访问权限的第三方应用: "Manage third-party apps that have gained access to your account",
  ...
  "粘贴图片链接（http/https）": "Paste an image link (http/https)",
  精确: "Exact",
  精选: "Featured",
  系统: "System",
  ...
  索引: "Index",
  紧凑列表: "Compact list",
  "纯字符串会直接覆盖整条请求头，或者点击“查看 JSON 示例”按 token 规则处理。": 'The pure string will directly cover the entire request header, or click "View JSON Example" to process it according to token rules.',
  ...
  累计获得: "Total received",
  累计贡献佣金: "Cumulative contribution commission",
  "累计返利 {{quota}}（共 {{count}} 次）": "Total rebate {{quota}} ({{count}} times)",
  "累计返利 {{quota}}（共 {{count}} 次）_one": "Accumulated rebate {{quota}} (total {{count}} times)",
  "累计返利 {{quota}}（共 {{count}} 次）_other": "Accumulated rebate {{quota}} (total {{count}} times)",
  累计邀请奖励: "Cumulative invitation rewards",
  累进阶梯: "Graduated Tier",
  ...
  "终态以上游 usage.completion_tokens 为准": "The terminal amount uses the upstream usage.completion_tokens",
  终止中: "Terminating",
  ...
  统计周期内代理用户创建的充值订单: "Recharge orders created by agent users within the statistical period",
  统计周期内完成支付的成功金额: "The successful amount of payment completed within the statistical period",
  ...
  "缓存创建 Token": "Cache creation token",
  ...
  网关处理用时: "Gateway processing time",
  ...
  自动填入: "Auto-fill",
  自动时长: "Auto duration",
  "自动时长将以 -1 发送，由模型自行决定": "Auto duration is sent as -1 and left to the model",
  自动检测: "Auto-detect",
  自动模式: "Auto Mode",
  ...
  "自动表示由模型决定分辨率，不发送尺寸参数": "Auto lets the model decide the resolution; no size parameter is sent",
  自动选择: "Auto Select",
  ...
  自定义流量管控: "Custom Traffic Control",
  ...
  获取代理分销信息失败: "Failed to obtain agent distribution information",
  获取代理统计失败: "Failed to obtain agent statistics",
  获取令牌密钥失败: "Failed to get token key",
  获取佣金流水失败: "Failed to obtain commission flow",
  获取充值流水失败: "Failed to obtain recharge water",
  ...
  获取已授权应用失败: "Failed to obtain authorized application",
  ...
  获取登录会话失败: "Failed to get login session",
  获取登录设备失败: "Failed to load login devices",
  ...
  获取邀请流水失败: "Failed to obtain invitation turnover",
  ...
  表格: "Table",
  表格视图: "Table view",
  "表达式/阶梯计费": "Expression/tiered billing",
  表达式编辑: "Expression Editor",
  表达式计费: "Expression billing",
  ...
  "规则描述（可选）": "Rule description (optional)",
  ...
  "解除后 {{name}} 将立即失去对你账户的访问权限，其已签发的令牌会全部失效。": "After deactivation, {{name}} will immediately lose access to your account, and all its issued tokens will become invalid.",
  解除授权: "Deauthorize",
  解除授权失败: "Deauthorization failed",
  触发套餐: "trigger package",
  ...
  计算成本: "Calculate Cost",
  计算盈利: "Calculate profit",
  计算盈利失败: "Profit calculation failed",
  ...
  "订阅购买成功，已生效": "Subscription purchased successfully and has taken effect",
  认证方式: "Auth Style",
  "让 AI 接口接入更简单": "Make AI interface access easier",
  ...
  设请求头: "Assume request header",
  访问容器: "Access Container",
  访问限制: "Access Restrictions",
  "该供应商会连同参考影片时长一起计费。": "This provider bills the reference video duration in addition to the output.",
  "该供应商提供多种AI模型，适用于不同的应用场景。": "This supplier provides multiple AI models, suitable for different application scenarios.",
  该入口仅用于一次性余额充值: "This entrance is only used for one-time balance recharge",
  该分类下没有可用模型: "No available models under this category",
  该分组下暂无可展示的模型: "No models to display in this group",
  "该分辨率不在模型能力契约内，不会被提供": "This resolution is not in the model capability contract and is not offered",
  "该分辨率没有已知的画面尺寸，请手动填写宽高，否则无法给出预估。": "This resolution has no known frame size — enter width and height manually, otherwise no estimate can be shown.",
  该域名已存在于白名单中: "The domain already exists in the whitelist",
  该套餐下暂无可展示的模型: "There are currently no models to display under this package",
  "该套餐未配置 Creem": "This plan is not configured for Creem",
  "该套餐未配置 Stripe": "This plan is not configured for Stripe",
  "该应用可以代表你发起 AI 请求，产生的费用将从你的账户余额中扣除。": "The app can make AI requests on your behalf, and fees will be deducted from your account balance.",
  该应用将获得以下权限: "The app will get the following permissions",
  该应用暂无登录会话: "There is currently no login session for this application",
  "该数据可能不可信，请谨慎使用": "This data may not be reliable, please use with caution",
  该文档可能已被移动或删除: "This document may have been moved or deleted",
  ...
  "该模型不支持：{{list}}": "Not supported by this model: {{list}}",
  "该模型不支持{{mode}}": "This model does not support {{mode}}",
  "该模型不支持仅用参考音频生成，请再添加一张参考图或一个参考视频": "This model does not support audio-only reference generation; add a reference image or video",
  该模型不支持没有参考图的参考视频生成: "This model does not support reference generation without a reference image",
  "该模型在{{mode}}下不接受参考图": "This model accepts no image in {{mode}}",
  "该模型存在固定价格与倍率计费方式冲突，请确认选择": "The model has a fixed price and ratio billing method conflict, please confirm the selection",
  "该模型的参考生成至少需要 {{limit}} 张参考图，仅提供参考视频或音频不被支持": "Reference generation on this model requires at least {{limit}} reference image; reference videos or audios alone are not supported",
  ...
  该渠道暂无可处理的上游模型更新: "This channel currently has no upstream model updates to process.",
  该渠道未开启上游模型更新检测: "Upstream model update detection is not enabled for this channel",
  ...
  请使用支付宝扫码支付: "Please use Alipay to scan the QR code to pay",
  ...
  请先新增模型或从左侧列表选择一个模型: "Please add a new model first or select a model from the list on the left",
  ...
  请先选择不低于最低额度的充值金额: "Please select a recharge amount that is no less than the minimum amount first",
  请先选择令牌: "Please select a token first",
  "请先选择供应商，再选择分组": "Select a provider, then select a group",
  ...
  "请在 Waffo 后台获取 API 密钥、商户 ID 以及 RSA 密钥对，并配置回调地址。": "Please obtain the API key, merchant ID and RSA key pair in the Waffo backend, and configure the callback address.",
  ...
  "请填写当前环境对应的 Product ID": "Please fill in the Product ID corresponding to the current environment",
  "请填写当前环境对应的 Store ID": "Please fill in the Store ID corresponding to the current environment",
  "请填写当前环境对应的商户 ID": "Please fill in the merchant ID corresponding to the current environment",
  ...
  "请求体超过该模型的 {{limit}} 字节上限，请减少或压缩参考素材": "The request body exceeds this model’s {{limit}}-byte limit; remove or compress reference media",
  ...
  请求含参考影片: "Request includes a reference video",
  请求域名: "Request domain",
  请求失败: "Request failed",
  请求头: "Request header",
  请求头覆盖: "Request header override",
  "请求尺寸：{{size}}": "Requested size: {{size}}",
  "请求尺寸是发送给模型的目标值，实际输出以模型或渠道返回为准": "The requested size is the target sent to the model; actual output depends on the model or channel response.",
  请求并计费模型: "Request and charge model",
  "请求时长: ${time}s": "Request time: ${time}s",
  请求条件调价: "Request condition price adjustment",
  ...
  "请确保你的服务可被支付网关回调访问，并在网关侧正确配置白名单与回调地址。": "Please ensure that your service can be accessed by the payment gateway callback, and the whitelist and callback address are correctly configured on the gateway side.",
  ...
  "请确认分组下存在与当前应用相容的模型，或稍后重试模型加载。": "Confirm a group has models compatible with this app, or retry loading models later.",
  ...
  "请稍后再来查看，或联系管理员获取入群方式。": "Please check again later, or contact the admin for the group invite.",
  ...
  请联系管理员在系统设置中启用模型状态页: "Please contact an administrator to enable the model status page in system settings",
  ...
  '请输入 JSON 格式的密钥内容，例如：\n{\n  "type": "service_account",\n  "project_id": "your-project-id",\n  "private_key_id": "...",\n  "private_key": "...",\n  "client_email": "...",\n  "client_id": "...",\n  "auth_uri": "...",\n  "token_uri": "...",\n  "auth_provider_x509_cert_url": "...",\n  "client_x509_cert_url": "..."\n}': `Please enter the key content in JSON format, for example:
{
  ...
  "请输入 Product ID": "Please enter Product ID",
  "请输入 Slug": "Please enter Slug",
  "请输入 Store ID": "Please enter Store ID",
  ...
  "请输入商户 ID": "Please enter merchant ID",
  ...
  "请输入密钥！": "Please enter the key!",
  请输入密钥前缀或尾号: "Enter a key prefix or suffix",
  "请输入封禁原因，用户会直接看到这段原因": "Please enter the reason for the ban. Users will see the reason directly.",
  请输入延长时长: "Please enter extension duration",
  请输入总额度: "Please enter total quota",
  请输入您的密码: "Please enter your password",
  请输入您的手机号或用户名: "Please enter your mobile phone number or username",
  ...
  请输入支付方式名称: "Please enter payment method name",
  请输入数值: "Enter a value",
  ...
  请输入有效的图片链接: "Please enter a valid image link",
...
Supports using model mapping format
{
  ...
  请选择返利套餐: "Please select a rebate package",
  请选择通知方式: "Please select notification method",
  请选择需要封禁的模型: "Please select the model to be banned",
  读取你的基本资料: "Read your basic information",
  读取你的邮箱地址: "Read your email address",
  调整额度: "Adjust Quota",
  调整额度成功: "Quota adjusted successfully",
  调用模型排名: "Call model ranking",
  调用次数: "Call Count",
  调用次数分布: "Models call distribution",
  调用次数排行: "Models call ranking",
  调用稳定性不足: "Inadequate call stability",
  调用趋势: "Call trend",
  调试信息: "Debug information",
  调试接口连接多种模型: "Debugging interface to connect multiple models",
  谢谢参与: "Thanks for participating",
  谨慎: "Cautious",
  警告: "Warning",
  ...
  软错误: "soft errors",
  "轻量化易用，低成本落地": "Lightweight, Easy to Use, Low-Cost Adoption",
  较早: "Earlier",
  输入: "Input",
  "输入 {{input}} tokens / 1M tokens * {{symbol}}{{price}}": "Input {{input}} tokens / 1M tokens * {{symbol}}{{price}}",
  "输入 {{price}} / 1M tokens": "Input {{price}} / 1M tokens",
  "输入 $/1M tokens": "Enter $/1M tokens",
  ...
  "输入 Token 总量": "Enter the total amount of Tokens",
  ...
  输入倍率: "Enter magnification",
  输入关键词以搜索文档内容: "Type a keyword to search the documentation",
  ...
  输入数字: "Enter Number",
  输入本次已打款金额: "Enter the amount paid this time",
  ...
  输出倍率: "Output magnification",
  "输出倍率 {{completionRatio}}": "Output ratio {{completionRatio}}",
  输出内容记录审查: "Output content record review",
  输出格式: "Output format",
  输出阶梯: "Output Tiers",
  ...
  近30天: "Last 30d",
  近7天: "Last 7d",
  近7天可用性: "Availability in the last 7 days",
  返余额: "Return balance",
  返利到账: "Rebate received",
  返利套餐: "Rebate package",
  返利方式: "Rebate method",
  返利百分比: "Rebate percentage",
  返利结果: "Rebate results",
  返利规则: "Rebate rules",
  返回修改: "Go back and edit",
  返回工单列表: "Back to tickets",
  返回文档首页: "Back to docs home",
  返回登录: "Return to Login",
  返回错误: "return error",
  返套餐: "Return package",
  "这个公式比较复杂，下面的简化表单没法完整还原，请在表达式编辑模式下修改。": "This formula is relatively complex and cannot be completely restored by the simplified form below. Please modify it in expression editing mode.",
  ...
  "这是受信任的官方应用，正在为你继续授权...": "This is a trusted official application and is continuing to authorize you...",
  ...
  这里会显示生成结果: "The generated results will be displayed here",
  这里会显示视频结果: "The generated video will appear here",
  "这里直接编辑 JSON 对象。适合简单覆盖参数的场景。": "Edit the JSON object directly here. Suitable for simple parameter override scenarios.",
  "这里配置 Waffo 下展示给用户的 Card、Apple Pay、Google Pay 等子支付方式。": "Here configure the card, Apple Pay, Google Pay and other sub-payment methods displayed to the user under Waffo.",
  "这里配置代理用户的默认首充和复充分成比例。单个用户如关闭“使用系统默认比例”，则以用户自身设置为准。": `Here, the default first deposit and repayment amount of the agent user are configured to be proportional. If a single user turns off "Use system default ratio", the user's own settings will prevail.`,
  ...
  退出: "Quit",
  退出会话: "Exit session",
  退出会话失败: "Failed to exit session",
  退出其他所有设备: "Sign out all other devices",
  "退出后该次登录将立即失效，其令牌会被吊销，需要重新登录。": "After logging out, the login will be invalid immediately, the token will be revoked, and you need to log in again.",
  "退出后该设备需要重新登录才能访问你的账户。": "After signing out, this device must sign in again to access your account.",
  退出设备: "Sign out",
  退出设备失败: "Failed to sign out this device",
  退款: "Refund",
  "适合任务类等按次收费模型。": "Suitable for task-based models billed per request.",
  ...
  "适用于统一下单返回 payUrl 的聚合支付网关。当前接入包含：下单、异步回调验签和充值入账。": "An aggregation payment gateway suitable for unified order return payUrl. Current access includes: order placement, asynchronous callback signature verification and recharge into account.",
  ...
  选择分组: "Select group",
  "选择分组，可多选并拖拽调整优先级": "Select a group, you can select multiple items and drag and drop to adjust the priority.",
  ...
  "选择金额后直接跳转到 Waffo Pancake 结账页，支付完成后会回到账户页。": "After selecting the amount, you will jump directly to the Waffo Pancake checkout page. After the payment is completed, you will return to the account page.",
  "选择预设...": "Select preset...",
  "选择预设模板（可选）": "Select Preset Template (optional)",
  透传请求体: "Pass through body",
  透传请求头: "Transparent request header",
  递归: "Recursive",
  ...
  "通过 {{name}} 快速构建稳定、安全、可扩展的 AI 应用。": "Quickly build stable, secure, and scalable AI applications with {{name}}.",
  ...
  邀请流水: "Invite running water",
  邀请用户: "Invited users",
  邀请用户数: "Number of invited users",
  "邀请的好友越多，获得的奖励越多": "The more friends you invite, the more rewards you will get",
  邀请码: "Invitation code",
  邀请码奖励: "Invitation code reward",
  邀请码已复制: "Invitation code has been copied",
  邀请获得额度: "Invitation quota",
  邀请计划: "invitation plan",
  "邀请计划会在被邀请用户每次充值时向其邀请人返利（仅返利一层，订阅购买仍仅首次）。": "The plan rebates to the inviter on every recharge by the invitee (single level only; subscription purchases still rebate on the first payment only).",
  邀请返利: "Invite rebate",
  邀请返利规则配置: "Invitation rebate rule configuration",
  ...
  部分分组模型加载失败: "Some group models failed to load",
  部分性能下降: "Partial degradation",
  部分服务中断: "Partial outage",
  ...
  "配置 Waffo 充值时可用的支付方式，保存后在充值页面展示给用户。": "Configure the payment methods available when recharging Waffo, and save them to display to the user on the recharge page.",
  "配置 WeChat Server": "Configure WeChat Server",
  "配置：": "Config:",
  配置价: "Configured",
  "配置到 CC Switch": "Configure CC Switch",
  "配置各工具的调用价格（$/1K次调用）。按次计费模型不额外收取工具费用。": "Configure the call price of each tool ($/1K calls). There are no additional tool fees for the pay-per-view model.",
  "配置后会在所有渠道请求中统一拼接到系统提示词前，可用于全局内容过滤": "After configuration, it will be uniformly spliced ​​before the system prompt word in all channel requests, and can be used for global content filtering.",
  ...
  "配置密钥、权限和项目": "Configure keys, permissions, and projects",
  ...
  "配置计划名称、启用状态、优先级和备注": "Configure plan name, activation status, priority and comments",
  配置说明: "Configuration instructions",
  配置邮箱域名白名单: "Configure email domain whitelist",
  配置链接已复制: "Configuration link copied",
  ...
  音频输入倍率: "Audio input magnification",
  ...
  预估: "Estimated",
  "预估 = 宽 × 高 × 帧率 × 时长 ÷ 1024 得到影片补全 tokens，再乘以所选费率。仅供参考，实际以上游返回的 usage.completion_tokens 结算。": "Estimate = width × height × fps × duration ÷ 1024 video completion tokens, multiplied by the selected rate. Indicative only — the actual charge uses the upstream usage.completion_tokens.",
  ...
  预计合计到账: "Estimated total arrival",
  预计活动赠送: "Expected event gifts",
  预计结束: "Estimated End",
  ...
  首充: "First charge",
  首充佣金: "First deposit commission",
  首充分成比例: "Fully proportional",
  首充用户: "First recharge user",
  "首充赠送最大额度不能小于 0": "The maximum amount of the first deposit gift cannot be less than 0",
  "首充赠送比例不能小于 0": "The first deposit bonus ratio cannot be less than 0",
  首充赠送结束时间: "First deposit bonus end time",
  "首充赠送起充额度不能小于 0": "The minimum deposit amount for the first deposit gift cannot be less than 0",
  "首单已消费，但未命中返利计划": "The first order has been consumed, but the rebate plan was not selected.",
  首单状态: "First order status",
  首尾帧生成: "First/last-frame generation",
  首尾生视频: "Head-tail generated video",
  首帧: "First frame",
  "首帧/尾帧图不能与参考图混用": "First/last-frame images cannot be mixed with reference images",
  "首帧/尾帧图不能与参考视频或参考音频同时使用": "First/last-frame images cannot be combined with reference videos or audios",
  ...
  "验证码发送成功，请查收短信！": "The verification code was sent successfully, please check the text message!",
...
If you still choose to enable this feature, you acknowledge all of the following:`,
  ...
  高并发接口调度: "High-Concurrency Scheduling",
  高度: "Height",
  高效: "Efficient",
  高级: "Advanced",
  ...
  "默认使用 USD 结算": "USD settlement is used by default",
  ...
  默认复充分成比例: "Default complex is fully proportional",
  默认异步回调地址: "Default asynchronous callback address",
  ...
  默认首充分成比例: "Default first is fully proportional",
  "首字之后的平均输出速度：输出 tokens / (用时 - 首字)": "Average output speed after the first token: output tokens / (duration - TTFT)",
  "首字之后的平均输出速度：输出 tokens / (用时 - 首字)。用时仅精确到秒，因此极短的请求无法给出速度。": "Average output speed after the first token: output tokens / (duration - TTFT). Duration is only recorded to the second, so very short requests cannot report a speed.",
  收起计费凭证: "Collapse billing evidence",
  展开计费凭证: "Expand billing evidence",
  ...
  "协助码仅用于客服定位案件，不能用于登录；案件关闭后停止使用，永久案件编号仍可用于历史查询。客服收到协助码后，才能在客服后台定位案件并查看已授权的协助案件及其允许的资料进行排查。客服协助不是网站内的在线客服，网站不提供即时聊天，实际沟通请在微信群完成。": "The assistance code only locates a support case and cannot be used to sign in. It stops working when the case closes, while the permanent case number remains available for history. After support receives the code, an agent can locate the case in the support console and inspect the authorized case and permitted data. Support assistance is not online customer service: this website does not provide live chat, and communication takes place in the WeChat group.",
  协助定位码已更新: "Assistance locator updated",
  "遇到问题请先在网站提交“请求协助”，提交后会取得永久案件编号和六位协助码（协助定位码），请将该码带到微信群发给客服。": "If you have a problem, first submit a “Request assistance” request on the website. You will receive a permanent case number and a six-character assistance code (assistance locator); take the code to the WeChat group and give it to support.",
  处理截止时间: "Handling deadline",
  案件编号: "Case number",
  "客服协助与工单是两个不同功能，客服协助不是在线客服，也不是工单对话；如需正式提交和跟进工单，请使用工单功能。请在下方描述问题，提交后将协助码带到微信群发给客服。": "Support assistance and tickets are separate features. Support assistance is not live chat or a ticket conversation. Use the ticket feature for formal ticket submission and follow-up. Describe the problem below, then take the assistance code to the WeChat group and give it to support.",
