const e = {
  ...
  "。在契约恢复之前无法生成视频。": "",
  "（共 {{total}} 个，省略 {{omit}} 个）": "(всего {{total}}, {{omit}} опущен)",
  "（共 {{total}} 个）": "(всего {{total}})",
  "（可自动）": "",
  "（当前仅支持易支付接口，默认使用上方服务器地址作为回调地址！）": "(В настоящее время поддерживается только интерфейс Easy Payment, а указанный выше адрес сервера используется в качестве адреса обратного вызова по умолчанию!)",
  ...
  "{{count}} 条结果": "Результатов: {{count}}",
  "{{count}} 项操作_few": "{{count}} операции",
  "{{count}} 项操作_many": "{{count}} операции",
  "{{count}} 项操作_one": "{{count}} операции",
  "{{count}} 项操作_other": "{{count}} операции",
  "{{discount}}折": "цена {{discount}}/10",
  "{{discount}}折 · 省 {{percent}}%": "{{discount}}/10 цены · экономия {{percent}}%",
  "{{inputDesc}} + {{outputDesc}}{{extraServices}} = {{symbol}}{{total}}": "{{inputDesc}} + {{outputDesc}}{{extraServices}} = {{symbol}}{{total}}",
  "{{label}} {{price}} / 1M tokens": "{{label}} {{price}} / 1 млн токенов",
  "{{min}} - {{max}} 秒": "",
  ...
  "{{ratio}} · 分组倍率": "{{ratio}} · коэффициент группы",
  ...
  "$/次": "$/время",
  "0 - 最低": "0 - Минимум",
  "0 表示不设上限": "0 означает отсутствие верхнего предела",
  "0 表示不限": "0 означает без лимита",
  "0 表示无限次": "0 означает неограниченное количество раз",
  "0.002-1之间的小数": "Десятичное число между 0.002-1",
  "0.1以上的小数": "Десятичное число выше 0.1",
  "0=周日 1=周一 2=周二 3=周三 4=周四 5=周五 6=周六": "0=воскресенье 1=понедельник 2=вторник 3=среда 4=четверг 5=пятница 6=суббота",
  "1:1 正方形": "1:1 Квадрат",
  ...
  "1=一月 ... 12=十二月": "1=январь ... 12=декабрь",
  "10 - 最高": "10 - Максимум",
  "100 次/秒": "100 запр./с",
  "15天": "",
  ...
  "1h缓存创建价格：{{symbol}}{{price}} / 1M tokens": "Цена создания кеша 1h: {{symbol}}{{price}} / 1M tokens",
  "1M图片输入": "Входное изображение 1M",
  "1M缓存创建": "Создание 1M кэша",
  "1M输入（不含缓存）": "1 Мб ввода (без кеша)",
  "1M输入（含缓存）": "1 Мб ввода (включая кэш)",
  "1M输出": "выход 1М",
  "2 - 低": "2 - Низкий",
  "2:3 竖向": "2:3 Книжная",
  ...
  "anthropic-beta JSON 示例": "Пример JSON антропопической бета-версии",
  "API Key": "API Key",
  ...
  "API 密钥": "Ключ API",
  "API 密钥 (沙盒)": "Ключ API (песочница)",
  "API 密钥 (生产)": "Ключ API (производственный)",
  "API 密钥（测试环境）": "Ключ API (тестовая среда)",
  "API 密钥（生产环境）": "Ключ API (производственная среда)",
  "API 指南": "Руководство по API",
  "API 文档": "Документация API",
  "API 私钥": "Закрытый ключ API",
  "API 私钥（测试环境）": "Закрытый ключ API (тестовая среда)",
  "API 私钥（生产环境）": "Закрытый ключ API (производственная среда)",
  ...
  "BLG 支付设置": "Настройки платежей BLG",
  ...
  "DALL·E 3 横向": "DALL·E 3 Альбомная",
  "DALL·E 3 竖向": "DALL·E 3 Книжная",
  ...
  "Esc 关闭": "Esc чтобы закрыть",
  "EUR (欧元)": "EUR (евро)",
  "Expr 预览": "Предварительный просмотр выражения",
  false: "false",
  "GC 已执行": "GC выполнен",
  ...
  "Hook 管理": "Управление крючками",
  "ICP/EDI经营许可证编号": "Номер коммерческой лицензии ICP/EDI",
  ICP备案号: "Номер регистрации ICP",
  ID: "ID",
  ...
  "JSON 必须是对象": "JSON должен быть объектом",
  "JSON 文本": "Текст JSON",
  ...
  "LLM 辅助设计提示词": "Слова подсказки для вспомогательного дизайна LLM",
  ...
  "OAuth 登录失败：": "Ошибка входа в систему OAuth:",
  "OAuth 端点": "Конечные точки OAuth",
  "OAuth 配置错误：授权端点必须是完整的 URL（以 http:// 或 https:// 开头）": "Ошибка конфигурации OAuth: конечная точка авторизации должна быть полным URL-адресом (начиная с http:// или https://).",
  OIDC: "OIDC",
  "OIDC ID": "ID OIDC",
  ...
  "Pay Method Name": "Название способа оплаты",
  "Pay Method Type": "Тип способа оплаты",
  ...
  "RSA 私钥 (沙盒)": "Закрытый ключ RSA (песочница)",
  "RSA 私钥 (生产)": "Закрытый ключ RSA (производственный)",
  ...
  "Token 估算器": "Оценщик токенов",
  "Token 用量范围": "Диапазон использования токена",
  "Token 类型": "Тип токена",
  "TokenRouter项目仓库地址：": "Адрес склада проекта TokenRouter:",
  ...
  "User Prompt Prefix": "Префикс пользовательской подсказки",
  ...
  "Waffo API 参数，可空，例如：CREDITCARD,DEBITCARD（最多64位）": "Параметры API Waffo, могут быть пустыми, например: CREDITCARD, DEBITCARD (до 64 бит).",
  "Waffo API 参数，可空（最多64位）": "Параметры Waffo API, могут быть пустыми (до 64 бит).",
  "Waffo Pancake": "Ваффо блин",
  "Waffo Pancake 设置": "Настройки для блинов ваффо",
  "Waffo 充值": "Перезарядка Ваффо",
  "Waffo 充值的最低数量，默认 1": "Минимальная сумма пополнения баланса Waffo, по умолчанию 1.",
  "Waffo 公钥 (沙盒)": "Открытый ключ Waffo (песочница)",
  "Waffo 公钥 (生产)": "Открытый ключ Waffo (производственный)",
  "Waffo 公钥（测试环境）": "Открытый ключ Waffo (тестовая среда)",
  "Waffo 公钥（生产环境）": "Открытый ключ Waffo (производственная среда)",
  "Waffo 商户 ID": "Идентификатор продавца Waffo",
  "Waffo 当前使用 USD 结算": "В настоящее время Waffo использует расчеты в долларах США.",
  "Waffo 是一个支付聚合平台，支持多种支付方式。": "Waffo — это платформа агрегации платежей, поддерживающая несколько способов оплаты.",
  "Waffo 设置": "Настройки Ваффо",
  ...
  "Webhook 公钥": "Открытый ключ вебхука",
  "Webhook 公钥（测试环境）": "Открытый ключ Webhook (тестовая среда)",
  "Webhook 公钥（生产环境）": "Открытый ключ Webhook (производственная среда)",
  ...
  'X 也可以小于 1，当折扣用。想做"只给输出加价"或"额外加固定费用"，请直接写完整计费公式。': "X также может быть меньше 1 и использоваться в качестве скидки. Если вы хотите «добавить только цену к выходным данным» или «добавить дополнительную фиксированную комиссию», напишите полную формулу выставления счета.",
  一个平台管理多种企业服务: "Manage enterprise services in one platform",
  一个月: "Один месяц",
  一天: "Один день",
  一小时: "Один час",
  一次性余额充值: "Единоразовое пополнение баланса",
  "一次性支付，付款后自动返回": "Единоразовый платеж, автоматически возвращается после оплаты",
  ...
  上一步: "Предыдущий шаг",
  上一页: "Назад",
  "上传 PNG/JPG/SVG 图片，建议尺寸 ≤ 128×128px": "Загрузите изображения PNG/JPG/SVG, рекомендуемый размер ≤ 128×128 пикселей.",
  上传参考图: "Загрузите эталонное изображение",
  上传后将在这里预览参考图: "Здесь появится предпросмотр референсного изображения",
  上传图片: "Загрузить фотографии",
  上传失败: "Ошибка загрузки",
  上传微信群二维码图片: "Загрузить изображение QR-кода группы WeChat",
  "上次保存: ": "Последнее сохранение: ",
  上次检测到可加入模型: "Последняя обнаруженная присоединяемая модель",
  上次检测时间: "Время последнего обнаружения",
  上游价格同步: "Синхронизация цен вверх по течению",
  上游倍率同步: "Синхронизация множителей upstream",
  上游已删除的模型: "Вышестоящая удаленная модель",
  ...
  下午好: "Добрый день",
  下单地址: "Адрес заказа",
  下单总数: "Общее количество заказов",
  下单数: "Количество заказов",
  下载: "скачать",
  下载文件: "",
  下载日志: "Download Logs",
  下载管理员发布的安装包和资料: "Загрузите установочный пакет и информацию, предоставленную администратором.",
  ...
  "下面是带注释的示例，仅用于参考；实际保存时请删除注释。": "Ниже приведен аннотированный пример только для справки; пожалуйста, удалите аннотации при сохранении.",
  ...
  不限: "Без ограничений",
  不限制: "Без ограничений",
  与官方价相同: "Совпадает с официальной ценой",
  ...
  个人开发调试: "Личная разработка и отладка",
  ...
  为模型前缀覆盖: "Переопределить префикс модели",
  ...
  为默认价格: "это цена по умолчанию",
  主导航: "",
  主模型: "Основная модель",
  主页链接填: "Введите ссылку на главную страницу",
  之前的所有日志: "Все предыдущие журналы",
  事件自动化和回调管理: "Автоматизация событий и управление обратными вызовами",
  ...
  仅提交已勾选: "Отправлять только отмеченные",
  仅支持: "Поддерживается только",
  "仅支持 JPEG / PNG / WebP 格式的图片": "Поддерживаются только изображения JPEG / PNG / WebP",
  ...
  仅支持上传图片文件: "Поддерживает только загрузку файлов изображений",
  仅显示已绑定: "Показать только привязанные",
  仅显示矛盾倍率: "Отображать только противоречивые коэффициенты",
  仅检测上游模型更新: "Обнаруживать только обновления вышестоящих моделей",
  ...
  仅用钱包: "Только кошелек",
  "仅管理员可用。开启后，当系统定时检测全部渠道发现上游模型变更或检测异常时，将按你选择的通知方式发送汇总通知；渠道或模型过多时会自动省略部分明细。": "Доступно только администраторам. После включения, когда система регулярно обнаруживает все каналы и обнаруживает изменения восходящей модели или аномалии обнаружения, она будет отправлять сводные уведомления в соответствии с выбранным вами методом уведомления; если каналов или моделей слишком много, некоторые детали будут автоматически опущены.",
  "仅统计成功充值订单，按完成时间归档。": "Только успешные заказы на пополнение учитываются и архивируются в соответствии со временем завершения.",
  仅自己: "только я",
  仅重置配置: "Только сбросить конфигурацию",
  今日充值: "Пополните счет сегодня",
  今日关闭: "Закрыть сегодня",
  今日已签到: "Зарегистрирован сегодня",
  "今日已签到，累计签到": "Зарегистрирован сегодня, всего регистраций",
  今日盈利: "Прибыль за сегодня",
  今日调用: "Вызовов сегодня",
  仍有未处理项: "Есть еще необработанные товары",
  ...
  付款完成后将自动回到账户页: "После завершения оплаты вы автоматически вернетесь на страницу аккаунта.",
  付费用户: "платящий пользователь",
  代理佣金已扣减: "Комиссия агентства удержана.",
  代理分销: "Агент по распространению",
  "代理分销信息加载中...": "Информация о распространении агентов загружается...",
  "代理分销比例不能大于 100": "Коэффициент распределения агентов не может быть больше 100.",
  "代理分销比例不能小于 0": "Коэффициент распределения агентов не может быть меньше 0.",
  代理分销默认配置: "Конфигурация распространения агента по умолчанию",
  代理地址: "Адрес прокси",
  代理已启用: "прокси включен",
  代理设置: "Настройки прокси",
  "代理邀请码、邀请用户和佣金流水": "Код приглашения агента, приглашенные пользователи и поток комиссионных",
  代码已复制到剪贴板: "Код скопирован в буфер обмена",
  代码示例: "",
  "代表你发起 AI 请求（费用记在你的账户）": "",
  令牌: "Токен",
  "令牌 / 密钥": "",
  令牌不存在: "Токен не существует",
  令牌分组: "Группа токенов",
  ...
  "价格为参考估算，实际计费以模型、渠道为准": "Цены являются ориентировочными; фактическая тарификация зависит от модели и канала.",
  价格可视化对比: "Визуальное сравнение цен",
  价格摘要: "Сводка цен",
  "价格暂时不可用，请稍后重试": "Price temporarily unavailable, please try again later",
  价格根据用量档位和请求条件动态调整: "Цены динамически корректируются в зависимости от уровня использования и условий запроса.",
  价格模式: "ценовая модель",
  "价格模式（默认）": "Режим цен (по умолчанию)",
  价格清单: "Прайс-лист",
  "价格计算中...": "Calculating price...",
  价格计算器: "калькулятор цен",
  ...
  "企业级稳定，高可用运行": "Корпоративная стабильность и высокая доступность",
  ...
  余额: "Баланс",
  余额充值: "Пополнение баланса",
  余额充值管理: "Управление пополнением баланса",
  余额地址: "Адрес баланса",
  余额返利: "Скидка на баланс",
  "余额返利直接返到邀请人的钱包余额；套餐返利会正常执行套餐分组升级": "Возврат баланса будет возвращен непосредственно на баланс кошелька приглашающего; скидка на пакет обычно будет повышена до группы пакетов.",
  "余额返利直接返到邀请人钱包；套餐返利会按套餐自身规则执行分组升级": "Возврат баланса будет возвращен непосредственно на кошелек пригласителя; Скидка на пакет будет сгруппирована и повышена в соответствии с собственными правилами пакета.",
  作废: "Аннулировать",
  作废于: "Аннулировано",
  ...
  "你还没有处理{{type}}模型（{{count}}个）。是否仅提交当前已勾选内容？_few": "Вы не имели дело с моделью {{type}} ({{count}}). Вы хотите отправить только проверенный в данный момент контент?",
  "你还没有处理{{type}}模型（{{count}}个）。是否仅提交当前已勾选内容？_many": "Вы не имели дело с моделью {{type}} ({{count}}). Вы хотите отправить только проверенный в данный момент контент?",
  "你还没有处理{{type}}模型（{{count}}个）。是否仅提交当前已勾选内容？_one": "Вы не имели дело с моделью {{type}} ({{count}}). Вы хотите отправить только проверенный в данный момент контент?",
  "你还没有处理{{type}}模型（{{count}}个）。是否仅提交当前已勾选内容？_other": "Вы не имели дело с моделью {{type}} ({{count}}). Вы хотите отправить только проверенный в данный момент контент?",
  你还没有授权任何应用: "",
  佣金余额: "Комиссионный баланс",
  "佣金支出 / 净流入": "Комиссионные расходы/чистый приток",
  佣金流水: "История комиссий",
  佣金订单数: "Количество комиссионных заказов",
  佣金记录: "Записи комиссии",
  佣金金额: "Сумма комиссии",
  ...
  使用系统默认比例: "Использовать системный масштаб по умолчанию",
  ...
  "例如 €, £, Rp, ₩, ₹...": "Например €, £, Rp, ₩, ₹...",
  "例如 0.5 或 2": "Например 0,5 или 2",
  "例如 10 表示新用户首充成功后，代理可获得实付金额的 10%": "Например, 10 означает, что после того, как новый пользователь впервые успешно внесет депозит, агент получит 10% от фактической суммы платежа.",
  "例如 901": "Например 901",
  "例如 anthropic-beta": "Например антропопический-бета",
  "例如 https://docs.newapi.pro": "Например https://docs.newapi.pro",
  "例如 https://example.com/api/mch/balance": "Например https://example.com/api/mch/balance",
  "例如 https://example.com/api/pay/query": "Например https://example.com/api/pay/query",
  "例如 https://example.com/api/pay/unifiedorder": "Например https://example.com/api/pay/unifiedorder",
  "例如 https://example.com/api/waffo/webhook": "Например https://example.com/api/waffo/webhook",
  "例如 https://example.com/console/topup": "Например https://example.com/console/topup",
  "例如 M1776096808": "Например М1776096808",
  "例如 service_tier": "Например, уровень_сервиса",
  "例如：": "например:",
  ...
  "例如：Credit Card": "Например: Кредитная карта",
  "例如：email": "напр.: email",
  ...
  "例如：github-enterprise": "напр.: github-enterprise",
  "例如：gpt-4.1-nano,regex:^claude-.*$,regex:^sora-.*$": "Например: gpt-4.1-nano,regex:^claude-.*$,regex:^sora-.*$",
  ...
  "例如：price_xxx": "Например: цена_xxx",
  "例如：prod_6I8rBerHpPxyoiU9WK4kot": "Например: prod_6I8rBerHpPxyoiU9WK4kot",
  "例如：PROD_xxx": "Например: PROD_xxx",
  "例如：sk_xxx 或 rk_xxx，留空表示保持当前不变": "Например: sk_xxx или rk_xxx. Оставьте поле пустым, чтобы сохранить текущее значение без изменений.",
  "例如：STO_xxx": "Например: STO_xxx",
  "例如：sub、id、data.user.id": "напр.: sub, id, data.user.id",
  "例如：whsec_xxx，留空表示保持当前不变": "Например: whsec_xxx. Оставьте это поле пустым, чтобы сохранить текущее значение без изменений.",
  ...
  "例如：清理工具参数，避免上游校验错误": "Например: Очистите параметры инструмента, чтобы избежать ошибок проверки выше по потоку.",
  "例如：该请求不满足准入策略": "напр.: Этот запрос не соответствует политике допуска",
  "例如：违规": "Например: Нарушение",
  ...
  保前缀: "Сохранить префикс",
  保后缀: "гарантированный суффикс",
  保存: "Сохранить",
  ...
  保存代理分销默认配置: "Сохранить конфигурацию распределения агента по умолчанию",
  保存修改: "Сохранить изменения",
  保存内容审查配置: "Сохранить конфигурацию проверки контента",
  保存分组倍率设置: "Сохранить настройки коэффициентов групп",
  保存分组相关设置: "Сохранить настройки, связанные с группами",
  "保存后不会回显，请填写当前环境对应的 API 私钥": "После сохранения оно не будет отображено. Пожалуйста, введите закрытый ключ API, соответствующий текущей среде.",
  "保存后不会回显，请填写当前环境对应的 Stripe API 密钥": "После сохранения оно не будет отображено. Введите ключ API Stripe, соответствующий текущей среде.",
  "保存后不会回显，请填写测试环境对应的 API 密钥": "После сохранения оно не будет отображено. Пожалуйста, введите ключ API, соответствующий тестовой среде.",
  "保存后不会回显，请填写测试环境对应的 API 私钥": "После сохранения оно не будет отображено. Введите закрытый ключ API, соответствующий тестовой среде.",
  "保存后不会回显，请填写生产环境对应的 API 密钥": "После сохранения оно не будет отображено. Пожалуйста, введите ключ API, соответствующий производственной среде.",
  "保存后不会回显，请填写生产环境对应的 API 私钥": "После сохранения оно не будет отображено. Введите закрытый ключ API, соответствующий производственной среде.",
  ...
  "倍率模式（默认）": "Режим увеличения (по умолчанию)",
  ...
  元: "Юань",
  充值: "Пополнить",
  充值与佣金金额趋势: "Тенденции пополнения и размера комиссий",
  "充值价格（x元/美金）": "Цена пополнения (x юаней/доллар США)",
  "充值价格必须大于 0": "Цена пополнения должна быть больше 0.",
  ...
  充值完成后跳回的页面: "Страница, на которую можно вернуться после завершения пополнения счета.",
  充值总额: "Полное пополнение",
  "充值成功，额度已到账": "Пополнение прошло успешно, сумма поступила.",
  充值数量: "Количество пополнения",
  "充值数量，最低 ": "Количество пополнения, минимум ",
  充值数量不能大于: "Сумма пополнения не может быть больше",
  ...
  充值流水: "История пополнений",
  充值确认: "Подтверждение пополнения",
  充值类型: "Тип пополнения",
  "充值类计划对每次充值生效，订阅类计划仅首次生效": "Планы пополнения действуют при каждом пополнении; планы подписки — только при первом платеже",
  充值订单: "Заказ пополнения счета",
  充值记录和状态查询: "Записи о пополнении счета и запрос статуса",
  ...
  兜底档: "Итог",
  入账时间: "Время входа",
  "全场景适配 · 赋能多元业务发展": "Для любых сценариев · Поддержка разностороннего развития бизнеса",
  ...
  全局系统提示词拼接: "Глобальная система подсказок сращивания слов",
  全局系统提示词豁免: "Исключение из глобального системного приглашения",
  全局设置: "Глобальные настройки",
  全平台: "Все платформы",
  "全方位安全，合规可控": "Всесторонняя безопасность и соответствие требованиям",
  全选: "Выбрать все",
  全选当前列表模型: "Выбрать все текущие модели списка",
  全部: "Все",
  ...
  全部类型: "Все типы",
  全部退出: "",
  "全面适配 Web 开发、小程序、APP、政企系统、第三方平台对接等各类场景，支持多协议与多数据格式，无缝衔接各类业务系统。": "Полностью адаптирована для веб-разработки, мини-программ, мобильных приложений, государственных и корпоративных систем и сторонних интеграций; поддержка множества протоколов и форматов данных обеспечивает бесшовное подключение любых бизнес-систем.",
  公告: "Объявление",
  ...
  关于项目: "О проекте",
  "关键字(ID、名称或卡密)": "Ключевое слово (ID, имя или код)",
  关键调用链路可审计: "",
  关闭: "Закрыть",
  ...
  内容: "Содержание",
  内容审查结果: "Результаты проверки контента",
  内容审查配置: "Настройка модерации контента",
  ...
  "内置接口鉴权、访问限流、异常拦截、数据加密等多重安全机制，精准拦截恶意请求，规范接口访问规则，全方位守护企业接口数据与业务安全。": "Встроенные аутентификация, ограничение частоты запросов, перехват аномалий и шифрование данных точно блокируют вредоносные запросы, упорядочивают правила доступа к API и всесторонне защищают данные и бизнес компании.",
  "内联图片总大小不能超过 {{limit}}": "",
  "内联图片总大小不能超过 45 MB": "Общий размер встроенных изображений не должен превышать 45 МБ",
  最优可用: "Лучший доступный",
  最低: "Минимум",
  最低充值数量: "Минимальная сумма пополнения",
  "最低充值数量必须大于 0": "Минимальная сумма пополнения должна быть больше 0",
  ...
  "最低实付金额（元）": "Минимальная фактическая сумма платежа (юани)",
  最低开票金额: "Minimum invoiceable amount",
  最后使用时间: "Время последнего использования",
  最后更新: "Last Updated",
  最后登录: "последний вход в систему",
  最后请求: "Последний запрос",
  "最多上传 {{count}} 张参考图_few": "Загрузите до {{count}} эталонных изображений.",
  "最多上传 {{count}} 张参考图_many": "Загрузите до {{count}} эталонных изображений.",
  "最多上传 {{count}} 张参考图_one": "Загрузите до {{count}} эталонных изображений.",
  "最多上传 {{count}} 张参考图_other": "Загрузите до {{count}} эталонных изображений.",
  最多只能指定一张尾帧图: "Можно указать только одно изображение последнего кадра",
  最多只能指定一张首帧图: "Можно указать только одно изображение первого кадра",
  "最多添加 {{limit}} 个参考视频": "Можно добавить не более {{limit}} референсных видео",
  "最多添加 {{limit}} 个参考音频": "Можно добавить не более {{limit}} референсных аудио",
  "最多添加 {{limit}} 张参考图": "Можно добавить не более {{limit}} референсных изображений",
  最大GPU数量: "Max Number of GPUs",
  最大可用: "Max Available",
  最大条目数: "Макс. кол-во записей",
  最大赠送额度: "Максимальная сумма подарка",
  最大返利金额: "Максимальная сумма скидки",
  最小充值金额: "Минимальная сумма пополнения",
  最终抵扣: "Итоговое списание",
  "最近 {{n}} 次检测": "",
  最近一次: "Последний",
  最近事件: "Recent Events",
  最近充值: "Недавнее пополнение счета",
  最近延迟: "",
  最近更新: "",
  最近检测: "",
  最近活动: "",
  最高优先级: "highest priority",
  最高充值不能小于最低充值: "Максимальное пополнение не может быть меньше минимального пополнения.",
  "最高实付金额（元）": "Максимальная фактическая сумма платежа (юани)",
  最高档: "Высший сорт",
  写: "Запись",
  ...
  函数: "функция",
  分佣比例: "коэффициент комиссии",
  分佣订单数: "Количество комиссионных заказов",
  "分时缓存 (Claude)": "Кэш с разделением времени (Клод)",
  分档价格表: "Многоуровневый прайс-лист",
  分类名称: "Название категории",
  分组: "Группа",
  分组JSON设置: "Group JSON Settings",
  分组与模型定价设置: "Группы и цены моделей",
  分组价格: "Цена группы",
  "分组价格 = 官方价格 × 分组倍率 ÷ 7": "Цена группы = официальная цена × коэффициент группы ÷ 7",
  分组倍率: "Коэффициент группы",
  "分组倍率 {{ratio}} × 换算 {{rate}} = 相对官方价 {{effective}}": "Коэффициент группы {{ratio}} × конвертация {{rate}} = {{effective}} от официальной цены",
  ...
  分组维度收入: "Доход по групповому измерению",
  分组维度消耗: "Группировка измерения потребления",
  ...
  "删除后无法恢复，且无返利记录的计划才允许删除": "Удаление невозможно восстановить, а планы без записей о скидках можно удалить.",
  ...
  "删除已选 {{selected}} / {{total}}": "Удалить выбранные {{selected}} / {{total}}",
  ...
  "加载中...": "Загрузка...",
  加载令牌失败: "",
  加载价格配置失败: "Не удалось загрузить конфигурацию цены.",
  ...
  加载数据分析失败: "Не удалось загрузить анализ данных.",
  "加载日志中...": "Loading logs...",
  加载日志失败: "Не удалось загрузить журнал",
  加载模型价格失败: "",
  ...
  加载邀请信息失败: "Не удалось загрузить информацию о приглашении.",
  "加载隐私政策内容失败...": "Не удалось загрузить содержимое политики конфиденциальности...",
  动态计费: "Динамический биллинг",
  ...
  匹配内容: "Соответствовать контенту",
  匹配方式: "Метод сопоставления",
  匹配模式: "шаблон соответствия",
  匹配类型: "Тип соответствия",
  "区分邀请返利与代理分销带来的充值与激励支出。": "Различают скидки и пополнения приглашений и поощрительные расходы, возникающие за счет агентского распределения.",
  区域: "Регион",
  ...
  "单价 (USD)": "Цена за единицу (долл. США)",
  单位: "Company",
  单位地址: "Address",
  单位电话: "Phone",
  "单张图片上限 {{limit}}": "",
  "单张图片大小不能超过 {{limit}}": "",
  "单张图片大小不能超过 10 MB": "Размер одного изображения не должен превышать 10 МБ",
  单条影片价格预估: "",
  占比: "Пропорция",
  卡片视图: "Карточки",
  危险: "",
  "历史数据已自动按年/月/日/小时汇总，今日尾段实时计算。": "Исторические данные автоматически агрегируются по году, месяцу, дню и часу, а хвост текущего дня рассчитывается в реальном времени.",
  ...
  去前缀: "удалить префикс",
  去后缀: "удалить суффикс",
  "去处理{{type}}": "Иди разберись с {{type}}",
  去抽奖: "Перейти к розыгрышу",
  去空格: "удалить пробелы",
  ...
  参数覆盖详情: "Подробности покрытия параметров",
  ...
  参考图: "Референсное изображение",
  "参考图（可选，最多 {{count}} 张）_few": "Справочные изображения (дополнительно, до изображений {{count}})",
  "参考图（可选，最多 {{count}} 张）_many": "Справочные изображения (дополнительно, до изображений {{count}})",
  "参考图（可选，最多 {{count}} 张）_one": "Справочные изображения (дополнительно, до изображений {{count}})",
  "参考图（可选，最多 {{count}} 张）_other": "Справочные изображения (дополнительно, до изображений {{count}})",
  "参考图（可选）": "Референсное изображение (необязательно)",
  "参考图已上传，本次将调用图生视频流程": "",
  "参考影片时长（秒）": "",
  参考生成: "",
  "参考视频（可选）": "Референсные видео (необязательно)",
  "参考视频链接（https）": "Ссылка на референсное видео (https)",
  "参考视频链接必须是 https 链接": "Ссылки на референсные видео должны использовать https",
  参考素材上限: "",
  参考素材生视频: "Видео по референсным материалам",
  "参考音频（可选）": "Референсное аудио (необязательно)",
  "参考音频链接（https）": "Ссылка на референсное аудио (https)",
  "参考音频链接必须是 https 链接": "Ссылки на референсное аудио должны использовать https",
  参考音频需要与参考图或参考视频一起使用: "",
  友情链接: "Дружественные ссылки",
  发布日期: "Дата публикации",
  发布时间: "Время публикации",
  发放奖励: "Распределяйте награды",
  ...
  可信: "Доверенный",
  "可勾选需要执行的变更：新增会加入渠道模型列表，删除会从渠道模型列表移除。": "Вы можете проверить изменения, которые необходимо выполнить: добавление будет добавлено в список моделей каналов, а удаление будет удалено из списка моделей каналов.",
  可参与次数: "Сколько раз вы можете участвовать",
  "可参与次数按“单个邀请人”累计命中的不同被邀请用户数计算": "Количество раз, когда можно принять участие, рассчитывается на основе количества различных приглашенных пользователей, которых посетил «один приглашающий».",
  可否选取: "Selectable",
  ...
  可用图片模型: "Доступные модели изображений",
  可用性: "",
  ...
  "可选，填写图片 URL": "Необязательно, укажите URL изображения.",
  "可选，用于复现结果": "Необязательно, для воспроизводимых результатов",
  "可选，用于记录用途": "Необязательно, для целей ведения журнала",
  "可选，用量达到此档时加收的固定费用": "Необязательно: при достижении этого уровня использования будет взиматься фиксированная плата.",
  ...
  可配置独立密钥管理: "",
  "各渠道成功率 / 失败率": "Коэффициент успеха/процент неудач каждого канала",
  各渠道消耗额度: "Квота потребления каждого канала",
  "合计：{{total}}": "Итого: {{total}}",
  "合计：文字部分 {{textTotal}} + 音频部分 {{audioTotal}} = {{total}}": "Итого: текстовая часть {{textTotal}} + аудиочасть {{audioTotal}} = {{total}}",
  "同一用户可以有多条记录，同一个模型出现在多条记录里也会正常生效。": "Один и тот же пользователь может иметь несколько записей, и одна и та же модель обычно вступает в силу, если она появляется в нескольких записях.",
  "同优先级下，充值按更高金额门槛命中；套餐按更贵的触发套餐命中。": "При том же приоритете пополнение будет выполнено в соответствии с более высоким порогом суммы; пакет будет поражен в соответствии с более дорогим триггерным пакетом.",
  同官方价: "Как официальная",
  同时满足: "Удовлетворить в то же время",
  同时重置消息: "Одновременно сбросить сообщения",
  同步: "Синхронизация",
  同步到渠道: "Sync to Channel",
  同步向导: "Мастер синхронизации",
  同步失败: "Синхронизация не удалась",
  同步字段: "поля синхронизации",
  ...
  否: "Нет",
  含时间条件: "Содержит временные условия",
  含请求条件: "Содержит условия запроса",
  启动: "Start",
  ...
  启用: "Включить",
  "启用 BLG 支付": "Включить платежи BLG",
  "启用 Prompt 检查": "Включить проверку Prompt",
  "启用 Waffo": "Включить Ваффо",
  "启用 Waffo Pancake": "Включить Waffo Pancake",
  ...
  启用全部: "Включить все",
  启用后会按测试环境保存这组配置: "После включения этот набор конфигураций будет сохранен в соответствии с тестовой средой.",
  ...
  "启用后将使用 Waffo 沙盒环境": "Если этот параметр включен, будет использоваться изолированная среда Waffo.",
  启用图片生成审查: "Включить проверку создания изображений",
  ...
  启用文本生成内容审查: "Включить проверку содержимого для генерации текста",
  ...
  "启用首充赠送时，赠送比例必须大于 0": "При включении бонуса на первый депозит коэффициент бонуса должен быть больше 0.",
  启用首次充值赠送: "Включить бонус на первое пополнение",
  ...
  "命中多个充值门槛时，会按更高门槛的计划优先": "При достижении нескольких порогов пополнения приоритет будет отдан плану с более высоким порогом.",
  命中档位: "ударить по шестерне",
  命中活动: "активность хитов",
  ...
  回调通知地址: "Адрес уведомления об обратном звонке",
  团队与项目权限细分: "",
  固定价格: "Фиксированная цена",
  "固定价格(每次)": "Фиксированная цена (за каждый раз)",
  固定价格值: "Значение фиксированной цены",
  固定费: "фиксированная плата",
  固定阶梯: "фиксированная лестница",
  "国家/地区": "Страна/регион",
  "国家/地区信息将用于适用法律法规、监管要求、平台合规策略及模型服务范围的判定。": "Информация о стране/регионе будет использоваться для определения применимых законов и правил, нормативных требований, стратегий соответствия платформы и объема модельных услуг.",
  "国家/地区信息已更新": "",
  ...
  "图标文件不能超过 100KB，请压缩后重新上传": "Размер файла значка не может превышать 100 КБ. Сожмите его и загрузите повторно.",
  图混合: "Смешивание изображений",
  "图片/音频价格（可选）": "Цена изображения/аудио (необязательно)",
  图片倍率: "Увеличение изображения",
  ...
  图片比例: "Соотношение сторон изображения",
  ...
  图片生成失败: "Не удалось создать изображение.",
  图片生成完成: "Создание изображения завершено",
  "图片生成审查（作用于 /pg 和 /v1 的 images/generations、images/edits）": "Обзор создания изображений (изображения/поколения, изображения/редактирования для /pg и /v1)",
  图片生成模型: "Модель генерации изображений",
  "图片生成调用：{{symbol}}{{price}} / 1次": "Вызов генерации изображения: {{symbol}}{{price}} / 1 раз",
  图片编辑完成: "Редактирование изображения завершено",
  图片设置: "Настройки изображения",
  "图片读取失败，请重试": "Не удалось прочитать изображение, попробуйте ещё раз",
  ...
  图片输入倍率: "Увеличение входного изображения",
  ...
  "在 Stripe 后台创建价格后获得": "Получено после создания цены в бэкэнде Stripe.",
  ...
  "填写后覆盖当前测试环境 API 密钥，留空表示保持当前不变": "После заполнения перезапишите текущий ключ API тестовой среды. Оставьте это поле пустым, чтобы сохранить текущий без изменений.",
  "填写后覆盖当前测试环境 Webhook 公钥，留空表示保持当前不变": "После заполнения перезапишите открытый ключ Webhook текущей тестовой среды. Оставьте это поле пустым, чтобы сохранить текущий без изменений.",
  "填写后覆盖当前测试环境私钥，留空表示保持当前不变": "После заполнения он перезапишет текущий закрытый ключ тестовой среды. Оставьте это поле пустым, чтобы сохранить текущий без изменений.",
  "填写后覆盖当前生产环境 API 密钥，留空表示保持当前不变": "После заполнения перезапишите текущий ключ API производственной среды. Оставьте это поле пустым, чтобы сохранить текущий без изменений.",
  "填写后覆盖当前生产环境 Webhook 公钥，留空表示保持当前不变": "После заполнения он перезапишет открытый ключ Webhook текущей производственной среды. Оставьте это поле пустым, чтобы сохранить текущий без изменений.",
  "填写后覆盖当前生产环境私钥，留空表示保持当前不变": "После заполнения он перезапишет текущий закрытый ключ производственной среды. Оставьте это поле пустым, чтобы сохранить текущий без изменений.",
  "填写后覆盖当前私钥，留空表示保持当前不变": "После заполнения перезапишите текущий закрытый ключ. Оставьте это поле пустым, чтобы сохранить текущий без изменений.",
  "填写带https的域名，逗号分隔": "Введите домены с https, разделённые запятыми",
  "填写平台域名，例如：www.tokenrouter.tech": "Введите доменное имя платформы, например: www.tokenrouter.tech.",
  "填写服务器地址后自动生成：": "Автоматически генерируется после заполнения адреса сервера:",
  "填写测试环境 Waffo 公钥，Base64 或 PEM 内容均可": "Заполните тестовую среду открытым ключом Waffo, можно использовать содержимое Base64 или PEM.",
  "填写生产环境 Waffo 公钥，Base64 或 PEM 内容均可": "Заполните открытый ключ производственной среды Waffo, можно использовать содержимое Base64 или PEM.",
  ...
  处理上游模型更新: "Обработка обновлений вышестоящих моделей",
  处理中: "Processing",
  处理代理提现: "Вывод агентов процесса",
  处理全部渠道上游更新: "Обработка всех обновлений восходящего канала",
  处理提现: "Обработка вывода средств",
  ...
  复充: "Перезарядка",
  复充佣金: "Комиссия по пополнению",
  复充分成比例: "Полностью пропорциональный",
  复充指该被邀请用户首充之后的后续成功充值订单: "Пополнение счета относится к последующим успешным заказам на пополнение счета после первого пополнения счета приглашенного пользователя.",
  复制: "Копировать",
  复制代码: "Копировать код",
  复制令牌: "Копировать токен",
  复制令牌失败: "Не удалось скопировать токен",
  "复制以下提示词发送给 LLM（如 ChatGPT / Claude），让它帮你设计计费表达式": "Скопируйте следующие слова-подсказки и отправьте их в LLM (например, ChatGPT / Claude), и пусть они помогут вам разработать выражение для выставления счета.",
  复制全部: "Копировать всё",
  ...
  复制提示词: "скопировать слово-подсказку",
  复制日志: "Copy Logs",
  复制渠道的所有信息: "Копировать всю информацию о канале",
  复制版本号: "Copy Version",
  复制生成的密钥并粘贴到此处: "Copy the generated key and paste it here",
  复制请求头: "Копировать заголовок запроса",
  复制连接信息: "Копировать данные подключения",
  复制邀请码: "Скопировать код приглашения",
  复制邀请链接: "Скопировать ссылку-приглашение",
  复制配置链接: "",
  复制链接: "Скопировать ссылку",
  外接设备: "Внешнее устройство",
  外部平台: "внешняя платформа",
  外部平台来源管理: "Управление исходным кодом внешней платформы",
  多个命令用空格分隔: "Multiple commands separated by spaces",
  多场景兼容适配: "Совместимость с множеством сценариев",
  ...
  天前: "дней назад",
  失败: "Неудача",
  "失败/过期单数": "Неудачное/истекшее нечетное число",
  失败原因: "Причина ошибки",
  ...
  套餐: "План",
  套餐信息无效: "Информация о пакете недействительна.",
  ...
  "如果你对接的是上游One API或者TokenRouter等转发项目，请使用OpenAI类型，不要使用此类型，除非你知道你在做什么。": "Если вы подключаетесь к вышестоящему API One или пересылаете проекты, такие как TokenRouter, используйте тип OpenAI. Не используйте этот тип, если вы не знаете, что делаете.",
  ...
  官方价格: "Официальная цена",
  官方价格为上游配置的原始美元基础价: "",
  "官方价格按 $1 = ￥7 折算": "Официальная цена пересчитывается по курсу $1 = ¥7",
  ...
  "实时记录接口调用次数、响应状态、异常日志等数据，可视化看板直观展示运行状态，助力快速排查问题、持续优化业务。": "Количество вызовов, статусы ответов и журналы ошибок фиксируются в реальном времени; наглядные дашборды показывают состояние системы с первого взгляда, ускоряя диагностику и постоянную оптимизацию.",
  实时调用监控统计: "Мониторинг вызовов в реальном времени",
  实际: "Фактически",
  "实际下载尺寸以模型或渠道返回的图片为准，NewAPI 不会压缩或重绘图片": "Фактический размер загружаемого изображения определяется изображением, возвращённым моделью или каналом; NewAPI не сжимает и не перерисовывает изображение.",
  "实际尺寸：{{size}}": "Фактический размер: {{size}}",
  "实际尺寸：加载后显示": "Фактический размер: будет показан после загрузки",
  实际模型: "Фактическая модель",
  实际环境: "реальная среда",
  实际用量: "Фактическое использование",
  ...
  实际额度: "Фактическая сумма",
  "审查失败时放行（fallback）": "Выпустить, если проверка не удалась (резервный вариант)",
  审计信息: "Информация об аудите",
  客服协助: "Support assistance",
  "客服协助功能当前未开放，暂时无法在网站提交请求，请留意后续开放通知。": "Помощь поддержки сейчас недоступна: отправить запрос через сайт нельзя. Следите за уведомлением о доступности.",
  ...
  对应代理分销已入账佣金: "Комиссии учтены для соответствующего агентского распределения.",
  "对比：不勾选「用户可选」的场景": 'Comparison: groups without "User Selectable"',
  对比项: "Сравнительный элемент",
  ...
  导航菜单: "",
  封禁结束时间必须晚于当前时间: "Время окончания бана должно быть позже текущего времени.",
  ...
  "将把当前编辑中的模型 {{name}} 的价格配置，批量应用到已勾选的 {{count}} 个模型。_few": "Конфигурация цен редактируемой в данный момент модели {{name}} будет пакетно применена к выбранным моделям {{count}}.",
  "将把当前编辑中的模型 {{name}} 的价格配置，批量应用到已勾选的 {{count}} 个模型。_many": "Конфигурация цен редактируемой в данный момент модели {{name}} будет пакетно применена к выбранным моделям {{count}}.",
  "将把当前编辑中的模型 {{name}} 的价格配置，批量应用到已勾选的 {{count}} 个模型。_one": "Конфигурация цен редактируемой в данный момент модели {{name}} будет пакетно применена к выбранным моделям {{count}}.",
  "将把当前编辑中的模型 {{name}} 的价格配置，批量应用到已勾选的 {{count}} 个模型。_other": "Конфигурация цен редактируемой в данный момент модели {{name}} будет пакетно применена к выбранным моделям {{count}}.",
  ...
  将额外乘以上述价格: "Умножьте дополнительную сумму на указанную выше цену.",
  小于: "меньше, чем",
  ...
  工具标识: "Идентификатор инструмента",
  工具调用定价: "Стоимость вызова инструмента",
  工单管理: "Управление заказами на работу",
  左侧边栏个人设置: "Персональные настройки левой боковой панели",
  "已上传参考图，本次将调用图片编辑接口": "Эталонное изображение загружено. На этот раз будет вызван интерфейс редактирования изображений.",
  ...
  "已勾选 {{count}} 个模型_few": "Модели {{count}} проверены",
  "已勾选 {{count}} 个模型_many": "Модели {{count}} проверены",
  "已勾选 {{count}} 个模型_one": "Модели {{count}} проверены",
  "已勾选 {{count}} 个模型_other": "Модели {{count}} проверены",
  ...
  已处理: "Resolved",
  "已处理上游模型更新：加入 {{added}} 个，删除 {{removed}} 个，本次忽略 {{ignored}} 个，当前已忽略模型 {{totalIgnored}} 个": "Обработаны обновления моделей верхнего уровня: {{added}} добавлен, {{removed}} удален, {{ignored}} на этот раз проигнорирован, модель {{totalIgnored}} в настоящее время игнорируется",
  ...
  "已将模型 {{name}} 的价格配置批量应用到 {{count}} 个模型_few": "Ценовая конфигурация модели {{name}} была применена пакетно к моделям {{count}}.",
  "已将模型 {{name}} 的价格配置批量应用到 {{count}} 个模型_many": "Ценовая конфигурация модели {{name}} была применена пакетно к моделям {{count}}.",
  "已将模型 {{name}} 的价格配置批量应用到 {{count}} 个模型_one": "Ценовая конфигурация модели {{name}} была применена пакетно к моделям {{count}}.",
  "已将模型 {{name}} 的价格配置批量应用到 {{count}} 个模型_other": "Ценовая конфигурация модели {{name}} была применена пакетно к моделям {{count}}.",
  已开启: "Включено",
  ...
  "已批量处理上游模型更新：渠道 {{channels}} 个，加入 {{added}} 个，删除 {{removed}} 个，失败 {{fails}} 个": "Обновления модели восходящего потока обрабатывались пакетно: каналы {{channels}}, добавлен {{added}}, удален {{removed}}, не удалось {{fails}}.",
  已拉取: "Вытащил",
  已拒绝: "Rejected",
  已授权应用: "",
  已提交: "Отправлено",
  ...
  已注销: "Выход выполнен",
  已消耗额度: "",
  "已消费，但暂未命中返利计划": "Совершал платежи, но подходящий план вознаграждения пока не найден",
  已消费用户数: "Количество пользователей, которые израсходовали",
  已添加: "Добавлено",
  ...
  "已清理 {{count}} 个日志文件，释放 {{size}}_few": "Очищены файлы журнала {{count}}, выпущен {{size}}.",
  "已清理 {{count}} 个日志文件，释放 {{size}}_many": "Очищены файлы журнала {{count}}, выпущен {{size}}.",
  "已清理 {{count}} 个日志文件，释放 {{size}}_one": "Очищены файлы журнала {{count}}, выпущен {{size}}.",
  "已清理 {{count}} 个日志文件，释放 {{size}}_other": "Очищены файлы журнала {{count}}, выпущен {{size}}.",
  已清空: "Очищено",
  ...
  已运行时间: "Uptime",
  已返利: "",
  已返利人数: "Количество человек, получивших скидки",
  已退出其他设备: "",
  已退出该会话: "",
  已退出该设备: "",
  已退款: "Возвращено",
  ...
  已邀请人数: "Количество приглашенных",
  已重置为默认配置: "Сброшено на конфигурацию по умолчанию",
  已销毁: "Destroyed",
  已预留: "Зарезервировано",
  币种: "Валюта",
  帐号信息: "Информация об аккаунте",
  带来充值: "Принесите пополнение",
  帧率: "",
  "帧率 FPS": "",
  ...
  平台: "Платформа",
  平台价格数据格式不正确: "Неправильный формат данных о ценах платформы.",
  平台地址格式不正确: "Неверный формат адреса платформы",
  "平台将在合规审核通过后予以处理；审核完成前，原登记信息持续有效。提交不真实、不完整或无法核验的材料，平台有权驳回申请，并依据平台规则及适用法律法规采取进一步限制措施。": "Платформа рассмотрит этот вопрос после прохождения проверки соответствия; до завершения проверки исходная регистрационная информация останется действительной. Если вы отправляете ложные, неполные или неподдающиеся проверке материалы, платформа имеет право отклонить заявку и принять дополнительные ограничительные меры в соответствии с правилами платформы и применимыми законами и положениями.",
  平均: "средний",
  平均RPM: "Среднее RPM",
  平均TPM: "Среднее TPM",
  ...
  "开启后，图片生成页面仅会展示此模型，不再依赖模型名称关键字判断": "При включении страница генерации изображений будет показывать только эту модель и больше не будет полагаться на ключевые слова в названии модели.",
  ...
  "开启后，视频生成页面仅会展示此模型，不再依赖模型名称关键字判断": "При включении страница генерации видео будет показывать только эту модель и больше не будет полагаться на ключевые слова в названии модели.",
  ...
  开启后检测到新增模型会自动加入当前渠道模型列表: "После открытия новые обнаруженные модели будут автоматически добавлены в текущий список моделей канала.",
  开启后由后端定时任务检测该渠道上游模型变化: "После его включения серверная запланированная задача обнаружит изменения в восходящей модели канала.",
  开启后由模型同时生成配音与音效: "Если включено, модель также создаёт озвучку и звуковые эффекты",
  "开启后该渠道不会参与任何并发竞速，但在竞速全部失败时仍可作为兜底通道被尝试": "Если включено, этот канал не будет участвовать ни в одной параллельной гонке, но его все равно можно будет попробовать как резервный канал, если все гоночные каналы завершатся неудачей",
  开启后该渠道的请求不会被注入全局系统提示词: "Если включено, в запросы через этот канал не будет внедряться глобальное системное приглашение",
  ...
  异步回调地址: "Асинхронный адрес обратного вызова",
  张图片: "изображений",
  ...
  "当前代理分销仅针对新用户通过代理邀请码注册后产生的钱包充值订单生效，购买套餐不参与该分销。": "Текущее агентское распределение действует только для заказов на пополнение кошелька, созданных новыми пользователями после регистрации с использованием кода приглашения агента. Покупка пакетов не участвует в данной раздаче.",
  "当前代理资格已停用，仅保留历史佣金与流水展示，后续不会再产生新的分销收益": "Текущая квалификация агента деактивирована, будут сохранены только исторические комиссии и отображение потоков, и в будущем не будет генерироваться новый доход от дистрибуции.",
  当前令牌没有相容分组: "",
  当前价格: "текущая цена",
  当前余额: "Текущий баланс",
  ...
  "当前分组暂无可用模型，请切换分组或联系管理员配置": "В текущей группе нет доступных моделей. Пожалуйста, переключите группы или обратитесь к администратору для настройки.",
  当前分组没有可用的图片模型: "Для текущей группы нет доступных моделей изображений.",
  当前分组没有可用的视频模型: "",
  当前剩余: "Currently Remaining",
  "当前参数覆盖不是合法的 JSON": "Текущее переопределение параметров не является допустимым JSON",
  当前参考素材组合不被该模型支持: "",
  当前可提现佣金: "Текущая комиссия доступна для вывода",
  当前周期: "текущий период",
  当前周期暂无成功充值: "В текущем цикле успешной перезарядки не происходит.",
  "当前尺寸：{{size}}": "Текущий размер: {{size}}",
  ...
  当前时间: "Текущее время",
  当前暂无可用邀请福利: "В настоящее время преимущества приглашения отсутствуют.",
  "当前未启用，需要时再打开即可。": "Это поле сейчас отключено. Включите его при необходимости.",
  当前来源汇率: "Текущий исходный обменный курс",
  "当前查看的分组为：{{group}}，{{comparison}}": "Текущая группа: {{group}} — {{comparison}}",
  ...
  当前版本: "Текущая версия",
  当前状态: "Current Status",
  "当前环境共用同一商户 ID": "Текущие среды используют один и тот же идентификатор продавца.",
  "当前用户将继承后台代理分销的默认首充/复充比例。": "Текущий пользователь унаследует коэффициент первого пополнения/пополнения по умолчанию для распределения внутреннего агента.",
  当前登录账号: "",
  当前登记地区: "Текущая зона регистрации",
  当前盈利: "текущая прибыль",
  当前绑定: "Bound",
  ...
  "当前账号未开通代理分销，管理员启用后会在这里展示邀请码、分销用户与佣金流水": "В текущем аккаунте не активирована агентская рассылка. После того, как администратор активирует его, здесь будет отображаться код приглашения, пользователи раздачи и поток комиссий.",
  "当前账户暂不支持用户自行变更国家/地区信息。如确需申请变更，请通过工单提交正式申请，并提供足以证明您当前实际所在国家/地区或主体归属地的真实、完整、有效佐证材料。": "Текущая учетная запись не позволяет пользователям самостоятельно изменять информацию о стране/регионе. Если вам действительно необходимо подать заявку на изменение, подайте официальное заявление через заказ на работу и предоставьте правдивые, полные и действительные подтверждающие материалы, достаточные для подтверждения вашей текущей фактической страны/региона или места проживания субъекта.",
  当前账户未开通代理分销: "На текущем счете не открыта агентская раздача",
  当前跟随系统: "Следовать системе",
  当前邀请福利: "Текущие преимущества приглашения",
  "当前金额未达到 Waffo Pancake 的最低充值要求": "Текущая сумма не соответствует минимальному требованию пополнения баланса Waffo Pancake.",
  当前额度: "Текущая квота",
  ...
  "当用户请求中已有系统提示词时，会优先拼接此内容；当用户未提供系统提示词时，会自动注入该内容": "При наличии в запросе пользователя слова системной подсказки, этот контент будет склеен в первую очередь; если пользователь не вводит слово системной подсказки, контент будет вставлен автоматически.",
  ...
  待处理: "В ожидании",
  待支付单数: "Количество заказов к оплате",
  ...
  微信支付: "WeChat Pay",
  微信群: "Группа WeChat",
  微信群二维码: "QR-код группы WeChat",
  微信群二维码图片链接: "URL изображения QR-кода группы WeChat",
  "微信账户绑定成功！": "Привязка учетной записи WeChat успешна!",
  "必填：请输入服务器地址以自动生成完整端点 URL": "Обязательно: введите адрес сервера, чтобы автоматически сгенерировать полный URL-адрес конечной точки.",
  ...
  总体成功率: "общий показатель успеха",
  "总体成功率 / 失败率": "Общий процент успеха/процент неудач",
  总充值金额: "Общая сумма пополнения",
  总分配内存: "Общая выделенная память",
  总密钥数: "Общее количество ключей",
  总收益: "Общий доход",
  总消耗额度: "Общий объем потребления",
  总计: "Итого",
  总请求数: "Всего запросов",
  总额: "Общая сумма",
  总额度: "Общая квота",
  ...
  成功: "Успешно",
  "成功 / 失败": "успех/неудача",
  成功充值次数: "Количество успешных пополнений",
  "成功兑换额度：": "Успешно обменяно квота: ",
  成功单数: "Нечетное число успеха",
  ...
  我的工单: "Мой заказ на работу",
  我的订阅: "Мои подписки",
  我确认开启高危重试: "Я подтверждаю, что разрешаю повторную попытку с высоким риском",
  我邀请的: "я пригласил",
  或: "или",
  ...
  "扫码加入微信群，与大家一起交流使用经验": "Отсканируйте QR-код, чтобы присоединиться к группе WeChat и обмениваться опытом.",
  扫码支付: "",
  ...
  批量处理失败: "Пакетная обработка не удалась",
  ...
  批量检测失败: "Не удалось обнаружить пакет",
  "批量检测完成：渠道 {{channels}} 个，新增 {{add}} 个，删除 {{remove}} 个，失败 {{fails}} 个": "Обнаружение пакета завершено: каналы {{channels}}, новый {{add}}, удаленный {{remove}}, неудачный {{fails}}",
  ...
  报价: "Тариф",
  抬头名称: "Invoice title",
  抽奖券说明: "Правила розыгрыша",
  抽奖活动: "",
  "抽奖活动火热进行中，充值之余别忘了参与抽奖赢取奖励！": "Розыгрыш уже идёт — не забудьте принять участие и выиграть награды!",
  "拉取中...": "Pulling...",
  拉取价格: "тянуть цену",
  拉取平台价格失败: "Не удалось получить цену платформы.",
  ...
  "拦截返回消息（inject_message）": "Перехватывать ответные сообщения (inject_message)",
  "按 1 美元对应的站内价格填写": "Заполните цену сайта, соответствующую 1 доллару США.",
  "按 Cron 表达式定时执行 JS 自动化脚本": "Регулярное выполнение сценариев автоматизации JS на основе выражений Cron.",
  按K显示单位: "Отображать единицы в K",
  "按上游 usage.completion_tokens 结算": "",
  按下单数与已成功订单数计算: "Подсчет количества нажатых заказов и количества успешных заказов",
  按价格字段筛选: "Фильтровать по полю цены",
  按价格设置: "Настроить по цене",
  按倍率类型筛选: "Фильтровать по типу коэффициента",
  按倍率设置: "Настроить по множителю",
  按分组与模型估算输入输出成本: "Оценка входных и выходных затрат по группам и моделям",
  按后续成功充值实付金额计算: "Рассчитывается на основе фактической суммы платежа после успешного пополнения счета.",
  按国家或地区限制模型可见性与调用权限: "Ограничить видимость модели и разрешения на вызовы по стране или региону.",
  按完成支付时间落在当前周期内统计: "Статистика на основе времени завершения платежа, попадающего в текущий цикл",
  "按实付人民币校验，填 0 表示不限制": "Подтвердите фактическую оплату в юанях. Введите 0, чтобы указать отсутствие лимита.",
  "按应用、令牌、模型的顺序选择后，将配置导入 CC Switch。": "",
  "按当前用户分组归档成功充值收入。": "Архивируйте доходы от успешных пополнений по текущей группе пользователей.",
  按成功充值订单口径统计: "Статистика на основе успешных заказов на пополнение баланса",
  "按成功日志与错误日志的数量口径计算。": "Рассчитывается на основе количества журналов успехов и журналов ошибок.",
  "按成功消费日志汇总各渠道的额度消耗。": "Суммируйте потребление квоты каждого канала в соответствии с журналом успешного потребления.",
  "按成功消费日志统计模型调用次数。": "Подсчитайте количество вызовов модели на основе успешных журналов потребления.",
  "按所选日期范围联动查看模型调用、延迟、分组收入、拉新贡献和缓存效率。": "Просматривайте вызовы моделей, задержки, сгруппированные доходы, новый вклад и эффективность кэша за выбранный диапазон дат.",
  按新用户首次充值实付金额计算: "Рассчитывается на основе фактической суммы, уплаченной новым пользователем за первое пополнение счета.",
  "按日志中的分组字段统计各分组消耗额度。": "Квота потребления каждой группы рассчитывается по полю группы в журнале.",
  "按日志响应时间计算各渠道平均延迟和长尾延迟。": "Рассчитайте среднюю задержку и задержку с длинным хвостом каждого канала на основе времени отклика журнала.",
  "按日期连续展示当前周期的消费走势。": "Постоянно отображает тенденцию потребления текущего периода по дате.",
  按模型倍率和分组倍率折算: "Преобразовано в соответствии с увеличением модели и увеличением группировки.",
  按次: "За запрос",
  ...
  "按次：{{symbol}}{{price}} * {{ratioType}}：{{ratio}} = {{symbol}}{{total}}": "За запрос: {{symbol}}{{price}} * {{ratioType}}: {{ratio}} = {{symbol}}{{total}}",
  按次价格: "Цена за просмотр",
  按次计费: "Оплата за запрос",
  "按消费 / 错误日志去重统计": "Статистика дедупликации по потреблению/журналу ошибок",
  "按消费日志中的缓存命中 token 统计": "Статистика на основе токенов попадания в кэш в журналах потребления.",
  按消费日志口径统计: "Статистика по калибру журнала потребления",
  "按消费日志统计缓存命中、缓存创建与节省额度。": "Статистика по попаданиям в кеш, созданию и экономии кеша на основе журналов потребления.",
  "按渠道聚合成功与错误请求，查看稳定性差异。": "Объедините успешные и ошибочные запросы по каналам, чтобы просмотреть различия в стабильности.",
  "按照如下格式输入：AccessKey|SecretAccessKey|Region": "Введите в формате: AccessKey|SecretAccessKey|Region",
  按用户创建和首次支付时间统计: "Статистика по созданию пользователей и времени первого платежа",
  "按近几天代理用户的下单与支付结果生成统计视图，成功率按下单数与成功单数计算": "Создайте статистическое представление на основе результатов заказов и платежей пользователей агента за последние дни. Вероятность успеха рассчитывается по количеству размещенных заказов и количеству успешных заказов.",
  "按选定周期内的成功消费额度排序。": "Сортировать по успешному объему потребления за выбранный период.",
  按量: "По количеству",
  ...
  "按页面显示额度判断，保存时自动换算，0 表示不限制": "Решение основано на сумме, отображаемой на странице, автоматически конвертируется при сохранении, 0 означает отсутствие ограничений.",
  "按页面显示额度封顶，保存时自动换算，0 表示不限制": "Сумма ограничена в зависимости от отображения страницы, автоматически конвертируется при сохранении, 0 означает отсутствие ограничений.",
  ...
  授权时间: "",
  授权端点: "Конечная точка авторизации",
  "授权范围 (Scopes)": "Область полномочий (Scopes)",
  授权请求已失效: "",
  排序: "Порядок",
  排队中: "В очереди",
  ...
  接收上游模型更新通知: "Получать уведомления об обновлении вышестоящей модели",
  接收发票邮箱: "Invoice recipient email",
  "控制代理资格、分销比例以及查看当前佣金汇总": "Контролируйте квалификацию агентов, коэффициенты распределения и просматривайте текущие сводки комиссий.",
  控制台: "Консоль",
  ...
  描述: "Описание",
  "描述你要生成的画面，例如：赛博朋克城市夜景，霓虹灯，电影感，超清细节": "Опишите сцену, которую вы хотите создать, например: ночная сцена города в стиле киберпанк, неоновые огни, кинематографическое ощущение, сверхчеткие детали.",
  "描述你要生成的视频，例如：镜头缓慢推进雨夜街道，一只橘猫回头望向镜头，电影感光影": "",
  提交: "Отправить",
  提交和跟进自己的工单: "Отправляйте и отслеживайте свои собственные заказы на работу",
  提交失败: "Failed to submit",
  提交开票申请: "Submit invoice request",
  提交时间: "Время отправки",
  提交结果: "Результат отправки",
  提供商名称: "Имя провайдера",
  提出修改要求: "Request a change",
  提升: "Повысить",
  提现扣减: "Вычет при снятии наличных",
  提现流水号: "Серийный номер вывода",
  提现金额: "Сумма вывода",
  提示: "Промпт",
  ...
  "搜索用户名、昵称或邮箱": "Поиск имени пользователя, псевдонима или адреса электронной почты",
  "搜索用户名、邮箱或来源订单号": "Поиск по имени пользователя, адресу электронной почты или номеру исходного заказа",
  "搜索用户名、邮箱或订单号": "Найдите имя пользователя, адрес электронной почты или номер заказа.",
  搜索结果: "Результаты поиска",
  搜索聊天应用名称: "Поиск по названию чат-приложения",
  "搜索规则（描述 / 类型 / 路径 / 来源 / 目标）": "Правила поиска (описание/тип/путь/источник/цель)",
  ...
  支付信息: "",
  支付地址: "Адрес оплаты",
  "支付处理中，可稍后刷新订阅状态": "Платеж обрабатывается. Статус подписки можно обновить позже.",
  "支付处理中，可稍后在充值记录查看状态": "Платеж обрабатывается, позже вы сможете проверить статус в записи пополнения.",
  支付失败: "Оплата не удалась",
  "支付失败，请重新发起充值": "Платеж не выполнен, пожалуйста, пополните баланс",
  "支付失败，请重新发起购买": "Платеж не выполнен, повторите покупку.",
  支付完成单数: "Количество выполненных платежей",
  "支付完成后用户跳转的页面，留空则自动使用 服务器地址 + /console/topup": "Страница, на которую переходит пользователь после завершения оплаты. Если оставить пустым, автоматически будет использоваться адрес сервера + /console/topup.",
  支付宝: "Alipay",
  支付宝扫码支付: "Оплата скан-кодом Alipay",
  支付成功率: "Процент успешных платежей",
  支付方式: "Способ оплаты",
  支付方式分布: "Распределение способов оплаты",
  支付方式名称: "Название метода оплаты",
  支付方式名称不能为空: "Название способа оплаты не может быть пустым.",
  支付方式图标: "Значок способа оплаты",
  支付方式类型: "Тип метода оплаты",
  支付方式设置: "Настройки способа оплаты",
  支付方式颜色: "Цвет способа оплаты",
  支付时间: "Paid at",
  ...
  "支持 JSONPath，如 email, data.user.email": "Поддержка JSONPath, например электронная почта, data.user.email.",
  "支持 JSONPath，如 name, display_name, data.user.name": "Поддержка JSONPath, например name, display_name, data.user.name.",
  "支持 JSONPath，如 preferred_username, login, data.user.username": "Поддержка JSONPath, например, предпочтительное_имя_пользователя, логин, данные.пользователь.имя_пользователя.",
  "支持 JSONPath，如 sub, id, data.user.id": "Поддержка JSONPath, например sub, id, data.user.id",
  ...
  "支持使用 {prompt} 占位原始提示词": "Поддержка использования исходного слова-заполнителя {prompt}.",
  ...
  "支持多个标记，使用换行、逗号、分号或竖线分隔。模型输出包含任一标记时将记录审查结果。": "Поддерживается несколько тегов, разделенных новой строкой, запятой, точкой с запятой или вертикальной чертой. Результаты проверки регистрируются, если выходные данные модели содержат любой флаг.",
  ...
  "支持文生视频、首尾帧、参考图与参考视频/音频": "Поддерживаются генерация видео по тексту, первый/последний кадр, референсные изображения, видео и аудио",
  支持的分辨率: "",
  ...
  支持的画面比例: "",
  支持的输出格式: "",
  "支持精确匹配；使用 regex: 开头可按正则匹配。": "Поддерживает точное соответствие; используйте регулярное выражение: в начале для соответствия обычным правилам.",
  "支持自定义请求限流、频率控制、黑白名单配置，灵活管控接口访问流量，避免恶意请求与突发流量冲击，保障业务有序平稳运行。": "Настраиваемые лимиты запросов, контроль частоты и чёрные/белые списки позволяют гибко управлять трафиком API, защищаться от вредоносных запросов и пиковых нагрузок и поддерживать упорядоченную стабильную работу бизнеса.",
  ...
  政企项目系统集成: "Гос- и корпоративные системы",
  ...
  "文+图生图": "Текст + изображения создают изображения",
  文件上传: "Загрузка файла",
  ...
  文心一言: "Wenxin Yiyan",
  "文本生成内容审查（命中输出标记时记录审查结果）": "Проверка содержимого генерации текста (результаты проверки записываются при нажатии выходных флагов)",
  文档: "Документация",
  文档中心: "Центр документации",
  文档加载失败: "Не удалось загрузить документацию",
  文档地址: "Адрес документации",
  文档导航: "",
  文档搜索加载失败: "Не удалось загрузить поиск по документации",
  文档目录: "Содержание",
  文档空间: "",
  文档翻页导航: "",
  文生图: "Винсентианская картина",
  文生视频: "Текст в видео",
  新增: "added",
  "新增 / 首充 / 活跃用户趋势": "Тренды новых/первых депозитов/активных пользователей",
  "新增 / 首充用户": "Новый пользователь/пользователь первого депозита",
  "新增 Key 来源": "Добавить источник ключа",
  新增供应商: "Добавить поставщика",
  新增失败: "Не удалось добавить",
  新增对比项: "Добавить элементы сравнения",
  新增封禁: "Добавить новый бан",
  新增封禁记录: "Добавить запись о бане",
  "新增已选 {{selected}} / {{total}}": "Добавить выбранные {{selected}} / {{total}}",
  新增平台对比: "Добавлено сравнение платформ.",
  新增成功: "Успешно добавлено",
  新增支付方式: "Добавить новый способ оплаты",
  新增条件: "Добавить условие",
  新增模型: "Добавить новую модель",
  新增用户: "Добавить нового пользователя",
  "新增用户按创建时间统计，首充用户按首次支付时间统计，活跃用户按日志去重统计。": "Новые пользователи подсчитываются на основе времени создания, пользователи, впервые внесшие депозит, подсчитываются на основе времени первого платежа, а активные пользователи подсчитываются на основе дедупликации журналов.",
  新增规则: "Добавить правило",
  新增订阅: "Добавить подписку",
  新增邀请计划: "Добавить план приглашения",
  新密码: "Новый пароль",
  "新密码需要和原密码不一致！": "Новый пароль должен отличаться от старого!",
  新年促销: "Новогодняя акция",
  新建: "Создать",
  新建套餐: "Создать план",
  ...
  新用户邀请: "Приглашение нового пользователя",
  ...
  "无条件（兜底档）": "Безусловный (низкий уровень)",
  "无法加载文档内容，请稍后重试": "Не удалось загрузить содержимое документации, повторите попытку позже",
  ...
  "无法复制到剪贴板，请重试": "",
  "无法构建搜索索引，请稍后重试": "Не удалось построить поисковый индекс. Повторите попытку позже.",
  无法添加图片: "Невозможно добавить изображение",
  无法获取容器详情: "Unable to get container details",
  "无法获取模型 {{model}} 的能力契约，暂时无法生成": "",
  无法获取用户信息: "Невозможно получить информацию о пользователе",
  无法读取剪贴板: "Не удалось прочитать буфер обмена",
  无生效: "Нет активных",
  无结果: "Нет результатов",
  无输入影片: "Без входного видео",
  ...
  日志追踪: "",
  日期: "дата",
  "旧数据/未知": "Устаревшие данные/неизвестно",
  ...
  是否检测上游模型更新: "Обнаруживать ли обновления вышестоящей модели",
  "是否确认充值？": "Подтвердить пополнение?",
  是否自动同步上游模型更新: "Следует ли автоматически синхронизировать обновления вышестоящей модели",
  ...
  显示名称字段: "поле отображаемого имени",
  ...
  晚上好: "Добрый вечер",
  "普通按量/按次直接填价格就行；如果价格要跟请求参数或请求头联动，请切到表达式/阶梯计费。": "Обычно просто заполняйте цену по объему/за раз; если цену необходимо связать с параметрами запроса или заголовками запроса, переключитесь на Expression/Ladder Billing.",
  ...
  暂无参数覆盖记录: "Пока нет записей о покрытии параметров",
  ...
  暂无差异化价格显示: "Дифференцированного отображения цен пока нет.",
  ...
  "暂无支付方式，点击上方按钮新增": "Способа оплаты пока нет. Нажмите кнопку выше, чтобы добавить.",
  暂无数据: "Нет данных",
  ...
  暂无模型: "No models",
  暂无模型封禁记录: "На данный момент нет записей о запрете модели.",
  ...
  暂无赠送日志: "Журнала подарков пока нет",
  暂无邀请码: "Кода приглашения пока нет",
  暂无邀请计划: "Плана приглашения пока нет",
  暂无邀请链接: "Ссылки на приглашение пока нет",
  暂无项目: "Нет проектов",
  暂无预填组: "Нет предварительно заполненных групп",
  暂时还没有代理佣金流水: "Комиссионного потока агентства пока нет",
  暂时还没有代理充值流水: "Потока пополнения агента пока нет",
  暂时还没有代理邀请用户: "Пока нет агента для приглашения пользователей.",
  暂时还没有邀请用户: "Пользователей пока не пригласили",
  暂时还没有邀请额度流水: "Переноса квоты приглашений пока нет.",
  ...
  更新: "Обновить",
  "更新 BLG 支付设置": "Обновите платежные настройки BLG",
  "更新 Creem 设置": "Обновить настройки Creem",
  "更新 Stripe 设置": "Обновить настройки Stripe",
  "更新 Waffo Pancake 设置": "Обновить настройки Waffo Pancake",
  "更新 Waffo 设置": "Обновить настройки Waffo",
  ...
  更新全局系统提示词拼接: "Обновить объединение слов в глобальную системную подсказку",
  ...
  有效至: "Valid until",
  "有输入/参考影片": "Входное/референсное видео",
  ...
  "未上传参考图时，默认调用文生图接口": "Если эталонное изображение не загружено, по умолчанию вызывается интерфейс изображений Винсента.",
  "未上传参考图时，默认调用文生视频流程": "",
  未产生佣金: "Комиссия не начисляется",
  ...
  "未找到差异化价格，无需同步": "Дифференцированная цена не найдена, синхронизация не требуется.",
  "未找到差异化倍率，无需同步": "Дифференцированные множители не найдены, синхронизация не требуется",
  未找到该文档: "Документ не найден",
  未授权: "Не авторизован",
  未提交: "Не отправлено",
  ...
  未登记: "Не зарегистрирован",
  未知: "Неизвестно",
  未知供应商: "Неизвестный поставщик",
  未知品牌: "Unknown Brand",
  未知方式: "неизвестный путь",
  ...
  未首单消费: "Не первая покупка",
  本地: "Локальный",
  本地数据存储: "Локальное хранение данных",
  本地计费: "Локальная тарификация",
  本月获得: "В этом месяце",
  本站: "Этот сайт",
  "本站来源使用该汇率，外部平台可在下方单独配置。": "Источник этого сайта использует этот обменный курс, а внешние платформы можно настроить отдельно ниже.",
  "本站汇率（CNY/USD）": "Курс обмена на этом сайте (CNY/USD)",
  ...
  本页暂无目录: "На этой странице нет заголовков",
  本页目录: "На этой странице",
  ...
  查单地址: "Проверить адрес",
  查看: "Просмотр",
  "查看 Codex 帐号信息与用量": "Просмотр информации об учетной записи Кодекса и ее использовании",
  "查看 JSON 示例": "Посмотреть пример JSON",
  查看你可使用的分组: "Просматривать доступные вам группы",
  查看你可使用的模型: "",
  查看关联部署: "View Associated Deployment",
  查看和筛选充值记录: "Просмотр и фильтрация записей о пополнении счета",
  查看图片: "Просмотр изображения",
  查看图片和文本审查结果: "Просмотр результатов проверки изображений и текста",
  查看图片和文本的审查记录: "Просмотр истории отзывов для изображений и текста",
  查看密钥: "Просмотр ключа",
  查看并退出你账户当前的登录设备: "",
  查看开票: "View invoice",
  查看当前可用的所有模型: "Просмотреть все доступные в настоящее время модели",
  "查看当前邀请福利，管理邀请列表，并追踪邀请额度流水": "Просматривайте текущие преимущества приглашений, управляйте списками приглашенных и отслеживайте движение квот приглашений.",
  ...
  查看接口文档: "",
  查看日志: "View Logs",
  查看来源: "Посмотреть источник",
  查看渠道密钥: "Просмотр ключа канала",
  查看登录会话: "",
  查看示例: "View Example",
  查看该应用对你账户的用量: "",
  查看详情: "View Details",
  "查看邀请码、邀请用户、充值流水和佣金流水": "Проверьте код приглашения, приглашенных пользователей, поток пополнения и поток комиссий.",
  查询: "Запрос",
  查询视频任务状态失败: "",
  标准价格: "Standard price",
  标签: "Метка",
  ...
  "标识符 (Slug)": "Идентификатор (слаг)",
  标识颜色: "Цвет идентификатора",
  样本数: "Количество образцов",
  核对中: "Under review",
  "核心优势 · 为什么选择 {{name}}": "Ключевые преимущества · Почему выбирают {{name}}",
  ...
  "根据哪个维度的 Token 数量决定落在哪一档": "Количество токенов в каком измерении определяет, в какую группу оно попадает.",
  "根据总用量落在哪个档位，所有 Token 都按该档价格计费": "В зависимости от того, к какой группе относится общее использование, все токены будут взиматься в соответствии с ценой этой категории.",
  ...
  档: "файлы",
  档位: "Уровень",
  档位名称: "Название ларька",
  档位标签: "метка шестерни",
  检查更新: "Проверить обновления",
  检测全部渠道上游更新: "Обнаружение всех обновлений восходящего канала",
  "检测到 FluentRead（流畅阅读）": "Обнаружен FluentRead (плавное чтение)",
  检测到以下高危状态码重定向规则: "Были обнаружены следующие правила перенаправления кода состояния высокого риска.",
  ...
  检测失败: "Обнаружение не удалось",
  "检测完成：新增 {{add}} 个，删除 {{remove}} 个": "Обнаружение завершено: {{add}} добавлен, {{remove}} удален.",
  检测超时: "",
  概览: "Overview",
  模型: "Модель",
  "模型 {{model}} 的能力契约不可用": "",
  ...
  模型优化提示词: "Слова-подсказки по оптимизации модели",
  ...
  "正在同步上游价格，请稍候": "Синхронизация цен на добычу, пожалуйста, подождите.",
  "正在同步价格，请稍候": "Синхронизация цен, пожалуйста, подождите.",
  "正在处理，请稍候": "Обработка, пожалуйста, подождите.",
  "正在处理大内容...": "Обработка большого содержимого...",
  "正在批量处理，请稍候": "Идет пакетная обработка, подождите.",
  "正在批量检测，请稍候": "Идет пакетное тестирование, подождите.",
  正在提交: "Отправка...",
  "正在构建搜索索引…": "Построение поискового индекса…",
  "正在构造请求体预览...": "Создание предварительного просмотра тела запроса...",
  "正在检测，请稍候": "Обнаружение, пожалуйста, подождите.",
  "正在测试第 ${current} - ${end} 个模型 (共 ${total} 个)": "Тестирование моделей с ${current} по ${end} (всего ${total})",
  "正在生成 ({{seconds}} s)": "Генерация ({{seconds}} с)",
  ...
  此支付方式最高充值金额为: "Максимальная сумма пополнения для этого способа оплаты составляет",
  "此时用户创建令牌时只能看到 standard 和 premium：": "Users can now only see standard and premium when creating tokens:",
  "此档上限（Token 数）": "Верхний предел этого файла (количество токенов)",
  ...
  "每个充值单位对应的 USD 金额，默认 1.0": "Сумма в долларах США, соответствующая каждой единице пополнения, по умолчанию 1,0.",
  ...
  "每个对比项都可选择来源（本站/外部平台），再分别选择分组和模型进行可视化对比。各来源按自己的汇率计算。": "Для каждого элемента сравнения вы можете выбрать источник (данный сайт/внешнюю платформу), а затем выбрать группы и модели для визуального сравнения. Каждый источник рассчитывает свой собственный обменный курс.",
  "每个档位可设置 0~2 个条件（对 len、p 和 c），最后一档为兜底档无需条件。len 为输入上下文总长度（含缓存），推荐用于阶梯条件。": "Каждая передача может устанавливать от 0 до 2 условий (для len, p и c), а последняя передача является нижней передачей без условий. len — общая длина входного контекста (включая кэш), рекомендуемая для условий релейной логики.",
  "每个档位可设置 0~2 个条件（对 p 和 c），最后一档为兜底档无需条件。": "Каждая передача может устанавливать условия от 0 до 2 (для p и c), а последняя передача является нижней передачей без условий.",
  每个模型使用其最低可用分组倍率: "Для каждой модели используется минимальный доступный коэффициент группы",
  ...
  每位邀请人可参与: "Каждый приглашающий может принять участие",
  每周: "Еженедельно",
  每天: "Ежедневно",
  每容器GPU数: "GPUs per Container",
  "每日仅可签到一次，请勿重复签到": "Только одна регистрация в день, пожалуйста, не регистрируйтесь повторно",
  每日充值金额: "Сумма ежедневного пополнения",
  每日支付成功率: "Ежедневный процент успешных платежей",
  每日消耗额度: "Суточная норма потребления",
  每日签到: "Ежедневная регистрация",
  每日签到可获得随机额度奖励: "Ежедневная регистрация награждает случайной квотой",
  每月: "Ежемесячно",
  "每百万 Token 价格": "Цена за миллион токенов",
  "每美元对应 Token 数": "Токенов за 1 доллар",
  每隔多少分钟测试一次所有通道: "Как часто тестировать все каналы (в минутах)",
  "比较模型价格，按供应商、分组和能力快速找到适合你的模型。": "Сравнивайте цены моделей и быстро находите подходящую модель по поставщику, группе и возможностям.",
  ...
  活动: "Активность",
  活动优惠以支付完成时系统配置为准: "",
  活动到期时间: "Срок действия активности",
  活跃: "",
  活跃文件: "Активные файлы",
  活跃用户: "активные пользователи",
  活跃用户数: "Количество активных пользователей",
  ...
  流状态: "статус потока",
  流量端口: "Traffic Port",
  流错误详情: "Подробности об ошибке трансляции",
  浅色: "Светлая",
  浅色模式: "Светлый режим",
  测活: "Health Check",
  测试: "Тест",
  "测试 Webhook 公钥": "Проверка открытого ключа вебхука",
  测试中: "Тестирование",
  "测试中...": "Тестирование...",
  ...
  测试模式: "Тестовый режим",
  测试环境: "тестовая среда",
  "测试环境 Webhook 验签公钥 Base64": "Тестовая среда Открытый ключ проверки подписи Webhook Base64",
  ...
  消费: "Расходы",
  消费后即可获得返利: "Вознаграждение начисляется после траты приглашённого",
  深色: "Тёмная",
  深色模式: "Тёмный режим",
  添加: "Добавить",
  "添加 (+:)": "Add (+:)",
  ...
  清空参考图: "Очистить эталонное изображение",
  ...
  "渠道平均响应 / P95 / P99": "Средний отклик канала / P95 / P99",
  ...
  "满足条件时，整单价格乘以 X；如果有多条同时命中，会继续相乘。": "При выполнении условий вся стоимость заказа умножается на X; если одновременно будет несколько попаданий, умножение продолжится.",
  ...
  点击处理删除模型: "Нажмите «Обработать», чтобы удалить модель.",
  点击处理新增模型: "Нажмите, чтобы обработать новую модель",
  ...
  现在: "",
  "生产 Webhook 公钥": "Создание открытого ключа вебхука",
  生产环境: "производственная среда",
  "生产环境 RSA 私钥 Base64 (PKCS#8 DER)": "RSA закрытый ключ Base64 (PKCS#8 DER) производственной среды",
  "生产环境 Waffo API 密钥": "Рабочий ключ API Waffo",
  "生产环境 Waffo 公钥 Base64 (X.509 DER)": "Открытый ключ Waffo Base64 (X.509 DER) производственной среды",
  "生产环境 Webhook 验签公钥 Base64": "Производственная среда Проверка подписи Webhook с открытым ключом Base64",
  生成: "Генерация",
  生成令牌: "Сгенерировать токен",
  生成参数: "",
  生成图片: "Сгенерированное изображение",
  ...
  生成模式: "Режим генерации",
  生成歌词: "Сгенерировать текст песни",
  生成配置链接失败: "",
  生成音乐: "Сгенерировать музыку",
  生成音频: "Генерировать аудио",
  生效: "Активно",
  生效中: "Вступает в силу",
  "用于“1M输入（含缓存）”估算，示例：0.95。": "Для оценки «1М ввода (включая кэш)» пример: 0,95.",
  "用于API调用的身份验证令牌，请妥善保管": "Токен аутентификации для API вызовов, пожалуйста, храните его надёжно",
  用于切换当前下单和回调校验所使用的环境: "Используется для переключения среды, используемой для текущего размещения заказа и проверки обратного вызова.",
  用于唯一标识用户的字段路径: "Путь поля для уникальной идентификации пользователей",
  "用于校验 Stripe Webhook 签名，保存后不会回显": "Используется для проверки подписи Stripe Webhook, не будет отображаться после сохранения.",
  "用于校验测试环境的 Waffo Pancake Webhook 签名": "Подпись Waffo Pancake Webhook для проверки тестовой среды",
  "用于校验测试环境的 Waffo 回调签名": "Подпись обратного вызова Waffo, используемая для проверки тестовой среды",
  "用于校验生产环境的 Waffo Pancake Webhook 签名": "Проверка подписи Waffo Pancake Webhook для производственных сред",
  "用于校验生产环境的 Waffo 回调签名": "Подпись обратного вызова Waffo для проверки производственной среды",
  ...
  用户: "Пользователь",
  "用户 ID 字段": "Поле идентификатора пользователя",
  ...
  用户信息端点: "Конечная точка информации о пользователе",
  ...
  用户单次最少可充值的美元数量: "Минимальная сумма долларов США, которую пользователь может пополнить за один раз.",
  ...
  用户名字段: "поле имени пользователя",
  "用户名字段（可选）": "Поле имени пользователя (необязательно)",
  用户名或邮箱: "Имя пользователя или email",
  用户名称: "Имя пользователя",
  "用户在充值页面看到的支付方式名称，例如：Credit Card": "Название способа оплаты, которое пользователи видят на странице пополнения счета, например: Кредитная карта.",
  用户工单处理: "Обработка заказов пользователей",
  ...
  "用户消耗排名 Top 10": "Топ-10 рейтингов потребления пользователей",
  ...
  "用量分段计价，每一段各自按对应档位价格计费（类似电费阶梯）": "Использование оценивается по сегментам, и каждый сегмент взимается в соответствии с соответствующей ценой (аналогично шкале счетов за электроэнергию).",
  "用量统计、模型选择、成本优化": "",
  用量范围: "Диапазон дозировки",
  ...
  "留空则使用 /console/topup?show_history=true": "Оставьте пустым, чтобы использовать /console/topup?show_history=true",
  留空则使用账号绑定的邮箱: "Если оставить пустым, будет использован email, привязанный к аккаунту",
  留空则使用默认回调地址: "Оставьте поле пустым, чтобы использовать адрес обратного вызова по умолчанию.",
  ...
  "留空则自动使用 服务器地址 + /api/waffo/webhook": "Оставьте поле пустым, чтобы автоматически использовать адрес сервера + /api/waffo/webhook.",
  留空则自动使用当前站点的默认充值页地址: "Если оставить это поле пустым, автоматически будет использоваться адрес страницы пополнения баланса текущего сайта по умолчанию.",
  ...
  "留空时默认使用服务器地址作为回调地址，填写后将覆盖默认值": "Если оставить пустым, адрес сервера будет использоваться в качестве адреса обратного вызова по умолчанию. Заполнение приведет к перезаписи значения по умолчанию.",
  "留空表示保留当前密钥，仅在需要更换时重新填写": "Оставьте это поле пустым, чтобы сохранить текущий ключ, и заполняйте его только в том случае, если вам нужно его изменить.",
  留空表示长期有效: "Оставьте пустым, чтобы указать долгосрочное действие",
  "登 录": "ВОЙТИ",
  登录: "Войти",
  登录会话: "",
  登录你的账号: "",
  ...
  目标分组: "Target Group",
  目标比例: "Целевое соотношение",
  目标清晰度: "Целевая чёткость",
  ...
  "确定要仅检测全部渠道上游模型更新吗？（不执行新增/删除）": "Вы уверены, что хотите обнаруживать только все обновления модели восходящего канала? (Добавление/удаление не будет выполнено)",
  ...
  "确定要删除该提供商吗？": "Вы уверены, что хотите удалить этого провайдера?",
  ...
  "确定要对全部渠道执行上游模型更新吗？": "Вы уверены, что хотите выполнить обновление восходящей модели для всех каналов?",
  ...
  "确认删除该邀请计划？": "Подтвердить удаление этого плана приглашения?",
  "确认删除这条模型封禁记录？": "Вы уверены, что удалите запись о запрете этой модели?",
  确认取消密码登录: "Подтвердить отмену входа по паролю",
  "确认后会从可提现佣金扣减，并累计到已提现佣金，同时写入代理佣金流水。": "После подтверждения она будет вычтена из снимаемой комиссии, накоплена в снимаемой комиссии и записана в поток комиссий агентства.",
  ...
  "示例：claude-opus-4-8 输入价，官方 ￥35.00，Claude lite（特价） ￥3.50": "Пример: входная цена claude-opus-4-8 — официальная ¥35,00; Claude lite (спеццена) ¥3,50",
  ...
  秒: "секунда",
  移动: "двигаться",
  移动请求头: "Переместить заголовок запроса",
  移除: "Remove",
  "移除 (-:)": "Remove (-:)",
  ...
  空: "Пусто",
  "空位 {{index}}": "Вакансия {{index}}",
  窗口处理: "Обработка окна",
  窗口等待: "Ожидание окна",
  立即充值: "Пополните баланс сейчас",
  立即生成: "Создать немедленно",
  ...
  端点: "Конечная точка",
  "端点 URL 必须以 http:// 或 https:// 开头：": "URL-адрес конечной точки должен начинаться с http:// или https://:",
  ...
  等待首单消费后判定返利: "Подождите, пока скидка будет определена после первой покупки.",
  筛选: "Фильтр",
  ...
  "简化接口调用，赋能业务高效运转": "Упростите вызовы API и обеспечьте эффективную работу бизнеса",
  ...
  管理员可视化报表中心: "Центр визуальных отчетов администратора",
  管理员尚未配置需要展示的分组: "",
  管理员尚未配置需要展示的套餐: "",
  管理员尚未配置需要展示的模型: "",
  管理员暂时未设置任何关于内容: "Администратор пока не установил никакой информации о проекте",
  管理员暂未配置微信群二维码: "Администратор еще не настроил QR-код группы WeChat.",
  ...
  管理员未开启支付宝充值: "Администратор не включил пополнение счета Alipay.",
  "管理员未开启支付宝充值！": "Администратор не включил пополнение Alipay!",
  "管理员未开启聚合支付！": "",
  ...
  "粘贴图片链接（http/https）": "Вставьте ссылку на изображение (http/https)",
  精确: "Точный",
  精选: "",
  系统: "Система",
  ...
  "纯字符串会直接覆盖整条请求头，或者点击“查看 JSON 示例”按 token 规则处理。": "Чистая строка будет напрямую охватывать весь заголовок запроса или нажать «Просмотреть пример JSON», чтобы обработать ее в соответствии с правилами токена.",
  累计佣金: "Накопленная комиссия",
  累计充值金额: "Суммарная сумма пополнения",
  累计签到: "Всего регистраций",
  累计获得: "Всего получено",
  累计贡献佣金: "Комиссия по накопительным взносам",
  "累计返利 {{quota}}（共 {{count}} 次）": "Всего вознаграждений {{quota}} ({{count}} раз)",
  "累计返利 {{quota}}（共 {{count}} 次）_few": "",
  "累计返利 {{quota}}（共 {{count}} 次）_many": "",
  "累计返利 {{quota}}（共 {{count}} 次）_one": "",
  "累计返利 {{quota}}（共 {{count}} 次）_other": "",
  累计邀请奖励: "Накопительные награды за приглашения",
  累进阶梯: "прогрессивная лестница",
  ...
  统计周期内代理用户创建的充值订单: "Заявки на пополнение счета, созданные пользователями-агентами в течение статистического периода",
  统计周期内完成支付的成功金额: "Успешная сумма платежа, совершенная в течение статистического периода",
  ...
  "缓存创建 Token": "Токен создания кэша",
  "缓存创建 Token (cc)": "Токен создания кэша (cc)",
  "缓存创建 Tokens": "Создание кэша токенов",
  "缓存创建-1h": "Создание кэша-1 час",
  "缓存创建-1小时": "Создание кэша - 1 час",
  "缓存创建-1小时 (cc1h)": "Создание кэша - 1 час (cc1h)",
  "缓存创建-5分钟": "Создание кэша - 5 минут",
  "缓存创建-5分钟 (cc5)": "Создание кэша - 5 минут (cc5)",
  ...
  "缓存创建价格-1小时": "Стоимость создания кэша - 1 час",
  "缓存创建价格-5分钟": "Стоимость создания кэша - 5 минут",
  ...
  "缓存命中 Token": "Токен попадания в кэш",
  缓存命中率: "Скорость попадания в кэш",
  缓存效率: "Эффективность кэша",
  缓存条目数: "Количество записей кэша",
  缓存率: "Скорость кэширования",
  缓存目录: "Директория кэша",
  缓存目录磁盘空间: "Дисковое пространство директории кэша",
  缓存节省额度: "Экономия кэша",
  缓存读: "Чтение кэша",
  "缓存读 {{price}} / 1M tokens": "Чтение кеша {{price}} / 1M tokens",
  缓存读取: "чтение кэша",
  "缓存读取 Token (cr)": "Токен чтения кэша (cr)",
  ...
  编辑封禁记录: "Редактировать историю банов",
  编辑成功: "Редактирование выполнено успешно",
  编辑提供商: "Изменить поставщика",
  ...
  自动: "Авто",
  "自动（由模型决定）": "Авто (определяет модель)",
  自动分组: "Auto Group",
  ...
  "自动表示由模型决定分辨率，不发送尺寸参数": "Авто означает, что модель сама определяет разрешение; параметр размера не отправляется",
  ...
  自定义流量管控: "Настраиваемое управление трафиком",
  ...
  获取代理分销信息失败: "Не удалось получить информацию о распространении агента.",
  获取代理统计失败: "Не удалось получить статистику агента.",
  获取令牌密钥失败: "Не удалось получить ключ токена",
  获取佣金流水失败: "Не удалось получить комиссионный поток",
  获取充值流水失败: "Не удалось получить пополняемую воду",
  ...
  获取邀请流水失败: "Не удалось получить оборот приглашения",
  ...
  "表达式/阶梯计费": "Выражение/многоуровневое выставление счетов",
  表达式编辑: "Редактирование выражений",
  表达式计费: "Выражение биллинга",
  表达式错误: "Ошибка выражения",
  被邀请人: "Приглашенный",
  覆盖: "Заменить",
  ...
  覆盖用户: "Охватите пользователей",
  见上方动态计费详情: "См. информацию о динамическом выставлении счетов выше.",
  规则: "Правило",
  ...
  "规则描述（可选）": "Описание правила (необязательно)",
  ...
  解除授权: "",
  解除授权失败: "",
  触发套餐: "триггерный пакет",
  触发条件: "Условие триггера",
  触发来源: "источник триггера",
  计价币种: "Pricing Currency",
  计价规则: "Правила расчёта цены",
  计划: "план",
  计划名称: "Название плана",
  计划状态: "статус плана",
  计算中: "Calculating",
  计算失败: "Расчет не выполнен",
  计算成本: "Calculate Cost",
  计算盈利: "Рассчитать прибыль",
  计算盈利失败: "Расчет прибыли не удался",
  ...
  "订阅购买成功，已生效": "Подписка успешно приобретена и вступила в силу",
  ...
  设请求头: "Предположим, заголовок запроса",
  ...
  该入口仅用于一次性余额充值: "Этот вход используется только для единоразового пополнения баланса.",
  ...
  该文档可能已被移动或删除: "Этот документ мог быть перемещён или удалён",
  ...
  该渠道暂无可处理的上游模型更新: "В настоящее время у этого канала нет обновлений восходящей модели для обработки.",
  该渠道未开启上游模型更新检测: "Обнаружение обновления модели восходящего потока не включено для этого канала.",
  ...
  请使用支付宝扫码支付: "Пожалуйста, используйте Alipay для сканирования QR-кода для оплаты.",
  ...
  "请先填写服务器地址，以自动生成完整的端点 URL": "Сначала введите адрес сервера, чтобы автоматически сгенерировать полный URL-адрес конечной точки.",
  "请先开启并填写音频输入价格。": "Сначала включите и заполните цену аудио-ввода.",
  请先新增模型或从左侧列表选择一个模型: "Сначала добавьте новую модель или выберите модель из списка слева.",
  ...
  请先选择不低于最低额度的充值金额: "Пожалуйста, сначала выберите сумму пополнения, которая не меньше минимальной суммы.",
  请先选择令牌: "",
  "请先选择供应商，再选择分组": "Сначала выберите поставщика, затем группу",
  ...
  "请在 Waffo 后台获取 API 密钥、商户 ID 以及 RSA 密钥对，并配置回调地址。": "Получите ключ API, идентификатор продавца и пару ключей RSA в серверной части Waffo и настройте адрес обратного вызова.",
  ...
  请填写封禁原因: "Пожалуйста, укажите причину бана",
  "请填写当前环境对应的 Product ID": "Пожалуйста, заполните идентификатор продукта, соответствующий текущей среде.",
  "请填写当前环境对应的 Store ID": "Пожалуйста, заполните идентификатор магазина, соответствующий текущей среде.",
  "请填写当前环境对应的商户 ID": "Пожалуйста, заполните идентификатор продавца, соответствующий текущей среде.",
  ...
  请求头: "Заголовок запроса",
  请求头覆盖: "Переопределение заголовков запроса",
  "请求尺寸：{{size}}": "Запрошенный размер: {{size}}",
  "请求尺寸是发送给模型的目标值，实际输出以模型或渠道返回为准": "Запрошенный размер — это целевое значение, отправляемое модели; фактический вывод зависит от ответа модели или канала.",
  请求并计费模型: "Запрос и выставление счёта модели",
  "请求时长: ${time}s": "Время запроса: ${time}s",
  请求条件调价: "Запросить корректировку цены условия",
  请求次数: "Количество запросов",
  请求结束后多退少补: "После вывода запроса возврат излишков и доплата недостатка",
  请求规则: "правила запроса",
  ...
  请求频率: "Частота запросов",
  请点击我: "Пожалуйста, нажмите на меня",
  "请确保你的服务可被支付网关回调访问，并在网关侧正确配置白名单与回调地址。": "Убедитесь, что к вашей услуге можно получить обратный вызов платежного шлюза, а белый список и адрес обратного вызова правильно настроены на стороне шлюза.",
  ...
  "请稍后再来查看，或联系管理员获取入群方式。": "Проверьте позже или свяжитесь с администратором, чтобы получить приглашение.",
  ...
  '请输入 JSON 格式的密钥内容，例如：\n{\n  "type": "service_account",\n  "project_id": "your-project-id",\n  "private_key_id": "...",\n  "private_key": "...",\n  "client_email": "...",\n  "client_id": "...",\n  "auth_uri": "...",\n  "token_uri": "...",\n  "auth_provider_x509_cert_url": "...",\n  "client_x509_cert_url": "..."\n}': `Пожалуйста, введите содержимое ключа в формате JSON, например:
{
  ...
  "请输入 Product ID": "Пожалуйста, введите идентификатор продукта",
  "请输入 Slug": "Введите Slug",
  "请输入 Store ID": "Пожалуйста, введите идентификатор магазина",
  ...
  "请输入商户 ID": "Пожалуйста, введите идентификатор продавца",
  ...
  "请输入密钥！": "Пожалуйста, введите ключ!",
  请输入密钥前缀或尾号: "",
  "请输入封禁原因，用户会直接看到这段原因": "Пожалуйста, укажите причину бана. Пользователи увидят причину напрямую.",
  ...
  请输入支付方式名称: "Пожалуйста, введите название способа оплаты",
  ...
  请输入有效的图片链接: "Введите корректную ссылку на изображение",
  ...
  请输入计划名称: "Пожалуйста, введите название плана",
...
Поддерживается формат сопоставления моделей
{
  ...
  "请选择国家/地区": "Пожалуйста, выберите страну/регион",
  请选择图片模型: "Пожалуйста, выберите модель изображения",
  ...
  请选择封禁结束时间: "Пожалуйста, выберите время окончания блокировки",
  请选择开始和结束日期: "Пожалуйста, выберите дату начала и окончания",
  "请选择您所在的国家/地区": "Пожалуйста, выберите вашу страну/регион",
  请选择支付方式: "Выберите способ оплаты",
  请选择日志记录时间: "Пожалуйста, выберите время записи журнала",
  请选择有效的结束时间: "Пожалуйста, выберите действительное время окончания",
  ...
  请选择触发套餐: "Пожалуйста, выберите триггерный пакет",
  ...
  请选择返利套餐: "Пожалуйста, выберите пакет скидок",
  请选择通知方式: "Пожалуйста, выберите способ уведомления",
  请选择需要封禁的模型: "Пожалуйста, выберите модель, которую нужно заблокировать",
  读取你的基本资料: "",
  读取你的邮箱地址: "",
  调整额度: "Скорректировать квоту",
  调整额度成功: "Квота успешно скорректирована",
  调用模型排名: "Рейтинг моделей звонков",
  ...
  资源中心: "Ресурсный центр",
  资源消耗: "Потребление ресурсов",
  赠送余额: "Подарочный баланс",
  赠送内容: "Бесплатный контент",
  赠送套餐: "Бесплатный пакет",
  赠送日志: "Журнал подарков",
  "赠送比例（%）": "Соотношение подарков (%)",
  起: "рост",
  起价: "",
  起充: "Начать зарядку",
  起充额度: "Минимальная сумма депозита",
  起始时间: "Время начала",
  超级管理员: "Суперадминистратор",
  "超级管理员未设置充值链接！": "Суперадминистратор не установил ссылку пополнения!",
  "超过 {{count}} 个": "Больше, чем {{count}}",
  ...
  跨夜范围: "Ночной диапазон",
  跨阶梯: "по лестнице",
  路径正则: "Regex пути",
  "路径正则（每行一个）": "Regex пути (по одному в строке)",
  跳转: "Перейти",
  跳转支付: "",
  转大写: "Преобразовать в верхний регистр",
  转小写: "Преобразовать в нижний регистр",
  转换: "Конвертировать",
  轮询: "Опрос",
  轮询模式: "Режим опроса",
  ...
  软错误: "программная ошибка",
  "轻量化易用，低成本落地": "Лёгкость, удобство и низкая стоимость внедрения",
  较早: "",
  输入: "Ввод",
  "输入 {{price}} / 1M tokens": "Вход {{price}} / 1M tokens",
  "输入 $/1M tokens": "Введите токены $/1M",
  ...
  "输入 Token": "Введите токен",
  "输入 Token 定价": "Введите цену токена",
  "输入 Token 总量": "Введите общее количество токенов",
  "输入 Token 数": "Введите количество токенов",
  "输入 Token 数 (p)": "Введите количество жетонов (p)",
  "输入 Token 数量，查看按当前配置的预计费用。": "Введите количество токенов, чтобы просмотреть ориентировочную стоимость на основе текущей конфигурации.",
  "输入 Token 数量，查看按当前配置的预计费用（不含分组倍率）。": "Введите количество токенов, чтобы просмотреть ориентировочную стоимость на основе текущей конфигурации (без учета множителя группировки).",
  "输入 Token 数量，查看按当前阶梯配置的预计费用。": "Введите количество токенов, чтобы просмотреть ориентировочную стоимость на основе текущей конфигурации уровня.",
  "输入 Tokens 阶梯": "Войдите в лестницу токенов",
  ...
  输入倍率: "Введите увеличение",
  输入关键词以搜索文档内容: "Введите ключевое слово для поиска по документации",
  ...
  "输入基础 URL": "Введите базовый URL",
  输入媒体: "Входные медиа",
  "输入密码，最短 8 位，最长 20 位": "Введите пароль, минимум 8 символов, максимум 20 символов",
  输入手机号: "",
  输入数字: "Введите число",
  输入本次已打款金额: "Введите сумму, выплаченную в этот раз",
  ...
  输入每次调用价格: "Введите цену за звонок",
  "输入消息…": "Type a message…",
  ...
  "输入计费表达式...": "Введите выражение для выставления счета...",
  ...
  "输出 Token": "Выходной токен",
  "输出 Token 定价": "Цена выходного токена",
  "输出 Token 数": "Выведите количество токенов",
  "输出 Token 数 (c)": "Выведите количество жетонов (c)",
  "输出 Tokens 阶梯": "Лестница выходных токенов",
  ...
  输出倍率: "Выходное увеличение",
  "输出倍率 {{completionRatio}}": "Коэффициент вывода {{completionRatio}}",
  输出内容记录审查: "Проверка выходной записи содержимого",
  输出格式: "",
  输出阶梯: "Выходная лестница",
  ...
  近7天: "",
  近7天可用性: "",
  返余额: "Возвратный баланс",
  返利到账: "Скидка получена",
  返利套餐: "Пакет скидок",
  返利方式: "Метод скидки",
  返利百分比: "Процент скидки",
  返利结果: "Результаты скидок",
  返利规则: "Правила скидок",
  返回修改: "Вернуться и исправить",
  返回文档首页: "Вернуться на главную документации",
  返回登录: "Вернуться к входу",
  返回错误: "ошибка возврата",
  返套餐: "Возврат посылки",
  "这个公式比较复杂，下面的简化表单没法完整还原，请在表达式编辑模式下修改。": "Эта формула относительно сложна и не может быть полностью восстановлена ​​по упрощенной форме, приведенной ниже. Пожалуйста, измените его в режиме редактирования выражения.",
  ...
  这里会显示生成结果: "Здесь будут отображаться сгенерированные результаты.",
  这里会显示视频结果: "",
  ...
  "这里配置 Waffo 下展示给用户的 Card、Apple Pay、Google Pay 等子支付方式。": "Здесь настройте карту, Apple Pay, Google Pay и другие методы дополнительной оплаты, отображаемые пользователю в Waffo.",
  "这里配置代理用户的默认首充和复充分成比例。单个用户如关闭“使用系统默认比例”，则以用户自身设置为准。": "Здесь сумма первого депозита и погашения по умолчанию пользователя-агента настроена как пропорциональная. Если один пользователь отключит параметр «Использовать системное соотношение по умолчанию», собственные настройки пользователя будут иметь преимущественную силу.",
  进入此档额外收费: "За ввод этого файла взимается дополнительная плата.",
  进度: "Прогресс",
  进行中: "В процессе",
  ...
  退出设备失败: "",
  退款: "Возврат",
  "适合任务类等按次收费模型。": "Подходит для задач, тарифицируемых за запрос.",
  ...
  "适用于统一下单返回 payUrl 的聚合支付网关。当前接入包含：下单、异步回调验签和充值入账。": "Агрегирующий платежный шлюз, подходящий для унифицированного payUrl возврата заказов. Текущий доступ включает в себя: размещение заказов, асинхронную проверку подписи обратного вызова и пополнение счета.",
  ...
  "选择金额后直接跳转到 Waffo Pancake 结账页，支付完成后会回到账户页。": "После выбора суммы вы перейдете прямо на страницу оформления заказа Waffo Pancake. После завершения оплаты вы вернетесь на страницу аккаунта.",
  "选择预设...": "Выберите предустановку...",
  "选择预设模板（可选）": "Выберите предустановленный шаблон (необязательно)",
  透传请求体: "Прямая передача тела запроса",
  透传请求头: "Прозрачный заголовок запроса",
  递归: "Рекурсия",
  递归策略: "Стратегия рекурсии",
  通义千问: "Tongyi Qianwen",
  通用缓存: "Универсальный кэш",
  ...
  邀请流水: "Пригласите проточную воду",
  邀请用户: "Приглашённые пользователи",
  邀请用户数: "Количество приглашенных пользователей",
  "邀请的好友越多，获得的奖励越多": "Чем больше друзей вы пригласите, тем больше вознаграждение получите",
  邀请码: "Код приглашения",
  邀请码奖励: "Награда за пригласительный код",
  邀请码已复制: "Пригласительный код скопирован",
  邀请获得额度: "Получить лимит через приглашение",
  邀请计划: "план приглашения",
  "邀请计划会在被邀请用户每次充值时向其邀请人返利（仅返利一层，订阅购买仍仅首次）。": "План начисляет вознаграждение пригласившему при каждом пополнении приглашённого (только один уровень; покупки подписки вознаграждаются только при первом платеже).",
  邀请返利: "Пригласить скидку",
  邀请返利规则配置: "Настройка правила скидки для приглашений",
  邀请链接: "Ссылка приглашения",
  邀请链接已复制: "Ссылка для приглашения скопирована.",
  ...
  "配置 Waffo 充值时可用的支付方式，保存后在充值页面展示给用户。": "Настройте способы оплаты, доступные при пополнении баланса Waffo, и сохраните их для отображения пользователю на странице пополнения баланса.",
  "配置 WeChat Server": "Настроить WeChat Server",
  "配置：": "Конфиг:",
  配置价: "",
  "配置到 CC Switch": "",
  "配置各工具的调用价格（$/1K次调用）。按次计费模型不额外收取工具费用。": "Настройте цену вызова для каждого инструмента (вызовы в размере $/1 тыс.). Для модели с оплатой за просмотр дополнительная плата за инструменты не взимается.",
  "配置后会在所有渠道请求中统一拼接到系统提示词前，可用于全局内容过滤": "После настройки оно будет равномерно склеено перед словом системной подсказки во всех запросах канала и может использоваться для глобальной фильтрации контента.",
  ...
  "配置计划名称、启用状态、优先级和备注": "Настройте название плана, статус активации, приоритет и комментарии.",
  ...
  长度: "длина",
  长期有效: "Эффективен в течение длительного времени",
  问题: "Issue",
  问题描述: "Description",
  问题标题: "Заголовок проблемы",
  队列中: "В очереди",
  阶: "уровень",
  "阶梯内 Token 数": "Количество жетонов в лестнице",
  阶梯判断依据: "Лестничная основа оценки",
  阶梯序号: "Номер лестницы",
  阶梯累进: "Прогресс по лестнице",
  阶梯计费: "Многоуровневое выставление счетов",
  "阶梯计费（表达式解析失败）": "Многоуровневое выставление счетов (не удалось проанализировать выражение)",
  阶梯计费详情: "Детали многоуровневого выставления счетов",
  阶梯配置摘要: "Сводная информация о конфигурации лестницы",
  ...
  音频补全倍率: "коэффициент завершения аудио",
  ...
  预计费用: "Ориентировочная стоимость",
  ...
  首充: "Первый заряд",
  首充佣金: "Комиссия за первый депозит",
  首充分成比例: "Полностью пропорциональный",
  首充用户: "Первый пользователь пополнения счета",
  "首充赠送最大额度不能小于 0": "Максимальная сумма подарка на первый депозит не может быть меньше 0",
  "首充赠送比例不能小于 0": "Коэффициент бонуса на первый депозит не может быть меньше 0.",
  首充赠送结束时间: "Время окончания бонуса на первый депозит",
  "首充赠送起充额度不能小于 0": "Минимальная сумма депозита для бонуса на первый депозит не может быть меньше 0.",
  "首单已消费，但未命中返利计划": "Первый заказ был израсходован, но план скидок не был выбран.",
  首单状态: "Статус первого заказа",
  首尾帧生成: "",
  ...
  高危操作确认: "Подтверждение операций высокого риска",
  高危状态码重试风险告知与免责声明Markdown: "Уведомление о риске повторной попытки кода статуса высокого риска и отказ от ответственности Markdown",
  高危状态码重试风险确认输入文本: "Код статуса высокого риска: повторите попытку, введите текст подтверждения риска",
  高危状态码重试风险确认项1: "Код статуса высокого риска, повторная попытка подтверждения риска, пункт 1",
  高危状态码重试风险确认项2: "Код статуса высокого риска, повторная попытка подтверждения риска, пункт 2",
  高危状态码重试风险确认项3: "Код статуса высокого риска, повторная попытка подтверждения риска, пункт 3",
  高危状态码重试风险确认项4: "Код статуса высокого риска, повторная попытка подтверждения риска, пункт 4",
  高危状态码重试风险输入不匹配提示: "Повторная попытка кода состояния высокого риска, риск несоответствия ввода",
  高危状态码重试风险输入框占位文案: "Копия заполнителя поля ввода кода риска повторной попытки с кодом состояния высокого риска",
  高并发接口调度: "Высококонкурентная диспетчеризация",
  高度: "",
  高效: "",
  高级: "Расширенные",
  ...
  "默认使用 USD 结算": "По умолчанию используется расчет в долларах США.",
  ...
  默认复充分成比例: "Комплекс по умолчанию полностью пропорционален",
  默认异步回调地址: "Адрес асинхронного обратного вызова по умолчанию",
  ...
  "协助码仅用于客服定位案件，不能用于登录；案件关闭后停止使用，永久案件编号仍可用于历史查询。客服收到协助码后，才能在客服后台定位案件并查看已授权的协助案件及其允许的资料进行排查。客服协助不是网站内的在线客服，网站不提供即时聊天，实际沟通请在微信群完成。": "Код помощи служит только для поиска обращения и не является данными для входа. После закрытия обращения он перестаёт работать, а постоянный номер доступен для истории. После получения кода поддержка может найти обращение в своей консоли и проверить разрешённые данные. Это не онлайн-чат: сайт не предоставляет мгновенную переписку, общение проходит в группе WeChat.",
  协助定位码已更新: "Assistance locator updated",
  "遇到问题请先在网站提交“请求协助”，提交后会取得永久案件编号和六位协助码（协助定位码），请将该码带到微信群发给客服。": "Если возникла проблема, сначала отправьте на сайте запрос «Запросить помощь». Вы получите постоянный номер обращения и шестизначный код помощи; передайте код поддержке в группе WeChat.",
  处理截止时间: "Handling deadline",
  案件编号: "Case number",
  "客服协助与工单是两个不同功能，客服协助不是在线客服，也不是工单对话；如需正式提交和跟进工单，请使用工单功能。请在下方描述问题，提交后将协助码带到微信群发给客服。": "Помощь поддержки и обращения — разные функции. Помощь не является онлайн-чатом или диалогом обращения. Для официальной подачи и отслеживания используйте функцию обращений. Опишите проблему ниже, затем передайте код помощи поддержке в группе WeChat.",
