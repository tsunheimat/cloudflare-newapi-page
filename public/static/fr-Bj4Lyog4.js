const e = {
  ...
  "。在契约恢复之前无法生成视频。": "",
  "（共 {{total}} 个，省略 {{omit}} 个）": "({{total}} au total, {{omit}} omis)",
  "（共 {{total}} 个）": "({{total}} au total)",
  "（可自动）": "",
  "（当前仅支持易支付接口，默认使用上方服务器地址作为回调地址！）": "(Actuellement, seule l'interface Easy Payment est prise en charge, et l'adresse du serveur ci-dessus est utilisée par défaut comme adresse de rappel !)",
  ...
  "{{count}} 项操作_many": "Opérations {{count}}",
  "{{count}} 项操作_one": "Opérations {{count}}",
  "{{count}} 项操作_other": "Opérations {{count}}",
  "{{discount}}折": "prix à {{discount}}/10",
  "{{discount}}折 · 省 {{percent}}%": "{{discount}}/10 du prix · économie de {{percent}}%",
  "{{inputDesc}} + {{outputDesc}}{{extraServices}} = {{symbol}}{{total}}": "{{inputDesc}} + {{outputDesc}}{{extraServices}} = {{symbol}}{{total}}",
  "{{label}} {{price}} / 1M tokens": "{{label}} {{price}} / 1 million de jetons",
  "{{min}} - {{max}} 秒": "",
  "{{mode}}下最多添加 {{limit}} 张参考图": "",
  "{{mode}}下至少需要 {{limit}} 张参考图": "",
  "{{n}} 分钟前": "",
  "{{n}} 天前": "",
  "{{n}} 小时前": "",
  "{{n}} 秒前": "",
  ...
  "{{name}} 围绕企业级使用场景构建安全机制，关注数据传输安全、访问权限可控和调用行为可追溯，帮助团队在使用 AI 能力时保持清晰、可控和可信。": "",
  "{{name}} 希望访问你的账号": "",
  ...
  "{{ratio}} · 分组倍率": "{{ratio}} · ratio de groupe",
  "{{ratioType}} {{ratio}}": "{{ratioType}} {{ratio}}",
  "{{ratioType}} {{ratio}}x": "{{ratioType}} {{ratio}}x",
  "{{up}}/{{total}} 个模型运行正常": "",
  "「有参考影片」指请求里带了参考/输入影片；生成结果本身是影片并不会选中该费率。最终结算以上游返回的 usage.completion_tokens 为准。": "",
  ...
  "0 表示不设上限": "0 signifie pas de limite supérieure",
  "0 表示不限": "0 signifie illimité",
  "0 表示无限次": "0 signifie des temps illimités",
  "0.002-1之间的小数": "Décimal entre 0,002-1",
  "0.1以上的小数": "Décimal supérieur à 0,1",
  "0=周日 1=周一 2=周二 3=周三 4=周四 5=周五 6=周六": "0=dimanche 1=lundi 2=mardi 3=mercredi 4=jeudi 5=vendredi 6=samedi",
  "1:1 正方形": "1:1 Carré",
  ...
  "1=一月 ... 12=十二月": "1=janvier ... 12=décembre",
  ...
  "1h缓存创建价格：{{symbol}}{{price}} / 1M tokens": "Prix de création du cache 1h : {{symbol}}{{price}} / 1M tokens",
  "1M图片输入": "Entrée d'image 1M",
  "1M缓存创建": "Création de cache 1M",
  "1M输入（不含缓存）": "Entrée 1M (hors cache)",
  "1M输入（含缓存）": "Entrée 1M (y compris le cache)",
  "1M输出": "Sortie 1M",
  "2 - 低": "2 - Basse",
  "2:3 竖向": "2:3 Portrait",
  ...
  "30天": "",
  "32位密钥，敏感信息不显示": "Clé 32 bits, les informations sensibles ne sont pas affichées",
  "360智脑": "360 AI Brain",
  ...
  "anthropic-beta JSON 示例": "Exemple JSON anthropopique-bêta",
  "API Key": "API Key",
  ...
  "API 密钥": "Clé API",
  "API 密钥 (沙盒)": "Clé API (bac à sable)",
  "API 密钥 (生产)": "Clé API (production)",
  "API 密钥（测试环境）": "Clé API (environnement de test)",
  "API 密钥（生产环境）": "Clé API (environnement de production)",
  "API 指南": "Guide API",
  "API 文档": "Docs API",
  "API 私钥": "Clé privée API",
  "API 私钥（测试环境）": "Clé privée API (environnement de test)",
  "API 私钥（生产环境）": "Clé privée API (environnement de production)",
  "API 配置": "Config. API",
  API令牌管理: "Jetons API",
  ...
  "BLG 支付设置": "Paramètres de paiement BLG",
  ...
  "DALL·E 3 横向": "DALL·E 3 Paysage",
  "DALL·E 3 竖向": "DALL·E 3 Portrait",
  ...
  "Hook 管理": "Gestion des crochets",
  "ICP/EDI经营许可证编号": "Numéro de licence commerciale ICP/EDI",
  ...
  "JSON 必须是对象": "JSON doit être un objet",
  "JSON 文本": "Texte JSON",
  ...
  "LLM 辅助设计提示词": "Mots d'invite de conception auxiliaire LLM",
  ...
  "OAuth 登录失败：": "Échec de la connexion OAuth :",
  "OAuth 端点": "Points de terminaison OAuth",
  "OAuth 配置错误：授权端点必须是完整的 URL（以 http:// 或 https:// 开头）": "Erreur de configuration OAuth : le point de terminaison d'autorisation doit être une URL complète (commençant par http:// ou https://)",
  OIDC: "OIDC",
  "OIDC ID": "ID OIDC",
  ...
  "Pay Method Name": "Nom du mode de paiement",
  "Pay Method Type": "Type de méthode de paiement",
  ...
  "reCAPTCHA 校验初始化失败，请刷新页面后重试": "",
  "Request ID": "Request ID",
  "RSA 私钥 (沙盒)": "Clé privée RSA (bac à sable)",
  "RSA 私钥 (生产)": "Clé privée RSA (production)",
  ...
  "Token 估算器": "Estimateur de jetons",
  "Token 用量范围": "Plage d'utilisation des jetons",
  "Token 类型": "Type de jeton",
  "TokenRouter项目仓库地址：": "Adresse de l'entrepôt du projet TokenRouter :",
  ...
  "User Prompt Prefix": "Préfixe d'invite utilisateur",
  ...
  "Waffo API 参数，可空，例如：CREDITCARD,DEBITCARD（最多64位）": "Les paramètres de l'API Waffo peuvent être vides, par exemple : CREDITCARD, DEBITCARD (jusqu'à 64 bits)",
  "Waffo API 参数，可空（最多64位）": "Paramètres de l'API Waffo, peuvent être vides (jusqu'à 64 bits)",
  "Waffo Pancake": "Crêpe Gaufre",
  "Waffo Pancake 设置": "Paramètres des crêpes gaufres",
  "Waffo 充值": "Recharge gaufre",
  "Waffo 充值的最低数量，默认 1": "Montant minimum de recharge Waffo, par défaut 1",
  "Waffo 公钥 (沙盒)": "Clé publique Waffo (bac à sable)",
  "Waffo 公钥 (生产)": "Clé publique Waffo (production)",
  "Waffo 公钥（测试环境）": "Clé publique Waffo (environnement de test)",
  "Waffo 公钥（生产环境）": "Clé publique Waffo (environnement de production)",
  "Waffo 商户 ID": "Identifiant du marchand Waffo",
  "Waffo 当前使用 USD 结算": "Waffo utilise actuellement le règlement en USD",
  "Waffo 是一个支付聚合平台，支持多种支付方式。": "Waffo est une plateforme d'agrégation de paiements qui prend en charge plusieurs méthodes de paiement.",
  "Waffo 设置": "Paramètres gaufrés",
  ...
  "Webhook 公钥": "Clé publique du webhook",
  "Webhook 公钥（测试环境）": "Clé publique Webhook (environnement de test)",
  "Webhook 公钥（生产环境）": "Clé publique Webhook (environnement de production)",
  ...
  'X 也可以小于 1，当折扣用。想做"只给输出加价"或"额外加固定费用"，请直接写完整计费公式。': "X peut également être inférieur à 1, utilisé comme remise. Si vous souhaitez « ajouter uniquement un prix à la sortie » ou « ajouter un forfait supplémentaire », veuillez rédiger directement la formule de facturation complète.",
  一个平台管理多种企业服务: "Manage enterprise services in one platform",
  一个月: "Un mois",
  一天: "Un jour",
  一小时: "Une heure",
  一次性余额充值: "Recharge unique du solde",
  "一次性支付，付款后自动返回": "Paiement unique, automatiquement restitué après paiement",
  ...
  上一步: "Précédent",
  上一页: "Précédent",
  "上传 PNG/JPG/SVG 图片，建议尺寸 ≤ 128×128px": "Téléchargez des images PNG/JPG/SVG, taille recommandée ≤ 128×128px",
  上传参考图: "Télécharger l'image de référence",
  上传后将在这里预览参考图: "L'image de référence s'affichera ici après l'ajout",
  上传图片: "Télécharger des photos",
  上传失败: "Échec du téléversement",
  上传微信群二维码图片: "Téléverser l’image du QR code du groupe WeChat",
  "上次保存: ": "Dernier enregistrement : ",
  上次检测到可加入模型: "Dernier modèle joignable détecté",
  上次检测时间: "Heure de la dernière détection",
  上游价格同步: "Synchronisation des prix en amont",
  上游倍率同步: "Synchronisation du ratio en amont",
  上游已删除的模型: "Modèle supprimé en amont",
  ...
  下一页: "Suivant",
  下午好: "Bon après-midi",
  下单地址: "Adresse de commande",
  下单总数: "Nombre total de commandes",
  下单数: "Nombre de commandes",
  下载: "télécharger",
  下载文件: "",
  下载日志: "Download Logs",
  下载管理员发布的安装包和资料: "Téléchargez le package d'installation et les informations publiées par l'administrateur",
  ...
  "下面是带注释的示例，仅用于参考；实际保存时请删除注释。": "Ce qui suit est un exemple annoté à titre de référence uniquement ; veuillez supprimer les annotations lors de la sauvegarde.",
  ...
  不限: "Illimité",
  不限制: "Illimité",
  与官方价相同: "Identique au prix officiel",
  与本地相同: "Identique au local",
  "专为企业场景打造的一站式 AI API 中转解决方案，解决接口跨域、转发受限、访问不稳定等各类问题，以高可用、低延迟的服务能力，支撑企业业务稳定运转。": "A one-stop AI API relay solution built for enterprise use, resolving cross-origin API access, forwarding restrictions, and unstable access while providing high availability and low latency for reliable business operations.",
  ...
  个人开发调试: "Développement et débogage individuels",
  个人设置: "Profil",
  个字段: " champs",
  个实例: " instances",
  个已过期: "expirés",
  ...
  为模型前缀覆盖: "Remplacer le préfixe du modèle",
  ...
  "仅在线充值订单可以开票；商店充值与商店兑换不在开票范围内。开票金额以充值记录的实际支付金额为准。": "Only online top-up orders can be invoiced — shop top-ups and shop redemptions are out of scope. The amount follows the payment amount recorded on the top-up.",
  仅密钥: "Clé uniquement",
  ...
  仅提交已勾选: "Soumettre uniquement coché",
  仅支持: "Seulement prend en charge",
  "仅支持 JPEG / PNG / WebP 格式的图片": "Seules les images JPEG / PNG / WebP sont prises en charge",
  ...
  仅支持上传图片文件: "Prend uniquement en charge le téléchargement de fichiers image",
  仅显示已绑定: "Afficher uniquement les liés",
  仅显示矛盾倍率: "Afficher uniquement les ratios contradictoires",
  仅检测上游模型更新: "Détecter uniquement les mises à jour de modèles en amont",
  ...
  "仅管理员可用。开启后，当系统定时检测全部渠道发现上游模型变更或检测异常时，将按你选择的通知方式发送汇总通知；渠道或模型过多时会自动省略部分明细。": "Disponible uniquement pour les administrateurs. Après l'avoir allumé, lorsque le système détecte régulièrement tous les canaux et découvre des changements de modèle en amont ou des anomalies de détection, il enverra des notifications récapitulatives selon la méthode de notification que vous choisissez ; s'il y a trop de chaînes ou de modèles, certains détails seront automatiquement omis.",
  "仅统计成功充值订单，按完成时间归档。": "Seules les commandes de recharge réussies sont comptabilisées et archivées en fonction du temps de réalisation.",
  仅自己: "seulement moi",
  仅重置配置: "Réinitialiser uniquement la configuration",
  今日充值: "Rechargez aujourd'hui",
  今日关闭: "Fermer aujourd'hui",
  今日已签到: "Enregistré aujourd'hui",
  "今日已签到，累计签到": "Enregistré aujourd'hui, total des enregistrements",
  今日盈利: "Profit du jour",
  今日调用: "Appels du jour",
  仍有未处理项: "Il reste encore des éléments non traités",
  "从 0.5 降到 0.3": "reduced from 0.5 to 0.3",
  "从侧边栏选择页面，或使用 Ctrl/Cmd+K 搜索。": "",
  从剪贴板粘贴配置: "Coller la config",
  "从在线充值记录选择订单申请开票，可选择多笔订单合并开票。": "Pick orders from your online top-up history; several orders can be invoiced together.",
  从官方模型库同步: "Synchroniser depuis la bibliothèque de modèles officielle",
  从接入到规模化调用: "",
  "从模型接入到稳定调用，从权限管理到成本优化，构建可持续的 AI 调用基础设施。": "",
  ...
  付款完成后将自动回到账户页: "Une fois le paiement effectué, vous reviendrez automatiquement à la page du compte",
  付费用户: "utilisateur payant",
  代理佣金已扣减: "La commission d'agence a été déduite",
  代理分销: "Agent de distribution",
  "代理分销信息加载中...": "Les informations sur la distribution des agents sont en cours de chargement...",
  "代理分销比例不能大于 100": "Le ratio de répartition des agents ne peut pas être supérieur à 100",
  "代理分销比例不能小于 0": "Le ratio de distribution des agents ne peut pas être inférieur à 0",
  代理分销默认配置: "Configuration par défaut de la distribution des agents",
  代理地址: "Adresse du proxy",
  代理已启用: "proxy activé",
  代理设置: "Paramètres du proxy",
  "代理邀请码、邀请用户和佣金流水": "Code d'invitation de l'agent, utilisateurs invités et flux de commissions",
  代码已复制到剪贴板: "Le code a été copié dans le presse-papiers",
  代码示例: "",
  "代表你发起 AI 请求（费用记在你的账户）": "",
  令牌: "Jeton",
  "令牌 / 密钥": "",
  令牌不存在: "Le jeton n'existe pas",
  ...
  令牌端点: "point de terminaison du jeton",
  令牌管理: "Jetons",
  ...
  "价格为参考估算，实际计费以模型、渠道为准": "Les prix sont des estimations indicatives ; la facturation réelle dépend du modèle et du canal.",
  价格可视化对比: "Comparaison visuelle des prix",
  价格摘要: "Résumé des prix",
  "价格暂时不可用，请稍后重试": "Price temporarily unavailable, please try again later",
  价格根据用量档位和请求条件动态调整: "Les prix sont ajustés dynamiquement en fonction des niveaux d'utilisation et des conditions de demande",
  价格模式: "modèle de prix",
  "价格模式（默认）": "Mode prix (par défaut)",
  价格清单: "Liste de prix",
  "价格计算中...": "Calculating price...",
  价格计算器: "calculateur de prix",
  ...
  企业服务平台: "Enterprise Service Platform",
  "企业级稳定，高可用运行": "Stabilité de niveau entreprise, haute disponibilité",
  企业级稳定运行: "Reliable enterprise operations",
  ...
  余额: "Solde",
  余额充值: "Recharge du solde",
  余额充值管理: "Recharge du solde",
  余额地址: "Adresse du solde",
  余额返利: "Rabais de solde",
  "余额返利直接返到邀请人的钱包余额；套餐返利会正常执行套餐分组升级": "La remise sur le solde sera directement reversée sur le solde du portefeuille de l'invitant ; la remise sur le forfait sera normalement mise à niveau vers le groupe de forfaits.",
  "余额返利直接返到邀请人钱包；套餐返利会按套餐自身规则执行分组升级": "La remise sur le solde sera reversée directement dans le portefeuille de l'invitant ; le rabais du forfait sera regroupé et mis à niveau selon les règles propres au forfait.",
  作废: "Invalider",
  作废于: "Invalidé le",
  ...
  "你可以随时在「个人设置 - 已授权应用」中解除该应用的授权。": "",
  "你还没有处理{{type}}模型（{{count}}个）。是否仅提交当前已勾选内容？_many": "Vous n'avez pas traité du modèle {{type}} ({{count}}). Souhaitez-vous soumettre uniquement le contenu actuellement vérifié ?",
  "你还没有处理{{type}}模型（{{count}}个）。是否仅提交当前已勾选内容？_one": "Vous n'avez pas traité du modèle {{type}} ({{count}}). Souhaitez-vous soumettre uniquement le contenu actuellement vérifié ?",
  "你还没有处理{{type}}模型（{{count}}个）。是否仅提交当前已勾选内容？_other": "Vous n'avez pas traité du modèle {{type}} ({{count}}). Souhaitez-vous soumettre uniquement le contenu actuellement vérifié ?",
  你还没有授权任何应用: "",
  佣金余额: "Solde des commissions",
  "佣金支出 / 净流入": "Charge de commissions / rentrée nette",
  佣金流水: "Historique des commissions",
  佣金订单数: "Nombre d'ordres de commission",
  佣金记录: "Dossiers des commissions",
  佣金金额: "Montant de la commission",
  ...
  使用系统默认比例: "Utiliser l'échelle par défaut du système",
  ...
  "例如 0.5 或 2": "Par exemple 0,5 ou 2",
  "例如 10 表示新用户首充成功后，代理可获得实付金额的 10%": "Par exemple, 10 signifie qu'après qu'un nouvel utilisateur effectue un premier dépôt avec succès, l'agent recevra 10 % du montant réel du paiement.",
  "例如 901": "Par exemple 901",
  "例如 anthropic-beta": "Par exemple anthropopic-beta",
  "例如 https://docs.newapi.pro": "Par exemple, https://docs.newapi.pro",
  "例如 https://example.com/api/mch/balance": "Par exemple https://example.com/api/mch/balance",
  "例如 https://example.com/api/pay/query": "Par exemple https://example.com/api/pay/query",
  "例如 https://example.com/api/pay/unifiedorder": "Par exemple https://example.com/api/pay/unifiedorder",
  "例如 https://example.com/api/waffo/webhook": "Par exemple https://example.com/api/waffo/webhook",
  "例如 https://example.com/console/topup": "Par exemple https://example.com/console/topup",
  "例如 M1776096808": "Par exemple M1776096808",
  "例如 service_tier": "Par exemple service_tier",
  "例如：": "Par exemple :",
  ...
  "例如：Credit Card": "Par exemple : carte de crédit",
  "例如：email": "ex. : email",
  ...
  "例如：github-enterprise": "ex. : github-enterprise",
  "例如：gpt-4.1-nano,regex:^claude-.*$,regex:^sora-.*$": "Par exemple : gpt-4.1-nano,regex:^claude-.*$,regex:^sora-.*$",
  ...
  "例如：MER_xxx": "Par exemple : MER_xxx",
  "例如：name、full_name": "ex. : name, full_name",
  "例如：nginx:latest": "e.g.: nginx:latest",
  "例如：preferred_username、login": "ex. : preferred_username, login",
  "例如：preview": "Par exemple : preview",
  "例如：price_xxx": "Par exemple : prix_xxx",
  "例如：prod_6I8rBerHpPxyoiU9WK4kot": "Ex. : prod_6I8rBerHpPxyoiU9WK4kot",
  "例如：PROD_xxx": "Par exemple : PROD_xxx",
  "例如：sk_xxx 或 rk_xxx，留空表示保持当前不变": "Par exemple : sk_xxx ou rk_xxx, laissez vide pour conserver la valeur actuelle inchangée",
  "例如：STO_xxx": "Par exemple : STO_xxx",
  "例如：sub、id、data.user.id": "ex. : sub, id, data.user.id",
  "例如：whsec_xxx，留空表示保持当前不变": "Par exemple : whsec_xxx, laissez-le vide pour conserver la valeur actuelle inchangée",
  "例如：分组设置错误导致请求失败": "e.g. requests fail after a wrong group setting",
  "例如：基础套餐": "Ex. : forfait de base",
  "例如：微信群昵称": "e.g. your WeChat group nickname",
  "例如：清理工具参数，避免上游校验错误": "Par exemple : Nettoyer les paramètres de l'outil pour éviter les erreurs de vérification en amont",
  "例如：该请求不满足准入策略": "ex. : Cette requête ne satisfait pas la politique d'admission",
  "例如：违规": "Par exemple : Violation",
  ...
  保存代理分销默认配置: "Enregistrer la configuration par défaut de la distribution des agents",
  保存修改: "Enregistrer les modifications",
  保存内容审查配置: "Enregistrer la configuration de la révision du contenu",
  保存分组倍率设置: "Enregistrer les paramètres de ratio de groupe",
  保存分组相关设置: "Enregistrer les paramètres liés aux groupes",
  "保存后不会回显，请填写当前环境对应的 API 私钥": "Il ne sera pas repris après l'enregistrement. Veuillez renseigner la clé privée API correspondant à l'environnement actuel.",
  "保存后不会回显，请填写当前环境对应的 Stripe API 密钥": "Il ne sera pas repris après l'enregistrement. Veuillez renseigner la clé API Stripe correspondant à l'environnement actuel.",
  "保存后不会回显，请填写测试环境对应的 API 密钥": "Il ne sera pas repris après l'enregistrement. Merci de renseigner la clé API correspondant à l'environnement de test.",
  "保存后不会回显，请填写测试环境对应的 API 私钥": "Il ne sera pas repris après l'enregistrement. Veuillez renseigner la clé privée API correspondant à l'environnement de test.",
  "保存后不会回显，请填写生产环境对应的 API 密钥": "Il ne sera pas repris après l'enregistrement. Merci de renseigner la clé API correspondant à l'environnement de production.",
  "保存后不会回显，请填写生产环境对应的 API 私钥": "Il ne sera pas repris après l'enregistrement. Merci de renseigner la clé privée API correspondant à l'environnement de production.",
  ...
  修改要求已提交: "Change request submitted",
  "修改要求已提交，等待操作员判断。资料在批准前保持锁定。": "Your change request is waiting for an operator. The data stays locked until it is approved.",
  倍率: "Ratio",
  倍率与优惠: "",
  倍率信息: "Informations sur le ratio",
  倍率是为了方便换算不同价格的模型: "Le ratio sert à faciliter la conversion de modèles à des prix différents.",
  倍率模式: "Mode de ratio",
  "倍率模式（默认）": "Mode grossissement (par défaut)",
  ...
  元: "CNY",
  充值: "Recharger",
  充值与佣金金额趋势: "Tendances des montants de recharge et de commission",
  "充值价格（x元/美金）": "Prix de recharge (x yuans/dollar)",
  "充值价格必须大于 0": "Le prix de la recharge doit être supérieur à 0",
  ...
  充值完成后跳回的页面: "La page à laquelle revenir une fois la recharge terminée",
  充值总额: "Recharge totale",
  "充值成功，额度已到账": "La recharge a réussi et le montant a été reçu.",
  充值数量: "Quantité de recharge",
  "充值数量，最低 ": "Quantité de recharge, minimum ",
  充值数量不能大于: "Le montant de la recharge ne peut pas être supérieur à",
  ...
  充值流水: "Historique des recharges",
  充值确认: "Confirmation de la recharge",
  充值类型: "Type de recharge",
  "充值类计划对每次充值生效，订阅类计划仅首次生效": "Les plans de recharge s'appliquent à chaque recharge ; les plans d'abonnement uniquement au premier paiement",
  充值订单: "Commande de recharge",
  充值记录和状态查询: "Recharger les enregistrements et demander l'état",
  ...
  兜底档: "Conclusion",
  入账时间: "Heure d'entrée",
  "全场景适配 · 赋能多元业务发展": "Adapté à tous les scénarios · Au service d'activités diversifiées",
  ...
  全局系统提示词拼接: "Épissage des mots d'invite du système global",
  全局系统提示词豁免: "Exemption de l'invite système globale",
  全局设置: "Paramètres globaux",
  全平台: "Toutes les plateformes",
  "全方位安全，合规可控": "Sécurité complète et conformité",
  全选: "Tout sélectionner",
  全选当前列表模型: "Sélectionnez tous les modèles de liste actuels",
  全部: "Tous",
  ...
  全部类型: "Tous les types",
  全部退出: "",
  "全面适配 Web 开发、小程序、APP、政企系统、第三方平台对接等各类场景，支持多协议与多数据格式，无缝衔接各类业务系统。": "Parfaitement adapté au développement web, aux mini-programmes, aux applications mobiles, aux systèmes publics/d'entreprise et aux intégrations tierces, avec prise en charge multi-protocoles et multi-formats pour une connexion transparente à tous les systèmes métier.",
  公告: "Annonce",
  ...
  "关闭后客服将不再处理该案件，协助码也会停止使用。": "Support will stop working on this case and the assistance code will no longer be used.",
  ...
  内容: "Contenu",
  内容审查结果: "Résultats de l'examen du contenu",
  内容审查配置: "Configuration de la modération du contenu",
  ...
  "内置接口鉴权、访问限流、异常拦截、数据加密等多重安全机制，精准拦截恶意请求，规范接口访问规则，全方位守护企业接口数据与业务安全。": "Authentification, limitation de débit, interception des anomalies et chiffrement des données intégrés bloquent précisément les requêtes malveillantes, normalisent les règles d'accès aux API et protègent intégralement les données et l'activité de l'entreprise.",
  "内联图片总大小不能超过 {{limit}}": "",
  "内联图片总大小不能超过 45 MB": "Les images intégrées ne doivent pas dépasser 45 Mo au total",
  最优可用: "Meilleur disponible",
  最低: "Le plus bas",
  最低充值数量: "Montant minimum de recharge",
  "最低充值数量必须大于 0": "Le montant minimum de recharge doit être supérieur à 0",
  ...
  "最低实付金额（元）": "Montant minimum du paiement réel (yuans)",
  最低开票金额: "Minimum invoiceable amount",
  最后使用时间: "Dernière utilisation",
  最后更新: "Last Updated",
  最后登录: "dernière connexion",
  最后请求: "Dernière requête",
  "最多上传 {{count}} 张参考图_many": "Téléchargez jusqu'à des images de référence {{count}}",
  "最多上传 {{count}} 张参考图_one": "Téléchargez jusqu'à des images de référence {{count}}",
  "最多上传 {{count}} 张参考图_other": "Téléchargez jusqu'à des images de référence {{count}}",
  最多只能指定一张尾帧图: "Une seule image de dernière trame peut être définie",
  最多只能指定一张首帧图: "Une seule image de première trame peut être définie",
  "最多添加 {{limit}} 个参考视频": "Vous pouvez ajouter jusqu'à {{limit}} vidéos de référence",
  "最多添加 {{limit}} 个参考音频": "Vous pouvez ajouter jusqu'à {{limit}} pistes audio de référence",
  "最多添加 {{limit}} 张参考图": "Vous pouvez ajouter jusqu'à {{limit}} images de référence",
  最大GPU数量: "Max Number of GPUs",
  最大可用: "Max Available",
  最大条目数: "Nombre max. d'entrées",
  最大赠送额度: "Montant maximum du cadeau",
  最大返利金额: "Montant maximum de remise",
  最小充值金额: "Montant minimum de recharge",
  最终抵扣: "Déduction finale",
  "最近 {{n}} 次检测": "",
  最近一次: "Dernière",
  最近事件: "Recent Events",
  最近充值: "Recharge récente",
  最近延迟: "",
  最近更新: "",
  最近检测: "",
  最近活动: "",
  最高优先级: "highest priority",
  最高充值不能小于最低充值: "La recharge maximale ne peut être inférieure à la recharge minimale",
  "最高实付金额（元）": "Montant maximum du paiement réel (yuans)",
  最高档: "Qualité supérieure",
  写: "Écriture",
  ...
  函数: "fonction",
  分佣比例: "taux de commission",
  分佣订单数: "Nombre d'ordres de commission",
  "分时缓存 (Claude)": "Cache en temps partagé (Claude)",
  分档价格表: "Liste de prix échelonnée",
  分类名称: "Nom de la catégorie",
  分组: "Groupe",
  分组JSON设置: "Group JSON Settings",
  分组与模型定价设置: "Groupes & tarification des modèles",
  分组价格: "Prix de groupe",
  "分组价格 = 官方价格 × 分组倍率 ÷ 7": "Prix de groupe = prix officiel × ratio du groupe ÷ 7",
  分组倍率: "Ratio",
  "分组倍率 {{ratio}} × 换算 {{rate}} = 相对官方价 {{effective}}": "Ratio de groupe {{ratio}} × conversion {{rate}} = {{effective}} du prix officiel",
  ...
  分组维度收入: "Revenu de la dimension groupe",
  分组维度消耗: "Regroupement de la consommation des dimensions",
  分组设置: "Groupe",
  ...
  创建协助请求失败: "Failed to create the assistance request",
  ...
  "删除后无法恢复，且无返利记录的计划才允许删除": "La suppression ne peut pas être restaurée et les plans sans enregistrement de remise peuvent être supprimés.",
  ...
  "删除已选 {{selected}} / {{total}}": "Supprimer la sélection {{selected}} / {{total}}",
  ...
  "加价 {{percent}}%": "Majoration de {{percent}}%",
  加入渠道: "Join Channel",
  ...
  "加载中...": "Chargement...",
  加载令牌失败: "",
  加载价格配置失败: "Échec du chargement de la configuration des prix",
  ...
  加载协助案件失败: "Failed to load the assistance case",
  加载失败: "Échec du chargement",
  "加载容器信息中...": "Loading container info...",
  "加载容器详情中...": "Loading container details...",
  加载开票申请失败: "Failed to load invoice requests",
  加载数据分析失败: "Échec du chargement de l'analyse des données",
  "加载日志中...": "Loading logs...",
  加载日志失败: "Échec du chargement du journal",
  加载模型价格失败: "",
  ...
  加载邀请信息失败: "Échec du chargement des informations d'invitation",
  "加载隐私政策内容失败...": "Échec du chargement du contenu de la politique de confidentialité...",
  动态计费: "Facturation dynamique",
  ...
  匹配内容: "Faire correspondre le contenu",
  匹配方式: "Méthode de correspondance",
  匹配模式: "modèle de correspondance",
  匹配类型: "Type de correspondance",
  "区分邀请返利与代理分销带来的充值与激励支出。": "Faites la distinction entre les remises et recharges d'invitations et les dépenses incitatives apportées par la distribution des agences.",
  区域: "Région",
  升级分组: "Groupe de mise à niveau",
  协助码: "Assistance code",
  "协助码只用于客服定位你的案件，不能用于登录。协助码在 {{hours}} 小时后失效，可随时重新生成。": "The assistance code only helps support locate your case; it cannot be used to sign in. It expires after {{hours}} hours and can be reissued at any time.",
  协助码已失效: "Code expired",
  协助码已更新: "Assistance code updated",
  协助请求已创建: "Assistance request created",
  单GPU小时费率: "Per GPU Hour Rate",
  单价: "prix unitaire",
  "单价 (USD)": "Prix ​​unitaire (USD)",
  单位: "Company",
  单位地址: "Address",
  单位电话: "Phone",
  "单张图片上限 {{limit}}": "",
  "单张图片大小不能超过 {{limit}}": "",
  "单张图片大小不能超过 10 MB": "Chaque image ne doit pas dépasser 10 Mo",
  单条影片价格预估: "",
  占比: "Proportion",
  卡片视图: "Vue cartes",
  危险: "",
  "历史数据已自动按年/月/日/小时汇总，今日尾段实时计算。": "Les données historiques sont agrégées automatiquement par année, mois, jour et heure, tandis que la fin de la journée en cours est calculée en temps réel.",
  ...
  原生格式: "Format natif",
  原生额度: "Quota brut",
  去前缀: "supprimer le préfixe",
  去后缀: "supprimer le suffixe",
  "去处理{{type}}": "Allez traiter avec {{type}}",
  去抽奖: "Aller à la loterie",
  去空格: "supprimer des espaces",
  ...
  参与次数: "Nombre de participations",
  参与限制: "Restrictions de participation",
  参数: "paramètre",
  参数传递: "Passage de paramètres",
  参数值: "Valeur du paramètre",
  参数覆盖: "Remplacement des paramètres",
  "参数覆盖 JSON 已复制": "JSON de remplacement des paramètres copié",
  参数覆盖已复制: "Remplacement des paramètres copié",
  ...
  参数覆盖详情: "Détails de la couverture des paramètres",
  ...
  "参考图（可选，最多 {{count}} 张）_many": "Images de référence (en option, jusqu'à images {{count}})",
  "参考图（可选，最多 {{count}} 张）_one": "Images de référence (en option, jusqu'à images {{count}})",
  "参考图（可选，最多 {{count}} 张）_other": "Images de référence (en option, jusqu'à images {{count}})",
  "参考图（可选）": "Image de référence (facultatif)",
  "参考图已上传，本次将调用图生视频流程": "",
  "参考影片时长（秒）": "",
  参考生成: "",
  "参考视频（可选）": "Vidéos de référence (facultatif)",
  "参考视频链接（https）": "Lien de vidéo de référence (https)",
  "参考视频链接必须是 https 链接": "Les liens de vidéo de référence doivent utiliser https",
  参考素材上限: "",
  参考素材生视频: "Vidéo à partir de médias de référence",
  "参考音频（可选）": "Audio de référence (facultatif)",
  "参考音频链接（https）": "Lien audio de référence (https)",
  "参考音频链接必须是 https 链接": "Les liens audio de référence doivent utiliser https",
  参考音频需要与参考图或参考视频一起使用: "",
  友情链接: "Liens amicaux",
  发布日期: "Date de publication",
  发布时间: "Heure de publication",
  发放奖励: "Distribuer des récompenses",
  "发现文档地址（Discovery URL，可选）": "URL de découverte (optionnel)",
  发票号码: "Invoice number",
  发票已作废: "Invoice voided",
  发票申请: "Invoice requests",
  发票类型: "Invoice type",
  发票资料: "Invoice details",
  "发行者 URL（Issuer URL）": "URL de l'émetteur (Issuer URL)",
  发起协助请求: "Request assistance",
  "发起协助请求后会得到一个协助码，请在微信群把协助码提供给客服。": "Creating a request issues an assistance code — give it to your support agent in the WeChat group.",
  发送: "Send",
  发送失败: "Failed to send",
  取消: "Annuler",
  取消全选: "Annuler la sélection",
  "取消后所选充值订单会重新变为可开票，申请记录与对话会保留。": "The selected orders become invoiceable again. The request and its conversation are kept.",
  取消失败: "Failed to cancel",
  取消开票申请: "Cancel invoice request",
  取消申请: "Cancel request",
  取消选择: "Deselect",
  受信任: "",
  变换: "Variation",
  ...
  可信: "Fiable",
  "可勾选需要执行的变更：新增会加入渠道模型列表，删除会从渠道模型列表移除。": "Vous pouvez vérifier les modifications qui doivent être effectuées : l'ajout sera ajouté à la liste des modèles de canal et la suppression sera supprimée de la liste des modèles de canal.",
  可参与次数: "Nombre de fois où vous pouvez participer",
  "可参与次数按“单个邀请人”累计命中的不同被邀请用户数计算": "Le nombre de fois où il est possible de participer est calculé en fonction du nombre d'utilisateurs invités différents qui sont touchés par « l'invitant unique ».",
  可否选取: "Selectable",
  ...
  "可填写打款渠道、流水号或备注": "Vous pouvez renseigner le canal de paiement, le numéro de série ou des remarques",
  ...
  可用图片模型: "Modèles d'images disponibles",
  可用性: "",
  ...
  "可选，填写图片 URL": "Facultatif, remplissez l'URL de l'image",
  "可选，用于复现结果": "Optionnel, pour des résultats reproductibles",
  "可选，用于记录用途": "Facultatif, à des fins de journalisation",
  "可选，用量达到此档时加收的固定费用": "En option, des frais fixes seront facturés lorsque l'utilisation atteint ce niveau",
  ...
  可配置独立密钥管理: "",
  "各渠道成功率 / 失败率": "Taux de réussite/taux d'échec de chaque canal",
  各渠道消耗额度: "Quota de consommation de chaque canal",
  "合计：{{total}}": "Total : {{total}}",
  "合计：文字部分 {{textTotal}} + 音频部分 {{audioTotal}} = {{total}}": "Total : partie texte {{textTotal}} + partie audio {{audioTotal}} = {{total}}",
  "同一用户可以有多条记录，同一个模型出现在多条记录里也会正常生效。": "Le même utilisateur peut avoir plusieurs enregistrements, et le même modèle prendra effet normalement s'il apparaît dans plusieurs enregistrements.",
  "同优先级下，充值按更高金额门槛命中；套餐按更贵的触发套餐命中。": "Sous la même priorité, la recharge sera atteinte selon le seuil de montant le plus élevé ; le package sera touché en fonction du package de déclenchement le plus cher.",
  同官方价: "Prix officiel",
  同时满足: "Satisfaire en même temps",
  ...
  否: "Non",
  含时间条件: "Contient des conditions de temps",
  含请求条件: "Contient les conditions de la demande",
  启动: "Start",
  ...
  启用: "Activer",
  "启用 BLG 支付": "Activer les paiements BLG",
  "启用 Prompt 检查": "Activer la vérification de l'invite",
  "启用 Waffo": "Activer Waffo",
  "启用 Waffo Pancake": "Activer les crêpes gaufres",
  ...
  启用代理: "Activer le proxy",
  启用供应商: "Activer le fournisseur",
  启用全部: "Activer tout",
  启用后会按测试环境保存这组配置: "Après activation, cet ensemble de configurations sera enregistré en fonction de l'environnement de test.",
  ...
  "启用后将使用 Waffo 沙盒环境": "Lorsqu'il est activé, l'environnement sandbox Waffo sera utilisé",
  启用图片生成审查: "Activer l'examen de la génération d'images",
  ...
  启用文本生成内容审查: "Activer la révision du contenu de la génération de texte",
  ...
  "启用首充赠送时，赠送比例必须大于 0": "Lors de l'activation du bonus de premier dépôt, le ratio de bonus doit être supérieur à 0",
  启用首次充值赠送: "Activer le bonus de première recharge",
  ...
  "命中多个充值门槛时，会按更高门槛的计划优先": "Lorsque plusieurs seuils de recharge sont atteints, le plan avec le seuil le plus élevé sera prioritaire.",
  命中档位: "frapper l'équipement",
  命中活动: "activité de frappe",
  命中率: "Taux de hits",
  ...
  "商户 ID": "ID marchand",
  商户号: "Numéro de commerçant",
  商户密钥: "Clé marchand",
  回答内容: "Contenu de la réponse",
  "回调 URL 填": "Remplir l'URL de rappel",
  "回调 URL 格式": "Format de l'URL de rappel",
  回调地址: "Adresse de rappel",
  回调支付方式: "Méthode de paiement du rappel",
  回调调用者IP: "IP de l'appelant du rappel",
  回调通知地址: "Adresse de notification de rappel",
  团队与项目权限细分: "",
  固定价格: "Prix fixe",
  ...
  固定阶梯: "échelle fixe",
  "国家/地区": "Pays/Région",
  "国家/地区信息将用于适用法律法规、监管要求、平台合规策略及模型服务范围的判定。": "Les informations sur le pays/la région seront utilisées pour déterminer les lois et réglementations applicables, les exigences réglementaires, les stratégies de conformité de la plateforme et la portée du service modèle.",
  "国家/地区信息已更新": "",
  "国家/地区变更保存后将即时用于模型服务范围判定；提交不真实、不完整或无法核验的信息，平台可依据规则及适用法律法规采取进一步限制措施。": "",
  "图 {{images}} / 视频 {{videos}} / 音频 {{audios}}": "",
  ...
  "图标文件不能超过 100KB，请压缩后重新上传": "Le fichier icône ne peut pas dépasser 100 Ko, veuillez le compresser et le télécharger à nouveau.",
  图混合: "Mélanger",
  "图片/音频价格（可选）": "Prix ​​image/audio (facultatif)",
  图片倍率: "Grossissement de l'image",
  ...
  图片生成失败: "La génération d'image a échoué",
  图片生成完成: "Génération d'images terminée",
  "图片生成审查（作用于 /pg 和 /v1 的 images/generations、images/edits）": "Revue de génération d'images (images/générations, images/modifications pour /pg et /v1)",
  图片生成模型: "Modèle de génération d'images",
  "图片生成调用：{{symbol}}{{price}} / 1次": "Appel de génération d'image : {{symbol}}{{price}} / 1 fois",
  图片编辑完成: "Retouche photo terminée",
  图片设置: "Paramètres d'image",
  "图片读取失败，请重试": "Échec de la lecture de l'image, veuillez réessayer",
  ...
  图片输入倍率: "Agrandissement de l'entrée d'image",
  ...
  "在 Stripe 后台创建价格后获得": "Obtenu après avoir créé un prix dans le backend Stripe",
  ...
  "填写后覆盖当前测试环境 API 密钥，留空表示保持当前不变": "Après avoir rempli, écrasez la clé API de l'environnement de test actuel. Laissez-le vide pour conserver celui actuel inchangé.",
  "填写后覆盖当前测试环境 Webhook 公钥，留空表示保持当前不变": "Après avoir rempli, écrasez la clé publique Webhook de l'environnement de test actuel. Laissez-le vide pour conserver celui actuel inchangé.",
  "填写后覆盖当前测试环境私钥，留空表示保持当前不变": "Une fois rempli, il écrasera la clé privée de l'environnement de test actuel. Laissez-le vide pour conserver celui actuel inchangé.",
  "填写后覆盖当前生产环境 API 密钥，留空表示保持当前不变": "Après avoir rempli, écrasez la clé API de l'environnement de production actuel. Laissez-le vide pour conserver celui actuel inchangé.",
  "填写后覆盖当前生产环境 Webhook 公钥，留空表示保持当前不变": "Une fois rempli, il écrasera la clé publique Webhook de l'environnement de production actuel. Laissez-le vide pour conserver celui actuel inchangé.",
  "填写后覆盖当前生产环境私钥，留空表示保持当前不变": "Une fois rempli, il écrasera la clé privée de l'environnement de production actuel. Laissez-le vide pour conserver celui actuel inchangé.",
  "填写后覆盖当前私钥，留空表示保持当前不变": "Après avoir rempli, écrasez la clé privée actuelle. Laissez-le vide pour conserver celui actuel inchangé.",
  "填写带https的域名，逗号分隔": "Saisir les domaines avec https, séparés par des virgules",
  "填写平台域名，例如：www.tokenrouter.tech": "Remplissez le nom de domaine de la plateforme, par exemple : www.tokenrouter.tech",
  "填写服务器地址后自动生成：": "Généré automatiquement après avoir renseigné l'adresse du serveur :",
  "填写测试环境 Waffo 公钥，Base64 或 PEM 内容均可": "Remplissez l'environnement de test La clé publique Waffo, le contenu Base64 ou PEM peut être utilisé",
  "填写生产环境 Waffo 公钥，Base64 或 PEM 内容均可": "Remplissez l'environnement de production La clé publique Waffo, le contenu Base64 ou PEM peut être utilisé",
  ...
  处理上游模型更新: "Gérer les mises à jour du modèle en amont",
  处理中: "Processing",
  处理代理提现: "Traiter les retraits des agents",
  处理全部渠道上游更新: "Gérer toutes les mises à jour du canal en amont",
  处理提现: "Traitement des retraits",
  ...
  复充: "Recharger",
  复充佣金: "Commission de recharge",
  复充分成比例: "Entièrement proportionnel",
  复充指该被邀请用户首充之后的后续成功充值订单: "La recharge fait référence aux commandes de recharge réussies ultérieures après la première recharge de l’utilisateur invité.",
  复制: "Copier",
  复制代码: "Copier le code",
  复制令牌: "Copier le Jeton",
  复制令牌失败: "Échec de la copie du jeton",
  "复制以下提示词发送给 LLM（如 ChatGPT / Claude），让它帮你设计计费表达式": "Copiez les mots d'invite suivants et envoyez-les à LLM (comme ChatGPT / Claude) et laissez-le vous aider à concevoir l'expression de facturation",
  复制全部: "Tout copier",
  复制名称: "Copier le nom",
  ...
  多端业务开发: "Multi-platform development",
  多系统接入复杂: "Complex system integration",
  大于: "supérieur à",
  大于等于: "Supérieur ou égal à",
  大模型接口网关: "API LLM Unifiée",
  天: "Jour",
  天前: "il y a des jours",
  失败: "Échec",
  "失败/过期单数": "Numéro impair en échec/expiré",
  ...
  奖励记录: "Record de récompense",
  奖励说明: "Description de la récompense",
  套餐: "Plan",
  套餐信息无效: "Les informations sur le package ne sont pas valides",
  ...
  套餐购买: "Achat de forfait",
  套餐返利: "Rabais sur les forfaits",
  ...
  "如果你对接的是上游One API或者TokenRouter等转发项目，请使用OpenAI类型，不要使用此类型，除非你知道你在做什么。": "Si vous vous connectez à une API One en amont ou si vous transférez des projets tels que TokenRouter, veuillez utiliser le type OpenAI. N'utilisez pas ce type à moins que vous sachiez ce que vous faites.",
  ...
  "如果这里没有你想要的令牌，请点击右上角的「快速创建令牌」新建。": "",
  ...
  官方价格: "Prix officiel",
  官方价格为上游配置的原始美元基础价: "",
  "官方价格按 $1 = ￥7 折算": "Le prix officiel est converti au taux de 1 $ = 7 ¥",
  ...
  "实付金额：": "Montant du paiement réel : ",
  "实付金额（{{currency}}） = 官方价格（USD） × 分组倍率 × 当前换算（{{rate}} {{currency}}/USD）": "",
  "实时记录接口调用次数、响应状态、异常日志等数据，可视化看板直观展示运行状态，助力快速排查问题、持续优化业务。": "Le nombre d'appels, les statuts de réponse et les journaux d'erreurs sont enregistrés en temps réel, avec des tableaux de bord visuels qui présentent l'état de fonctionnement en un coup d'œil pour accélérer le diagnostic et l'optimisation continue.",
  实时调用监控统计: "Surveillance des appels en temps réel",
  实际: "Réel",
  "实际下载尺寸以模型或渠道返回的图片为准，NewAPI 不会压缩或重绘图片": "La taille réellement téléchargée dépend de l'image renvoyée par le modèle ou le canal ; NewAPI ne compresse pas et ne redessine pas l'image.",
  "实际尺寸：{{size}}": "Taille réelle : {{size}}",
  "实际尺寸：加载后显示": "Taille réelle : affichée après chargement",
  实际模型: "Modèle réel",
  实际环境: "environnement réel",
  实际用量: "Utilisation réelle",
  ...
  实际额度: "Montant réel",
  "审查失败时放行（fallback）": "Libérer en cas d'échec de l'examen (remplacement)",
  审计信息: "Informations d'audit",
  客服协助: "Support assistance",
  "客服协助功能当前未开放，暂时无法在网站提交请求，请留意后续开放通知。": "L'assistance est actuellement indisponible : les demandes ne peuvent pas être envoyées depuis le site. Consultez les prochaines annonces de disponibilité.",
  客服处理中: "Support is working on it",
  容器: "Container",
  容器ID: "Container ID",
  ...
  对应代理分销已入账佣金: "Des commissions ont été enregistrées pour la distribution des agents correspondants",
  "对比：不勾选「用户可选」的场景": 'Comparison: groups without "User Selectable"',
  对比项: "Article comparatif",
  ...
  导航菜单: "",
  封禁结束时间必须晚于当前时间: "L'heure de fin du bannissement doit être postérieure à l'heure actuelle",
  ...
  "将把当前编辑中的模型 {{name}} 的价格配置，批量应用到已勾选的 {{count}} 个模型。_many": "La configuration tarifaire du modèle {{name}} actuellement édité sera appliquée par lots aux modèles {{count}} sélectionnés.",
  "将把当前编辑中的模型 {{name}} 的价格配置，批量应用到已勾选的 {{count}} 个模型。_one": "La configuration tarifaire du modèle {{name}} actuellement édité sera appliquée par lots aux modèles {{count}} sélectionnés.",
  "将把当前编辑中的模型 {{name}} 的价格配置，批量应用到已勾选的 {{count}} 个模型。_other": "La configuration tarifaire du modèle {{name}} actuellement édité sera appliquée par lots aux modèles {{count}} sélectionnés.",
  ...
  "将立即退出除当前设备外的所有登录，其它设备需要重新登录。": "",
  "将追加 2 条规则到现有规则列表。": "2 règles seront ajoutées à la liste de règles existante.",
  将额外乘以上述价格: "Multipliez le supplément par le prix ci-dessus",
  小于: "moins que",
  小于等于: "inférieur ou égal à",
  小时: "Heure",
  小时费率: "Hourly Rate",
  小计: "Total",
  ...
  工具标识: "ID de l'outil",
  工具调用定价: "Tarification des appels d'outils",
  工单管理: "Gestion des bons de travail",
  左侧边栏个人设置: "Paramètres personnels de la barre latérale gauche",
  "已上传参考图，本次将调用图片编辑接口": "L'image de référence a été téléchargée. Cette fois, l'interface d'édition d'images sera appelée.",
  ...
  已产生佣金: "La commission a été générée",
  ...
  "已加载 {{loaded}}/{{total}} 个分组": "",
  已勾选: "Sélectionné",
  "已勾选 {{count}} 个模型": "{{count}} modèles sélectionnés",
  "已勾选 {{count}} 个模型_many": "Modèles {{count}} vérifiés",
  "已勾选 {{count}} 个模型_one": "Modèles {{count}} vérifiés",
  "已勾选 {{count}} 个模型_other": "Modèles {{count}} vérifiés",
  ...
  已处理: "Resolved",
  "已处理上游模型更新：加入 {{added}} 个，删除 {{removed}} 个，本次忽略 {{ignored}} 个，当前已忽略模型 {{totalIgnored}} 个": "Mises à jour du modèle en amont traitées : {{added}} ajouté, {{removed}} supprimé, {{ignored}} ignoré cette fois, modèle {{totalIgnored}} actuellement ignoré",
  已备份: "Sauvegardé",
  已复制: "Copié",
  ...
  "已将模型 {{name}} 的价格配置批量应用到 {{count}} 个模型_many": "La configuration des prix du modèle {{name}} a été appliquée par lots aux modèles {{count}}.",
  "已将模型 {{name}} 的价格配置批量应用到 {{count}} 个模型_one": "La configuration des prix du modèle {{name}} a été appliquée par lots aux modèles {{count}}.",
  "已将模型 {{name}} 的价格配置批量应用到 {{count}} 个模型_other": "La configuration des prix du modèle {{name}} a été appliquée par lots aux modèles {{count}}.",
  已开启: "Activé",
  ...
  "已批量处理上游模型更新：渠道 {{channels}} 个，加入 {{added}} 个，删除 {{removed}} 个，失败 {{fails}} 个": "Les mises à jour du modèle en amont ont été traitées par lots : canaux {{channels}}, ajout de {{added}}, suppression de {{removed}}, échec de {{fails}}.",
  已拉取: "Tiré",
  已拒绝: "Rejected",
  已授权应用: "",
  已提交: "Soumis",
  "已提交，等待操作员核对": "Submitted — waiting for an operator to check it",
  已提出修改要求: "Change requested",
  已提现佣金: "Commission de retrait",
  已支付金额: "Amount Paid",
  ...
  已注销: "Déconnecté",
  已消耗额度: "",
  "已消费，但暂未命中返利计划": "A consommé, mais aucun plan de commission ne correspond pour l'instant",
  已消费用户数: "Nombre d'utilisateurs ayant consommé",
  已添加: "Ajouté",
  ...
  "已清理 {{count}} 个日志文件，释放 {{size}}_many": "Fichiers journaux {{count}} nettoyés, publication de {{size}}",
  "已清理 {{count}} 个日志文件，释放 {{size}}_one": "Fichiers journaux {{count}} nettoyés, publication de {{size}}",
  "已清理 {{count}} 个日志文件，释放 {{size}}_other": "Fichiers journaux {{count}} nettoyés, publication de {{size}}",
  已清空: "Vidé",
  ...
  已运行时间: "Uptime",
  已返利: "",
  已返利人数: "Nombre de personnes ayant bénéficié de rabais",
  已退出其他设备: "",
  已退出该会话: "",
  已退出该设备: "",
  已退款: "Remboursé",
  "已退款但已开票，需人工核对": "Refunded but invoiced; manual review required",
  "已选分组（拖拽调整优先级）": "",
  "已选合计（预览）": "Selected total (preview)",
  ...
  已邀请人数: "Nombre de personnes invitées",
  已重置为默认配置: "Réinitialisé à la configuration par défaut",
  已销毁: "Destroyed",
  已预留: "Réservé",
  币种: "Devise",
  帐号信息: "Informations sur le compte",
  带来充值: "Apportez une recharge",
  帧率: "",
  "帧率 FPS": "",
  ...
  平台: "plateforme",
  平台价格数据格式不正确: "Le format des données de prix de la plateforme est incorrect",
  平台地址格式不正确: "Le format de l'adresse de la plateforme est incorrect",
  "平台将在合规审核通过后予以处理；审核完成前，原登记信息持续有效。提交不真实、不完整或无法核验的材料，平台有权驳回申请，并依据平台规则及适用法律法规采取进一步限制措施。": "La plateforme traitera l'affaire après avoir passé l'examen de conformité ; jusqu'à ce que l'examen soit terminé, les informations d'inscription originales resteront valides. Si vous soumettez des éléments faux, incomplets ou invérifiables, la plateforme a le droit de rejeter la candidature et de prendre d'autres mesures restrictives conformément aux règles de la plateforme et aux lois et réglementations applicables.",
  平均: "moyenne",
  平均RPM: "RPM moyen",
  平均TPM: "TPM moyen",
  平均延迟: "Latence moyenne",
  "平均延迟 (7天)": "",
  平移: "Panoramique",
  年: "an",
  ...
  "开启后，图片生成页面仅会展示此模型，不再依赖模型名称关键字判断": "Lorsqu'elle est activée, la page de génération d'images n'affichera que ce modèle et ne s'appuiera plus sur les mots-clés du nom du modèle.",
  ...
  "开启后，视频生成页面仅会展示此模型，不再依赖模型名称关键字判断": "Lorsqu'elle est activée, la page de génération vidéo n'affichera que ce modèle et ne s'appuiera plus sur les mots-clés du nom du modèle.",
  ...
  开启后检测到新增模型会自动加入当前渠道模型列表: "Après ouverture, les nouveaux modèles détectés seront automatiquement ajoutés à la liste actuelle des modèles de chaîne.",
  开启后由后端定时任务检测该渠道上游模型变化: "Une fois activée, la tâche planifiée back-end détectera les modifications dans le modèle en amont du canal.",
  开启后由模型同时生成配音与音效: "Une fois activé, le modèle génère aussi la voix off et les effets sonores",
  "开启后该渠道不会参与任何并发竞速，但在竞速全部失败时仍可作为兜底通道被尝试": "Une fois activé, ce canal ne participera à aucune course concurrente, mais pourra toujours être essayé comme canal de secours si tous les canaux de course échouent",
  开启后该渠道的请求不会被注入全局系统提示词: "Une fois activé, les requêtes via ce canal ne recevront pas l'invite système globale",
  ...
  开始时间: "heure de début",
  开户银行: "Bank",
  "开票功能当前未开放。": "Invoicing is currently unavailable.",
  开票合计: "Invoice total",
  "开票合计由所选充值订单的支付金额自动计算，不能手动填写。": "The invoice total is computed from the selected top-up payment amounts and cannot be entered manually.",
  开票处理中: "Issuing",
  开票对话: "Conversation",
  开票状态: "Invoice status",
  开票申请详情: "Invoice request",
  异常: "anormal",
  异步任务退款: "Remboursement de tâche asynchrone",
  异步回调地址: "Adresse de rappel asynchrone",
  张图片: "images",
  ...
  "当前代理分销仅针对新用户通过代理邀请码注册后产生的钱包充值订单生效，购买套餐不参与该分销。": "La distribution actuelle des agents n'est efficace que pour les commandes de recharge de portefeuille générées par les nouveaux utilisateurs après s'être inscrits avec le code d'invitation de l'agent. L'achat de packages ne participe pas à cette distribution.",
  "当前代理资格已停用，仅保留历史佣金与流水展示，后续不会再产生新的分销收益": "La qualification actuelle d'agent a été désactivée, seules les commissions historiques et les affichages de flux seront conservés et aucun nouveau revenu de distribution ne sera généré à l'avenir.",
  当前令牌没有相容分组: "",
  当前价格: "prix actuel",
  当前余额: "Solde actuel",
  当前值: "Valeur actuelle",
  ...
  "当前分组暂无可用模型，请切换分组或联系管理员配置": "Il n'y a aucun modèle disponible dans le groupe actuel. Veuillez changer de groupe ou contacter l'administrateur pour la configuration.",
  当前分组没有可用的图片模型: "Il n'y a aucun modèle d'image disponible pour le groupe actuel",
  当前分组没有可用的视频模型: "",
  当前剩余: "Currently Remaining",
  "当前参数覆盖不是合法的 JSON": "Le remplacement de paramètres actuel n'est pas un JSON valide",
  当前参考素材组合不被该模型支持: "",
  当前可提现佣金: "Commission actuelle disponible pour le retrait",
  当前周期: "période actuelle",
  当前周期暂无成功充值: "Il n’y a pas de recharge réussie dans le cycle en cours.",
  "当前尺寸：{{size}}": "Taille actuelle : {{size}}",
  ...
  当前时间: "Heure actuelle",
  当前暂无可用邀请福利: "Il n'y a actuellement aucun avantage d'invitation disponible.",
  "当前未启用，需要时再打开即可。": "Ce champ est actuellement désactivé. Activez-le si nécessaire.",
  当前来源汇率: "Taux de change source actuel",
  "当前查看的分组为：{{group}}，{{comparison}}": "Groupe actuel : {{group}} — {{comparison}}",
  ...
  当前状态: "Current Status",
  "当前环境共用同一商户 ID": "Les environnements actuels partagent le même identifiant marchand",
  "当前用户将继承后台代理分销的默认首充/复充比例。": "L'utilisateur actuel héritera du premier ratio de recharge/recharge par défaut de la distribution de l'agent backend.",
  当前登录账号: "",
  当前登记地区: "Zone d'inscription actuelle",
  当前盈利: "bénéfice actuel",
  当前绑定: "Bound",
  ...
  "当前账号未开通代理分销，管理员启用后会在这里展示邀请码、分销用户与佣金流水": "Le compte courant n'a pas activé la distribution en agence. Une fois que l'administrateur l'a activé, le code d'invitation, les utilisateurs de distribution et le flux de commission seront affichés ici.",
  "当前账户暂不支持用户自行变更国家/地区信息。如确需申请变更，请通过工单提交正式申请，并提供足以证明您当前实际所在国家/地区或主体归属地的真实、完整、有效佐证材料。": "Le compte actuel ne permet pas aux utilisateurs de modifier eux-mêmes les informations sur le pays/la région. Si vous avez vraiment besoin de demander un changement, veuillez soumettre une demande formelle via un bon de travail et fournir des pièces justificatives véridiques, complètes et valides, suffisantes pour prouver votre pays/région actuel ou le lieu de résidence du sujet.",
  当前账户未开通代理分销: "Le compte courant n'a pas ouvert la distribution des agents",
  当前跟随系统: "Suit actuellement le système",
  当前邀请福利: "Avantages actuels des invitations",
  "当前金额未达到 Waffo Pancake 的最低充值要求": "Le montant actuel ne répond pas aux exigences de recharge minimales de Waffo Pancake.",
  当前额度: "Quota actuel",
  ...
  "当用户请求中已有系统提示词时，会优先拼接此内容；当用户未提供系统提示词时，会自动注入该内容": "Lorsqu'il y a un mot d'invite système dans la demande de l'utilisateur, ce contenu sera épissé en premier ; lorsque l'utilisateur ne fournit pas de mot d'invite système, le contenu sera automatiquement injecté.",
  ...
  待处理: "En attente",
  待支付单数: "Nombre de commandes à payer",
  ...
  微信群: "Groupe WeChat",
  微信群二维码: "QR code du groupe WeChat",
  微信群二维码图片链接: "URL de l’image du QR code du groupe WeChat",
  "微信账户绑定成功！": "Compte WeChat lié avec succès !",
  "必填：请输入服务器地址以自动生成完整端点 URL": "Obligatoire : veuillez saisir l'adresse du serveur pour générer automatiquement l'URL complète du point de terminaison.",
  ...
  快速创建令牌: "",
  "快速响应，高效运行": "Fast response, efficient operation",
  快速开始: "Démarrage rapide",
  "快速开始、API 参考、整合教学与控制台指南。": "",
  快速选择: "Quick Select",
  忽略: "Ignorer",
  ...
  总体成功率: "taux de réussite global",
  "总体成功率 / 失败率": "Taux de réussite/taux d’échec global",
  总充值金额: "Montant total de la recharge",
  总分配内存: "Mémoire totale allouée",
  总密钥数: "Nombre total de clés",
  总收益: "revenu total",
  总消耗额度: "Montant total de la consommation",
  总计: "Total",
  总请求数: "Total des demandes",
  ...
  "您可以在此自行更新国家/地区信息；如未填写，则默认视为未申报。请确保所填信息真实、准确、有效。": "",
  ...
  成功: "Succès",
  "成功 / 失败": "succès/échec",
  成功充值次数: "Nombre de recharges réussies",
  "成功兑换额度：": "Montant de l'échange réussi :",
  成功单数: "Nombre impair de réussite",
  ...
  我的工单: "Mon bon de travail",
  我的订阅: "Mes abonnements",
  我确认开启高危重试: "Je confirme pour activer les nouvelles tentatives à haut risque",
  我邀请的: "j'ai invité",
  或: "Ou",
  ...
  "扫码加入微信群，与大家一起交流使用经验": "Scannez le QR code pour rejoindre le groupe WeChat et échanger des conseils d’utilisation.",
  扫码支付: "",
  ...
  批量处理失败: "Le traitement par lots a échoué",
  ...
  批量检测失败: "Échec de la détection du lot",
  "批量检测完成：渠道 {{channels}} 个，新增 {{add}} 个，删除 {{remove}} 个，失败 {{fails}} 个": "Détection par lots terminée : canaux {{channels}}, nouveau {{add}}, {{remove}} supprimé, échec {{fails}}",
  ...
  报价: "Devis",
  抬头名称: "Invoice title",
  抽奖券说明: "Règles de la loterie",
  抽奖活动: "",
  "抽奖活动火热进行中，充值之余别忘了参与抽奖赢取奖励！": "La loterie est en cours — pensez à participer pour gagner des récompenses !",
  "拉取中...": "Pulling...",
  拉取价格: "tirer le prix",
  拉取平台价格失败: "Échec de la détermination du prix de la plateforme",
  拉取新模型: "Pull New Model",
  拉取模型: "Pull Model",
  拉取进度: "Pull Progress",
  拉新贡献: "nouvelle contribution",
  拒绝: "",
  "拒绝提示模板（可选）": "Modèle d'invite de rejet (optionnel)",
  拦截原因: "Raison du blocage",
  "拦截返回消息（inject_message）": "Intercepter les messages de retour (inject_message)",
  "按 1 美元对应的站内价格填写": "Remplissez le prix du site correspondant à 1 USD",
  "按 Cron 表达式定时执行 JS 自动化脚本": "Exécuter régulièrement des scripts d'automatisation JS basés sur des expressions Cron",
  按K显示单位: "Afficher en K",
  "按上游 usage.completion_tokens 结算": "",
  按下单数与已成功订单数计算: "Calcul du nombre de commandes pressées et du nombre de commandes réussies",
  按价格字段筛选: "Filtrer par champ de prix",
  按价格设置: "Définir par prix",
  按倍率类型筛选: "Filtrer par type de ratio",
  按倍率设置: "Définir par ratio",
  按分组与模型估算输入输出成本: "Estimation des coûts d’entrée et de sortie par groupe et modèle",
  按后续成功充值实付金额计算: "Calculé sur la base du montant réel du paiement après une recharge réussie",
  按国家或地区限制模型可见性与调用权限: "Restreindre la visibilité du modèle et les autorisations d'appel par pays ou région",
  按完成支付时间落在当前周期内统计: "Statistiques basées sur le délai d'exécution des paiements tombant dans le cycle en cours",
  "按实付人民币校验，填 0 表示不限制": "Vérifiez sur la base du paiement réel en RMB, remplissez 0 pour indiquer aucune limite",
  "按应用、令牌、模型的顺序选择后，将配置导入 CC Switch。": "",
  "按当前用户分组归档成功充值收入。": "Archivez les revenus de recharge réussis par groupe d’utilisateurs actuel.",
  按成功充值订单口径统计: "Statistiques basées sur les commandes de recharge réussies",
  "按成功日志与错误日志的数量口径计算。": "Calculé en fonction du nombre de journaux de réussite et de journaux d'erreurs.",
  "按成功消费日志汇总各渠道的额度消耗。": "Résumez la consommation de quota de chaque canal en fonction du journal de consommation réussi.",
  "按成功消费日志统计模型调用次数。": "Comptez le nombre d'appels de modèle en fonction des journaux de consommation réussis.",
  "按所选日期范围联动查看模型调用、延迟、分组收入、拉新贡献和缓存效率。": "Affichez les appels de modèles, les retards, les revenus groupés, les nouvelles contributions et l'efficacité du cache par plage de dates sélectionnée.",
  按新用户首次充值实付金额计算: "Calculé sur la base du montant réel payé par un nouvel utilisateur pour la première recharge",
  "按日志中的分组字段统计各分组消耗额度。": "Le quota de consommation de chaque groupe est calculé en fonction du champ groupe dans le journal.",
  "按日志响应时间计算各渠道平均延迟和长尾延迟。": "Calculez le délai moyen et le délai longue traîne de chaque canal en fonction du temps de réponse du journal.",
  "按日期连续展示当前周期的消费走势。": "Affiche en continu la tendance de consommation de la période en cours par date.",
  按模型倍率和分组倍率折算: "Converti en fonction du grossissement du modèle et du grossissement de regroupement",
  按次: "Par requête",
  ...
  "按次：{{symbol}}{{price}} * {{ratioType}}：{{ratio}} = {{symbol}}{{total}}": "Par requête : {{symbol}}{{price}} * {{ratioType}} : {{ratio}} = {{symbol}}{{total}}",
  按次价格: "Prix ​​​​à la carte",
  按次计费: "Paiement par requête",
  "按消费 / 错误日志去重统计": "Statistiques de déduplication par consommation/journal d'erreurs",
  "按消费日志中的缓存命中 token 统计": "Statistiques basées sur les jetons d'accès au cache dans les journaux de consommation",
  按消费日志口径统计: "Statistiques par calibre de journal de consommation",
  "按消费日志统计缓存命中、缓存创建与节省额度。": "Statistiques sur les accès au cache, la création de cache et les économies basées sur les journaux de consommation.",
  "按渠道聚合成功与错误请求，查看稳定性差异。": "Regroupez les demandes réussies et les erreurs par canal pour afficher les différences de stabilité.",
  "按照如下格式输入：AccessKey|SecretAccessKey|Region": "Entrez au format : AccessKey|SecretAccessKey|Region",
  按用户创建和首次支付时间统计: "Statistiques par création d'utilisateur et heure du premier paiement",
  "按近几天代理用户的下单与支付结果生成统计视图，成功率按下单数与成功单数计算": "Générez une vue statistique basée sur les résultats de commande et de paiement des utilisateurs agents au cours des derniers jours. Le taux de réussite est calculé par le nombre de commandes passées et le nombre de commandes réussies.",
  "按选定周期内的成功消费额度排序。": "Trier par montant de consommation réussie au cours de la période sélectionnée.",
  按量: "Selon la quantité",
  ...
  "按页面显示额度判断，保存时自动换算，0 表示不限制": "Jugement basé sur le montant affiché sur la page, automatiquement converti lors de la sauvegarde, 0 signifie aucune limite",
  "按页面显示额度封顶，保存时自动换算，0 表示不限制": "Le montant est plafonné en fonction de l'affichage de la page, converti automatiquement lors de la sauvegarde, 0 signifie aucune limite",
  ...
  授权时间: "",
  授权端点: "Point de terminaison d’autorisation",
  "授权范围 (Scopes)": "Portée de l'autorisation (Portées)",
  授权请求已失效: "",
  排序: "Ordre",
  ...
  接收上游模型更新通知: "Recevoir des notifications de mise à jour du modèle en amont",
  接收发票邮箱: "Invoice recipient email",
  "控制代理资格、分销比例以及查看当前佣金汇总": "Contrôlez les qualifications des agents, les ratios de distribution et consultez les résumés actuels des commissions.",
  控制台: "Console",
  ...
  描述: "Description",
  "描述你要生成的画面，例如：赛博朋克城市夜景，霓虹灯，电影感，超清细节": "Décrivez la scène que vous souhaitez générer, par exemple : scène nocturne de la ville cyberpunk, néons, ambiance cinématographique, détails ultra clairs",
  "描述你要生成的视频，例如：镜头缓慢推进雨夜街道，一只橘猫回头望向镜头，电影感光影": "",
  提交: "Soumettre",
  提交和跟进自己的工单: "Soumettre et suivre vos propres bons de travail",
  提交失败: "Failed to submit",
  提交开票申请: "Submit invoice request",
  提交时间: "Heure de soumission",
  提交结果: "Résultats",
  提供商名称: "Nom du fournisseur",
  提出修改要求: "Request a change",
  提升: "Promouvoir",
  提现扣减: "Déduction pour retrait d'espèces",
  提现流水号: "Numéro de série de retrait",
  ...
  搜索文档: "Rechercher dans la doc",
  "搜索文档、接口路径、模型名…": "",
  "搜索文档内容…": "Rechercher dans la documentation…",
  ...
  "搜索用户名、昵称或邮箱": "Rechercher un nom d'utilisateur, un pseudo ou une adresse e-mail",
  "搜索用户名、邮箱或来源订单号": "Rechercher un nom d'utilisateur, un e-mail ou un numéro de commande source",
  "搜索用户名、邮箱或订单号": "Rechercher un nom d'utilisateur, un e-mail ou un numéro de commande",
  搜索结果: "Résultats de recherche",
  搜索聊天应用名称: "Rechercher le nom de l'application de chat",
  "搜索规则（描述 / 类型 / 路径 / 来源 / 目标）": "Règles de recherche (description / type / chemin / source / cible)",
  "搜索规则（类型 / 路径 / 来源 / 目标）": "Rechercher des règles (type / chemin / source / cible)",
  操作: "Actions",
  操作员: "Operator",
  操作员要求补充资料: "The operator asked for more information",
  ...
  "支付处理中，可稍后刷新订阅状态": "Le paiement est en cours de traitement. Le statut de l'abonnement peut être actualisé ultérieurement.",
  "支付处理中，可稍后在充值记录查看状态": "Le paiement est en cours de traitement, vous pourrez vérifier le statut dans le dossier de recharge ultérieurement.",
  支付失败: "Paiement échoué",
  "支付失败，请重新发起充值": "Échec du paiement, veuillez recharger",
  "支付失败，请重新发起购买": "Le paiement a échoué, veuillez relancer l'achat",
  支付完成单数: "Nombre de paiement effectué",
  "支付完成后用户跳转的页面，留空则自动使用 服务器地址 + /console/topup": "La page à laquelle l'utilisateur accède une fois le paiement terminé. Si laissé vide, l'adresse du serveur + /console/topup sera automatiquement utilisée.",
  支付宝: "Alipay",
  支付宝扫码支付: "Paiement par code scan Alipay",
  支付成功率: "Taux de réussite des paiements",
  支付方式: "Mode de paiement",
  支付方式分布: "Répartition des moyens de paiement",
  支付方式名称: "Nom de méthode de paiement",
  支付方式名称不能为空: "Le nom du mode de paiement ne peut pas être vide",
  支付方式图标: "Icône du mode de paiement",
  支付方式类型: "Type de méthode de paiement",
  支付方式设置: "Paramètres du mode de paiement",
  支付方式颜色: "Couleur du moyen de paiement",
  支付时间: "Paid at",
  ...
  "支持 JSONPath，如 email, data.user.email": "Prend en charge JSONPath, tel que l'e-mail, data.user.email",
  "支持 JSONPath，如 name, display_name, data.user.name": "Prend en charge JSONPath, tel que nom, display_name, data.user.name",
  "支持 JSONPath，如 preferred_username, login, data.user.username": "Prend en charge JSONPath, tel que nom d'utilisateur préféré, connexion, data.user.username",
  "支持 JSONPath，如 sub, id, data.user.id": "Prend en charge JSONPath, tel que sub, id, data.user.id",
  ...
  "支持使用 {prompt} 占位原始提示词": "Prend en charge l'utilisation du mot d'invite original de l'espace réservé {prompt}",
  ...
  支持备份: "Pris en charge",
  "支持多个标记，使用换行、逗号、分号或竖线分隔。模型输出包含任一标记时将记录审查结果。": "Plusieurs balises sont prises en charge, séparées par une nouvelle ligne, une virgule, un point-virgule ou une barre verticale. Les résultats de la révision sont enregistrés lorsque la sortie du modèle contient l'un ou l'autre des indicateurs.",
  ...
  "支持文生视频、首尾帧、参考图与参考视频/音频": "Prend en charge le texte-vers-vidéo, les première/dernière images, les images, vidéos et audios de référence",
  支持的分辨率: "",
  ...
  支持的画面比例: "",
  支持的输出格式: "",
  "支持精确匹配；使用 regex: 开头可按正则匹配。": "Prend en charge la correspondance exacte ; utilisez regex : au début pour faire correspondre selon les règles habituelles.",
  "支持自定义请求限流、频率控制、黑白名单配置，灵活管控接口访问流量，避免恶意请求与突发流量冲击，保障业务有序平稳运行。": "Configurez la limitation de débit, le contrôle de fréquence et les listes noires/blanches pour gérer le trafic des API avec souplesse, absorber les requêtes malveillantes et les pics de trafic, et assurer un fonctionnement fluide et ordonné.",
  ...
  政企项目系统集成: "Systèmes publics et d'entreprise",
  ...
  "文+图生图": "Le texte + les images produisent des images",
  ...
  文心一言: "ERNIE Bot",
  "文本生成内容审查（命中输出标记时记录审查结果）": "Examen du contenu de la génération de texte (examen des résultats enregistrés lorsque les indicateurs de sortie sont activés)",
  文档: "Documentation",
  文档中心: "Centre de documentation",
  文档加载失败: "Échec du chargement de la documentation",
  文档地址: "Lien du document",
  文档导航: "",
  文档搜索加载失败: "Échec du chargement de la recherche de documentation",
  文档目录: "Sommaire de la doc",
  文档空间: "",
  文档翻页导航: "",
  文生图: "Image vincentienne",
  文生视频: "Texte vers vidéo",
  新增: "added",
  "新增 / 首充 / 活跃用户趋势": "Tendances des nouveaux/premiers dépôts/utilisateurs actifs",
  "新增 / 首充用户": "Nouvel utilisateur/premier dépôt",
  "新增 Key 来源": "Ajouter une source de clé",
  新增供应商: "Ajouter un fournisseur",
  新增失败: "Échec de l'ajout",
  新增对比项: "Ajouter des éléments de comparaison",
  新增封禁: "Ajouter une nouvelle interdiction",
  新增封禁记录: "Ajouter un enregistrement d'interdiction",
  "新增已选 {{selected}} / {{total}}": "Ajouter la sélection {{selected}} / {{total}}",
  新增平台对比: "Comparaison de plate-forme ajoutée",
  新增成功: "Ajouté avec succès",
  新增支付方式: "Ajouter un nouveau mode de paiement",
  新增条件: "Ajouter une condition",
  新增模型: "Ajouter un nouveau modèle",
  新增用户: "Ajouter un nouvel utilisateur",
  "新增用户按创建时间统计，首充用户按首次支付时间统计，活跃用户按日志去重统计。": "Les nouveaux utilisateurs sont comptés en fonction de l'heure de création, les nouveaux utilisateurs de dépôt sont comptés en fonction de l'heure du premier paiement et les utilisateurs actifs sont comptés en fonction de la déduplication des journaux.",
  新增规则: "Ajouter une règle",
  新增订阅: "Ajouter un abonnement",
  新增邀请计划: "Ajouter un plan d'invitation",
  新密码: "Nouveau mot de passe",
  "新密码需要和原密码不一致！": "Le nouveau mot de passe doit être différent de l'ancien mot de passe !",
  新年促销: "Promotion du Nouvel An",
  新建: "Créer",
  新建套餐: "Créer un plan",
  ...
  新建组: "Nouveau groupe",
  新支付方式: "Nouveau mode de paiement",
  ...
  新用户邀请: "Invitation d'un nouvel utilisateur",
  ...
  "无条件（兜底档）": "Inconditionnel (bas de gamme)",
  "无法加载文档内容，请稍后重试": "Impossible de charger le contenu de la documentation, veuillez réessayer plus tard",
  ...
  "无法复制到剪贴板，请重试": "",
  "无法构建搜索索引，请稍后重试": "Impossible de construire l'index de recherche. Veuillez réessayer plus tard.",
  无法添加图片: "Impossible d'ajouter l'image",
  无法获取容器详情: "Unable to get container details",
  "无法获取模型 {{model}} 的能力契约，暂时无法生成": "",
  无法获取用户信息: "Impossible d'obtenir les informations utilisateur",
  无法读取剪贴板: "Impossible de lire le presse-papiers",
  无生效: "Aucun actif",
  无结果: "Aucun résultat",
  无输入影片: "Aucune vidéo d'entrée",
  无邀请人: "Pas d'invitant",
  无限: "illimité",
  无限制: "Illimité",
  无限额度: "Quota illimité",
  ...
  日志追踪: "",
  日期: "date",
  "旧数据/未知": "Données anciennes/inconnu",
  ...
  易支付设置: "Paramètres de paiement faciles",
  星期: "Semaine",
  昨天充值: "Recharger hier",
  是: "Oui",
  ...
  是否检测上游模型更新: "S'il faut détecter les mises à jour du modèle en amont",
  "是否确认充值？": "Confirmer la recharge ?",
  是否自动同步上游模型更新: "S'il faut synchroniser automatiquement les mises à jour du modèle en amont",
  ...
  显示名称字段: "champ de nom d'affichage",
  ...
  晚上好: "Bonsoir",
  "普通按量/按次直接填价格就行；如果价格要跟请求参数或请求头联动，请切到表达式/阶梯计费。": "Normalement, il suffit de renseigner directement le prix par volume/par temps ; si le prix doit être lié aux paramètres de demande ou aux en-têtes de demande, veuillez passer à la facturation expression/échelle.",
  ...
  暂无赠送日志: "Pas encore de journal de cadeaux",
  暂无邀请码: "Pas encore de code d'invitation",
  暂无邀请计划: "Pas encore de plan d'invitation",
  暂无邀请链接: "Pas encore de lien d'invitation",
  暂无项目: "Aucun projet",
  暂无预填组: "Aucun groupe pré-rempli",
  暂时还没有代理佣金流水: "Il n'y a pas encore de flux de commissions d'agence",
  暂时还没有代理充值流水: "Il n'y a pas encore de flux de recharge d'agent",
  暂时还没有代理邀请用户: "Il n'y a pas encore d'agent pour inviter des utilisateurs",
  暂时还没有邀请用户: "Aucun utilisateur n'a encore été invité",
  暂时还没有邀请额度流水: "Il n’y a pas encore de transfert de quota d’invitations.",
  ...
  更新: "Mettre à jour",
  "更新 BLG 支付设置": "Mettre à jour les paramètres de paiement BLG",
  "更新 Creem 设置": "Mettre à jour les paramètres Creem",
  "更新 Stripe 设置": "Mettre à jour les paramètres Stripe",
  "更新 Waffo Pancake 设置": "Mettre à jour les paramètres de Waffo Pancake",
  "更新 Waffo 设置": "Mettre à jour les paramètres de Waffo",
  ...
  更新全局系统提示词拼接: "Mettre à jour l'épissage des mots d'invite du système global",
  ...
  更新易支付设置: "Mettre à jour les paramètres d'Easy Pay",
  ...
  更新邀请计划: "Mettre à jour le programme d'invitation",
  ...
  有效至: "Valid until",
  "有输入/参考影片": "Vidéo entrée/référence",
  ...
  "未上传参考图时，默认调用文生图接口": "Lorsqu'aucune image de référence n'est téléchargée, l'interface d'image Vincent est appelée par défaut.",
  "未上传参考图时，默认调用文生视频流程": "",
  未产生佣金: "Aucune commission accumulée",
  ...
  "未找到差异化价格，无需同步": "Prix ​​différencié introuvable, aucune synchronisation requise",
  "未找到差异化倍率，无需同步": "Aucun ratio différentiel trouvé, aucune synchronisation n'est requise",
  未找到该文档: "Document introuvable",
  未授权: "Non autorisé",
  未提交: "Non soumis",
  ...
  未首单消费: "Pas le premier achat",
  本地: "Local",
  本地数据存储: "Stockage de données locales",
  本地计费: "Facturation locale",
  本月获得: "Ce mois-ci",
  本站: "Ce site",
  "本站来源使用该汇率，外部平台可在下方单独配置。": "La source de ce site utilise ce taux de change, et les plateformes externes peuvent être configurées séparément ci-dessous.",
  "本站汇率（CNY/USD）": "Taux de change sur ce site (CNY/USD)",
  ...
  本页暂无目录: "Aucun titre sur cette page",
  本页目录: "Sur cette page",
  ...
  "条，共": "sur",
  条件: "condition",
  条件乘数: "multiplicateur conditionnel",
  ...
  来源订单号: "Numéro de commande source",
  "来自模型重定向，尚未加入模型列表": "Issu d'une redirection de modèle, pas encore ajouté à la liste des modèles",
  "来自能力契约 {{profile}} 修订 {{revision}}": "",
  "某些配置更改可能需要几分钟才能生效。": "Some configuration changes may take a few minutes to take effect.",
  查单地址: "Vérifier l'adresse",
  查看: "Voir",
  "查看 Codex 帐号信息与用量": "Afficher les informations et l'utilisation du compte Codex",
  "查看 JSON 示例": "Voir l'exemple JSON",
  查看你可使用的分组: "Voir les groupes que vous pouvez utiliser",
  查看你可使用的模型: "",
  查看关联部署: "View Associated Deployment",
  查看和筛选充值记录: "Afficher et filtrer les enregistrements de recharge",
  查看图片: "Voir les images",
  查看图片和文本审查结果: "Afficher les résultats de l'examen des images et du texte",
  查看图片和文本的审查记录: "Afficher l'historique des avis pour les images et le texte",
  查看密钥: "Afficher la clé",
  查看并退出你账户当前的登录设备: "",
  查看开票: "View invoice",
  查看当前可用的所有模型: "Voir tous les modèles actuellement disponibles",
  "查看当前邀请福利，管理邀请列表，并追踪邀请额度流水": "Afficher les avantages actuels des invitations, gérer les listes d'invitations et suivre le flux des quotas d'invitations",
  ...
  查看该应用对你账户的用量: "",
  查看详情: "View Details",
  "查看邀请码、邀请用户、充值流水和佣金流水": "Vérifiez le code d'invitation, les utilisateurs invités, le flux de recharge et le flux de commission",
  查询: "Requête",
  查询视频任务状态失败: "",
  标准价格: "Standard price",
  标签: "Étiquette",
  ...
  "标识符 (Slug)": "Identifiant (limace)",
  标识颜色: "Couleur de l'identifiant",
  样本数: "Nombre d'échantillons",
  核对中: "Under review",
  "核心优势 · 为什么选择 {{name}}": "Atouts clés · Pourquoi choisir {{name}}",
  ...
  "根据哪个维度的 Token 数量决定落在哪一档": "Le nombre de jetons dans quelle dimension détermine dans quelle tranche il se situe.",
  "根据总用量落在哪个档位，所有 Token 都按该档价格计费": "En fonction de la tranche dans laquelle se situe l'utilisation totale, tous les jetons seront facturés en fonction du prix de cette tranche.",
  ...
  "根据相关法律法规，您所在的国家/地区不受支持，我们无法为您提供相关服务。": "",
  格式: "Format",
  格式化: "Formater",
  ...
  档位: "Palier",
  档位名称: "Nom du stand",
  档位标签: "étiquette d'équipement",
  检查更新: "Vérifier les mises à jour",
  检测全部渠道上游更新: "Détecter toutes les mises à jour de chaîne en amont",
  "检测到 FluentRead（流畅阅读）": "FluentRead détecté",
  检测到以下高危状态码重定向规则: "Les règles de redirection de code d'état à haut risque suivantes ont été détectées",
  ...
  "检测完成：新增 {{add}} 个，删除 {{remove}} 个": "Détection terminée : {{add}} ajouté, {{remove}} supprimé",
  检测超时: "",
  概览: "Overview",
  模型: "Modèle",
  "模型 {{model}} 的能力契约不可用": "",
  ...
  模型优化提示词: "Mots d'invite d'optimisation du modèle",
  模型倍率: "Ratio",
  ...
  模型缓存倍率: "Agrandissement du cache du modèle",
  ...
  "正在同步上游价格，请稍候": "Synchronisation des prix en amont, veuillez patienter.",
  "正在同步价格，请稍候": "Synchronisation des prix, veuillez patienter.",
  "正在处理，请稍候": "Traitement en cours, veuillez patienter.",
  "正在处理大内容...": "Traitement de contenu volumineux...",
  "正在批量处理，请稍候": "Traitement par lots en cours, veuillez patienter.",
  "正在批量检测，请稍候": "Des tests par lots sont en cours, veuillez patienter.",
  正在提交: "Envoi en cours",
  "正在构建搜索索引…": "Construction de l'index de recherche…",
  "正在构造请求体预览...": "Construction de l'aperçu du corps de la requête...",
  "正在检测，请稍候": "Détection, veuillez patienter.",
  "正在测试第 ${current} - ${end} 个模型 (共 ${total} 个)": "Test des modèles ${current} - ${end} sur ${total} au total",
  "正在生成 ({{seconds}} s)": "Génération ({{seconds}} s)",
  ...
  "此对话仅用于开票沟通，与普通工单完全分开。": "This conversation is for invoicing only and is completely separate from ordinary tickets.",
  "此授权请求已失效或过期，请返回应用重新发起授权": "",
  ...
  此支付方式最高充值金额为: "Le montant maximum de recharge pour ce mode de paiement est de",
  "此时用户创建令牌时只能看到 standard 和 premium：": "Users can now only see standard and premium when creating tokens:",
  "此档上限（Token 数）": "La limite supérieure de ce fichier (nombre de Tokens)",
  ...
  "每个充值单位对应的 USD 金额，默认 1.0": "Montant en USD correspondant à chaque unité de recharge, par défaut 1,0",
  ...
  "每个对比项都可选择来源（本站/外部平台），再分别选择分组和模型进行可视化对比。各来源按自己的汇率计算。": "Vous pouvez sélectionner la source (ce site/plateforme externe) pour chaque élément de comparaison, puis sélectionner des groupes et des modèles pour une comparaison visuelle. Chaque source calcule son propre taux de change.",
  "每个档位可设置 0~2 个条件（对 len、p 和 c），最后一档为兜底档无需条件。len 为输入上下文总长度（含缓存），推荐用于阶梯条件。": "Chaque vitesse peut définir des conditions de 0 à 2 (pour len, p et c), et la dernière vitesse est la vitesse inférieure sans conditions. len est la longueur totale du contexte d'entrée (y compris le cache), qui est recommandée pour les conditions de relais.",
  "每个档位可设置 0~2 个条件（对 p 和 c），最后一档为兜底档无需条件。": "Chaque vitesse peut définir 0 à 2 conditions (pour p et c), et la dernière vitesse est la vitesse inférieure sans conditions.",
  每个模型使用其最低可用分组倍率: "Chaque modèle utilise le ratio de groupe disponible le plus bas",
  ...
  每位邀请人可参与: "Chaque invité peut participer",
  每周: "Hebdomadaire",
  每天: "Quotidien",
  ...
  每日充值金额: "Montant de recharge quotidien",
  每日支付成功率: "Taux de réussite des paiements quotidiens",
  每日消耗额度: "Quota de consommation journalier",
  每日签到: "Enregistrement quotidien",
  每日签到可获得随机额度奖励: "L'enregistrement quotidien récompense un quota aléatoire",
  每月: "Mensuel",
  "每百万 Token 价格": "Prix ​​par million de jetons",
  "每美元对应 Token 数": "Tokens par USD",
  每隔多少分钟测试一次所有通道: "Tous les combien de minutes tester tous les canaux",
  "比较模型价格，按供应商、分组和能力快速找到适合你的模型。": "Comparez les tarifs des modèles et trouvez rapidement le modèle adapté par fournisseur, groupe et capacité.",
  ...
  活动: "Activité",
  活动优惠以支付完成时系统配置为准: "",
  活动到期时间: "Délai d'expiration de l'activité",
  活跃: "",
  活跃文件: "Fichiers actifs",
  活跃用户: "utilisateurs actifs",
  活跃用户数: "Nombre d'utilisateurs actifs",
  ...
  流状态: "état du flux",
  流量端口: "Traffic Port",
  流错误详情: "Détails de l'erreur de flux",
  浅色: "Clair",
  浅色模式: "Mode clair",
  测活: "Health Check",
  测试: "Tester",
  "测试 Webhook 公钥": "Tester la clé publique du webhook",
  测试中: "Test en cours",
  "测试中...": "Test en cours...",
  ...
  测试模式: "Mode test",
  测试环境: "environnement de test",
  "测试环境 Webhook 验签公钥 Base64": "Environnement de test Clé publique de vérification de signature Webhook Base64",
  ...
  消耗额度: "Quota utilisé",
  消费: "Consommer",
  消费后即可获得返利: "La commission est versée après une dépense du filleul",
  深色: "Sombre",
  深色模式: "Mode sombre",
  添加: "Ajouter",
  "添加 (+:)": "Add (+:)",
  ...
  添加提供商: "Ajouter un fournisseur",
  添加时间条件: "Ajouter une condition de temps",
  添加时间规则: "Ajouter une règle de temps",
  添加更多档位: "Ajouter plus de vitesses",
  添加条件: "Ajouter des conditions",
  添加条件组: "Ajouter un groupe de conditions",
  ...
  添加视频链接: "Ajouter un lien vidéo",
  添加聊天配置: "Ajouter une configuration de chat",
  添加规则: "Add Rule",
  添加链接: "Ajouter un lien",
  添加键值对: "Ajouter une paire clé-valeur",
  添加问答: "Ajouter une FAQ",
  添加阶梯: "ajouter une échelle",
  添加音频链接: "Ajouter un lien audio",
  ...
  清空参考图: "Image de référence claire",
  ...
  "渠道平均响应 / P95 / P99": "Réponse moyenne du canal / P95 / P99",
  ...
  "满足条件时，整单价格乘以 X；如果有多条同时命中，会继续相乘。": "Lorsque les conditions sont remplies, le prix total de la commande est multiplié par X ; s'il y a plusieurs résultats en même temps, la multiplication continuera.",
  ...
  点击处理删除模型: "Cliquez sur Processus pour supprimer le modèle",
  点击处理新增模型: "Cliquez pour traiter le nouveau modèle",
  ...
  现在: "",
  "生产 Webhook 公钥": "Produire la clé publique du webhook",
  生产环境: "environnement de production",
  "生产环境 RSA 私钥 Base64 (PKCS#8 DER)": "Clé privée RSA Base64 (PKCS#8 DER) de production",
  "生产环境 Waffo API 密钥": "Clé API Waffo de production",
  "生产环境 Waffo 公钥 Base64 (X.509 DER)": "Clé publique Waffo Base64 (X.509 DER) de production",
  "生产环境 Webhook 验签公钥 Base64": "Environnement de production Clé publique de vérification de signature Webhook Base64",
  生成: "Génération",
  ...
  生成音频: "Générer l'audio",
  生效: "Actif",
  生效中: "Prendre effet",
  "用于“1M输入（含缓存）”估算，示例：0.95。": "Pour l'estimation « 1 M d'entrée (y compris le cache) », exemple : 0,95.",
  "用于API调用的身份验证令牌，请妥善保管": "Jeton d'authentification pour les appels d'API, veuillez le conserver en lieu sûr",
  用于切换当前下单和回调校验所使用的环境: "Utilisé pour changer l'environnement utilisé pour la passation de commande en cours et la vérification des rappels",
  用于唯一标识用户的字段路径: "Chemin du champ pour identifier les utilisateurs de manière unique",
  "用于校验 Stripe Webhook 签名，保存后不会回显": "Utilisé pour vérifier la signature Stripe Webhook, ne sera pas repris après l'enregistrement",
  "用于校验测试环境的 Waffo Pancake Webhook 签名": "Signature Waffo Pancake Webhook pour vérifier l'environnement de test",
  "用于校验测试环境的 Waffo 回调签名": "Signature de rappel Waffo utilisée pour vérifier l'environnement de test",
  "用于校验生产环境的 Waffo Pancake Webhook 签名": "Vérification de la signature Waffo Pancake Webhook pour les environnements de production",
  "用于校验生产环境的 Waffo 回调签名": "Signature de rappel Waffo pour vérifier l'environnement de production",
  ...
  用户信息端点: "Point de terminaison des informations utilisateur",
  ...
  用户单次最少可充值的美元数量: "Le montant minimum de dollars américains qu'un utilisateur peut recharger à la fois",
  ...
  用户名字段: "champ du nom d'utilisateur",
  "用户名字段（可选）": "Champ nom d'utilisateur (optionnel)",
  用户名或邮箱: "Nom d'utilisateur ou e-mail",
  用户名称: "Nom d'utilisateur",
  "用户在充值页面看到的支付方式名称，例如：Credit Card": "Le nom du mode de paiement que les utilisateurs voient sur la page de recharge, par exemple : Carte de crédit",
  用户工单处理: "Traitement des bons de travail des utilisateurs",
  ...
  "用户消耗排名 Top 10": "Top 10 des classements de consommation des utilisateurs",
  ...
  "用量分段计价，每一段各自按对应档位价格计费（类似电费阶梯）": "L'utilisation est tarifée par segments, et chaque segment est facturé selon le prix correspondant (similaire à l'échelle de facture d'électricité)",
  "用量统计、模型选择、成本优化": "",
  用量范围: "Plage de dosage",
  ...
  申请已取消: "Request cancelled",
  申请开票: "Request an invoice",
  申请编号: "Request ID",
  "画面 {{width}}×{{height}}，计费时长 {{seconds}} 秒，预估影片补全 tokens {{tokens}}": "",
  "画面 {{width}}×{{height}}，预估影片补全 tokens {{tokens}}": "",
  画面比例: "",
  ...
  "留空则使用 /console/topup?show_history=true": "Laissez vide pour utiliser /console/topup?show_history=true",
  留空则使用账号绑定的邮箱: "Si ce champ est laissé vide, l'adresse e-mail liée au compte sera utilisée",
  留空则使用默认回调地址: "Laissez vide pour utiliser l'adresse de rappel par défaut",
  ...
  "留空则自动使用 服务器地址 + /api/waffo/webhook": "Laissez vide pour utiliser automatiquement l'adresse du serveur + /api/waffo/webhook",
  留空则自动使用当前站点的默认充值页地址: "Si elle est laissée vide, l'adresse de la page de recharge par défaut du site actuel sera automatiquement utilisée.",
  ...
  "留空时默认使用服务器地址作为回调地址，填写后将覆盖默认值": "Si elle est laissée vide, l'adresse du serveur sera utilisée comme adresse de rappel par défaut. Le fait de remplir écrasera la valeur par défaut.",
  "留空表示保留当前密钥，仅在需要更换时重新填写": "Laissez-le vide pour conserver la clé actuelle et ne la remplissez que si vous devez la modifier.",
  留空表示长期有效: "Laisser vide pour indiquer la validité à long terme",
  "登 录": "Se connecter",
  登录: "Se connecter",
  登录会话: "",
  登录你的账号: "",
  ...
  "确定要仅检测全部渠道上游模型更新吗？（不执行新增/删除）": "Voulez-vous vraiment détecter uniquement toutes les mises à jour du modèle de canal en amont ? (L'ajout/suppression ne sera pas effectué)",
  ...
  "确定要删除该提供商吗？": "Êtes-vous sûr de vouloir supprimer ce fournisseur ?",
  ...
  "确定要对全部渠道执行上游模型更新吗？": "Êtes-vous sûr de vouloir effectuer une mise à jour du modèle en amont pour tous les canaux ?",
  ...
  "确认删除该邀请计划？": "Confirmer la suppression de ce plan d'invitation ?",
  "确认删除这条模型封禁记录？": "Êtes-vous sûr de supprimer cet enregistrement d'interdiction de modèle ?",
  确认取消密码登录: "Confirmer l'annulation de la connexion par mot de passe",
  "确认后会从可提现佣金扣减，并累计到已提现佣金，同时写入代理佣金流水。": "Après confirmation, elle sera déduite de la commission retirable et accumulée dans la commission retirable, et inscrite dans le flux des commissions de l'agence.",
  ...
  "示例：claude-opus-4-8 输入价，官方 ￥35.00，Claude lite（特价） ￥3.50": "Exemple : prix d’entrée de claude-opus-4-8 — officiel 35,00 ¥ ; Claude lite (tarif spécial) 3,50 ¥",
  "示例：官方 {{officialPrice}} × {{groupRatio}} × {{rate}} {{currency}}/USD = {{payable}}": "",
  "示例：官方 {{officialPrice}} × {{groupRatio}} × {{rate}} {{currency}}/USD = {{payable}}（优惠 {{adjustmentPercent}}%）": "",
  "示例：官方 {{officialPrice}} × {{groupRatio}} × {{rate}} {{currency}}/USD = {{payable}}（加价 {{adjustmentPercent}}%）": "",
  视频: "Vidéo",
  视频Remix: "Remix vidéo",
  视频不可用: "Vidéo indisponible",
  视频任务已提交: "",
  "视频任务已提交，系统会每 5 秒自动查询一次结果": "",
  "视频已完成，但未返回可播放地址": "",
  视频扩展: "Extension vidéo",
  "视频无法在当前浏览器中播放，这可能是由于：": "La vidéo ne peut pas être lue dans ce navigateur, cela peut être dû à :",
  视频生成: "",
  视频生成失败: "",
  视频生成完成: "",
  视频生成模型: "Modèle de génération vidéo",
  视频编辑: "Montage vidéo",
  视频预览: "",
  禁用: "Désactiver",
  ...
  秒: "Seconde",
  移动: "se déplacer",
  移动请求头: "Déplacer l'en-tête de la demande",
  移除: "Remove",
  "移除 (-:)": "Remove (-:)",
  ...
  稳定: "",
  稳定调用: "",
  稳定高效的企业服务平台: "A stable and efficient enterprise service platform",
  空: "Vide",
  "空位 {{index}}": "Poste vacant {{index}}",
  窗口处理: "gestion des fenêtres",
  窗口等待: "attente de la fenêtre",
  立即充值: "Rechargez maintenant",
  立即生成: "Générer immédiatement",
  ...
  "端点 URL 必须以 http:// 或 https:// 开头：": "L'URL du point de terminaison doit commencer par http:// ou https:// :",
  ...
  等待中: "En attente",
  等待客服: "Waiting for support",
  "等待获取邮箱信息...": "En attente d'obtenir des informations par e-mail...",
  等待首单消费后判定返利: "Attendez que le rabais soit déterminé après le premier achat.",
  筛选: "Filtre",
  ...
  "简化接口调用，赋能业务高效运转": "Simplifiez les appels d'API et dynamisez vos opérations",
  ...
  管理员可视化报表中心: "Centre de rapports visuel de l'administrateur",
  管理员尚未配置需要展示的分组: "",
  管理员尚未配置需要展示的套餐: "",
  管理员尚未配置需要展示的模型: "",
  管理员暂时未设置任何关于内容: `L'administrateur n'a encore défini aucun contenu personnalisé "À propos".`,
  管理员暂未配置微信群二维码: "L’administrateur n’a pas encore configuré le QR code du groupe WeChat.",
  ...
  管理员未开启支付宝充值: "L'administrateur n'a pas activé la recharge Alipay.",
  "管理员未开启支付宝充值！": "L'administrateur n'a pas activé la recharge Alipay !",
  "管理员未开启聚合支付！": "",
  ...
  "粘贴图片链接（http/https）": "Collez un lien d'image (http/https)",
  精确: "Exact",
  精选: "",
  系统: "Système",
  ...
  索引: "Index",
  紧凑列表: "Liste compacte",
  "纯字符串会直接覆盖整条请求头，或者点击“查看 JSON 示例”按 token 规则处理。": `La chaîne pure couvrira directement l'intégralité de l'en-tête de la requête, ou cliquez sur "Afficher l'exemple JSON" pour la traiter selon les règles des jetons.`,
  累计佣金: "Commission accumulée",
  累计充值金额: "Montant de recharge cumulé",
  累计签到: "Total des enregistrements",
  累计获得: "Total reçu",
  累计贡献佣金: "Commission de cotisation cumulée",
  "累计返利 {{quota}}（共 {{count}} 次）": "Commission totale {{quota}} ({{count}} fois)",
  "累计返利 {{quota}}（共 {{count}} 次）_many": "",
  "累计返利 {{quota}}（共 {{count}} 次）_one": "",
  "累计返利 {{quota}}（共 {{count}} 次）_other": "",
  累计邀请奖励: "Récompenses d'invitation cumulatives",
  累进阶梯: "échelle progressive",
  线路描述: "Description de l'itinéraire",
  组列表: "Liste des groupes",
  组名: "Nom du groupe",
  组织: "Organisation",
  "组织，不填则为默认组织": "Organisation, par défaut si vide",
  "终态以上游 usage.completion_tokens 为准": "",
  终止中: "Terminating",
  ...
  绘图: "Dessin",
  统一定价: "Tarification uniforme",
  统一接入: "",
  统一服务接入: "Unified service access",
  "统一服务流程，减少重复适配": "Unified workflows reduce repeated integration work",
  统一的: "La Passerelle",
  "统一社会信用代码／纳税人识别号": "Unified social credit / taxpayer ID",
  统计Tokens: "Jetons statistiques",
  统计周期内代理用户创建的充值订单: "Recharger les commandes créées par les utilisateurs agents au cours de la période statistique",
  统计周期内完成支付的成功金额: "Le montant du paiement effectué avec succès au cours de la période statistique",
  ...
  "缓存创建 Token": "Jeton de création de cache",
  "缓存创建 Token (cc)": "Jeton de création de cache (cc)",
  "缓存创建 Tokens": "Jetons de création de cache",
  "缓存创建-1h": "Création de cache-1h",
  "缓存创建-1小时": "Création de cache - 1 heure",
  "缓存创建-1小时 (cc1h)": "Création de cache - 1 heure (cc1h)",
  "缓存创建-5分钟": "Création de cache - 5 minutes",
  "缓存创建-5分钟 (cc5)": "Création de cache - 5 minutes (cc5)",
  ...
  "缓存创建价格-1小时": "Prix ​​de création de cache - 1 heure",
  "缓存创建价格-5分钟": "Prix ​​de création de cache - 5 minutes",
  ...
  "缓存创建价格：{{symbol}}{{price}} / 1M tokens": "Prix de création du cache : {{symbol}}{{price}} / 1M tokens",
  "缓存创建价格（1小时）": "Tarif création de cache (1 heure)",
  "缓存创建价格（5分钟）": "Prix ​​de création de cache (5 minutes)",
  ...
  缓存读取倍率: "Taux de lecture du cache",
  ...
  编辑封禁记录: "Modifier l'historique des interdictions",
  编辑成功: "Modification réussie",
  编辑提供商: "Modifier le fournisseur",
  编辑支付方式: "Modifier le mode de paiement",
  编辑方式: "Mode d'édition",
  ...
  网关处理用时: "Temps de traitement de la passerelle",
  ...
  腾讯混元: "Hunyuan",
  自动: "Auto",
  "自动（由模型决定）": "Auto (déterminé par le modèle)",
  自动分组: "Auto Group",
  ...
  "自动表示由模型决定分辨率，不发送尺寸参数": "Auto signifie que le modèle décide de la résolution ; aucun paramètre de taille n'est envoyé",
  ...
  自定义流量管控: "Contrôle de trafic personnalisé",
  ...
  获取代理分销信息失败: "Échec de l'obtention des informations sur la distribution des agents",
  获取代理统计失败: "Échec de l'obtention des statistiques de l'agent",
  获取令牌密钥失败: "Impossible d'obtenir la clé du jeton",
  获取佣金流水失败: "Échec de l'obtention du flux de commission",
  获取充值流水失败: "Impossible d'obtenir de l'eau de recharge",
  ...
  获取邀请流水失败: "Échec de l'obtention du chiffre d'affaires des invitations",
  ...
  表格: "Tableau",
  表格视图: "Vue tableau",
  "表达式/阶梯计费": "Facturation par expression/niveau",
  表达式编辑: "Édition d'expressions",
  表达式计费: "Facturation des expressions",
  表达式错误: "Erreur d'expression",
  被邀请人: "Invité",
  覆盖: "Remplacer",
  ...
  覆盖用户: "Toucher les utilisateurs",
  见上方动态计费详情: "Voir les détails de facturation dynamique ci-dessus",
  规则: "Règle",
  ...
  "规则描述（可选）": "Description de la règle (facultatif)",
  "规则未找到，请刷新后重试": "Règle non trouvée, veuillez actualiser et réessayer",
  规则版本: "Version de règle",
  角色: "Rôle",
  ...
  "解除后 {{name}} 将立即失去对你账户的访问权限，其已签发的令牌会全部失效。": "",
  解除授权: "",
  解除授权失败: "",
  触发套餐: "paquet de déclenchement",
  触发条件: "Condition de déclenchement",
  触发来源: "source de déclenchement",
  计价币种: "Pricing Currency",
  计价规则: "Règles de tarification",
  计划: "plan",
  计划名称: "Nom du forfait",
  计划状态: "statut du régime",
  计算中: "Calculating",
  计算失败: "Échec du calcul",
  计算成本: "Calculate Cost",
  计算盈利: "Calculer le bénéfice",
  计算盈利失败: "Le calcul du bénéfice a échoué",
  ...
  计费凭证: "Reçu de facturation",
  计费开始: "Billing Start",
  计费摘要: "Récapitulatif de facturation",
  计费方式: "Mode de facturation",
  计费明细: "Détails de facturation",
  ...
  计费额度: "Quota facturé",
  订单号: "N° de commande",
  订单支付方式: "Méthode de paiement de la commande",
  订单数: "Nombre de commandes",
  订单趋势: "Tendance des commandes",
  订阅: "Abonnement",
  ...
  "订阅购买成功，已生效": "Abonnement acheté avec succès et pris effet",
  ...
  设请求头: "Supposons que l'en-tête de la demande",
  ...
  该入口仅用于一次性余额充值: "Cette entrée n'est utilisée que pour une recharge unique du solde",
  该分类下没有可用模型: "Aucun modèle disponible dans cette catégorie",
  该分组下暂无可展示的模型: "",
  "该分辨率不在模型能力契约内，不会被提供": "",
  "该分辨率没有已知的画面尺寸，请手动填写宽高，否则无法给出预估。": "",
  ...
  "该应用可以代表你发起 AI 请求，产生的费用将从你的账户余额中扣除。": "",
  该应用将获得以下权限: "",
  该应用暂无登录会话: "",
  "该数据可能不可信，请谨慎使用": "Ces données peuvent ne pas être fiables, veuillez les utiliser avec prudence",
  该文档可能已被移动或删除: "Ce document a peut-être été déplacé ou supprimé",
  ...
  "该模型不支持：{{list}}": "",
  "该模型不支持{{mode}}": "",
  "该模型不支持仅用参考音频生成，请再添加一张参考图或一个参考视频": "",
  该模型不支持没有参考图的参考视频生成: "",
  "该模型在{{mode}}下不接受参考图": "",
  ...
  "该模型的参考生成至少需要 {{limit}} 张参考图，仅提供参考视频或音频不被支持": "",
  ...
  该渠道暂无可处理的上游模型更新: "Ce canal n'a actuellement aucune mise à jour de modèle en amont à traiter.",
  该渠道未开启上游模型更新检测: "La détection des mises à jour du modèle en amont n'est pas activée pour ce canal",
  ...
  请使用支付宝扫码支付: "Veuillez utiliser Alipay pour scanner le code QR pour payer",
  ...
  "请先填写服务器地址，以自动生成完整的端点 URL": "Veuillez d'abord remplir l'adresse du serveur pour générer automatiquement l'URL complète du point de terminaison.",
  "请先开启并填写音频输入价格。": "Activez et renseignez d'abord le prix d'entrée audio.",
  请先新增模型或从左侧列表选择一个模型: "Veuillez d'abord ajouter un nouveau modèle ou sélectionner un modèle dans la liste de gauche",
  ...
  请先选择不低于最低额度的充值金额: "Veuillez d'abord sélectionner un montant de recharge qui n'est pas inférieur au montant minimum.",
  请先选择令牌: "",
  "请先选择供应商，再选择分组": "Sélectionnez un fournisseur, puis un groupe",
  ...
  "请在 Waffo 后台获取 API 密钥、商户 ID 以及 RSA 密钥对，并配置回调地址。": "Veuillez obtenir la clé API, l'ID marchand et la paire de clés RSA dans le backend Waffo, et configurer l'adresse de rappel.",
  ...
  请填写封禁原因: "Veuillez indiquer le motif de l'interdiction",
  "请填写当前环境对应的 Product ID": "Veuillez renseigner l'ID produit correspondant à l'environnement actuel",
  "请填写当前环境对应的 Store ID": "Veuillez renseigner le Store ID correspondant à l'environnement actuel",
  "请填写当前环境对应的商户 ID": "Merci de renseigner l'identifiant marchand correspondant à l'environnement actuel",
  请填写抬头名称: "Please enter the invoice title",
  请填写接收发票的邮箱: "Please enter the recipient email",
  "请填写渠道名称和渠道密钥！": "Veuillez saisir le nom et la clé du canal !",
  请填写部署地区: "Veuillez remplir la région de déploiement",
  请填写问题标题: "Please enter an issue title",
  ...
  "请求体超过该模型的 {{limit}} 字节上限，请减少或压缩参考素材": "",
  请求参数: "Paramètres de la demande",
  ...
  请求含参考影片: "",
  请求域名: "Domaine de requête",
  请求失败: "Échec de la demande",
  请求头: "En-tête de requête",
  请求头覆盖: "Remplacement des en-têtes de demande",
  "请求尺寸：{{size}}": "Taille demandée : {{size}}",
  "请求尺寸是发送给模型的目标值，实际输出以模型或渠道返回为准": "La taille demandée est la cible envoyée au modèle ; la sortie réelle dépend de la réponse du modèle ou du canal.",
  请求并计费模型: "Modèle de demande et de facturation",
  "请求时长: ${time}s": "Durée de la requête : ${time}s",
  请求条件调价: "Demander un ajustement du prix des conditions",
  请求次数: "Nombre de demandes",
  请求结束后多退少补: "Ajuster après la fin de la demande",
  请求规则: "règles de demande",
  ...
  请求频率: "Fréquence des requêtes",
  请点击我: "Veuillez cliquer sur moi",
  "请确保你的服务可被支付网关回调访问，并在网关侧正确配置白名单与回调地址。": "Veuillez vous assurer que votre service est accessible par le rappel de la passerelle de paiement et que la liste blanche et l'adresse de rappel sont correctement configurées du côté de la passerelle.",
  ...
  "请稍后再来查看，或联系管理员获取入群方式。": "Veuillez réessayer plus tard ou contacter l’administrateur pour obtenir une invitation.",
  "请稍后几秒重试，Turnstile 正在检查用户环境！": "Veuillez réessayer dans quelques secondes, Turnstile vérifie l'environnement utilisateur !",
  "请简单描述遇到的问题，客服会依据协助码查看你的请求与错误纪录进行排查。": "Briefly describe the problem. Using the assistance code, an agent can review your requests and error records to diagnose it.",
  ...
  请至少选择一笔在线充值订单: "Select at least one online top-up order",
  请说明需要修改的内容: "Describe what needs to change",
  ...
  '请输入 JSON 格式的密钥内容，例如：\n{\n  "type": "service_account",\n  "project_id": "your-project-id",\n  "private_key_id": "...",\n  "private_key": "...",\n  "client_email": "...",\n  "client_id": "...",\n  "auth_uri": "...",\n  "token_uri": "...",\n  "auth_provider_x509_cert_url": "...",\n  "client_x509_cert_url": "..."\n}': `Veuillez saisir le contenu de la clé au format JSON, par exemple :
{
  ...
  "请输入 Product ID": "Veuillez saisir l'ID du produit",
  "请输入 Slug": "Veuillez saisir le Slug",
  "请输入 Store ID": "Veuillez saisir l'identifiant du magasin",
  ...
  "请输入商户 ID": "Veuillez saisir l'identifiant du marchand",
  ...
  "请输入密钥！": "Veuillez saisir la clé !",
  请输入密钥前缀或尾号: "",
  "请输入封禁原因，用户会直接看到这段原因": "Veuillez saisir la raison de l'interdiction. Les utilisateurs verront directement la raison.",
  ...
  请输入支付方式名称: "Veuillez saisir le nom du mode de paiement",
  ...
  请输入有效的图片链接: "Veuillez saisir un lien d'image valide",
  ...
  请输入正确的提现金额: "Veuillez saisir le montant correct du retrait",
  ...
  请输入计划名称: "Veuillez saisir le nom du forfait",
...
Prend en charge l'utilisation du format de mappage de modèle
{
  ...
  "请选择国家/地区": "Veuillez sélectionner un pays/une région",
  请选择图片模型: "Veuillez sélectionner un modèle d'image",
  ...
  请选择触发套餐: "Veuillez sélectionner un package de déclenchement",
  ...
  请选择返利套餐: "Veuillez sélectionner un forfait de remise",
  请选择通知方式: "Veuillez sélectionner la méthode de notification",
  请选择需要封禁的模型: "Veuillez sélectionner le modèle à bannir",
  读取你的基本资料: "",
  读取你的邮箱地址: "",
  调整额度: "Ajuster le quota",
  调整额度成功: "Quota ajusté avec succès",
  调用模型排名: "Classement des modèles d'appel",
  ...
  费用预估: "Cost Estimate",
  资料已锁定: "Data locked",
  "资料已锁定，提出要求不会自动解锁；操作员判断后才会重新开放修改。": "The data is locked. Requesting a change does not unlock it — an operator decides whether to reopen editing.",
  "资料已锁定，无法直接修改。如需更改请点击「提出修改要求」，由操作员判断后重新开放。": 'The data is locked and cannot be edited directly. Use "Request a change" and an operator will decide whether to reopen it.',
  资料版本历史: "Data version history",
  资源中心: "Centre de ressources",
  资源消耗: "Consommation de ressources",
  赠送余额: "Solde des cadeaux",
  赠送内容: "Contenu gratuit",
  赠送套餐: "Forfait gratuit",
  赠送日志: "Journal de cadeaux",
  "赠送比例（%）": "Taux de don (%)",
  起: "augmenter",
  起价: "",
  起充: "Commencez à charger",
  起充额度: "Montant minimum du dépôt",
  起始时间: "Heure de début",
  超级管理员: "Super Admin",
  "超级管理员未设置充值链接！": "Le super administrateur n'a pas défini le lien de recharge !",
  "超过 {{count}} 个": "Plus que {{count}}",
  ...
  跨夜范围: "Gamme de nuit",
  跨阶梯: "à travers l'échelle",
  路径正则: "Regex de chemin",
  "路径正则（每行一个）": "Regex de chemin (un par ligne)",
  跳转: "Sauter",
  跳转支付: "",
  转大写: "Convertir en majuscule",
  转小写: "Convertir en minuscules",
  转换: "Convertir",
  轮询: "Sondage",
  ...
  软错误: "erreur logicielle",
  "轻量化易用，低成本落地": "Léger, simple d'utilisation et économique",
  较早: "",
  输入: "Entrée",
  "输入 {{price}} / 1M tokens": "Entrée {{price}} / 1M tokens",
  "输入 $/1M tokens": "Entrez les jetons $/1 M",
  ...
  "输入 Token": "Entrez le jeton",
  "输入 Token 定价": "Entrez le prix du jeton",
  "输入 Token 总量": "Entrez le montant total des jetons",
  "输入 Token 数": "Entrez le nombre de jetons",
  "输入 Token 数 (p)": "Entrez le nombre de jetons (p)",
  "输入 Token 数量，查看按当前配置的预计费用。": "Saisissez le nombre de jetons pour afficher le coût estimé en fonction de la configuration actuelle.",
  "输入 Token 数量，查看按当前配置的预计费用（不含分组倍率）。": "Saisissez le nombre de jetons pour afficher le coût estimé en fonction de la configuration actuelle (hors multiplicateur de regroupement).",
  "输入 Token 数量，查看按当前阶梯配置的预计费用。": "Saisissez le nombre de jetons pour afficher le coût estimé en fonction de la configuration actuelle du niveau.",
  "输入 Tokens 阶梯": "Entrez dans l'échelle des jetons",
  ...
  输入倍率: "Entrez le grossissement",
  输入关键词以搜索文档内容: "Saisissez un mot-clé pour rechercher dans la documentation",
  ...
  输入每次调用价格: "Entrez le prix par appel",
  "输入消息…": "Type a message…",
  ...
  "输入计费表达式...": "Saisissez l'expression de facturation...",
  ...
  输入长度: "Entrez la longueur",
  输入阶梯: "Entrez dans l'échelle",
  ...
  "输出 Token": "Jeton de sortie",
  "输出 Token 定价": "Tarification des jetons de sortie",
  "输出 Token 数": "Afficher le nombre de jetons",
  "输出 Token 数 (c)": "Afficher le nombre de jetons (c)",
  "输出 Tokens 阶梯": "Échelle de jetons de sortie",
  ...
  输出倍率: "Grossissement de sortie",
  "输出倍率 {{completionRatio}}": "Ratio de sortie {{completionRatio}}",
  输出内容记录审查: "Examen des enregistrements de contenu de sortie",
  输出格式: "",
  输出阶梯: "Échelle de sortie",
  边栏设置: "Barre latérale",
  过期于: "Expire le",
  ...
  近7天: "",
  近7天可用性: "",
  返余额: "Retourner le solde",
  返利到账: "Rabais reçu",
  返利套餐: "Forfait de remise",
  返利方式: "Méthode de remise",
  返利百分比: "Pourcentage de remise",
  返利结果: "Résultats des remises",
  返利规则: "Règles de remise",
  返回修改: "Revenir pour modifier",
  返回文档首页: "Retour à l'accueil de la doc",
  返回登录: "Retour à la connexion",
  返回错误: "erreur de retour",
  返套餐: "Colis de retour",
  "这个公式比较复杂，下面的简化表单没法完整还原，请在表达式编辑模式下修改。": "Cette formule est relativement complexe et ne peut être entièrement restituée par le formulaire simplifié ci-dessous. Veuillez le modifier en mode édition d'expression.",
  ...
  这里会显示生成结果: "Les résultats générés seront affichés ici",
  这里会显示视频结果: "",
  ...
  "这里配置 Waffo 下展示给用户的 Card、Apple Pay、Google Pay 等子支付方式。": "Configurez ici la carte, Apple Pay, Google Pay et autres méthodes de sous-paiement affichées à l'utilisateur sous Waffo.",
  "这里配置代理用户的默认首充和复充分成比例。单个用户如关闭“使用系统默认比例”，则以用户自身设置为准。": "Ici, le premier dépôt par défaut et le montant du remboursement de l'utilisateur agent sont configurés pour être proportionnels. Si un seul utilisateur désactive « Utiliser le rapport par défaut du système », les paramètres de l'utilisateur prévaudront.",
  进入此档额外收费: "Il y a des frais supplémentaires pour saisir ce fichier",
  进度: "calendrier",
  进行中: "En cours",
  ...
  退出会话失败: "",
  退出其他所有设备: "",
  "退出后该次登录将立即失效，其令牌会被吊销，需要重新登录。": "",
  "退出后该设备需要重新登录才能访问你的账户。": "",
  退出设备: "",
  退出设备失败: "",
  退款: "Remboursement",
  "适合任务类等按次收费模型。": "Convient aux modèles de tâches facturés à la requête.",
  ...
  "适用于统一下单返回 payUrl 的聚合支付网关。当前接入包含：下单、异步回调验签和充值入账。": "Une passerelle de paiement d'agrégation adaptée au retour de commande unifié payUrl. L'accès actuel comprend : la passation de commande, la vérification de la signature de rappel asynchrone et le rechargement du compte.",
  ...
  "选择金额后直接跳转到 Waffo Pancake 结账页，支付完成后会回到账户页。": "Après avoir sélectionné le montant, vous accéderez directement à la page de paiement de Waffo Pancake. Une fois le paiement effectué, vous reviendrez à la page du compte.",
  "选择预设...": "Sélectionnez un préréglage...",
  "选择预设模板（可选）": "Sélectionner un modèle prédéfini (optionnel)",
  透传请求体: "Corps de transmission",
  透传请求头: "En-tête de requête transparent",
  递归: "Récursif",
  递归策略: "Stratégie récursive",
  通义千问: "Qwen",
  通用缓存: "Cache universel",
  通用设置: "Général",
  通知: "Avis",
  ...
  邀请流水: "Inviter l'eau courante",
  邀请用户: "Utilisateurs invités",
  邀请用户数: "Nombre d'utilisateurs invités",
  "邀请的好友越多，获得的奖励越多": "Plus vous invitez d'amis, plus vous obtiendrez de récompenses",
  邀请码: "Code d'invitation",
  邀请码奖励: "Récompense du code d'invitation",
  邀请码已复制: "Le code d'invitation a été copié",
  邀请获得额度: "Quota d'invitation",
  邀请计划: "plan d'invitation",
  "邀请计划会在被邀请用户每次充值时向其邀请人返利（仅返利一层，订阅购买仍仅首次）。": "Le programme reverse une commission au parrain à chaque recharge du filleul (un seul niveau ; les achats d'abonnement ne sont rétribués qu'au premier paiement).",
  邀请返利: "Remise sur invitation",
  邀请返利规则配置: "Configuration des règles de remise sur invitation",
  邀请链接: "Lien d'invitation",
  邀请链接已复制: "Lien d'invitation copié",
  ...
  邮箱字段: "Champ de courrier électronique",
  ...
  "配置 Waffo 充值时可用的支付方式，保存后在充值页面展示给用户。": "Configurez les modes de paiement disponibles lors de la recharge de Waffo, et enregistrez-les pour les afficher à l'utilisateur sur la page de recharge.",
  "配置 WeChat Server": "Configurer le serveur WeChat",
  "配置：": "Configuration :",
  配置价: "",
  "配置到 CC Switch": "",
  "配置各工具的调用价格（$/1K次调用）。按次计费模型不额外收取工具费用。": "Configurez le prix d'appel de chaque outil ($/1K appels). Il n'y a pas de frais d'outils supplémentaires pour le modèle à la carte.",
  "配置后会在所有渠道请求中统一拼接到系统提示词前，可用于全局内容过滤": "Après la configuration, il sera uniformément épissé avant le mot d'invite du système dans toutes les requêtes de canal et pourra être utilisé pour le filtrage de contenu global.",
  ...
  "配置计划名称、启用状态、优先级和备注": "Configurer le nom du plan, l'état d'activation, la priorité et les commentaires",
  ...
  重新发送: "Renvoyer",
  重新生成: "Régénérer",
  重新生成协助码: "Reissue assistance code",
  "重新生成后，旧的协助码会立即失效，请把新的协助码提供给客服。": "The previous code stops working immediately. Give the new code to your support agent.",
  ...
  长度: "longueur",
  长期有效: "Efficace depuis longtemps",
  问题: "Issue",
  问题描述: "Description",
  问题标题: "Titre de la question",
  队列中: "En file d'attente",
  阶: "niveau",
  "阶梯内 Token 数": "Nombre de jetons dans le ladder",
  阶梯判断依据: "Base de jugement en échelle",
  阶梯序号: "Numéro d'échelle",
  阶梯累进: "Progression de l'échelle",
  阶梯计费: "Facturation échelonnée",
  "阶梯计费（表达式解析失败）": "Facturation échelonnée (échec de l'analyse des expressions)",
  阶梯计费详情: "Détails de facturation hiérarchisée",
  阶梯配置摘要: "Résumé de la configuration de l'échelle",
  ...
  音频补全倍率: "taux d'achèvement audio",
  ...
  音频输入倍率: "Agrandissement de l'entrée audio",
  ...
  预估: "",
  "预估 = 宽 × 高 × 帧率 × 时长 ÷ 1024 得到影片补全 tokens，再乘以所选费率。仅供参考，实际以上游返回的 usage.completion_tokens 结算。": "",
  预估总费用: "Estimated Total Cost",
  预估环境: "Environnement estimé",
  ...
  首充: "Première charge",
  首充佣金: "Commission de premier dépôt",
  首充分成比例: "Entièrement proportionnel",
  首充用户: "Premier utilisateur de recharge",
  "首充赠送最大额度不能小于 0": "Le montant maximum du cadeau de premier dépôt ne peut être inférieur à 0",
  "首充赠送比例不能小于 0": "Le ratio du bonus de premier dépôt ne peut pas être inférieur à 0",
  首充赠送结束时间: "Heure de fin du bonus de premier dépôt",
  "首充赠送起充额度不能小于 0": "Le montant minimum du dépôt pour le bonus de premier dépôt ne peut pas être inférieur à 0",
  "首单已消费，但未命中返利计划": "La première commande a été consommée, mais le plan de remise n'a pas été sélectionné.",
  首单状态: "Statut de la première commande",
  首尾帧生成: "",
  首尾生视频: "Vidéo de début et de fin",
  首帧: "Première image",
  "首帧/尾帧图不能与参考图混用": "",
  "首帧/尾帧图不能与参考视频或参考音频同时使用": "",
  首帧生成: "",
  首帧生视频: "Vidéo à partir de la première image",
  首页: "Accueil",
  ...
  高危操作确认: "Confirmation des opérations à haut risque",
  高危状态码重试风险告知与免责声明Markdown: "Notification de risque de nouvelle tentative de code d'état à haut risque et clause de non-responsabilité",
  高危状态码重试风险确认输入文本: "Texte d'entrée de confirmation de risque de nouvelle tentative de code d'état de risque élevé",
  高危状态码重试风险确认项1: "Code d'état à haut risque, nouvelle tentative, élément de confirmation du risque 1",
  高危状态码重试风险确认项2: "Élément 2 de confirmation du risque de nouvelle tentative du code d'état à haut risque",
  高危状态码重试风险确认项3: "Élément 3 de confirmation du risque de nouvelle tentative du code d'état à haut risque",
  高危状态码重试风险确认项4: "Élément 4 de confirmation du risque de nouvelle tentative du code d'état à haut risque",
  高危状态码重试风险输入不匹配提示: "Invite de non-concordance d'entrée de risque de nouvelle tentative de code d'état à haut risque",
  高危状态码重试风险输入框占位文案: "Copie de l'espace réservé de la zone de saisie du risque de nouvelle tentative du code d'état à haut risque",
  高并发接口调度: "Planification haute concurrence",
  高度: "",
  高效: "",
  高级: "Avancé",
  ...
  "默认使用 USD 结算": "Le règlement en USD est utilisé par défaut",
  ...
  默认复充分成比例: "Le complexe par défaut est entièrement proportionnel",
  默认异步回调地址: "Adresse de rappel asynchrone par défaut",
  ...
  默认比例: "Échelle par défaut",
  默认测试模型: "Modèle de test par défaut",
  默认用户消息: "Bonjour",
  默认补全倍率: "Taux de complétion par défaut",
  默认首充分成比例: "Le premier par défaut est entièrement proportionnel",
  "关闭后客服将不再处理该案件，协助定位码也会停止使用。": "After closure, support will stop handling the case and the assistance locator will stop working.",
  协助定位码: "Assistance locator",
  "协助码仅用于客服定位案件，不能用于登录；案件关闭后停止使用，永久案件编号仍可用于历史查询。客服收到协助码后，才能在客服后台定位案件并查看已授权的协助案件及其允许的资料进行排查。客服协助不是网站内的在线客服，网站不提供即时聊天，实际沟通请在微信群完成。": "Le code d'assistance sert uniquement à retrouver votre dossier et ne permet pas de se connecter. Il cesse de fonctionner à la fermeture du dossier, tandis que le numéro permanent reste disponible pour l'historique. Après réception du code, le support peut retrouver le dossier dans sa console et examiner les données autorisées. Il ne s'agit pas d'un chat en ligne : le site n'offre pas de messagerie instantanée et les échanges ont lieu dans le groupe WeChat.",
  协助定位码已更新: "Assistance locator updated",
  "遇到问题请先在网站提交“请求协助”，提交后会取得永久案件编号和六位协助码（协助定位码），请将该码带到微信群发给客服。": "En cas de problème, envoyez d'abord une demande « Demander de l'assistance » sur le site. Vous recevrez un numéro de dossier permanent et un code d'assistance à six caractères (code de localisation) à transmettre au support dans le groupe WeChat.",
  处理截止时间: "Handling deadline",
  案件编号: "Case number",
  "客服协助与工单是两个不同功能，客服协助不是在线客服，也不是工单对话；如需正式提交和跟进工单，请使用工单功能。请在下方描述问题，提交后将协助码带到微信群发给客服。": "L'assistance et les tickets sont deux fonctions distinctes. L'assistance n'est ni un chat en ligne ni une conversation de ticket. Utilisez la fonction de ticket pour une demande et un suivi formels. Décrivez le problème ci-dessous, puis transmettez le code au support dans le groupe WeChat.",
  重新生成协助定位码: "Regenerate assistance locator",
  "重新生成后，旧的协助定位码会立即停止使用；永久案件编号不会改变。": "After regeneration, the old assistance locator stops working immediately; the permanent case number does not change."
}, t = {
  translation: e
};
export {
