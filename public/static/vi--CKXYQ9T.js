const n = {
  ...
  "。在契约恢复之前无法生成视频。": "",
  "（共 {{total}} 个，省略 {{omit}} 个）": "(Tổng cộng {{total}}, {{omit}} bị bỏ qua)",
  "（共 {{total}} 个）": "(Tổng cộng {{total}})",
  "（可自动）": "",
  "（当前仅支持易支付接口，默认使用上方服务器地址作为回调地址！）": "(Hiện tại chỉ hỗ trợ giao diện Thanh toán dễ dàng và địa chỉ máy chủ ở trên được sử dụng làm địa chỉ gọi lại theo mặc định!)",
  ...
  "{{count}} 条结果": "{{count}} kết quả",
  "{{count}} 项操作_other": "Hoạt động {{count}}",
  "{{discount}}折": "giá {{discount}}/10",
  "{{discount}}折 · 省 {{percent}}%": "Giá {{discount}}/10 · tiết kiệm {{percent}}%",
  "{{inputDesc}} + {{outputDesc}}{{extraServices}} = {{symbol}}{{total}}": "{{inputDesc}} + {{outputDesc}}{{extraServices}} = {{symbol}}{{total}}",
  "{{label}} {{price}} / 1M tokens": "{{label}} {{price}} / 1M token",
  "{{min}} - {{max}} 秒": "",
  ...
  "$/次": "$/lần",
  "0 - 最低": "0 - Thấp nhất",
  "0 表示不设上限": "0 có nghĩa là không có giới hạn trên",
  "0 表示不限": "0 nghĩa là không giới hạn",
  "0 表示无限次": "0 có nghĩa là không giới hạn số lần",
  "0.002-1之间的小数": "Số thập phân giữa 0.002-1",
  "0.1以上的小数": "Số thập phân trên 0.1",
  "0=周日 1=周一 2=周二 3=周三 4=周四 5=周五 6=周六": "0=Chủ Nhật 1=Thứ Hai 2=Thứ Ba 3=Thứ Tư 4=Thứ Năm 5=Thứ Sáu 6=Thứ Bảy",
  "1:1 正方形": "1:1 Vuông",
  ...
  "1=一月 ... 12=十二月": "1=Tháng Giêng... 12=Tháng Mười Hai",
  "10 - 最高": "10 - Cao nhất",
  "100 次/秒": "100 lần/giây",
  "15天": "",
  ...
  "1h缓存创建价格：{{symbol}}{{price}} / 1M tokens": "Giá tạo bộ nhớ đệm 1h: {{symbol}}{{price}} / 1M tokens",
  "1M图片输入": "Đầu vào hình ảnh 1M",
  "1M缓存创建": "Tạo bộ đệm 1M",
  "1M输入（不含缓存）": "Đầu vào 1M (không bao gồm bộ đệm)",
  "1M输入（含缓存）": "Đầu vào 1M (bao gồm bộ đệm)",
  "1M输出": "đầu ra 1M",
  "2 - 低": "2 - Thấp",
  "2:3 竖向": "2:3 Dọc",
  ...
  "30天": "",
  "32位密钥，敏感信息不显示": "Khóa 32 bit, thông tin nhạy cảm không được hiển thị",
  "360智脑": "360 AI Brain",
  ...
  "anthropic-beta JSON 示例": "ví dụ JSON của nhân loại-beta",
  "API Key": "API Key",
  ...
  "API 密钥": "Khóa API",
  "API 密钥 (沙盒)": "Khóa API (Hộp cát)",
  "API 密钥 (生产)": "Khóa API (sản xuất)",
  "API 密钥（测试环境）": "Khóa API (môi trường thử nghiệm)",
  "API 密钥（生产环境）": "Khóa API (môi trường sản xuất)",
  "API 指南": "Hướng dẫn API",
  "API 文档": "Tài liệu API",
  "API 私钥": "Khóa riêng API",
  "API 私钥（测试环境）": "Khóa riêng API (môi trường thử nghiệm)",
  "API 私钥（生产环境）": "Khóa riêng API (môi trường sản xuất)",
  "API 配置": "Cấu hình API",
  ...
  "BLG 支付设置": "Cài đặt thanh toán BLG",
  ...
  "DALL·E 3 横向": "DALL·E 3 Ngang",
  "DALL·E 3 竖向": "DALL·E 3 Dọc",
  ...
  "Hook 管理": "Quản lý móc",
  "ICP/EDI经营许可证编号": "Số giấy phép kinh doanh ICP/EDI",
  ICP备案号: "Số đăng ký ICP",
  ID: "ID",
  ...
  "JSON 必须是对象": "JSON phải là một đối tượng",
  ...
  "LLM 辅助设计提示词": "Lời nhắc thiết kế phụ trợ LLM",
  ...
  "OAuth 登录失败：": "Đăng nhập OAuth không thành công:",
  "OAuth 端点": "Endpoint OAuth",
  "OAuth 配置错误：授权端点必须是完整的 URL（以 http:// 或 https:// 开头）": "Lỗi cấu hình OAuth: Điểm cuối ủy quyền phải là một URL đầy đủ (bắt đầu bằng http:// hoặc https://)",
  OIDC: "OIDC",
  "OIDC ID": "OIDC ID",
  ...
  "Pay Method Name": "Tên phương thức thanh toán",
  "Pay Method Type": "Loại phương thức thanh toán",
  ...
  "RSA 私钥 (沙盒)": "Khóa riêng RSA (hộp cát)",
  "RSA 私钥 (生产)": "Khóa riêng RSA (sản xuất)",
  ...
  "Token 估算器": "Công cụ ước tính mã thông báo",
  "Token 用量范围": "Phạm vi sử dụng mã thông báo",
  "Token 类型": "Loại mã thông báo",
  "TokenRouter项目仓库地址：": "Địa chỉ kho dự án TokenRouter:",
  ...
  "User Prompt Prefix": "Tiền tố lời nhắc của người dùng",
  ...
  "Waffo API 参数，可空，例如：CREDITCARD,DEBITCARD（最多64位）": "Tham số API Waffo, có thể trống, ví dụ: CREDITCARD, DEBITCARD (tối đa 64 bit)",
  "Waffo API 参数，可空（最多64位）": "Tham số API Waffo, có thể trống (tối đa 64 bit)",
  "Waffo Pancake": "bánh quế",
  "Waffo Pancake 设置": "Cài đặt bánh kếp Waffo",
  "Waffo 充值": "nạp tiền bánh quế",
  "Waffo 充值的最低数量，默认 1": "Số lần nạp Waffo tối thiểu, mặc định 1",
  "Waffo 公钥 (沙盒)": "Khóa công khai Waffo (hộp cát)",
  "Waffo 公钥 (生产)": "Khóa công khai Waffo (sản xuất)",
  "Waffo 公钥（测试环境）": "Khóa công khai Waffo (môi trường thử nghiệm)",
  "Waffo 公钥（生产环境）": "Khóa công khai Waffo (môi trường sản xuất)",
  "Waffo 商户 ID": "ID người bán bánh quế",
  "Waffo 当前使用 USD 结算": "Waffo hiện sử dụng thanh toán bằng USD",
  "Waffo 是一个支付聚合平台，支持多种支付方式。": "Waffo là một nền tảng tổng hợp thanh toán hỗ trợ nhiều phương thức thanh toán.",
  "Waffo 设置": "Cài đặt bánh quế",
  ...
  "Webhook 公钥": "Khóa công khai Webhook",
  "Webhook 公钥（测试环境）": "Khóa công khai Webhook (môi trường thử nghiệm)",
  "Webhook 公钥（生产环境）": "Khóa công khai Webhook (môi trường sản xuất)",
  ...
  'X 也可以小于 1，当折扣用。想做"只给输出加价"或"额外加固定费用"，请直接写完整计费公式。': 'X cũng có thể nhỏ hơn 1, được sử dụng như một khoản giảm giá. Nếu bạn muốn "chỉ thêm giá vào đầu ra" hoặc "thêm một khoản phí cố định bổ sung", vui lòng viết trực tiếp công thức thanh toán đầy đủ.',
  一个平台管理多种企业服务: "Manage enterprise services in one platform",
  一个月: "Một tháng",
  一天: "Một ngày",
  一小时: "Một giờ",
  一次性余额充值: "Nạp tiền số dư một lần",
  "一次性支付，付款后自动返回": "Thanh toán một lần, tự động trả lại sau khi thanh toán",
  ...
  上一步: "Trước",
  上一页: "Trang trước",
  "上传 PNG/JPG/SVG 图片，建议尺寸 ≤ 128×128px": "Tải lên hình ảnh PNG/JPG/SVG, kích thước khuyến nghị ≤ 128×128px",
  上传参考图: "Tải lên hình ảnh tham khảo",
  上传后将在这里预览参考图: "Ảnh tham chiếu sẽ được xem trước tại đây sau khi thêm",
  上传图片: "Tải ảnh lên",
  上传失败: "Tải lên thất bại",
  上传微信群二维码图片: "Tải lên ảnh mã QR nhóm WeChat",
  "上次保存: ": "Lần lưu cuối: ",
  上次检测到可加入模型: "Mô hình có thể tham gia được phát hiện lần cuối",
  上次检测时间: "Thời gian phát hiện lần cuối",
  上游价格同步: "Đồng bộ hóa giá thượng nguồn",
  上游倍率同步: "Đồng bộ hóa tỷ lệ thượng nguồn",
  上游已删除的模型: "Mô hình đã xóa ngược dòng",
  ...
  下一页: "Trang sau",
  下午好: "Chào buổi chiều",
  下单地址: "Địa chỉ đặt hàng",
  下单总数: "Tổng số đơn đặt hàng",
  下单数: "Số lượng đơn đặt hàng",
  下载: "tải về",
  下载文件: "",
  下载日志: "Download Logs",
  下载管理员发布的安装包和资料: "Tải xuống gói cài đặt và thông tin do quản trị viên cung cấp",
  ...
  "下面是带注释的示例，仅用于参考；实际保存时请删除注释。": "Sau đây là ví dụ có chú thích chỉ để tham khảo; vui lòng xóa chú thích khi thực sự lưu.",
  ...
  个人开发调试: "Phát triển & gỡ lỗi cá nhân",
  ...
  中午好: "Chào buổi trưa",
  中小企业业务对接: "Kết nối nghiệp vụ DNVVN",
  ...
  为模型前缀覆盖: "Ghi đè tiền tố mô hình",
  ...
  为默认价格: "là giá mặc định",
  主导航: "",
  主模型: "Model chính",
  主页链接填: "Nhập liên kết trang chủ",
  之前的所有日志: "Tất cả nhật ký trước đó",
  事件自动化和回调管理: "Tự động hóa sự kiện và quản lý cuộc gọi lại",
  ...
  仅提交已勾选: "Gửi chỉ được kiểm tra",
  仅支持: "Chỉ hỗ trợ",
  "仅支持 JPEG / PNG / WebP 格式的图片": "Chỉ hỗ trợ ảnh định dạng JPEG / PNG / WebP",
  ...
  仅支持上传图片文件: "Chỉ hỗ trợ upload file hình ảnh",
  仅显示已绑定: "Chỉ hiển thị đã liên kết",
  仅显示矛盾倍率: "Chỉ hiển thị tỷ lệ mâu thuẫn",
  仅检测上游模型更新: "Chỉ phát hiện các cập nhật mô hình ngược dòng",
  ...
  仅用钱包: "Chỉ dùng ví",
  "仅管理员可用。开启后，当系统定时检测全部渠道发现上游模型变更或检测异常时，将按你选择的通知方式发送汇总通知；渠道或模型过多时会自动省略部分明细。": "Chỉ có sẵn cho quản trị viên. Sau khi bật lên, khi hệ thống thường xuyên phát hiện tất cả các kênh và phát hiện các thay đổi của mô hình ngược dòng hoặc phát hiện điểm bất thường thì sẽ gửi thông báo tóm tắt theo phương thức thông báo bạn chọn; nếu có quá nhiều kênh hoặc mô hình, một số chi tiết sẽ tự động bị bỏ qua.",
  "仅统计成功充值订单，按完成时间归档。": "Chỉ những lệnh nạp tiền thành công mới được tính và lưu trữ theo thời gian hoàn thành.",
  仅自己: "chỉ có mình tôi",
  仅重置配置: "Chỉ đặt lại cấu hình",
  今日充值: "Nạp tiền ngay hôm nay",
  今日关闭: "Đóng hôm nay",
  今日已签到: "Đã đăng nhập hôm nay",
  "今日已签到，累计签到": "Đã đăng nhập hôm nay, tổng số lần đăng nhập",
  今日盈利: "Lợi nhuận hôm nay",
  今日调用: "Lượt gọi hôm nay",
  仍有未处理项: "Vẫn còn những mặt hàng chưa được xử lý",
  ...
  付款完成后将自动回到账户页: "Sau khi thanh toán hoàn tất, bạn sẽ tự động quay lại trang tài khoản",
  付费用户: "người dùng trả tiền",
  代理佣金已扣减: "Hoa hồng đại lý đã được khấu trừ",
  代理分销: "Đại lý phân phối",
  "代理分销信息加载中...": "Đang tải thông tin phân phối đại lý...",
  "代理分销比例不能大于 100": "Tỷ lệ phân phối đại lý không được lớn hơn 100",
  "代理分销比例不能小于 0": "Tỷ lệ phân bổ đại lý không thể nhỏ hơn 0",
  代理分销默认配置: "Cấu hình mặc định phân phối đại lý",
  代理地址: "Địa chỉ proxy",
  代理已启用: "đã bật proxy",
  代理设置: "Cài đặt proxy",
  "代理邀请码、邀请用户和佣金流水": "Mã mời đại lý, người dùng được mời và quy trình hoa hồng",
  代码已复制到剪贴板: "Mã đã được sao chép vào khay nhớ tạm",
  代码示例: "",
  "代表你发起 AI 请求（费用记在你的账户）": "",
  令牌: "Mã thông báo",
  "令牌 / 密钥": "",
  令牌不存在: "Mã thông báo không tồn tại",
  ...
  "价格为参考估算，实际计费以模型、渠道为准": "Giá chỉ mang tính tham khảo; chi phí thực tế phụ thuộc vào mô hình và kênh.",
  价格可视化对比: "So sánh trực quan về giá",
  价格摘要: "Tóm tắt giá",
  "价格暂时不可用，请稍后重试": "Price temporarily unavailable, please try again later",
  价格根据用量档位和请求条件动态调整: "Giá được điều chỉnh linh hoạt dựa trên mức độ sử dụng và điều kiện yêu cầu",
  价格模式: "mô hình giá",
  ...
  "企业级稳定，高可用运行": "Ổn định cấp doanh nghiệp, vận hành sẵn sàng cao",
  ...
  余额地址: "Địa chỉ số dư",
  余额返利: "Giảm giá số dư",
  "余额返利直接返到邀请人的钱包余额；套餐返利会正常执行套餐分组升级": "Số dư giảm giá sẽ được trả trực tiếp vào số dư ví của người mời; gói giảm giá sẽ được nâng cấp lên nhóm gói bình thường.",
  "余额返利直接返到邀请人钱包；套餐返利会按套餐自身规则执行分组升级": "Số dư hoàn trả sẽ được trả lại trực tiếp vào ví của người mời; Ưu đãi giảm giá gói sẽ được nhóm và nâng cấp theo quy định riêng của gói.",
  作废: "Vô hiệu",
  作废于: "Vô hiệu vào",
  ...
  "你还没有处理{{type}}模型（{{count}}个）。是否仅提交当前已勾选内容？_other": "Bạn chưa xử lý mẫu {{type}} ({{count}}). Bạn có muốn chỉ gửi nội dung hiện được kiểm tra không?",
  你还没有授权任何应用: "",
  佣金余额: "Số dư hoa hồng",
  "佣金支出 / 净流入": "Chi phí hoa hồng / dòng tiền ròng",
  佣金流水: "Lịch sử hoa hồng",
  佣金订单数: "Số lệnh hoa hồng",
  佣金记录: "hồ sơ ủy ban",
  ...
  使用模式: "Chế độ sử dụng",
  使用系统默认比例: "Sử dụng thang đo mặc định của hệ thống",
  ...
  "例如 €, £, Rp, ₩, ₹...": "Ví dụ, €, £, Rp, ₩, ₹...",
  "例如 0.5 或 2": "Ví dụ 0,5 hoặc 2",
  "例如 10 表示新用户首充成功后，代理可获得实付金额的 10%": "Ví dụ: 10 có nghĩa là sau khi người dùng mới gửi tiền thành công lần đầu tiên, đại lý sẽ nhận được 10% số tiền thanh toán thực tế.",
  "例如 901": "Ví dụ 901",
  "例如 anthropic-beta": "Ví dụ: humanpic-beta",
  "例如 https://docs.newapi.pro": "Ví dụ, https://docs.newapi.pro",
  "例如 https://example.com/api/mch/balance": "Ví dụ https://example.com/api/mch/balance",
  "例如 https://example.com/api/pay/query": "Ví dụ https://example.com/api/pay/query",
  "例如 https://example.com/api/pay/unifiedorder": "Ví dụ https://example.com/api/pay/unifiedorder",
  "例如 https://example.com/api/waffo/webhook": "Ví dụ https://example.com/api/waffo/webhook",
  "例如 https://example.com/console/topup": "Ví dụ https://example.com/console/topup",
  "例如 M1776096808": "Ví dụ M1776096808",
  "例如 service_tier": "Ví dụ: dịch vụ_tier",
  "例如：": "Ví dụ:",
  ...
  "例如：Credit Card": "Ví dụ: Thẻ tín dụng",
  "例如：email": "VD: email",
  ...
  "例如：github-enterprise": "VD: github-enterprise",
  "例如：gpt-4.1-nano,regex:^claude-.*$,regex:^sora-.*$": "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
  ...
  "例如：MER_xxx": "Ví dụ: MER_xxx",
  "例如：name、full_name": "VD: name, full_name",
  "例如：nginx:latest": "e.g.: nginx:latest",
  "例如：preferred_username、login": "VD: preferred_username, login",
  "例如：preview": "ví dụ: preview",
  "例如：price_xxx": "Ví dụ: giá_xxx",
  "例如：prod_6I8rBerHpPxyoiU9WK4kot": "Ví dụ: prod_6I8rBerHpPxyoiU9WK4kot",
  "例如：PROD_xxx": "Ví dụ: PROD_xxx",
  "例如：sk_xxx 或 rk_xxx，留空表示保持当前不变": "Ví dụ: sk_xxx hoặc rk_xxx, để trống để giữ nguyên giá trị hiện tại",
  "例如：STO_xxx": "Ví dụ: STO_xxx",
  "例如：sub、id、data.user.id": "VD: sub, id, data.user.id",
  "例如：whsec_xxx，留空表示保持当前不变": "Ví dụ: whsec_xxx, để trống để giữ nguyên giá trị hiện tại",
  ...
  "例如：清理工具参数，避免上游校验错误": "Ví dụ: Làm sạch các thông số công cụ để tránh lỗi xác minh ngược dòng",
  ...
  保存代理分销默认配置: "Lưu cấu hình mặc định phân phối đại lý",
  保存修改: "Lưu thay đổi",
  保存内容审查配置: "Lưu cấu hình xem xét nội dung",
  保存分组倍率设置: "Lưu cài đặt tỷ lệ nhóm",
  保存分组相关设置: "Lưu cài đặt liên quan đến nhóm",
  "保存后不会回显，请填写当前环境对应的 API 私钥": "Nó sẽ không được lặp lại sau khi lưu. Vui lòng điền khóa riêng API tương ứng với môi trường hiện tại.",
  "保存后不会回显，请填写当前环境对应的 Stripe API 密钥": "Nó sẽ không được lặp lại sau khi lưu. Vui lòng điền khóa API Stripe tương ứng với môi trường hiện tại.",
  "保存后不会回显，请填写测试环境对应的 API 密钥": "Nó sẽ không được lặp lại sau khi lưu. Vui lòng điền khóa API tương ứng với môi trường thử nghiệm.",
  "保存后不会回显，请填写测试环境对应的 API 私钥": "Nó sẽ không được lặp lại sau khi lưu. Vui lòng điền khóa riêng API tương ứng với môi trường thử nghiệm.",
  "保存后不会回显，请填写生产环境对应的 API 密钥": "Nó sẽ không được lặp lại sau khi lưu. Vui lòng điền khóa API tương ứng với môi trường sản xuất.",
  "保存后不会回显，请填写生产环境对应的 API 私钥": "Nó sẽ không được lặp lại sau khi lưu. Vui lòng điền khóa riêng API tương ứng với môi trường sản xuất.",
  ...
  倍率模式: "Chế độ tỷ lệ",
  "倍率模式（默认）": "Chế độ phóng to (mặc định)",
  ...
  元: "CNY",
  充值: "Nạp tiền",
  充值与佣金金额趋势: "Xu hướng về số tiền nạp và hoa hồng",
  "充值价格（x元/美金）": "Giá nạp (x tệ/đô la)",
  "充值价格必须大于 0": "Giá nạp tiền phải lớn hơn 0",
  充值价格显示: "Giá nạp",
  充值分组倍率: "Tỷ lệ nhóm nạp tiền",
  "充值分组倍率不是合法的 JSON 字符串": "Tỷ lệ nhóm nạp tiền không phải là chuỗi JSON hợp lệ",
  充值完成后跳回的页面: "Trang để quay lại sau khi nạp tiền xong",
  充值总额: "Tổng số tiền nạp lại",
  "充值成功，额度已到账": "Việc nạp tiền đã thành công và số tiền đã được nhận.",
  充值数量: "Số lượng nạp",
  "充值数量，最低 ": "Số lượng nạp, tối thiểu",
  充值数量不能大于: "Số tiền nạp không được lớn hơn",
  ...
  充值流水: "Lịch sử nạp tiền",
  充值确认: "Xác nhận nạp tiền",
  充值类型: "Loại nạp tiền",
  "充值类计划对每次充值生效，订阅类计划仅首次生效": "Kế hoạch nạp tiền áp dụng cho mỗi lần nạp; kế hoạch đăng ký chỉ áp dụng lần thanh toán đầu",
  充值订单: "Lệnh nạp tiền",
  充值记录和状态查询: "Hồ sơ nạp tiền và yêu cầu trạng thái",
  ...
  兑换额度: "Đổi",
  兜底档: "Điểm mấu chốt",
  入账时间: "Thời gian vào cửa",
  "全场景适配 · 赋能多元业务发展": "Thích ứng mọi kịch bản · Tiếp sức phát triển đa dạng nghiệp vụ",
  ...
  全局系统提示词拼接: "Nối từ nhắc nhở hệ thống toàn cầu",
  全局系统提示词豁免: "Miễn lời nhắc hệ thống toàn cục",
  全局设置: "Cài đặt toàn cầu",
  全平台: "Tất cả nền tảng",
  "全方位安全，合规可控": "An toàn toàn diện, tuân thủ và kiểm soát",
  全选: "Chọn tất cả",
  全选当前列表模型: "Chọn tất cả các mô hình danh sách hiện tại",
  全部: "Tất cả",
  ...
  全部退出: "",
  "全面适配 Web 开发、小程序、APP、政企系统、第三方平台对接等各类场景，支持多协议与多数据格式，无缝衔接各类业务系统。": "Thích ứng toàn diện với phát triển Web, mini program, APP, hệ thống chính phủ/doanh nghiệp, kết nối nền tảng bên thứ ba; hỗ trợ đa giao thức và đa định dạng dữ liệu, kết nối liền mạch mọi hệ thống nghiệp vụ.",
  公告: "Thông báo",
  ...
  关于项目: "Về dự án",
  "关键字(ID、名称或卡密)": "Từ khóa (ID, tên hoặc mã)",
  关键调用链路可审计: "",
  关闭: "Đóng",
  ...
  内容: "Nội dung",
  内容审查结果: "Kết quả xét duyệt nội dung",
  内容审查配置: "Cấu hình kiểm duyệt nội dung",
  ...
  "内置接口鉴权、访问限流、异常拦截、数据加密等多重安全机制，精准拦截恶意请求，规范接口访问规则，全方位守护企业接口数据与业务安全。": "Tích hợp sẵn xác thực API, giới hạn lưu lượng truy cập, chặn bất thường, mã hóa dữ liệu cùng nhiều cơ chế an ninh, chặn chính xác các yêu cầu độc hại, chuẩn hóa quy tắc truy cập API, bảo vệ toàn diện dữ liệu API và an toàn kinh doanh của doanh nghiệp.",
  "内联图片总大小不能超过 {{limit}}": "",
  "内联图片总大小不能超过 45 MB": "Tổng dung lượng ảnh nhúng không được vượt quá 45 MB",
  最优可用: "Tốt nhất hiện có",
  最低: "thấp nhất",
  最低充值数量: "Số tiền nạp tối thiểu",
  "最低充值数量必须大于 0": "Số tiền nạp tối thiểu phải lớn hơn 0",
  最低充值美元数量: "Số tiền nạp đô la tối thiểu",
  "最低充值美元数量必须大于 0": "Số tiền nạp đô la tối thiểu phải lớn hơn 0",
  "最低实付金额（元）": "Số tiền thanh toán thực tế tối thiểu (nhân dân tệ)",
  最低开票金额: "Minimum invoiceable amount",
  最后使用时间: "Thời gian sử dụng cuối cùng",
  最后更新: "Last Updated",
  最后登录: "lần đăng nhập cuối cùng",
  最后请求: "Yêu cầu cuối cùng",
  "最多上传 {{count}} 张参考图_other": "Tải lên tối đa hình ảnh tham khảo {{count}}",
  最多只能指定一张尾帧图: "Chỉ có thể chọn một ảnh khung hình cuối",
  最多只能指定一张首帧图: "Chỉ có thể chọn một ảnh khung hình đầu",
  "最多添加 {{limit}} 个参考视频": "Chỉ có thể thêm tối đa {{limit}} video tham chiếu",
  "最多添加 {{limit}} 个参考音频": "Chỉ có thể thêm tối đa {{limit}} âm thanh tham chiếu",
  "最多添加 {{limit}} 张参考图": "Chỉ có thể thêm tối đa {{limit}} ảnh tham chiếu",
  最大GPU数量: "Max Number of GPUs",
  最大可用: "Max Available",
  最大条目数: "Số mục tối đa",
  最大赠送额度: "Số tiền quà tặng tối đa",
  最大返利金额: "Số tiền giảm giá tối đa",
  最小充值金额: "Số tiền nạp tối thiểu",
  最终抵扣: "Khấu trừ cuối cùng",
  "最近 {{n}} 次检测": "",
  最近一次: "Lần gần nhất",
  最近事件: "Recent Events",
  最近充值: "Nạp tiền gần đây",
  最近延迟: "",
  最近更新: "",
  最近检测: "",
  最近活动: "",
  最高优先级: "highest priority",
  最高充值不能小于最低充值: "Số lần nạp tối đa không được nhỏ hơn số lần nạp tối thiểu",
  "最高实付金额（元）": "Số tiền thanh toán thực tế tối đa (nhân dân tệ)",
  最高档: "Lớp cao nhất",
  写: "Ghi",
  ...
  函数: "chức năng",
  分佣比例: "tỷ lệ hoa hồng",
  分佣订单数: "Số lệnh hoa hồng",
  "分时缓存 (Claude)": "Bộ đệm chia sẻ thời gian (Claude)",
  分档价格表: "Bảng giá theo bậc",
  分类名称: "Tên danh mục",
  分组: "Nhóm",
  分组JSON设置: "Group JSON Settings",
  分组与模型定价设置: "Nhóm & định giá mô hình",
  分组价格: "Giá nhóm",
  "分组价格 = 官方价格 × 分组倍率 ÷ 7": "Giá nhóm = giá chính thức × hệ số nhóm ÷ 7",
  分组倍率: "Tỷ lệ nhóm",
  "分组倍率 {{ratio}} × 换算 {{rate}} = 相对官方价 {{effective}}": "Hệ số nhóm {{ratio}} × quy đổi {{rate}} = {{effective}} so với giá chính thức",
  ...
  分组维度收入: "Thu nhập theo chiều nhóm",
  分组维度消耗: "Nhóm kích thước tiêu thụ",
  分组设置: "Cài đặt nhóm",
  ...
  "删除后无法恢复，且无返利记录的计划才允许删除": "Việc xóa không thể được khôi phục và các gói không có hồ sơ giảm giá được phép xóa.",
  ...
  "删除已选 {{selected}} / {{total}}": "Xóa {{selected}} / {{total}} đã chọn",
  删除成功: "Xóa thành công",
  删除所选: "Xóa đã chọn",
  ...
  "加载中...": "Đang tải...",
  加载令牌失败: "",
  加载价格配置失败: "Không tải được cấu hình giá",
  ...
  加载数据分析失败: "Không tải được phân tích dữ liệu",
  "加载日志中...": "Loading logs...",
  加载日志失败: "Không thể tải nhật ký",
  加载模型价格失败: "",
  ...
  加载邀请信息失败: "Không tải được thông tin lời mời",
  "加载隐私政策内容失败...": "Tải nội dung chính sách bảo mật thất bại...",
  动态计费: "Thanh toán động",
  ...
  匹配内容: "Nội dung phù hợp",
  匹配方式: "Phương thức khớp",
  匹配模式: "mẫu khớp",
  匹配类型: "Loại khớp",
  "区分邀请返利与代理分销带来的充值与激励支出。": "Phân biệt giữa giảm giá theo lời mời và số lần nạp tiền cũng như chi phí khuyến khích do phân phối của đại lý mang lại.",
  区域: "Khu vực",
  升级分组: "Nhóm nâng cấp",
  协助码: "Assistance code",
  ...
  "单张图片上限 {{limit}}": "",
  "单张图片大小不能超过 {{limit}}": "",
  "单张图片大小不能超过 10 MB": "Mỗi ảnh không được vượt quá 10 MB",
  单条影片价格预估: "",
  占比: "Tỷ lệ",
  卡片视图: "Chế độ xem thẻ",
  危险: "",
  "历史数据已自动按年/月/日/小时汇总，今日尾段实时计算。": "Dữ liệu lịch sử được tự động tổng hợp theo năm, tháng, ngày và giờ, còn phần đuôi của hôm nay được tính theo thời gian thực.",
  历史消耗: "Tiêu thụ",
  原价: "Giá gốc",
  ...
  参与次数: "Số lần tham gia",
  参与限制: "Hạn chế tham gia",
  参数: "tham số",
  参数传递: "Truyền tham số",
  参数值: "Giá trị tham số",
  参数覆盖: "Ghi đè tham số",
  "参数覆盖 JSON 已复制": "JSON ghi đè tham số đã được sao chép",
  参数覆盖已复制: "Đã sao chép ghi đè tham số",
  ...
  参数覆盖详情: "Chi tiết phạm vi tham số",
  参数配置: "Cấu hình tham số",
  参数配置有误: "Cấu hình tham số không hợp lệ",
  参数错误: "Lỗi tham số",
  参照生视频: "Tạo video tham chiếu",
  参考图: "Ảnh tham chiếu",
  "参考图（可选，最多 {{count}} 张）_other": "Hình ảnh tham khảo (tùy chọn, tối đa hình ảnh {{count}})",
  "参考图（可选）": "Ảnh tham chiếu (tùy chọn)",
  "参考图已上传，本次将调用图生视频流程": "",
  "参考影片时长（秒）": "",
  参考生成: "",
  "参考视频（可选）": "Video tham chiếu (tùy chọn)",
  "参考视频链接（https）": "Liên kết video tham chiếu (https)",
  "参考视频链接必须是 https 链接": "Liên kết video tham chiếu phải là liên kết https",
  参考素材上限: "",
  参考素材生视频: "Tạo video từ nội dung tham chiếu",
  "参考音频（可选）": "Âm thanh tham chiếu (tùy chọn)",
  "参考音频链接（https）": "Liên kết âm thanh tham chiếu (https)",
  "参考音频链接必须是 https 链接": "Liên kết âm thanh tham chiếu phải là liên kết https",
  参考音频需要与参考图或参考视频一起使用: "",
  友情链接: "Liên kết thân thiện",
  发布日期: "Ngày xuất bản",
  发布时间: "Thời gian xuất bản",
  发放奖励: "Phân phối phần thưởng",
  ...
  可信: "Đáng tin cậy",
  "可勾选需要执行的变更：新增会加入渠道模型列表，删除会从渠道模型列表移除。": "Bạn có thể kiểm tra những thay đổi cần thực hiện: việc thêm sẽ được thêm vào danh sách mô hình kênh và việc xóa sẽ bị xóa khỏi danh sách mô hình kênh.",
  可参与次数: "Số lần bạn có thể tham gia",
  "可参与次数按“单个邀请人”累计命中的不同被邀请用户数计算": 'Số lần có thể tham gia được tính toán dựa trên số lượng người dùng được mời khác nhau được "người mời duy nhất" tấn công.',
  可否选取: "Selectable",
  "可在设置页面设置关于内容，支持 HTML & Markdown": "Nội dung Giới thiệu có thể được đặt trên trang cài đặt, hỗ trợ HTML & Markdown",
  "可填写打款渠道、流水号或备注": "Bạn có thể điền kênh thanh toán, số serial hoặc nhận xét",
  "可手动填写，多个 scope 用空格分隔": "Có thể điền thủ công, nhiều scope phân cách bằng dấu cách",
  可用: "Khả dụng",
  可用令牌分组: "Nhóm mã thông báo khả dụng",
  可用佣金: "Hoa hồng có sẵn",
  可用分组: "Nhóm khả dụng",
  "可用变量：{{provider}} {{field}} {{op}} {{required}} {{current}} 以及 {{current.path}}": "Biến khả dụng: {{provider}} {{field}} {{op}} {{required}} {{current}} và {{current.path}}",
  可用图片模型: "Mẫu hình ảnh có sẵn",
  可用性: "",
  ...
  "可选，填写图片 URL": "Tùy chọn, điền URL hình ảnh",
  "可选，用于复现结果": "Tùy chọn, để tái tạo kết quả",
  "可选，用于记录用途": "Tùy chọn, cho mục đích ghi nhật ký",
  "可选，用量达到此档时加收的固定费用": "Tùy chọn, một khoản phí cố định sẽ được tính khi mức sử dụng đạt đến mức này",
  ...
  可配置独立密钥管理: "",
  "各渠道成功率 / 失败率": "Tỷ lệ thành công/tỷ lệ thất bại của từng kênh",
  各渠道消耗额度: "Định mức tiêu thụ của từng kênh",
  ...
  "同一用户可以有多条记录，同一个模型出现在多条记录里也会正常生效。": "Cùng một người dùng có thể có nhiều bản ghi và cùng một mô hình sẽ có hiệu lực bình thường nếu nó xuất hiện trong nhiều bản ghi.",
  "同优先级下，充值按更高金额门槛命中；套餐按更贵的触发套餐命中。": "Với cùng mức độ ưu tiên, việc nạp tiền sẽ được thực hiện theo ngưỡng số tiền cao hơn; gói sẽ được đánh theo gói kích hoạt đắt hơn.",
  同官方价: "Bằng giá gốc",
  同时满足: "Thỏa mãn cùng một lúc",
  同时重置消息: "Đặt lại tin nhắn đồng thời",
  同步: "Đồng bộ",
  同步到渠道: "Sync to Channel",
  同步向导: "Trình hướng dẫn đồng bộ",
  同步失败: "Đồng bộ hóa thất bại",
  同步字段: "trường đồng bộ hóa",
  ...
  同步返回地址: "Địa chỉ trả về đồng bộ",
  名称: "Tên",
  "名称+密钥": "Tên + Khóa",
  名称不能为空: "Tên không được để trống",
  名称匹配类型: "Loại khớp tên",
  "后：": "Sau:",
  后端固定: "đã sửa lỗi phụ trợ",
  ...
  否: "Không",
  含时间条件: "Chứa điều kiện thời gian",
  含请求条件: "Chứa điều kiện yêu cầu",
  启动: "Start",
  ...
  启用: "Bật",
  "启用 BLG 支付": "Kích hoạt thanh toán BLG",
  "启用 Prompt 检查": "Bật kiểm tra Prompt",
  "启用 Waffo": "Kích hoạt bánh quế",
  "启用 Waffo Pancake": "Kích hoạt bánh Waffo",
  ...
  启用全部: "Bật tất cả",
  启用后会按测试环境保存这组配置: "Sau khi kích hoạt, bộ cấu hình này sẽ được lưu theo môi trường thử nghiệm.",
  ...
  "启用后将使用 Waffo 沙盒环境": "Khi được bật, môi trường hộp cát Waffo sẽ được sử dụng",
  启用图片生成审查: "Bật đánh giá tạo hình ảnh",
  ...
  启用文本生成内容审查: "Bật đánh giá nội dung tạo văn bản",
  ...
  "启用首充赠送时，赠送比例必须大于 0": "Khi kích hoạt thưởng tiền gửi lần đầu, tỷ lệ tiền thưởng phải lớn hơn 0",
  启用首次充值赠送: "Kích hoạt phần thưởng nạp tiền đầu tiên",
  启用验证: "Bật xác thực",
  周: "tuần",
  ...
  "命中多个充值门槛时，会按更高门槛的计划优先": "Khi đạt nhiều ngưỡng nạp tiền, gói có ngưỡng nạp cao hơn sẽ được ưu tiên.",
  命中档位: "đánh thiết bị",
  命中活动: "hoạt động đánh",
  命中率: "Tỷ lệ trúng",
  ...
  "商户 ID": "ID người bán",
  商户号: "Mã số người bán",
  商户密钥: "Chìa khóa thương gia",
  回答内容: "Nội dung trả lời",
  "回调 URL 填": "Điền URL gọi lại",
  "回调 URL 格式": "Định dạng URL callback",
  回调地址: "Địa chỉ gọi lại",
  回调支付方式: "Phương thức thanh toán callback",
  回调调用者IP: "IP người gọi callback",
  回调通知地址: "Địa chỉ thông báo gọi lại",
  团队与项目权限细分: "",
  固定价格: "Giá cố định",
  ...
  "国家/地区信息将用于适用法律法规、监管要求、平台合规策略及模型服务范围的判定。": "Thông tin quốc gia/khu vực sẽ được sử dụng để xác định luật và quy định hiện hành, yêu cầu pháp lý, chiến lược tuân thủ nền tảng và phạm vi dịch vụ mô hình.",
  "国家/地区信息已更新": "",
  ...
  "图标文件不能超过 100KB，请压缩后重新上传": "File icon không được vượt quá 100KB, vui lòng nén lại và upload lại.",
  图混合: "Pha trộn",
  "图片/音频价格（可选）": "Giá hình ảnh/âm thanh (tùy chọn)",
  图片倍率: "Phóng to hình ảnh",
  ...
  图片生成失败: "Tạo hình ảnh không thành công",
  图片生成完成: "Quá trình tạo hình ảnh đã hoàn tất",
  "图片生成审查（作用于 /pg 和 /v1 的 images/generations、images/edits）": "Đánh giá việc tạo hình ảnh (hình ảnh/thế hệ, hình ảnh/chỉnh sửa cho /pg và /v1)",
  图片生成模型: "Mô hình tạo ảnh",
  "图片生成调用：{{symbol}}{{price}} / 1次": "Gọi tạo hình ảnh: {{symbol}}{{price}} / 1 lần",
  图片编辑完成: "Chỉnh sửa hình ảnh đã hoàn tất",
  图片设置: "Cài đặt hình ảnh",
  "图片读取失败，请重试": "Đọc ảnh thất bại, vui lòng thử lại",
  ...
  图片输入倍率: "Độ phóng đại đầu vào hình ảnh",
  ...
  "在 Stripe 后台创建价格后获得": "Nhận được sau khi tạo giá trong phần phụ trợ của Stripe",
  ...
  "填写后覆盖当前测试环境 API 密钥，留空表示保持当前不变": "Sau khi điền, hãy ghi đè khóa API của môi trường thử nghiệm hiện tại. Để trống để giữ nguyên hiện tại.",
  "填写后覆盖当前测试环境 Webhook 公钥，留空表示保持当前不变": "Sau khi điền, ghi đè khóa công khai Webhook của môi trường thử nghiệm hiện tại. Để trống để giữ nguyên hiện tại.",
  "填写后覆盖当前测试环境私钥，留空表示保持当前不变": "Sau khi điền vào, nó sẽ ghi đè khóa riêng của môi trường thử nghiệm hiện tại. Để trống để giữ nguyên hiện tại.",
  "填写后覆盖当前生产环境 API 密钥，留空表示保持当前不变": "Sau khi điền, hãy ghi đè khóa API của môi trường sản xuất hiện tại. Để trống để giữ nguyên hiện tại.",
  "填写后覆盖当前生产环境 Webhook 公钥，留空表示保持当前不变": "Sau khi điền, nó sẽ ghi đè khóa công khai Webhook của môi trường sản xuất hiện tại. Để trống để giữ nguyên hiện tại.",
  "填写后覆盖当前生产环境私钥，留空表示保持当前不变": "Sau khi điền vào, nó sẽ ghi đè khóa riêng của môi trường sản xuất hiện tại. Để trống để giữ nguyên hiện tại.",
  "填写后覆盖当前私钥，留空表示保持当前不变": "Sau khi điền xong, hãy ghi đè lên khóa riêng hiện tại. Để trống để giữ nguyên hiện tại.",
  "填写带https的域名，逗号分隔": "Điền tên miền có https, phân tách bằng dấu phẩy",
  "填写平台域名，例如：www.tokenrouter.tech": "Điền tên miền nền tảng, ví dụ: www.tokenrouter.tech",
  "填写服务器地址后自动生成：": "Tự động được tạo sau khi điền địa chỉ máy chủ:",
  "填写测试环境 Waffo 公钥，Base64 或 PEM 内容均可": "Điền vào môi trường thử nghiệm Khóa công khai Waffo, nội dung Base64 hoặc PEM có thể được sử dụng",
  "填写生产环境 Waffo 公钥，Base64 或 PEM 内容均可": "Điền vào môi trường sản xuất Khóa công khai Waffo, nội dung Base64 hoặc PEM có thể được sử dụng",
  ...
  处理上游模型更新: "Xử lý các cập nhật mô hình ngược dòng",
  处理中: "Processing",
  处理代理提现: "Quá trình rút tiền đại lý",
  处理全部渠道上游更新: "Xử lý tất cả các cập nhật ngược dòng của kênh",
  处理提现: "Đang xử lý việc rút tiền",
  备份支持: "Hỗ trợ sao lưu",
  ...
  复充: "nạp tiền",
  复充佣金: "Hoa hồng nạp tiền",
  复充分成比例: "Hoàn toàn tỷ lệ thuận",
  复充指该被邀请用户首充之后的后续成功充值订单: "Nạp tiền đề cập đến các lần nạp tiền thành công tiếp theo sau lần nạp tiền đầu tiên của người dùng được mời.",
  复制: "Sao chép",
  复制代码: "Sao chép mã",
  复制令牌: "Sao chép mã thông báo",
  复制令牌失败: "Không sao chép được mã thông báo",
  "复制以下提示词发送给 LLM（如 ChatGPT / Claude），让它帮你设计计费表达式": "Sao chép các từ gợi ý sau và gửi đến LLM (chẳng hạn như ChatGPT / Claude) và để nó giúp bạn thiết kế biểu thức thanh toán",
  ...
  复制请求头: "Sao chép tiêu đề yêu cầu",
  复制连接信息: "Sao chép thông tin kết nối",
  复制邀请码: "Sao chép mã lời mời",
  复制邀请链接: "Sao chép liên kết lời mời",
  复制配置链接: "",
  复制链接: "Copy link",
  外接设备: "Thiết bị ngoại vi",
  外部平台: "nền tảng bên ngoài",
  外部平台来源管理: "Quản lý nguồn nền tảng bên ngoài",
  多个命令用空格分隔: "Multiple commands separated by spaces",
  多场景兼容适配: "Tương thích đa kịch bản",
  ...
  天前: "ngày trước",
  失败: "Thất bại",
  "失败/过期单数": "Số lẻ không thành công/hết hạn",
  ...
  奖励记录: "Kỷ lục giải thưởng",
  奖励说明: "Mô tả phần thưởng",
  套餐: "Gói",
  套餐信息无效: "Thông tin gói không hợp lệ",
  套餐副标题: "Phụ đề gói",
  套餐名称: "Tên gói",
  套餐标题: "Tiêu đề gói",
  ...
  "如果你对接的是上游One API或者TokenRouter等转发项目，请使用OpenAI类型，不要使用此类型，除非你知道你在做什么。": "Nếu bạn đang kết nối với One API ngược dòng hoặc chuyển tiếp các dự án như TokenRouter, vui lòng sử dụng loại OpenAI. Không sử dụng loại này trừ khi bạn biết bạn đang làm gì.",
  ...
  官方价格: "Giá chính thức",
  官方价格为上游配置的原始美元基础价: "",
  "官方价格按 $1 = ￥7 折算": "Giá chính thức được quy đổi theo $1 = ¥7",
  ...
  "实时记录接口调用次数、响应状态、异常日志等数据，可视化看板直观展示运行状态，助力快速排查问题、持续优化业务。": "Ghi lại thời gian thực số lần gọi API, trạng thái phản hồi, nhật ký bất thường; bảng điều khiển trực quan hiển thị rõ trạng thái vận hành, giúp nhanh chóng truy tìm sự cố và tối ưu nghiệp vụ liên tục.",
  实时调用监控统计: "Giám sát thống kê cuộc gọi thời gian thực",
  实际: "Thực tế",
  "实际下载尺寸以模型或渠道返回的图片为准，NewAPI 不会压缩或重绘图片": "Kích thước tải xuống thực tế phụ thuộc vào hình ảnh do mô hình hoặc kênh trả về; NewAPI không nén hoặc vẽ lại hình ảnh.",
  "实际尺寸：{{size}}": "Kích thước thực tế: {{size}}",
  "实际尺寸：加载后显示": "Kích thước thực tế: hiển thị sau khi tải",
  实际模型: "Mô hình thực tế",
  实际环境: "môi trường thực tế",
  实际用量: "Mức sử dụng thực tế",
  ...
  实际额度: "Số tiền thực tế",
  "审查失败时放行（fallback）": "Phát hành khi xem xét không thành công (dự phòng)",
  审计信息: "Thông tin kiểm toán",
  客服协助: "Support assistance",
  "客服协助功能当前未开放，暂时无法在网站提交请求，请留意后续开放通知。": "Tính năng hỗ trợ hiện chưa khả dụng nên chưa thể gửi yêu cầu trên website. Vui lòng theo dõi thông báo khi tính năng được mở.",
  ...
  对应代理分销已入账佣金: "Hoa hồng đã được ghi nhận cho việc phân phối đại lý tương ứng",
  ...
  导航菜单: "",
  封禁结束时间必须晚于当前时间: "Thời gian kết thúc lệnh cấm phải muộn hơn thời gian hiện tại",
  ...
  "将把当前编辑中的模型 {{name}} 的价格配置，批量应用到已勾选的 {{count}} 个模型。_other": "Cấu hình giá của mẫu {{name}} hiện đang được chỉnh sửa sẽ được áp dụng theo đợt cho các mẫu {{count}} đã chọn.",
  ...
  将额外乘以上述价格: "Nhân số tiền thêm với giá trên",
  小于: "ít hơn",
  ...
  工具标识: "Mã công cụ",
  工具调用定价: "Định giá cuộc gọi công cụ",
  工单管理: "Quản lý trật tự công việc",
  左侧边栏个人设置: "Cài đặt cá nhân ở thanh bên trái",
  "已上传参考图，本次将调用图片编辑接口": "Hình ảnh tham khảo đã được tải lên. Lúc này giao diện chỉnh sửa ảnh sẽ được gọi.",
  ...
  "已勾选 {{count}} 个模型_other": "Đã kiểm tra các mẫu {{count}}",
  ...
  已处理: "Resolved",
  "已处理上游模型更新：加入 {{added}} 个，删除 {{removed}} 个，本次忽略 {{ignored}} 个，当前已忽略模型 {{totalIgnored}} 个": "Đã xử lý các bản cập nhật mô hình ngược dòng: {{added}} đã thêm, {{removed}} đã xóa, {{ignored}} bị bỏ qua lần này, mô hình {{totalIgnored}} hiện bị bỏ qua",
  已备份: "Đã sao lưu",
  已复制: "Đã sao chép",
  ...
  "已将模型 {{name}} 的价格配置批量应用到 {{count}} 个模型_other": "Cấu hình giá của model {{name}} đã được áp dụng hàng loạt cho các model {{count}}",
  已开启: "Đã bật",
  ...
  "已批量处理上游模型更新：渠道 {{channels}} 个，加入 {{added}} 个，删除 {{removed}} 个，失败 {{fails}} 个": "Các bản cập nhật mô hình ngược dòng đã được xử lý theo đợt: kênh {{channels}}, {{added}} đã thêm, {{removed}} đã xóa, {{fails}} không thành công",
  已拉取: "kéo",
  已拒绝: "Rejected",
  已授权应用: "",
  已提交: "Đã gửi",
  ...
  已注销: "Đã đăng xuất",
  已消耗额度: "",
  "已消费，但暂未命中返利计划": "Đã chi tiêu, nhưng chưa khớp kế hoạch hoàn tiền",
  已消费用户数: "Số lượng người dùng đã tiêu dùng",
  已添加: "Đã thêm",
  ...
  "已清理 {{count}} 个日志文件，释放 {{size}}_other": "Đã làm sạch các tệp nhật ký {{count}}, phát hành {{size}}",
  已清空: "Đã xóa sạch",
  ...
  已运行时间: "Uptime",
  已返利: "",
  已返利人数: "Số người đã nhận được giảm giá",
  已退出其他设备: "",
  已退出该会话: "",
  已退出该设备: "",
  已退款: "Đã hoàn tiền",
  ...
  平台: "nền tảng",
  平台价格数据格式不正确: "Định dạng dữ liệu giá nền tảng không chính xác",
  平台地址格式不正确: "Định dạng địa chỉ nền tảng không chính xác",
  "平台将在合规审核通过后予以处理；审核完成前，原登记信息持续有效。提交不真实、不完整或无法核验的材料，平台有权驳回申请，并依据平台规则及适用法律法规采取进一步限制措施。": "Nền tảng sẽ xử lý vấn đề sau khi vượt qua đánh giá tuân thủ; cho đến khi quá trình xem xét hoàn tất, thông tin đăng ký ban đầu vẫn có hiệu lực. Nếu bạn gửi tài liệu không đúng sự thật, không đầy đủ hoặc không thể xác minh, nền tảng có quyền từ chối đơn đăng ký và thực hiện các biện pháp hạn chế hơn nữa theo các quy tắc của nền tảng cũng như luật và quy định hiện hành.",
  平均: "trung bình",
  平均RPM: "RPM trung bình",
  平均TPM: "TPM trung bình",
  平均延迟: "Độ trễ trung bình",
  "平均延迟 (7天)": "",
  平移: "Pan",
  年: "năm",
  ...
  "开启后，图片生成页面仅会展示此模型，不再依赖模型名称关键字判断": "Khi bật, trang tạo ảnh sẽ chỉ hiển thị mô hình này và không còn dựa vào từ khóa trong tên mô hình để nhận diện nữa.",
  ...
  "开启后，视频生成页面仅会展示此模型，不再依赖模型名称关键字判断": "Khi bật, trang tạo video sẽ chỉ hiển thị mô hình này và không còn dựa vào từ khóa trong tên mô hình để nhận diện nữa.",
  ...
  开启后检测到新增模型会自动加入当前渠道模型列表: "Sau khi được bật, các mẫu mới được phát hiện sẽ tự động được thêm vào danh sách mẫu kênh hiện tại.",
  开启后由后端定时任务检测该渠道上游模型变化: "Sau khi được bật, tác vụ được lập lịch ở phía sau sẽ phát hiện các thay đổi trong mô hình ngược dòng của kênh.",
  开启后由模型同时生成配音与音效: "Khi bật, mô hình sẽ tạo cả lời thoại và hiệu ứng âm thanh",
  "开启后该渠道不会参与任何并发竞速，但在竞速全部失败时仍可作为兜底通道被尝试": "Khi bật, kênh này sẽ không tham gia bất kỳ cuộc đua đồng thời nào, nhưng vẫn có thể được thử như kênh dự phòng sau khi tất cả các kênh đua đều thất bại",
  开启后该渠道的请求不会被注入全局系统提示词: "Khi bật, các yêu cầu qua kênh này sẽ không được chèn lời nhắc hệ thống toàn cục",
  ...
  异步回调地址: "Địa chỉ gọi lại không đồng bộ",
  张图片: "hình ảnh",
  弱变换: "Biến thể cao",
  ...
  "当前代理分销仅针对新用户通过代理邀请码注册后产生的钱包充值订单生效，购买套餐不参与该分销。": "Việc phân phối đại lý hiện tại chỉ có hiệu lực đối với các đơn đặt hàng nạp tiền vào ví do người dùng mới tạo sau khi đăng ký bằng mã mời đại lý. Mua các gói không tham gia vào việc phân phối này.",
  "当前代理资格已停用，仅保留历史佣金与流水展示，后续不会再产生新的分销收益": "Chứng chỉ đại lý hiện tại đã bị vô hiệu hóa, chỉ có hoa hồng lịch sử và hiển thị dòng chảy sẽ được giữ lại và sẽ không có thu nhập phân phối mới nào được tạo ra trong tương lai.",
  当前令牌没有相容分组: "",
  当前价格: "giá hiện tại",
  当前余额: "Số dư hiện tại",
  ...
  当前充值已满足活动条件: "",
  当前充值暂未满足活动条件: "",
  当前入口状态: "Tình trạng nhập cảnh hiện tại",
  ...
  "当前分组暂无可用模型，请切换分组或联系管理员配置": "Hiện tại không có mô hình nào có sẵn trong nhóm hiện tại. Vui lòng chuyển nhóm hoặc liên hệ với quản trị viên để cấu hình.",
  当前分组没有可用的图片模型: "Không có mẫu hình ảnh nào cho nhóm hiện tại",
  当前分组没有可用的视频模型: "",
  当前剩余: "Currently Remaining",
  "当前参数覆盖不是合法的 JSON": "Ghi đè tham số hiện tại không phải JSON hợp lệ",
  当前参考素材组合不被该模型支持: "",
  当前可提现佣金: "Hoa hồng hiện tại có sẵn để rút tiền",
  当前周期: "giai đoạn hiện tại",
  当前周期暂无成功充值: "Không có lần nạp tiền thành công nào trong chu kỳ hiện tại.",
  "当前尺寸：{{size}}": "Kích thước hiện tại: {{size}}",
  当前提示: "Gợi ý hiện tại",
  ...
  当前暂无可用邀请福利: "Hiện tại không có lợi ích lời mời nào.",
  "当前未启用，需要时再打开即可。": "Trường này hiện đang tắt. Hãy bật khi cần.",
  当前来源汇率: "Tỷ giá hối đoái nguồn hiện tại",
  "当前查看的分组为：{{group}}，{{comparison}}": "Nhóm hiện tại: {{group}} — {{comparison}}",
  ...
  当前状态: "Current Status",
  "当前环境共用同一商户 ID": "Các môi trường hiện tại có chung ID người bán",
  "当前用户将继承后台代理分销的默认首充/复充比例。": "Người dùng hiện tại sẽ kế thừa tỷ lệ nạp lại/nạp lại đầu tiên mặc định của phân phối tác nhân phụ trợ.",
  当前登录账号: "",
  当前登记地区: "Khu vực đăng ký hiện tại",
  当前盈利: "lợi nhuận hiện tại",
  当前绑定: "Bound",
  ...
  "当前账号未开通代理分销，管理员启用后会在这里展示邀请码、分销用户与佣金流水": "Tài khoản hiện tại chưa kích hoạt phân phối đại lý. Sau khi quản trị viên kích hoạt nó, mã mời, người dùng phân phối và luồng hoa hồng sẽ được hiển thị tại đây.",
  "当前账户暂不支持用户自行变更国家/地区信息。如确需申请变更，请通过工单提交正式申请，并提供足以证明您当前实际所在国家/地区或主体归属地的真实、完整、有效佐证材料。": "Tài khoản hiện tại không cho phép người dùng tự thay đổi thông tin quốc gia/khu vực. Nếu bạn thực sự cần đăng ký thay đổi, vui lòng gửi đơn đăng ký chính thức thông qua lệnh sản xuất và cung cấp các tài liệu hỗ trợ xác thực, đầy đủ và hợp lệ, đủ để chứng minh quốc gia/khu vực hoặc nơi cư trú thực tế hiện tại của bạn.",
  当前账户未开通代理分销: "Tài khoản vãng lai chưa mở phân phối đại lý",
  当前跟随系统: "Hiện đang theo hệ thống",
  当前邀请福利: "Lợi ích lời mời hiện tại",
  "当前金额未达到 Waffo Pancake 的最低充值要求": "Số tiền hiện tại không đáp ứng yêu cầu nạp tiền tối thiểu của Waffo Pancake",
  ...
  "当用户请求中已有系统提示词时，会优先拼接此内容；当用户未提供系统提示词时，会自动注入该内容": "Khi có từ nhắc hệ thống trong yêu cầu của người dùng, nội dung này sẽ được ghép trước; khi người dùng không cung cấp từ nhắc nhở của hệ thống, nội dung sẽ tự động được đưa vào.",
  ...
  待处理: "Chưa giải quyết",
  待支付单数: "Số lượng đơn hàng phải thanh toán",
  ...
  微信群: "Nhóm WeChat",
  微信群二维码: "Mã QR nhóm WeChat",
  微信群二维码图片链接: "URL ảnh mã QR nhóm WeChat",
  "微信账户绑定成功！": "Đã liên kết tài khoản WeChat thành công!",
  "必填：请输入服务器地址以自动生成完整端点 URL": "Bắt buộc: Vui lòng nhập địa chỉ máy chủ để tự động tạo URL điểm cuối đầy đủ",
  ...
  总体成功率: "tỷ lệ thành công chung",
  "总体成功率 / 失败率": "Tỷ lệ thành công/tỷ lệ thất bại chung",
  总充值金额: "Tổng số tiền nạp lại",
  总分配内存: "Tổng bộ nhớ đã phân bổ",
  总密钥数: "Tổng số khóa",
  总收益: "tổng doanh thu",
  总消耗额度: "Tổng lượng tiêu thụ",
  总计: "Tổng cộng",
  总请求数: "Tổng số yêu cầu",
  总额: "số tiền một lần",
  总额度: "Tổng hạn ngạch",
  ...
  成功充值次数: "Số lần nạp thành công",
  "成功兑换额度：": "Số tiền đổi thành công:",
  成功单数: "Số lẻ thành công",
  ...
  我的工单: "Lệnh làm việc của tôi",
  我的订阅: "Đăng ký của tôi",
  我确认开启高危重试: "Tôi xác nhận bật thử lại có rủi ro cao",
  我邀请的: "tôi đã mời",
  或: "hoặc",
  ...
  "所有 Token": "Tất cả các mã thông báo",
  ...
  扩展价格: "Giá mở rộng",
  扫描二维码: "Quét mã QR",
  "扫码加入微信群，与大家一起交流使用经验": "Quét mã QR để tham gia nhóm WeChat và trao đổi kinh nghiệm sử dụng.",
  扫码支付: "",
  批量创建: "Tạo hàng loạt",
  ...
  批量处理失败: "Xử lý hàng loạt không thành công",
  ...
  批量检测失败: "Phát hiện hàng loạt không thành công",
  "批量检测完成：渠道 {{channels}} 个，新增 {{add}} 个，删除 {{remove}} 个，失败 {{fails}} 个": "Đã hoàn tất phát hiện hàng loạt: các kênh {{channels}}, {{add}} mới, {{remove}} đã xóa, {{fails}} không thành công",
  ...
  报价: "Báo giá",
  抬头名称: "Invoice title",
  抽奖券说明: "Quy tắc quay thưởng",
  抽奖活动: "",
  "抽奖活动火热进行中，充值之余别忘了参与抽奖赢取奖励！": "Sự kiện quay thưởng đang diễn ra — đừng quên tham gia để nhận thưởng!",
  "拉取中...": "Pulling...",
  拉取价格: "kéo giá",
  拉取平台价格失败: "Không thể kéo giá nền tảng",
  ...
  拦截原因: "Lý do chặn",
  "拦截返回消息（inject_message）": "Chặn tin nhắn trả về (inject_message)",
  "按 1 美元对应的站内价格填写": "Điền giá site tương ứng với 1 USD",
  "按 Cron 表达式定时执行 JS 自动化脚本": "Thực thi các tập lệnh tự động hóa JS thường xuyên dựa trên các biểu thức Cron",
  按K显示单位: "Hiển thị theo K",
  "按上游 usage.completion_tokens 结算": "",
  按下单数与已成功订单数计算: "Tính số lệnh ép và số lệnh thành công",
  按价格字段筛选: "Lọc theo trường giá",
  按价格设置: "Đặt theo giá",
  按倍率类型筛选: "Lọc theo loại tỷ lệ",
  按倍率设置: "Đặt theo tỷ lệ",
  按分组与模型估算输入输出成本: "Ước tính chi phí đầu vào và đầu ra theo nhóm và mô hình",
  按后续成功充值实付金额计算: "Tính dựa trên số tiền thanh toán thực tế sau khi nạp tiền thành công",
  按国家或地区限制模型可见性与调用权限: "Hạn chế khả năng hiển thị mô hình và quyền gọi theo quốc gia hoặc khu vực",
  按完成支付时间落在当前周期内统计: "Thống kê dựa trên thời gian hoàn thành thanh toán trong chu kỳ hiện tại",
  "按实付人民币校验，填 0 表示不限制": "Xác minh dựa trên khoản thanh toán thực tế bằng RMB, điền vào số 0 để biểu thị không có giới hạn",
  "按应用、令牌、模型的顺序选择后，将配置导入 CC Switch。": "",
  "按当前用户分组归档成功充值收入。": "Lưu trữ thu nhập nạp tiền thành công theo nhóm người dùng hiện tại.",
  按成功充值订单口径统计: "Thống kê dựa trên các lệnh nạp tiền thành công",
  "按成功日志与错误日志的数量口径计算。": "Tính toán dựa trên số lượng nhật ký thành công và nhật ký lỗi.",
  "按成功消费日志汇总各渠道的额度消耗。": "Tổng hợp hạn ngạch tiêu thụ của từng kênh theo nhật ký tiêu thụ thành công.",
  "按成功消费日志统计模型调用次数。": "Đếm số lượng cuộc gọi mô hình dựa trên nhật ký sử dụng thành công.",
  "按所选日期范围联动查看模型调用、延迟、分组收入、拉新贡献和缓存效率。": "Xem các cuộc gọi mô hình, sự chậm trễ, doanh thu được nhóm, đóng góp mới và hiệu quả bộ nhớ đệm theo phạm vi ngày đã chọn.",
  按新用户首次充值实付金额计算: "Được tính dựa trên số tiền thực tế mà người dùng mới thanh toán cho lần nạp tiền đầu tiên",
  "按日志中的分组字段统计各分组消耗额度。": "Hạn ngạch tiêu thụ của mỗi nhóm được tính theo trường nhóm trong nhật ký.",
  "按日志响应时间计算各渠道平均延迟和长尾延迟。": "Tính toán độ trễ trung bình và độ trễ đuôi dài của từng kênh dựa trên thời gian phản hồi nhật ký.",
  "按日期连续展示当前周期的消费走势。": "Hiển thị liên tục xu hướng tiêu dùng của kỳ hiện tại theo ngày.",
  按模型倍率和分组倍率折算: "Chuyển đổi theo độ phóng đại mô hình và độ phóng đại nhóm",
  按次: "Theo lượt gọi",
  ...
  "按次：{{symbol}}{{price}} * {{ratioType}}：{{ratio}} = {{symbol}}{{total}}": "Theo lượt gọi: {{symbol}}{{price}} * {{ratioType}}: {{ratio}} = {{symbol}}{{total}}",
  按次价格: "Giá trả cho mỗi lần xem",
  按次计费: "Tính phí theo lượt gọi",
  "按消费 / 错误日志去重统计": "Thống kê chống trùng lặp theo nhật ký tiêu thụ/lỗi",
  "按消费日志中的缓存命中 token 统计": "Thống kê dựa trên mã thông báo truy cập bộ đệm trong nhật ký tiêu thụ",
  按消费日志口径统计: "Thống kê theo nhật ký tiêu thụ",
  "按消费日志统计缓存命中、缓存创建与节省额度。": "Thống kê về số lần truy cập bộ đệm, tạo và tiết kiệm bộ đệm dựa trên nhật ký sử dụng.",
  "按渠道聚合成功与错误请求，查看稳定性差异。": "Tổng hợp các yêu cầu thành công và lỗi theo kênh để xem sự khác biệt về độ ổn định.",
  "按照如下格式输入：AccessKey|SecretAccessKey|Region": "Enter in the format: AccessKey|SecretAccessKey|Region",
  按用户创建和首次支付时间统计: "Thống kê theo lần tạo người dùng và lần thanh toán đầu tiên",
  "按近几天代理用户的下单与支付结果生成统计视图，成功率按下单数与成功单数计算": "Tạo chế độ xem thống kê dựa trên đơn hàng và kết quả thanh toán của người dùng đại lý trong những ngày gần đây. Tỷ lệ thành công được tính bằng số lượng đơn hàng đã đặt và số lượng đơn hàng thành công.",
  "按选定周期内的成功消费额度排序。": "Sắp xếp theo lượng tiêu thụ thành công trong khoảng thời gian đã chọn.",
  按量: "Theo số lượng",
  ...
  "按页面显示额度判断，保存时自动换算，0 表示不限制": "Phán quyết dựa trên số tiền hiển thị trên trang, được tự động chuyển đổi khi lưu, 0 nghĩa là không giới hạn",
  "按页面显示额度封顶，保存时自动换算，0 表示不限制": "Số tiền được giới hạn theo hiển thị trang, tự động chuyển đổi khi lưu, 0 nghĩa là không giới hạn",
  ...
  授权时间: "",
  授权端点: "Điểm cuối ủy quyền",
  "授权范围 (Scopes)": "Phạm vi ủy quyền (Scopes)",
  授权请求已失效: "",
  排序: "Thứ tự",
  排队中: "Đang xếp hàng",
  ...
  接收上游模型更新通知: "Nhận thông báo cập nhật mô hình ngược dòng",
  接收发票邮箱: "Invoice recipient email",
  "控制代理资格、分销比例以及查看当前佣金汇总": "Kiểm soát trình độ đại lý, tỷ lệ phân phối và xem tóm tắt hoa hồng hiện tại",
  控制台: "Bảng điều khiển",
  ...
  描述: "Mô tả",
  "描述你要生成的画面，例如：赛博朋克城市夜景，霓虹灯，电影感，超清细节": "Mô tả cảnh bạn muốn tạo, ví dụ: cảnh đêm thành phố cyberpunk, ánh đèn neon, cảm giác điện ảnh, chi tiết cực kỳ rõ ràng",
  "描述你要生成的视频，例如：镜头缓慢推进雨夜街道，一只橘猫回头望向镜头，电影感光影": "",
  提交: "Gửi",
  提交和跟进自己的工单: "Gửi và theo dõi các đơn đặt hàng công việc của riêng bạn",
  提交失败: "Failed to submit",
  提交开票申请: "Submit invoice request",
  提交时间: "Thời gian gửi",
  提交结果: "Kết quả",
  提供商名称: "Tên nhà cung cấp",
  提出修改要求: "Request a change",
  提升: "Thăng cấp",
  提现扣减: "Khấu trừ rút tiền mặt",
  提现流水号: "Số serial rút tiền",
  提现金额: "Số tiền rút",
  提示: "Gợi ý",
  ...
  "搜索用户名、昵称或邮箱": "Tìm kiếm tên người dùng, biệt danh hoặc email",
  "搜索用户名、邮箱或来源订单号": "Tìm kiếm tên người dùng, email hoặc số thứ tự nguồn",
  "搜索用户名、邮箱或订单号": "Tìm kiếm tên người dùng, email hoặc số đơn đặt hàng",
  搜索结果: "Kết quả tìm kiếm",
  搜索聊天应用名称: "Tìm kiếm tên ứng dụng trò chuyện",
  "搜索规则（描述 / 类型 / 路径 / 来源 / 目标）": "Quy tắc tìm kiếm (mô tả/loại/đường dẫn/nguồn/đích)",
  ...
  "支付处理中，可稍后刷新订阅状态": "Thanh toán đang được xử lý. Trạng thái đăng ký có thể được làm mới sau.",
  "支付处理中，可稍后在充值记录查看状态": "Thanh toán đang được xử lý, bạn có thể kiểm tra trạng thái trong hồ sơ nạp tiền sau.",
  支付失败: "Thanh toán thất bại",
  "支付失败，请重新发起充值": "Thanh toán không thành công, vui lòng nạp tiền",
  "支付失败，请重新发起购买": "Thanh toán không thành công, vui lòng bắt đầu lại việc mua hàng",
  支付完成单数: "Số lần thanh toán hoàn thành",
  "支付完成后用户跳转的页面，留空则自动使用 服务器地址 + /console/topup": "Trang mà người dùng chuyển đến sau khi thanh toán hoàn tất. Nếu để trống, địa chỉ máy chủ + /console/topup sẽ được sử dụng tự động.",
  支付宝: "Alipay",
  支付宝扫码支付: "Thanh toán mã quét Alipay",
  支付成功率: "Tỷ lệ thanh toán thành công",
  支付方式: "Phương thức thanh toán",
  支付方式分布: "Phân phối phương thức thanh toán",
  支付方式名称: "Tên phương thức thanh toán",
  支付方式名称不能为空: "Tên phương thức thanh toán không được để trống",
  支付方式图标: "Biểu tượng phương thức thanh toán",
  支付方式类型: "Loại phương thức thanh toán",
  支付方式设置: "Cài đặt phương thức thanh toán",
  支付方式颜色: "Màu phương thức thanh toán",
  支付时间: "Paid at",
  ...
  "支持 JSONPath，如 email, data.user.email": "Hỗ trợ JSONPath, chẳng hạn như email, data.user.email",
  "支持 JSONPath，如 name, display_name, data.user.name": "Hỗ trợ JSONPath, chẳng hạn như tên, display_name, data.user.name",
  "支持 JSONPath，如 preferred_username, login, data.user.username": "Hỗ trợ JSONPath, chẳng hạn như favorite_username, login, data.user.username",
  "支持 JSONPath，如 sub, id, data.user.id": "Hỗ trợ JSONPath, chẳng hạn như sub, id, data.user.id",
  ...
  "支持使用 {prompt} 占位原始提示词": "Hỗ trợ sử dụng từ nhắc nhở gốc giữ chỗ {prompt}",
  ...
  支持备份: "Được hỗ trợ",
  "支持多个标记，使用换行、逗号、分号或竖线分隔。模型输出包含任一标记时将记录审查结果。": "Nhiều thẻ được hỗ trợ, được phân tách bằng dòng mới, dấu phẩy, dấu chấm phẩy hoặc thanh dọc. Kết quả đánh giá được ghi lại khi đầu ra mô hình chứa một trong hai cờ.",
  ...
  "支持文生视频、首尾帧、参考图与参考视频/音频": "Hỗ trợ tạo video từ văn bản, khung hình đầu/cuối, ảnh, video và âm thanh tham chiếu",
  支持的分辨率: "",
  ...
  支持的画面比例: "",
  支持的输出格式: "",
  "支持精确匹配；使用 regex: 开头可按正则匹配。": "Hỗ trợ kết hợp chính xác; sử dụng biểu thức chính quy: lúc đầu để khớp theo quy tắc thông thường.",
  "支持自定义请求限流、频率控制、黑白名单配置，灵活管控接口访问流量，避免恶意请求与突发流量冲击，保障业务有序平稳运行。": "Hỗ trợ tùy chỉnh giới hạn tốc độ, kiểm soát tần suất, cấu hình danh sách đen/trắng, kiểm soát linh hoạt lưu lượng truy cập API, tránh yêu cầu độc hại và lưu lượng đột biến, đảm bảo nghiệp vụ vận hành trật tự, ổn định.",
  ...
  政企项目系统集成: "Tích hợp hệ thống chính phủ/DN",
  ...
  "文+图生图": "Văn bản + hình ảnh tạo ra hình ảnh",
  文件上传: "Tải lên tệp",
  ...
  文心一言: "ERNIE Bot",
  "文本生成内容审查（命中输出标记时记录审查结果）": "Đánh giá nội dung tạo văn bản (xem lại kết quả được ghi lại khi chạm vào cờ đầu ra)",
  文档: "Tài liệu",
  文档中心: "Trung tâm tài liệu",
  文档加载失败: "Không tải được tài liệu",
  文档地址: "Liên kết tài liệu",
  文档导航: "",
  文档搜索加载失败: "Không tải được tìm kiếm tài liệu",
  文档目录: "Mục lục tài liệu",
  文档空间: "",
  文档翻页导航: "",
  文生图: "hình ảnh Vincentian",
  文生视频: "Văn bản sang video",
  新增: "added",
  "新增 / 首充 / 活跃用户趋势": "Xu hướng người dùng mới/lần gửi tiền đầu tiên/người dùng đang hoạt động",
  "新增 / 首充用户": "Người dùng gửi tiền mới/lần đầu tiên",
  "新增 Key 来源": "Thêm nguồn Key",
  新增供应商: "Thêm nhà cung cấp",
  新增失败: "Thêm thất bại",
  新增对比项: "Thêm mục so sánh",
  新增封禁: "Thêm lệnh cấm mới",
  新增封禁记录: "Thêm hồ sơ cấm",
  "新增已选 {{selected}} / {{total}}": "Thêm {{selected}} / {{total}} đã chọn",
  新增平台对比: "Đã thêm so sánh nền tảng",
  新增成功: "Thêm thành công",
  新增支付方式: "Thêm phương thức thanh toán mới",
  新增条件: "Thêm điều kiện",
  新增模型: "Thêm mô hình mới",
  新增用户: "Thêm người dùng mới",
  "新增用户按创建时间统计，首充用户按首次支付时间统计，活跃用户按日志去重统计。": "Người dùng mới được tính dựa trên thời gian tạo, người dùng gửi tiền lần đầu được tính dựa trên thời gian thanh toán đầu tiên và người dùng đang hoạt động được tính dựa trên việc loại bỏ trùng lặp nhật ký.",
  新增规则: "Thêm quy tắc",
  新增订阅: "Thêm đăng ký",
  新增邀请计划: "Thêm kế hoạch mời",
  新密码: "Mật khẩu mới",
  "新密码需要和原密码不一致！": "Mật khẩu mới phải khác với mật khẩu cũ!",
  新年促销: "Khuyến mãi năm mới",
  新建: "Tạo",
  新建套餐: "Tạo gói",
  ...
  新建数量: "Số lượng mới",
  新建组: "Nhóm mới",
  新支付方式: "Phương thức thanh toán mới",
  ...
  "无条件（兜底档）": "Vô điều kiện (cấp thấp)",
  "无法加载文档内容，请稍后重试": "Không thể tải nội dung tài liệu, vui lòng thử lại sau",
  ...
  "无法复制到剪贴板，请重试": "",
  "无法构建搜索索引，请稍后重试": "Không thể xây dựng chỉ mục tìm kiếm. Vui lòng thử lại sau.",
  无法添加图片: "Không thể thêm hình ảnh",
  无法获取容器详情: "Unable to get container details",
  "无法获取模型 {{model}} 的能力契约，暂时无法生成": "",
  无法获取用户信息: "Không thể lấy được thông tin người dùng",
  无法读取剪贴板: "Không thể đọc bộ nhớ tạm",
  无生效: "Không có gói đăng ký hiệu lực",
  无结果: "Không có kết quả",
  无输入影片: "Không có video đầu vào",
  ...
  日志追踪: "",
  日期: "ngày",
  "旧数据/未知": "Dữ liệu cũ/không xác định",
  ...
  时间条件: "điều kiện thời gian",
  时间粒度: "Độ chi tiết thời gian",
  时间范围: "",
  易支付: "Epay",
  易支付商户ID: "ID người bán Epay",
  易支付商户密钥: "Khóa người bán Epay",
  易支付设置: "Cài đặt thanh toán dễ dàng",
  星期: "Tuần",
  昨天充值: "Nạp tiền ngày hôm qua",
  是: "Có",
  ...
  是否检测上游模型更新: "Có phát hiện các cập nhật mô hình ngược dòng hay không",
  "是否确认充值？": "Confirm the recharge?",
  是否自动同步上游模型更新: "Có tự động đồng bộ hóa các bản cập nhật mô hình ngược dòng hay không",
  ...
  晚上好: "Chào buổi tối",
  "普通按量/按次直接填价格就行；如果价格要跟请求参数或请求头联动，请切到表达式/阶梯计费。": "Thông thường chỉ cần điền giá trực tiếp theo khối lượng/lần; nếu giá cần được liên kết với các tham số yêu cầu hoặc tiêu đề yêu cầu, vui lòng chuyển sang Thanh toán biểu thức/Ladder.",
  ...
  暂无差异化价格显示: "Chưa hiển thị giá phân biệt",
  ...
  "暂无支付方式，点击上方按钮新增": "Chưa có phương thức thanh toán nào, nhấp vào nút bên trên để thêm",
  ...
  暂无模型: "No models",
  暂无模型封禁记录: "Hiện tại chưa có hồ sơ cấm người mẫu",
  ...
  暂无赠送日志: "Chưa có nhật ký quà tặng",
  暂无邀请码: "Chưa có mã mời",
  暂无邀请计划: "Chưa có kế hoạch mời",
  暂无邀请链接: "Chưa có liên kết lời mời",
  暂无项目: "Không có dự án",
  暂无预填组: "Không có nhóm điền sẵn",
  暂时还没有代理佣金流水: "Chưa có luồng hoa hồng đại lý nào",
  暂时还没有代理充值流水: "Chưa có luồng nạp đại lý nào",
  暂时还没有代理邀请用户: "Chưa có đại lý để mời người dùng",
  暂时还没有邀请用户: "Chưa có người dùng nào được mời",
  暂时还没有邀请额度流水: "Chưa có chuyển hạn ngạch lời mời nào.",
  ...
  更新: "Cập nhật",
  "更新 BLG 支付设置": "Cập nhật cài đặt thanh toán BLG",
  "更新 Creem 设置": "Cập nhật cài đặt Creem",
  "更新 Stripe 设置": "Cập nhật cài đặt Stripe",
  "更新 Waffo Pancake 设置": "Cập nhật cài đặt bánh Waffo",
  "更新 Waffo 设置": "Cập nhật cài đặt Waffo",
  ...
  更新全局系统提示词拼接: "Cập nhật nối từ nhắc nhở hệ thống toàn cầu",
  ...
  有效至: "Valid until",
  "有输入/参考影片": "Có video đầu vào/tham chiếu",
  ...
  "未上传参考图时，默认调用文生图接口": "Khi không có ảnh tham chiếu nào được tải lên, giao diện ảnh Vincent sẽ được gọi theo mặc định.",
  "未上传参考图时，默认调用文生视频流程": "",
  未产生佣金: "Không tích lũy hoa hồng",
  ...
  "未找到差异化价格，无需同步": "Không tìm thấy giá phân biệt, không cần đồng bộ hóa",
  "未找到差异化倍率，无需同步": "Không tìm thấy tỷ lệ khác biệt, không cần đồng bộ hóa",
  未找到该文档: "Không tìm thấy tài liệu",
  ...
  未首单消费: "Không phải lần mua hàng đầu tiên",
  本地: "Cục bộ",
  本地数据存储: "Lưu trữ dữ liệu cục bộ",
  本地计费: "Local billing",
  本月获得: "Tháng này",
  本站: "Trang web này",
  "本站来源使用该汇率，外部平台可在下方单独配置。": "Nguồn của trang này sử dụng tỷ giá hối đoái này và các nền tảng bên ngoài có thể được cấu hình riêng bên dưới.",
  "本站汇率（CNY/USD）": "Tỷ giá hối đoái trên trang web này (CNY/USD)",
  "本设备：手机指纹/面容，外接：USB安全密钥": "Tích hợp: vân tay/khuôn mặt điện thoại, Bên ngoài: khóa bảo mật USB",
  本设备内置: "Thiết bị tích hợp",
  本页暂无目录: "Trang này chưa có mục lục",
  本页目录: "Trên trang này",
  ...
  查单地址: "Kiểm tra địa chỉ",
  查看: "Kiểm tra",
  "查看 Codex 帐号信息与用量": "Xem thông tin tài khoản Codex và cách sử dụng",
  "查看 JSON 示例": "Xem ví dụ JSON",
  查看你可使用的分组: "Xem các nhóm bạn có thể sử dụng",
  查看你可使用的模型: "",
  查看关联部署: "View Associated Deployment",
  查看和筛选充值记录: "Xem và lọc hồ sơ nạp tiền",
  查看图片: "Xem hình ảnh",
  查看图片和文本审查结果: "Xem kết quả đánh giá hình ảnh và văn bản",
  查看图片和文本的审查记录: "Xem lịch sử đánh giá cho hình ảnh và văn bản",
  查看密钥: "Xem khóa",
  查看并退出你账户当前的登录设备: "",
  查看开票: "View invoice",
  查看当前可用的所有模型: "Xem tất cả các mô hình khả dụng",
  "查看当前邀请福利，管理邀请列表，并追踪邀请额度流水": "Xem lợi ích lời mời hiện tại, quản lý danh sách lời mời và theo dõi luồng hạn ngạch lời mời",
  ...
  查看该应用对你账户的用量: "",
  查看详情: "View Details",
  "查看邀请码、邀请用户、充值流水和佣金流水": "Kiểm tra mã mời, người dùng được mời, luồng nạp tiền và luồng hoa hồng",
  查询: "Truy vấn",
  查询视频任务状态失败: "",
  标准价格: "Standard price",
  标签: "Nhãn",
  ...
  "标识符 (Slug)": "Mã định danh (Sên)",
  标识颜色: "Màu định danh",
  样本数: "Số lượng mẫu",
  核对中: "Under review",
  "核心优势 · 为什么选择 {{name}}": "Ưu thế cốt lõi · Vì sao chọn {{name}}",
  ...
  "根据哪个维度的 Token 数量决定落在哪一档": "Số lượng Token trong thứ nguyên xác định nó rơi vào khung nào.",
  "根据总用量落在哪个档位，所有 Token 都按该档价格计费": "Tùy thuộc vào khung nào mà tổng mức sử dụng rơi vào, tất cả Token sẽ được tính theo giá của khung đó.",
  ...
  检测全部渠道上游更新: "Phát hiện tất cả các cập nhật ngược dòng của kênh",
  "检测到 FluentRead（流畅阅读）": "Đã phát hiện FluentRead (đọc trôi chảy)",
  检测到以下高危状态码重定向规则: "Đã phát hiện các quy tắc chuyển hướng mã trạng thái có rủi ro cao sau đây",
  ...
  检测失败: "Phát hiện không thành công",
  "检测完成：新增 {{add}} 个，删除 {{remove}} 个": "Quá trình phát hiện đã hoàn tất: Đã thêm {{add}}, đã xóa {{remove}}",
  检测超时: "",
  概览: "Overview",
  模型: "Mô hình",
  "模型 {{model}} 的能力契约不可用": "",
  ...
  模型优化提示词: "Lời nhắc tối ưu hóa mô hình",
  模型倍率: "Tỷ lệ mô hình",
  ...
  "模型地址 BaseURL": "Địa chỉ mẫu BaseURL",
  ...
  模型类型: "Loại mô hình",
  模型组: "Nhóm mô hình",
  模型缓存倍率: "Phóng đại bộ đệm mô hình",
  ...
  欧元: "EUR",
  止: "kết thúc",
  正则替换: "Thay thế thường xuyên",
  正在使用: "Đang sử dụng",
  "正在加载...": "Đang tải...",
  正在加载分组计价规则: "",
  "正在加载可用部署位置...": "Loading available deployment locations...",
  "正在加载模型...": "Đang tải mô hình...",
  "正在加载模型能力契约，请稍候": "",
  "正在加载模型能力契约...": "",
  "正在加载签到状态...": "Đang tải trạng thái đăng nhập...",
  "正在同步上游价格，请稍候": "Đang đồng bộ giá ngược dòng, vui lòng chờ.",
  "正在同步价格，请稍候": "Đang đồng bộ giá, vui lòng chờ.",
  正在处理: "Đang xử lý",
  "正在处理，请稍候": "Đang xử lý, vui lòng đợi.",
  "正在处理大内容...": "Đang xử lý nội dung lớn...",
  "正在导出...": "Đang xuất...",
  "正在批量处理，请稍候": "Đang xử lý hàng loạt, vui lòng đợi.",
  "正在批量检测，请稍候": "Đang tiến hành kiểm tra hàng loạt, vui lòng đợi.",
  正在提交: "Đang gửi",
  "正在提交...": "Đang gửi...",
  "正在更新...": "Đang cập nhật...",
  "正在构建搜索索引…": "Đang xây dựng chỉ mục tìm kiếm…",
  "正在构造请求体预览...": "Đang tạo xem trước thân yêu cầu...",
  "正在检查数据库一致性，请稍候...": "Đang kiểm tra tính nhất quán của cơ sở dữ liệu, vui lòng đợi...",
  "正在检测，请稍候": "Đang phát hiện, vui lòng đợi.",
  "正在测试...": "Đang kiểm tra...",
  "正在测试第 ${current} - ${end} 个模型 (共 ${total} 个)": "Đang kiểm tra mô hình thứ ${current} - ${end} (tổng cộng ${total})",
  "正在生成 ({{seconds}} s)": "Đang tạo ({{seconds}} s)",
  "正在登录...": "Đang đăng nhập...",
  ...
  此支付方式最高充值金额为: "Số tiền nạp tối đa cho phương thức thanh toán này là",
  "此时用户创建令牌时只能看到 standard 和 premium：": "Users can now only see standard and premium when creating tokens:",
  "此档上限（Token 数）": "Giới hạn trên của tệp này (số lượng Token)",
  ...
  "每个充值单位对应的 USD 金额，默认 1.0": "Số tiền USD tương ứng với mỗi đơn vị nạp tiền, mặc định 1.0",
  ...
  "每个对比项都可选择来源（本站/外部平台），再分别选择分组和模型进行可视化对比。各来源按自己的汇率计算。": "Bạn có thể chọn nguồn (trang này/nền tảng bên ngoài) cho từng mục so sánh, sau đó chọn các nhóm và mô hình để so sánh trực quan. Mỗi nguồn tính toán tỷ giá hối đoái riêng của mình.",
  "每个档位可设置 0~2 个条件（对 len、p 和 c），最后一档为兜底档无需条件。len 为输入上下文总长度（含缓存），推荐用于阶梯条件。": "Mỗi bánh răng có thể đặt điều kiện 0 ~ 2 (đối với len, p và c), và bánh răng cuối cùng là bánh răng phía dưới không có điều kiện. len là tổng độ dài của bối cảnh đầu vào (bao gồm cả bộ đệm), được khuyến nghị cho các điều kiện bậc thang.",
  "每个档位可设置 0~2 个条件（对 p 和 c），最后一档为兜底档无需条件。": "Mỗi bánh răng có thể đặt điều kiện 0 ~ 2 (đối với p và c), và bánh răng cuối cùng là bánh răng dưới cùng không có điều kiện.",
  每个模型使用其最低可用分组倍率: "Mỗi mô hình sử dụng tỷ lệ nhóm khả dụng thấp nhất",
  ...
  每位邀请人可参与: "Mỗi người mời đều có thể tham gia",
  每周: "Hàng tuần",
  每天: "Hàng ngày",
  每容器GPU数: "GPUs per Container",
  "每日仅可签到一次，请勿重复签到": "Chỉ có thể đăng nhập một lần mỗi ngày, vui lòng không đăng nhập lặp lại",
  每日充值金额: "Số tiền nạp hàng ngày",
  每日支付成功率: "Tỷ lệ thanh toán thành công hàng ngày",
  每日消耗额度: "Định mức tiêu thụ hàng ngày",
  ...
  每月: "Hàng tháng",
  "每百万 Token 价格": "Giá mỗi triệu Token",
  "每美元对应 Token 数": "Số token trên mỗi USD",
  每隔多少分钟测试一次所有通道: "Bao nhiêu phút kiểm tra tất cả các kênh một lần",
  比率: "Tỷ lệ",
  "比较模型价格，按供应商、分组和能力快速找到适合你的模型。": "So sánh giá mô hình và nhanh chóng tìm mô hình phù hợp theo nhà cung cấp, nhóm và khả năng.",
  ...
  "没有找到与“{{query}}”相关的内容": "Không tìm thấy nội dung cho “{{query}}”",
  ...
  活动: "Hoạt động",
  活动优惠以支付完成时系统配置为准: "",
  活动到期时间: "Thời gian hết hạn hoạt động",
  活跃: "",
  活跃文件: "Tệp đang hoạt động",
  活跃用户: "người dùng đang hoạt động",
  活跃用户数: "Số lượng người dùng đang hoạt động",
  活跃缓存数: "Số bộ nhớ đệm hoạt động",
  流: "luồng",
  流式: "Streaming",
  流式响应完成: "Luồng hoàn tất",
  流式输出: "Đầu ra luồng",
  流状态: "trạng thái dòng chảy",
  流量端口: "Traffic Port",
  流错误详情: "Chi tiết lỗi phát trực tuyến",
  浅色: "Sáng",
  浅色模式: "Chế độ sáng",
  测活: "Health Check",
  测试: "Kiểm tra",
  "测试 Webhook 公钥": "Kiểm tra khóa công khai webhook",
  测试中: "Đang kiểm tra",
  "测试中...": "Đang kiểm tra...",
  ...
  测试渠道: "Kênh kiểm tra",
  测试环境: "môi trường thử nghiệm",
  "测试环境 Webhook 验签公钥 Base64": "Môi trường thử nghiệm Xác minh chữ ký Webhook khóa công khai Base64",
  ...
  消费: "Tiêu thụ",
  消费后即可获得返利: "Hoàn tiền sau khi người được mời chi tiêu",
  深色: "Tối",
  深色模式: "Chế độ tối",
  添加: "Thêm",
  "添加 (+:)": "Add (+:)",
  ...
  添加新通道: "Thêm kênh mới",
  添加时间条件: "Thêm điều kiện thời gian",
  添加时间规则: "Thêm quy tắc thời gian",
  添加更多档位: "Thêm nhiều bánh răng hơn",
  添加条件: "Thêm điều kiện",
  添加条件组: "Thêm nhóm điều kiện",
  添加标签: "Thêm thẻ",
  添加模型: "Thêm mô hình",
  ...
  "渠道平均响应 / P95 / P99": "Phản hồi trung bình của kênh / P95 / P99",
  渠道排序: "Sắp xếp kênh",
  ...
  "满足条件时，整单价格乘以 X；如果有多条同时命中，会继续相乘。": "Khi thỏa mãn các điều kiện, toàn bộ giá đặt hàng được nhân với X; nếu có nhiều lượt truy cập cùng lúc thì phép nhân sẽ tiếp tục.",
  演示站点: "Trang web demo",
  ...
  点击处理删除模型: "Nhấn Process để xóa mô hình",
  点击处理新增模型: "Bấm để xử lý mô hình mới",
  ...
  现在: "",
  "生产 Webhook 公钥": "Tạo khóa công khai webhook",
  生产环境: "môi trường sản xuất",
  "生产环境 RSA 私钥 Base64 (PKCS#8 DER)": "Khóa riêng RSA Base64 (PKCS#8 DER) môi trường sản xuất",
  "生产环境 Waffo API 密钥": "Khóa API Waffo sản xuất",
  "生产环境 Waffo 公钥 Base64 (X.509 DER)": "Khóa công khai Waffo Base64 (X.509 DER) môi trường sản xuất",
  "生产环境 Webhook 验签公钥 Base64": "Môi trường sản xuất Xác minh chữ ký Webhook khóa công khai Base64",
  生成: "Tạo",
  "生成中...": "Đang tạo...",
  生成令牌: "Tạo mã thông báo",
  生成兑换码: "Tạo mã đổi thưởng",
  生成参数: "",
  生成图片: "Hình ảnh đã tạo",
  生成失败: "Tạo thất bại",
  生成并填入: "Tạo và điền",
  生成成功: "Tạo thành công",
  生成数量: "Số lượng tạo",
  ...
  "用于“1M输入（含缓存）”估算，示例：0.95。": 'Đối với ước tính "1M đầu vào (bao gồm cả bộ đệm)", ví dụ: 0,95.',
  "用于API调用的身份验证令牌，请妥善保管": "Mã thông báo xác thực cho các cuộc gọi API, vui lòng giữ an toàn",
  用于切换当前下单和回调校验所使用的环境: "Được sử dụng để chuyển đổi môi trường được sử dụng cho việc đặt hàng hiện tại và xác minh gọi lại",
  用于唯一标识用户的字段路径: "Đường dẫn trường để nhận dạng duy nhất người dùng",
  "用于校验 Stripe Webhook 签名，保存后不会回显": "Dùng để xác minh chữ ký Stripe Webhook, sẽ không bị lặp lại sau khi lưu",
  "用于校验测试环境的 Waffo Pancake Webhook 签名": "Chữ ký Waffo Pancake Webhook để xác minh môi trường thử nghiệm",
  "用于校验测试环境的 Waffo 回调签名": "Chữ ký gọi lại Waffo được sử dụng để xác minh môi trường thử nghiệm",
  "用于校验生产环境的 Waffo Pancake Webhook 签名": "Xác minh chữ ký Waffo Pancake Webhook cho môi trường sản xuất",
  "用于校验生产环境的 Waffo 回调签名": "Chữ ký gọi lại Waffo để xác minh môi trường sản xuất",
  ...
  用户信息端点: "Điểm cuối thông tin người dùng",
  ...
  用户单次最少可充值的美元数量: "Số tiền đô la Mỹ tối thiểu mà người dùng có thể nạp tại một thời điểm",
  ...
  用户名: "Tên người dùng",
  用户名字段: "trường tên người dùng",
  "用户名字段（可选）": "Trường tên người dùng (tùy chọn)",
  用户名或邮箱: "Tên người dùng hoặc email",
  用户名称: "Tên người dùng",
  "用户在充值页面看到的支付方式名称，例如：Credit Card": "Tên phương thức thanh toán mà người dùng nhìn thấy trên trang nạp tiền, ví dụ: Thẻ tín dụng",
  用户在线: "Người dùng trực tuyến",
  用户头像: "Ảnh đại diện người dùng",
  用户密码: "Mật khẩu người dùng",
  用户工单处理: "Xử lý đơn đặt hàng công việc của người dùng",
  ...
  "用户消耗排名 Top 10": "Top 10 bảng xếp hạng tiêu dùng của người dùng",
  ...
  用途: "Mục đích",
  "用量分段计价，每一段各自按对应档位价格计费（类似电费阶梯）": "Mức sử dụng được tính theo từng phân khúc, mỗi phân khúc được tính theo mức giá tương ứng (tương tự như thang hóa đơn tiền điện)",
  "用量统计、模型选择、成本优化": "",
  用量范围: "Phạm vi liều lượng",
  ...
  "留空则使用 /console/topup?show_history=true": "Để trống để sử dụng /console/topup?show_history=true",
  ...
  留空则使用默认回调地址: "Để trống để sử dụng địa chỉ gọi lại mặc định",
  ...
  "留空则自动使用 服务器地址 + /api/waffo/webhook": "Để trống để tự động sử dụng địa chỉ máy chủ + /api/waffo/webhook",
  留空则自动使用当前站点的默认充值页地址: "Nếu để trống, địa chỉ trang nạp tiền mặc định của trang hiện tại sẽ tự động được sử dụng.",
  ...
  "留空时默认使用服务器地址作为回调地址，填写后将覆盖默认值": "Nếu để trống, địa chỉ máy chủ sẽ được sử dụng làm địa chỉ gọi lại theo mặc định. Điền vào sẽ ghi đè giá trị mặc định.",
  "留空表示保留当前密钥，仅在需要更换时重新填写": "Để trống để giữ khóa hiện tại và chỉ nạp lại nếu bạn cần thay đổi.",
  留空表示长期有效: "Để trống để cho biết hiệu lực lâu dài",
  "登 录": "Đăng nhập",
  登录: "Đăng nhập",
  ...
  "确定要仅检测全部渠道上游模型更新吗？（不执行新增/删除）": "Bạn có chắc chắn muốn chỉ phát hiện tất cả các cập nhật mô hình ngược dòng của kênh không? (Việc thêm/xóa sẽ không được thực hiện)",
  ...
  "确定要删除该提供商吗？": "Bạn có chắc chắn muốn xóa nhà cung cấp này không?",
  ...
  "确定要对全部渠道执行上游模型更新吗？": "Bạn có chắc chắn muốn thực hiện cập nhật mô hình ngược dòng cho tất cả các kênh không?",
  ...
  "确认删除该邀请计划？": "Xác nhận xóa kế hoạch mời này?",
  "确认删除这条模型封禁记录？": "Bạn có chắc chắn xóa bản ghi lệnh cấm mô hình này không?",
  确认取消密码登录: "Xác nhận hủy đăng nhập mật khẩu",
  "确认后会从可提现佣金扣减，并累计到已提现佣金，同时写入代理佣金流水。": "Sau khi xác nhận, số tiền này sẽ được khấu trừ từ hoa hồng có thể rút và tích lũy vào hoa hồng có thể rút và được ghi vào dòng hoa hồng đại lý.",
  确认启用: "Xác nhận bật",
  确认密码: "Xác nhận mật khẩu",
  确认导入配置: "Xác nhận nhập cấu hình",
  确认延长: "Confirm Extension",
  确认延长容器时长: "Confirm Container Duration Extension",
  确认扣减: "Xác nhận khấu trừ",
  确认提交: "Xác nhận gửi",
  ...
  "示例：claude-opus-4-8 输入价，官方 ￥35.00，Claude lite（特价） ￥3.50": "Ví dụ: giá đầu vào claude-opus-4-8 — chính thức ¥35,00; Claude lite (giá đặc biệt) ¥3,50",
  ...
  视频生成失败: "",
  视频生成完成: "",
  视频生成模型: "Mô hình tạo video",
  视频编辑: "Chỉnh sửa video",
  视频预览: "",
  禁用: "Vô hiệu hóa",
  ...
  积分记录: "Hồ sơ điểm",
  移动: "di chuyển",
  移动请求头: "Di chuyển tiêu đề yêu cầu",
  移除: "Remove",
  "移除 (-:)": "Remove (-:)",
  ...
  空: "Trống",
  "空位 {{index}}": "Vị trí tuyển dụng {{index}}",
  窗口处理: "xử lý cửa sổ",
  窗口等待: "chờ cửa sổ",
  立即充值: "Nạp tiền ngay",
  立即注册: "Đăng ký ngay",
  立即生成: "Tạo ngay lập tức",
  立即登录: "Đăng nhập ngay",
  立即签到: "Đăng nhập ngay",
  立即订阅: "Đăng ký ngay",
  立即验证: "Xác minh ngay",
  ...
  端点: "Điểm cuối",
  "端点 URL 必须以 http:// 或 https:// 开头：": "URL điểm cuối phải bắt đầu bằng http:// hoặc https://:",
  ...
  等待首单消费后判定返利: "Đợi giảm giá được xác định sau lần mua đầu tiên.",
  策略: "Chiến lược",
  筛选: "Lọc",
  ...
  简介: "Giới thiệu",
  "简化接口调用，赋能业务高效运转": "Đơn giản hóa việc gọi API, tiếp sức nghiệp vụ vận hành hiệu quả",
  ...
  管理员可视化报表中心: "Trung tâm báo cáo trực quan của quản trị viên",
  管理员尚未配置需要展示的分组: "",
  管理员尚未配置需要展示的套餐: "",
  管理员尚未配置需要展示的模型: "",
  管理员暂时未设置任何关于内容: "Quản trị viên chưa đặt bất kỳ nội dung Giới thiệu tùy chỉnh nào",
  管理员暂未配置微信群二维码: "Quản trị viên chưa cấu hình mã QR nhóm WeChat.",
  ...
  管理员未开启支付宝充值: "Quản trị viên chưa kích hoạt nạp tiền Alipay.",
  "管理员未开启支付宝充值！": "Quản trị viên chưa kích hoạt nạp tiền Alipay!",
  "管理员未开启聚合支付！": "",
  ...
  "粘贴图片链接（http/https）": "Dán liên kết ảnh (http/https)",
  精确: "Chính xác",
  精选: "",
  系统: "Hệ thống",
  ...
  "纯字符串会直接覆盖整条请求头，或者点击“查看 JSON 示例”按 token 规则处理。": 'Chuỗi thuần sẽ trực tiếp bao gồm toàn bộ tiêu đề yêu cầu hoặc nhấp vào "Xem ví dụ JSON" để xử lý chuỗi đó theo quy tắc mã thông báo.',
  纯文本: "Văn bản thuần túy",
  累计佣金: "Hoa hồng tích lũy",
  累计充值金额: "Số tiền nạp tích lũy",
  累计消耗: "Tiêu thụ tích lũy",
  累计签到: "Tổng số lần đăng nhập",
  累计获得: "Tổng đã nhận",
  累计贡献佣金: "Hoa hồng đóng góp tích lũy",
  "累计返利 {{quota}}（共 {{count}} 次）": "Tổng hoàn tiền {{quota}} ({{count}} lần)",
  "累计返利 {{quota}}（共 {{count}} 次）_other": "",
  累计邀请奖励: "Phần thưởng lời mời tích lũy",
  累进阶梯: "thang tiến bộ",
  线路: "Tuyến",
  线路描述: "Mô tả tuyến",
  组: "Nhóm",
  ...
  统计周期内代理用户创建的充值订单: "Lệnh nạp tiền do người dùng đại lý tạo trong kỳ thống kê",
  统计周期内完成支付的成功金额: "Số tiền thanh toán thành công đã hoàn thành trong kỳ thống kê",
  ...
  "缓存创建 Token": "Mã thông báo tạo bộ đệm",
  "缓存创建 Token (cc)": "Mã thông báo tạo bộ đệm (cc)",
  "缓存创建 Tokens": "Tokens tạo bộ nhớ đệm",
  "缓存创建-1h": "Tạo bộ đệm-1h",
  "缓存创建-1小时": "Tạo bộ đệm - 1 giờ",
  "缓存创建-1小时 (cc1h)": "Tạo bộ đệm - 1 giờ (cc1h)",
  "缓存创建-5分钟": "Tạo bộ đệm - 5 phút",
  "缓存创建-5分钟 (cc5)": "Tạo bộ đệm - 5 phút (cc5)",
  ...
  "缓存创建价格-1小时": "Giá tạo bộ đệm - 1 giờ",
  "缓存创建价格-5分钟": "Giá tạo bộ đệm - 5 phút",
  ...
  "缓存命中 Token": "Mã truy cập bộ nhớ đệm",
  缓存命中率: "Tỷ lệ truy cập bộ đệm",
  缓存效率: "Hiệu suất bộ nhớ đệm",
  缓存条目数: "Số mục bộ nhớ đệm",
  缓存率: "Tốc độ bộ đệm",
  缓存目录: "Thư mục bộ nhớ đệm",
  缓存目录磁盘空间: "Dung lượng đĩa thư mục bộ nhớ đệm",
  缓存节省额度: "Tiết kiệm bộ nhớ đệm",
  缓存读: "Đọc bộ nhớ đệm",
  "缓存读 {{price}} / 1M tokens": "Đọc bộ nhớ đệm {{price}} / 1M tokens",
  缓存读取: "đọc bộ nhớ đệm",
  "缓存读取 Token (cr)": "Mã thông báo đọc bộ đệm (cr)",
  ...
  编辑密钥: "Chỉnh sửa khóa",
  编辑封禁记录: "Chỉnh sửa lịch sử cấm",
  编辑成功: "Chỉnh sửa thành công",
  编辑提供商: "Chỉnh sửa nhà cung cấp",
  ...
  网关处理用时: "Thời gian xử lý gateway",
  ...
  自动: "Tự động",
  "自动（由模型决定）": "Tự động (do mô hình quyết định)",
  自动分组: "Auto Group",
  ...
  "自动表示由模型决定分辨率，不发送尺寸参数": "Tự động nghĩa là mô hình quyết định độ phân giải, không gửi tham số kích thước",
  自动选择: "Tự động chọn",
  ...
  自定义流量管控: "Kiểm soát lưu lượng tùy chỉnh",
  ...
  "获取中...": "Đang lấy...",
  获取代理分销信息失败: "Không thể lấy được thông tin phân phối đại lý",
  获取代理统计失败: "Không thể lấy được số liệu thống kê về đại lý",
  获取代码: "Lấy mã",
  获取令牌密钥失败: "Không lấy được mã thông báo",
  获取佣金流水失败: "Không thể nhận được luồng hoa hồng",
  获取充值流水失败: "Không lấy được nước nạp lại",
  ...
  获取邀请流水失败: "Không thể nhận được doanh thu từ lời mời",
  ...
  "表达式/阶梯计费": "Thanh toán theo biểu thức/theo cấp độ",
  表达式编辑: "Chỉnh sửa biểu thức",
  表达式计费: "Thanh toán biểu thức",
  表达式错误: "Lỗi biểu thức",
  被封禁: "Bị cấm",
  被禁用: "Bị vô hiệu hóa",
  被邀请人: "người được mời",
  ...
  覆盖用户: "Tiếp cận người dùng",
  见上方动态计费详情: "Xem chi tiết thanh toán động ở trên",
  规则: "Quy tắc",
  ...
  触发来源: "nguồn kích hoạt",
  触发词: "Từ kích hoạt",
  计价币种: "Pricing Currency",
  计价规则: "Quy tắc tính giá",
  计划: "kế hoạch",
  计划名称: "Tên kế hoạch",
  计划状态: "tình trạng kế hoạch",
  计算中: "Calculating",
  计算失败: "Tính toán không thành công",
  计算成本: "Calculate Cost",
  计算盈利: "Tính lợi nhuận",
  计算盈利失败: "Tính toán lợi nhuận không thành công",
  ...
  计费凭证: "Biên nhận tính phí",
  计费开始: "Billing Start",
  计费摘要: "Tóm tắt thanh toán",
  计费方式: "Chế độ tính phí",
  计费明细: "Chi tiết thanh toán",
  计费显示模式: "Chế độ hiển thị tính phí",
  计费模式: "Billing mode",
  计费类型: "Loại thanh toán",
  计费规则: "Quy tắc thanh toán",
  计费过程: "Quá trình thanh toán",
  计费额度: "Hạn mức tính phí",
  订单号: "Số đơn hàng",
  订单支付方式: "Phương thức thanh toán đơn hàng",
  订单数: "Số lượng đơn đặt hàng",
  订单趋势: "Xu hướng đặt hàng",
  订阅: "Đăng ký",
  ...
  订阅说明: "Mô tả đăng ký",
  "订阅购买成功，已生效": "Đăng ký được mua thành công và có hiệu lực",
  认证: "Xác thực",
  ...
  该入口仅用于一次性余额充值: "Lối vào này chỉ được sử dụng để nạp lại số dư một lần",
  ...
  该文档可能已被移动或删除: "Tài liệu này có thể đã bị di chuyển hoặc xóa",
  ...
  该渠道暂无可处理的上游模型更新: "Kênh này hiện không có bản cập nhật mô hình ngược dòng nào để xử lý.",
  该渠道未开启上游模型更新检测: "Tính năng phát hiện cập nhật mô hình ngược dòng không được bật cho kênh này",
  ...
  请使用支付宝扫码支付: "Vui lòng sử dụng Alipay để quét mã QR để thanh toán",
  ...
  "请先填写服务器地址，以自动生成完整的端点 URL": "Vui lòng điền địa chỉ máy chủ trước để tự động tạo URL điểm cuối đầy đủ",
  "请先开启并填写音频输入价格。": "Hãy bật và điền giá đầu vào âm thanh trước.",
  请先新增模型或从左侧列表选择一个模型: "Vui lòng thêm mẫu mới trước hoặc chọn mẫu từ danh sách bên trái",
  ...
  请先选择不低于最低额度的充值金额: "Trước tiên hãy chọn số tiền nạp không nhỏ hơn số tiền tối thiểu",
  请先选择令牌: "",
  "请先选择供应商，再选择分组": "Chọn nhà cung cấp, sau đó chọn nhóm",
  ...
  "请在 Waffo 后台获取 API 密钥、商户 ID 以及 RSA 密钥对，并配置回调地址。": "Vui lòng lấy khóa API, ID người bán và cặp khóa RSA trong phần phụ trợ Waffo và định cấu hình địa chỉ gọi lại.",
  ...
  请填写封禁原因: "Vui lòng điền lý do cấm",
  "请填写当前环境对应的 Product ID": "Vui lòng điền ID sản phẩm tương ứng với môi trường hiện tại",
  "请填写当前环境对应的 Store ID": "Vui lòng điền ID cửa hàng tương ứng với môi trường hiện tại",
  "请填写当前环境对应的商户 ID": "Vui lòng điền ID người bán tương ứng với môi trường hiện tại",
  ...
  "请确保你的服务可被支付网关回调访问，并在网关侧正确配置白名单与回调地址。": "Vui lòng đảm bảo rằng dịch vụ của bạn có thể được truy cập bằng lệnh gọi lại cổng thanh toán và danh sách trắng cũng như địa chỉ gọi lại được định cấu hình chính xác ở phía cổng.",
  ...
  "请稍候...": "Vui lòng đợi...",
  "请稍后再来查看，或联系管理员获取入群方式。": "Vui lòng quay lại sau hoặc liên hệ quản trị viên để nhận cách tham gia nhóm.",
  ...
  '请输入 JSON 格式的密钥内容，例如：\n{\n  "type": "service_account",\n  "project_id": "your-project-id",\n  "private_key_id": "...",\n  "private_key": "...",\n  "client_email": "...",\n  "client_id": "...",\n  "auth_uri": "...",\n  "token_uri": "...",\n  "auth_provider_x509_cert_url": "...",\n  "client_x509_cert_url": "..."\n}': `Vui lòng nhập nội dung khóa ở định dạng JSON, ví dụ:
{
  ...
  "请输入 Product ID": "Vui lòng nhập ID sản phẩm",
  "请输入 Slug": "Vui lòng nhập Slug",
  "请输入 Store ID": "Vui lòng nhập ID cửa hàng",
  ...
  "请输入商户 ID": "Vui lòng nhập ID người bán",
  ...
  "请输入密钥！": "Vui lòng nhập khóa!",
  请输入密钥前缀或尾号: "",
  "请输入封禁原因，用户会直接看到这段原因": "Vui lòng nhập lý do cấm. Người dùng sẽ thấy lý do trực tiếp.",
  ...
  "请输入手机号！": "",
  "请输入手机验证码！": "",
  请输入提示词: "Vui lòng nhập từ gợi ý",
  请输入搜索关键字: "Vui lòng nhập từ khóa tìm kiếm",
  请输入搜索内容: "Vui lòng nhập nội dung tìm kiếm",
  请输入支付方式名称: "Vui lòng nhập tên phương thức thanh toán",
  ...
  请输入有效的图片链接: "Vui lòng nhập liên kết ảnh hợp lệ",
  ...
  请输入正确的提现金额: "Vui lòng nhập đúng số tiền rút",
  ...
  请输入计划名称: "Vui lòng nhập tên kế hoạch",
...
Hỗ trợ sử dụng định dạng ánh xạ mô hình
{
  ...
  "请选择国家/地区": "Vui lòng chọn quốc gia/khu vực",
  请选择图片: "Vui lòng chọn hình ảnh",
  请选择图片模型: "Vui lòng chọn mẫu hình ảnh",
  ...
  请选择封禁结束时间: "Vui lòng chọn thời gian kết thúc lệnh cấm",
  请选择开始和结束日期: "Vui lòng chọn ngày bắt đầu và ngày kết thúc",
  "请选择您所在的国家/地区": "Vui lòng chọn quốc gia/khu vực của bạn",
  ...
  请选择有效的结束时间: "Vui lòng chọn thời gian kết thúc hợp lệ",
  ...
  请选择触发套餐: "Vui lòng chọn gói kích hoạt",
  ...
  请选择返利套餐: "Vui lòng chọn gói giảm giá",
  请选择通知方式: "Vui lòng chọn phương thức thông báo",
  请选择需要封禁的模型: "Vui lòng chọn mẫu bị cấm",
  ...
  调用模型排名: "Xếp hạng mô hình cuộc gọi",
  调用次数: "Số lần gọi",
  ...
  跨夜范围: "phạm vi qua đêm",
  跨阶梯: "qua cái thang",
  路径正则: "Regex đường dẫn",
  "路径正则（每行一个）": "Regex đường dẫn (mỗi dòng một mục)",
  跳转: "Nhảy",
  跳转支付: "",
  转大写: "Chuyển sang chữ hoa",
  转小写: "Chuyển sang chữ thường",
  转换: "Chuyển thành",
  转账: "Chuyển tiền",
  ...
  软错误: "lỗi mềm",
  "轻量化易用，低成本落地": "Gọn nhẹ dễ dùng, triển khai chi phí thấp",
  较早: "",
  输入: "Đầu vào",
  "输入 {{price}} / 1M tokens": "Đầu vào {{price}} / 1M tokens",
  "输入 $/1M tokens": "Nhập mã thông báo $/1 triệu",
  ...
  "输入 Token": "Nhập mã thông báo",
  "输入 Token 定价": "Nhập giá mã thông báo",
  "输入 Token 总量": "Nhập tổng số lượng Token",
  "输入 Token 数": "Nhập số lượng Token",
  "输入 Token 数 (p)": "Nhập số lượng Token (p)",
  "输入 Token 数量，查看按当前配置的预计费用。": "Nhập số lượng token để xem chi phí ước tính dựa trên cấu hình hiện tại.",
  "输入 Token 数量，查看按当前配置的预计费用（不含分组倍率）。": "Nhập số lượng Token để xem chi phí ước tính dựa trên cấu hình hiện tại (không bao gồm hệ số nhân nhóm).",
  "输入 Token 数量，查看按当前阶梯配置的预计费用。": "Nhập số lượng Token để xem chi phí ước tính dựa trên cấu hình cấp hiện tại.",
  "输入 Tokens 阶梯": "Nhập bậc thang Token",
  ...
  输入每次调用价格: "Nhập giá mỗi cuộc gọi",
  "输入消息…": "Type a message…",
  ...
  "输入计费表达式...": "Nhập biểu thức thanh toán...",
  ...
  "输出 Token": "Mã thông báo đầu ra",
  "输出 Token 定价": "Định giá mã thông báo đầu ra",
  "输出 Token 数": "Xuất số lượng Token",
  "输出 Token 数 (c)": "Xuất ra số lượng Token (c)",
  "输出 Tokens 阶梯": "Thang mã thông báo đầu ra",
  ...
  输出倍率: "Độ phóng đại đầu ra",
  "输出倍率 {{completionRatio}}": "Output ratio {{completionRatio}}",
  输出内容记录审查: "Đánh giá hồ sơ nội dung đầu ra",
  输出格式: "",
  输出阶梯: "Thang đầu ra",
  ...
  近7天可用性: "",
  返余额: "Trả lại số dư",
  返利到账: "Đã nhận được giảm giá",
  返利套餐: "Gói giảm giá",
  返利方式: "Phương thức giảm giá",
  返利百分比: "Tỷ lệ hoàn tiền",
  返利结果: "Kết quả giảm giá",
  返利规则: "Quy tắc giảm giá",
  返回: "Quay lại",
  返回上级: "Quay lại cấp trên",
  返回修改: "Go back and edit",
  返回列表: "Quay lại danh sách",
  返回文档首页: "Về trang chủ tài liệu",
  返回登录: "Quay lại đăng nhập",
  返回错误: "lỗi trả về",
  返回首页: "Quay lại trang chủ",
  返套餐: "Gói trả lại",
  "这个公式比较复杂，下面的简化表单没法完整还原，请在表达式编辑模式下修改。": "Công thức này tương đối phức tạp và không thể khôi phục hoàn toàn bằng dạng đơn giản dưới đây. Vui lòng sửa đổi nó trong chế độ chỉnh sửa biểu thức.",
  ...
  这里会显示生成结果: "Kết quả tạo ra sẽ hiển thị ở đây",
  这里会显示视频结果: "",
  "这里直接编辑 JSON 对象。适合简单覆盖参数的场景。": "Chỉnh sửa đối tượng JSON trực tiếp tại đây. Phù hợp cho các trường hợp ghi đè tham số đơn giản.",
  "这里配置 Waffo 下展示给用户的 Card、Apple Pay、Google Pay 等子支付方式。": "Tại đây, hãy định cấu hình thẻ, Apple Pay, Google Pay và các phương thức thanh toán phụ khác được hiển thị cho người dùng trong Waffo.",
  "这里配置代理用户的默认首充和复充分成比例。单个用户如关闭“使用系统默认比例”，则以用户自身设置为准。": 'Ở đây, số tiền gửi và trả nợ đầu tiên mặc định của người dùng đại lý được định cấu hình theo tỷ lệ. Nếu một người dùng tắt "Sử dụng tỷ lệ mặc định của hệ thống", cài đặt của chính người dùng đó sẽ được ưu tiên.',
  进入: "Nhập",
  进入此档额外收费: "Có một khoản phí bổ sung để nhập tập tin này",
  进度: "Tiến độ",
  进行中: "Đang tiến hành",
  ...
  退出设备失败: "",
  退款: "Hoàn tiền",
  "适合任务类等按次收费模型。": "Phù hợp với các mô hình tác vụ tính phí theo lượt gọi.",
  ...
  "适用于统一下单返回 payUrl 的聚合支付网关。当前接入包含：下单、异步回调验签和充值入账。": "Cổng thanh toán tổng hợp phù hợp với payUrl trả lại đơn hàng thống nhất. Quyền truy cập hiện tại bao gồm: đặt hàng, xác minh chữ ký gọi lại không đồng bộ và nạp tiền vào tài khoản.",
  ...
  "选择金额后直接跳转到 Waffo Pancake 结账页，支付完成后会回到账户页。": "Sau khi chọn số lượng, bạn sẽ chuyển thẳng đến trang thanh toán Waffo Pancake. Sau khi thanh toán hoàn tất, bạn sẽ quay lại trang tài khoản.",
  "选择预设...": "Chọn cài đặt trước...",
  "选择预设模板（可选）": "Chọn mẫu đặt trước (tùy chọn)",
  选项: "Tùy chọn",
  透传请求体: "Truyền qua thân yêu cầu",
  透传请求头: "Tiêu đề yêu cầu minh bạch",
  递归: "Đệ quy",
  ...
  邀请流水: "Mời nước chảy",
  邀请用户: "Người dùng được mời",
  邀请用户数: "Số lượng người dùng được mời",
  "邀请的好友越多，获得的奖励越多": "Mời càng nhiều bạn bè, bạn càng nhận được nhiều phần thưởng",
  邀请码: "Mã mời",
  邀请码奖励: "Phần thưởng mã mời",
  邀请码已复制: "Mã lời mời đã được sao chép",
  邀请获得额度: "Hạn ngạch nhận được từ lời mời",
  邀请计划: "kế hoạch mời",
  "邀请计划会在被邀请用户每次充值时向其邀请人返利（仅返利一层，订阅购买仍仅首次）。": "Chương trình hoàn tiền cho người mời mỗi khi người được mời nạp tiền (chỉ một cấp; mua gói đăng ký chỉ hoàn ở lần thanh toán đầu).",
  邀请返利: "Mời giảm giá",
  邀请返利规则配置: "Cấu hình quy tắc giảm giá lời mời",
  邀请链接: "Liên kết mời",
  邀请链接已复制: "Đã sao chép liên kết lời mời",
  ...
  "配置 Waffo 充值时可用的支付方式，保存后在充值页面展示给用户。": "Định cấu hình các phương thức thanh toán khả dụng khi nạp tiền Waffo và lưu chúng để hiển thị cho người dùng trên trang nạp tiền.",
  ...
  "配置到 CC Switch": "",
  "配置各工具的调用价格（$/1K次调用）。按次计费模型不额外收取工具费用。": "Định cấu hình giá cuộc gọi của từng công cụ ($/1 nghìn cuộc gọi). Không có phí công cụ bổ sung cho mô hình trả tiền cho mỗi lần xem.",
  配置名称: "Tên cấu hình",
  "配置后会在所有渠道请求中统一拼接到系统提示词前，可用于全局内容过滤": "Sau khi cấu hình, nó sẽ được ghép thống nhất trước từ nhắc nhở của hệ thống trong tất cả các yêu cầu kênh và có thể được sử dụng để lọc nội dung toàn cầu.",
  ...
  "配置计划名称、启用状态、优先级和备注": "Định cấu hình tên gói, trạng thái kích hoạt, mức độ ưu tiên và nhận xét",
  ...
  队列中: "Trong hàng đợi",
  阶: "mức độ",
  "阶梯内 Token 数": "Số lượng Token trong bậc thang",
  阶梯判断依据: "Cơ sở phán đoán bậc thang",
  阶梯序号: "Số thang",
  阶梯累进: "Tiến trình thang",
  阶梯计费: "Thanh toán theo cấp độ",
  "阶梯计费（表达式解析失败）": "Thanh toán theo từng cấp (phân tích biểu thức không thành công)",
  阶梯计费详情: "Chi tiết thanh toán theo từng cấp",
  阶梯配置摘要: "Tóm tắt cấu hình thang",
  ...
  音频补全倍率: "tỷ lệ hoàn thành âm thanh",
  ...
  音频输入倍率: "Độ phóng đại đầu vào âm thanh",
  ...
  首充: "Lần sạc đầu tiên",
  首充佣金: "Hoa hồng tiền gửi đầu tiên",
  首充分成比例: "Hoàn toàn tỷ lệ thuận",
  首充用户: "Người dùng nạp tiền đầu tiên",
  "首充赠送最大额度不能小于 0": "Số tiền tối đa của quà tặng gửi lần đầu không thể nhỏ hơn 0",
  "首充赠送比例不能小于 0": "Tỷ lệ thưởng khi gửi tiền lần đầu không thể nhỏ hơn 0",
  首充赠送结束时间: "Thời gian kết thúc thưởng tiền gửi lần đầu",
  "首充赠送起充额度不能小于 0": "Số tiền gửi tối thiểu cho quà tặng gửi lần đầu không thể nhỏ hơn 0",
  "首单已消费，但未命中返利计划": "Đơn hàng đầu tiên đã được sử dụng nhưng gói giảm giá không được chọn.",
  首单状态: "Trạng thái đơn hàng đầu tiên",
  首尾帧生成: "",
  ...
  首帧生成: "",
  首帧生视频: "Tạo video từ khung hình đầu",
  首页: "Trang chủ",
  ...
  高危操作确认: "Xác nhận các hoạt động có rủi ro cao",
  高危状态码重试风险告知与免责声明Markdown: "Thông báo và tuyên bố từ chối trách nhiệm về việc thử lại mã trạng thái rủi ro cao Markdown",
  高危状态码重试风险确认输入文本: "Mã trạng thái rủi ro cao thử lại văn bản nhập xác nhận rủi ro",
  高危状态码重试风险确认项1: "Mã trạng thái rủi ro cao thử lại mục xác nhận rủi ro 1",
  高危状态码重试风险确认项2: "Mã trạng thái rủi ro cao thử lại mục xác nhận rủi ro 2",
  高危状态码重试风险确认项3: "Mã trạng thái rủi ro cao thử lại mục xác nhận rủi ro 3",
  高危状态码重试风险确认项4: "Mã trạng thái rủi ro cao thử lại mục xác nhận rủi ro 4",
  高危状态码重试风险输入不匹配提示: "Lời nhắc thử lại mã trạng thái rủi ro cao có rủi ro nhập không khớp",
  高危状态码重试风险输入框占位文案: "Bản giữ chỗ của hộp nhập liệu có rủi ro cao khi thử lại mã trạng thái rủi ro cao",
  高并发接口调度: "Điều phối API đồng thời cao",
  高度: "",
  高效: "",
  高级: "Nâng cao",
  ...
  "默认使用 USD 结算": "Việc thanh toán bằng USD được sử dụng theo mặc định",
  ...
  默认复充分成比例: "Phức tạp mặc định hoàn toàn tỷ lệ thuận",
  默认异步回调地址: "Địa chỉ gọi lại không đồng bộ mặc định",
  ...
  默认首充分成比例: "Mặc định đầu tiên là hoàn toàn tỷ lệ thuận",
  ...
  "协助码仅用于客服定位案件，不能用于登录；案件关闭后停止使用，永久案件编号仍可用于历史查询。客服收到协助码后，才能在客服后台定位案件并查看已授权的协助案件及其允许的资料进行排查。客服协助不是网站内的在线客服，网站不提供即时聊天，实际沟通请在微信群完成。": "Mã hỗ trợ chỉ dùng để nhân viên tìm hồ sơ và không thể dùng để đăng nhập. Mã hết hiệu lực khi hồ sơ đóng, còn số hồ sơ cố định vẫn dùng được để tra cứu lịch sử. Sau khi nhận mã, nhân viên mới có thể định vị hồ sơ trong bảng điều khiển và kiểm tra dữ liệu được cho phép. Đây không phải là hỗ trợ trực tuyến: website không có chat thời gian thực, việc trao đổi diễn ra trong nhóm WeChat.",
  协助定位码已更新: "Assistance locator updated",
  "遇到问题请先在网站提交“请求协助”，提交后会取得永久案件编号和六位协助码（协助定位码），请将该码带到微信群发给客服。": "Nếu gặp vấn đề, trước tiên hãy gửi yêu cầu “Yêu cầu hỗ trợ” trên website. Bạn sẽ nhận được số hồ sơ cố định và mã hỗ trợ sáu ký tự; hãy gửi mã này cho nhân viên trong nhóm WeChat.",
  处理截止时间: "Handling deadline",
  案件编号: "Case number",
  "客服协助与工单是两个不同功能，客服协助不是在线客服，也不是工单对话；如需正式提交和跟进工单，请使用工单功能。请在下方描述问题，提交后将协助码带到微信群发给客服。": "Hỗ trợ và ticket là hai tính năng khác nhau. Hỗ trợ không phải chat trực tuyến hay hội thoại ticket. Hãy dùng tính năng ticket để gửi và theo dõi yêu cầu chính thức. Mô tả vấn đề bên dưới, sau đó gửi mã hỗ trợ cho nhân viên trong nhóm WeChat.",
