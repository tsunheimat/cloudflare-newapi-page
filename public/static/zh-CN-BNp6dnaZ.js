const e = {
  " + Web搜索 {{count}}次 / 1K 次 * {{symbol}}{{price}} * {{ratioType}} {{ratio}}_one": " + Web搜索 {{count}}次 / 1K 次 * {{symbol}}{{price}} * {{ratioType}} {{ratio}}_one",
  ...
  " + 文件搜索 {{count}}次 / 1K 次 * {{symbol}}{{price}} * {{ratioType}} {{ratio}}_one": " + 文件搜索 {{count}}次 / 1K 次 * {{symbol}}{{price}} * {{ratioType}} {{ratio}}_one",
  ...
  "{{count}} 条结果": "{{count}} 条结果",
  "{{count}} 项操作_one": "{{count}} 项操作_one",
  "{{count}} 项操作_other": "{{count}} 项操作",
  ...
  "{{min}} - {{max}} 秒": "{{min}} - {{max}} 秒",
  "{{mode}}下最多添加 {{limit}} 张参考图": "{{mode}}下最多添加 {{limit}} 张参考图",
  "{{mode}}下至少需要 {{limit}} 张参考图": "{{mode}}下至少需要 {{limit}} 张参考图",
  "{{n}} 分钟前": "{{n}} 分钟前",
  "{{n}} 天前": "{{n}} 天前",
  "{{n}} 小时前": "{{n}} 小时前",
  "{{n}} 秒前": "{{n}} 秒前",
  "{{n}}s 后刷新": "{{n}}s 后刷新",
  "{{name}} ID": "{{name}} ID",
  "{{name}} 为企业、开发者和团队提供统一、稳定、安全的数字服务，帮助用户降低项目接入、权限配置、运行监控和成本控制的复杂度。": "{{name}} 为企业、开发者和团队提供统一、稳定、安全的数字服务，帮助用户降低项目接入、权限配置、运行监控和成本控制的复杂度。",
  "{{name}} 围绕企业级使用场景构建安全机制，关注数据传输安全、访问权限可控和调用行为可追溯，帮助团队在使用 AI 能力时保持清晰、可控和可信。": "{{name}} 围绕企业级使用场景构建安全机制，关注数据传输安全、访问权限可控和调用行为可追溯，帮助团队在使用 AI 能力时保持清晰、可控和可信。",
  "{{name}} 希望访问你的账号": "{{name}} 希望访问你的账号",
  "{{name}} 面向企业、开发者和团队提供稳定、安全、易用的数字服务，帮助用户简化项目管理、权限配置、运行监控和成本控制。": "{{name}} 面向企业、开发者和团队提供稳定、安全、易用的数字服务，帮助用户简化项目管理、权限配置、运行监控和成本控制。",
  "{{percent}}% of official": "{{percent}}% 官方",
  "{{ratio}} · 分组倍率": "{{ratio}} · 分组倍率",
  "{{ratioType}} {{ratio}}": "{{ratioType}} {{ratio}}",
  "{{ratioType}} {{ratio}}x": "{{ratioType}} {{ratio}}x",
  "{{up}}/{{total}} 个模型运行正常": "{{up}}/{{total}} 个模型运行正常",
  "「有参考影片」指请求里带了参考/输入影片；生成结果本身是影片并不会选中该费率。最终结算以上游返回的 usage.completion_tokens 为准。": "「有参考影片」指请求里带了参考/输入影片；生成结果本身是影片并不会选中该费率。最终结算以上游返回的 usage.completion_tokens 为准。",
  "「用户可选」决定用户创建令牌时能否自主选择该分组。未勾选的分组只能由管理员在后台分配给用户，不会出现在用户的令牌创建页面中。": "「用户可选」决定用户创建令牌时能否自主选择该分组。未勾选的分组只能由管理员在后台分配给用户，不会出现在用户的令牌创建页面中。",
  "/ 1{{unit}} tokens": "/ 1{{unit}} tokens",
  "/ 1M 影片补全 tokens": "/ 1M 影片补全 tokens",
  ...
  "1:1 正方形": "1:1 正方形",
  "1. 管理员在此创建分组并设置倍率": "1. 管理员在此创建分组并设置倍率",
  ...
  "2 - 低": "2 - 低",
  "2:3 竖向": "2:3 竖向",
  "2. 管理员在用户管理中将用户分配到对应分组（如 vip）": "2. 管理员在用户管理中将用户分配到对应分组（如 vip）",
  '2025年5月10日后添加的渠道，不需要再在部署的时候移除模型名称中的"."': '2025年5月10日后添加的渠道，不需要再在部署的时候移除模型名称中的"."',
  "3:2 横向": "3:2 横向",
  "3. 用户创建令牌时，下拉菜单中出现勾选了「用户可选」的分组": "3. 用户创建令牌时，下拉菜单中出现勾选了「用户可选」的分组",
  "30天": "30天",
  "32位密钥，敏感信息不显示": "32位密钥，敏感信息不显示",
  "360智脑": "360智脑",
  "4. 令牌使用所选分组的倍率进行计费": "4. 令牌使用所选分组的倍率进行计费",
  "5 - 正常（默认）": "5 - 正常（默认）",
  ...
  "API 密钥 (沙盒)": "API 密钥 (沙盒)",
  "API 密钥 (生产)": "API 密钥 (生产)",
  "API 密钥（测试环境）": "API 密钥（测试环境）",
  "API 密钥（生产环境）": "API 密钥（生产环境）",
  "API 指南": "API 指南",
  "API 文档": "API 文档",
  "API 私钥": "API 私钥",
  "API 私钥（测试环境）": "API 私钥（测试环境）",
  "API 私钥（生产环境）": "API 私钥（生产环境）",
  "API 配置": "API 配置",
  API令牌管理: "API令牌管理",
  API使用记录: "API使用记录",
  API信息: "API信息",
  ...
  "Creem 充值": "Creem 充值",
  "Creem 设置": "Creem 设置",
  "DALL·E 3 横向": "DALL·E 3 横向",
  "DALL·E 3 竖向": "DALL·E 3 竖向",
  "default 和 vip 只能由管理员在「用户管理」中分配给用户。适用于按用户等级定价、内部测试等不希望用户自主选择的场景。": "default 和 vip 只能由管理员在「用户管理」中分配给用户。适用于按用户等级定价、内部测试等不希望用户自主选择的场景。",
  ...
  "reCAPTCHA 校验初始化失败，请刷新页面后重试": "reCAPTCHA 校验初始化失败，请刷新页面后重试",
  "Recharge Quota": "充值额度",
  ...
  "standard 已被移除，vip 用户看不到": "standard 已被移除，vip 用户看不到",
  "Store ID": "Store ID",
  ...
  "Token 类型": "Token 类型",
  "TokenRouter项目仓库地址：": "TokenRouter项目仓库地址：",
  ...
  "Waffo API 参数，可空，例如：CREDITCARD,DEBITCARD（最多64位）": "Waffo API 参数，可空，例如：CREDITCARD,DEBITCARD（最多64位）",
  "Waffo API 参数，可空（最多64位）": "Waffo API 参数，可空（最多64位）",
  "Waffo Pancake": "Waffo Pancake",
  "Waffo Pancake 设置": "Waffo Pancake 设置",
  "Waffo 充值": "Waffo 充值",
  "Waffo 充值的最低数量，默认 1": "Waffo 充值的最低数量，默认 1",
  "Waffo 公钥 (沙盒)": "Waffo 公钥 (沙盒)",
  "Waffo 公钥 (生产)": "Waffo 公钥 (生产)",
  "Waffo 公钥（测试环境）": "Waffo 公钥（测试环境）",
  "Waffo 公钥（生产环境）": "Waffo 公钥（生产环境）",
  "Waffo 商户 ID": "Waffo 商户 ID",
  "Waffo 当前使用 USD 结算": "Waffo 当前使用 USD 结算",
  "Waffo 是一个支付聚合平台，支持多种支付方式。": "Waffo 是一个支付聚合平台，支持多种支付方式。",
  "Waffo 设置": "Waffo 设置",
  "Web 搜索 {{count}} 次 * {{symbol}}{{price}} / 1K 次": "Web 搜索 {{count}} 次 * {{symbol}}{{price}} / 1K 次",
  ...
  "Webhook 公钥（测试环境）": "Webhook 公钥（测试环境）",
  "Webhook 公钥（生产环境）": "Webhook 公钥（生产环境）",
  ...
  Worker地址: "Worker地址",
  Worker密钥: "Worker密钥",
  'X 也可以小于 1，当折扣用。想做"只给输出加价"或"额外加固定费用"，请直接写完整计费公式。': 'X 也可以小于 1，当折扣用。想做"只给输出加价"或"额外加固定费用"，请直接写完整计费公式。',
  一个平台管理多种企业服务: "一个平台管理多种企业服务",
  一个月: "一个月",
  一天: "一天",
  一小时: "一小时",
  一次性余额充值: "一次性余额充值",
  ...
  上一步: "上一步",
  上一页: "上一页",
  "上传 PNG/JPG/SVG 图片，建议尺寸 ≤ 128×128px": "上传 PNG/JPG/SVG 图片，建议尺寸 ≤ 128×128px",
  上传参考图: "上传参考图",
  上传后将在这里预览参考图: "上传后将在这里预览参考图",
  上传图片: "上传图片",
  上传失败: "上传失败",
  上传微信群二维码图片: "上传微信群二维码图片",
  "上次保存: ": "上次保存: ",
  上次检测到可加入模型: "上次检测到可加入模型",
  上次检测时间: "上次检测时间",
  上游价格同步: "上游价格同步",
  上游倍率同步: "上游倍率同步",
  上游已删除的模型: "上游已删除的模型",
  ...
  下载文件: "下载文件",
  下载日志: "下载日志",
  下载管理员发布的安装包和资料: "下载管理员发布的安装包和资料",
  "下面展示这个模型保存后会写入哪些后端字段，便于和原始 JSON 编辑框保持一致。": "下面展示这个模型保存后会写入哪些后端字段，便于和原始 JSON 编辑框保持一致。",
  "下面是带注释的示例，仅用于参考；实际保存时请删除注释。": "下面是带注释的示例，仅用于参考；实际保存时请删除注释。",
  不会出现: "不会出现",
  不再提醒: "不再提醒",
  不勾选用户可选: "不勾选用户可选",
  不升级: "不升级",
  ...
  不设上限: "不设上限",
  "不配置特殊倍率时：": "不配置特殊倍率时：",
  "不配置规则时，所有用户看到的下拉框一样：": "不配置规则时，所有用户看到的下拉框一样：",
  不重置: "不重置",
  不重试: "不重试",
  不限: "不限",
  不限制: "不限制",
  ...
  专属倍率: "专属倍率",
  专属分组: "专属分组",
  "专注企业级数字服务，让业务运行更稳定、更安全、更高效": "专注企业级数字服务，让业务运行更稳定、更安全、更高效",
  "两个分组都勾选了「用户可选」，所以用户创建令牌时可以看到这两个选项：": "两个分组都勾选了「用户可选」，所以用户创建令牌时可以看到这两个选项：",
  ...
  "为什么 default 不勾选「用户可选」？": "为什么 default 不勾选「用户可选」？",
  "为保证匹配准确，请确保客户端直连本站点（避免反向代理/网关改写 User-Agent）。": "为保证匹配准确，请确保客户端直连本站点（避免反向代理/网关改写 User-Agent）。",
  为模型前缀覆盖: "为模型前缀覆盖",
  "为特定用户分组配置可用分组的增减规则。「添加」为该分组新增可用分组，「移除」移除默认可用分组，「追加」直接追加分组": "为特定用户分组配置可用分组的增减规则。「添加」为该分组新增可用分组，「移除」移除默认可用分组，「追加」直接追加分组",
  ...
  "仅在线充值订单可以开票；商店充值与商店兑换不在开票范围内。开票金额以充值记录的实际支付金额为准。": "仅在线充值订单可以开票；商店充值与商店兑换不在开票范围内。开票金额以充值记录的实际支付金额为准。",
  仅密钥: "仅密钥",
  仅对自定义模型有效: "仅对自定义模型有效",
  仅当前层: "仅当前层",
  ...
  仅提交已勾选: "仅提交已勾选",
  仅支持: "仅支持",
  "仅支持 JPEG / PNG / WebP 格式的图片": "仅支持 JPEG / PNG / WebP 格式的图片",
  ...
  仅用订阅: "仅用订阅",
  仅用钱包: "仅用钱包",
  "仅管理员可用。开启后，当系统定时检测全部渠道发现上游模型变更或检测异常时，将按你选择的通知方式发送汇总通知；渠道或模型过多时会自动省略部分明细。": "仅管理员可用。开启后，当系统定时检测全部渠道发现上游模型变更或检测异常时，将按你选择的通知方式发送汇总通知；渠道或模型过多时会自动省略部分明细。",
  "仅统计成功充值订单，按完成时间归档。": "仅统计成功充值订单，按完成时间归档。",
  仅自己: "仅自己",
  仅重置配置: "仅重置配置",
  今日充值: "今日充值",
  今日兑换: "今日兑换",
  ...
  今日调用: "今日调用",
  仍有未处理项: "仍有未处理项",
  "从 0.5 降到 0.3": "从 0.5 降到 0.3",
  "从侧边栏选择页面，或使用 Ctrl/Cmd+K 搜索。": "从侧边栏选择页面，或使用 Ctrl/Cmd+K 搜索。",
  从剪贴板粘贴配置: "从剪贴板粘贴配置",
  "从在线充值记录选择订单申请开票，可选择多笔订单合并开票。": "从在线充值记录选择订单申请开票，可选择多笔订单合并开票。",
  从官方模型库同步: "从官方模型库同步",
  从接入到规模化调用: "从接入到规模化调用",
  "从模型接入到稳定调用，从权限管理到成本优化，构建可持续的 AI 调用基础设施。": "从模型接入到稳定调用，从权限管理到成本优化，构建可持续的 AI 调用基础设施。",
  "从认证器应用中获取验证码，或使用备用码": "从认证器应用中获取验证码，或使用备用码",
  从配置文件同步: "从配置文件同步",
  从默认列表中去掉一个分组: "从默认列表中去掉一个分组",
  付款完成后将自动回到账户页: "付款完成后将自动回到账户页",
  付费用户: "付费用户",
  代理佣金已扣减: "代理佣金已扣减",
  代理分销: "代理分销",
  "代理分销信息加载中...": "代理分销信息加载中...",
  "代理分销比例不能大于 100": "代理分销比例不能大于 100",
  "代理分销比例不能小于 0": "代理分销比例不能小于 0",
  代理分销默认配置: "代理分销默认配置",
  代理地址: "代理地址",
  代理已启用: "代理已启用",
  代理设置: "代理设置",
  "代理邀请码、邀请用户和佣金流水": "代理邀请码、邀请用户和佣金流水",
  代码已复制到剪贴板: "代码已复制到剪贴板",
  代码示例: "代码示例",
  "代表你发起 AI 请求（费用记在你的账户）": "代表你发起 AI 请求（费用记在你的账户）",
  令牌: "令牌",
  "令牌 / 密钥": "令牌 / 密钥",
  令牌不存在: "令牌不存在",
  令牌分组: "令牌分组",
  "令牌分组，默认为用户的分组": "令牌分组，默认为用户的分组",
  "令牌分组设为 auto 时，按以下顺序依次尝试选择可用分组，排在前面的优先级更高": "令牌分组设为 auto 时，按以下顺序依次尝试选择可用分组，排在前面的优先级更高",
  "令牌分组设为 auto 时，系统按优先级顺序自动选择一个可用分组。": "令牌分组设为 auto 时，系统按优先级顺序自动选择一个可用分组。",
  ...
  "价格为参考估算，实际计费以模型、渠道为准": "价格为参考估算，实际计费以模型、渠道为准",
  价格可视化对比: "价格可视化对比",
  价格摘要: "价格摘要",
  ...
  企业应用集成: "企业应用集成",
  企业服务平台: "企业服务平台",
  "企业级稳定，高可用运行": "企业级稳定，高可用运行",
  企业级稳定运行: "企业级稳定运行",
  "企业账户为特殊返回格式，需要特殊处理，如果非企业账户，请勿勾选": "企业账户为特殊返回格式，需要特殊处理，如果非企业账户，请勿勾选",
  优先级: "优先级",
  优先订阅: "优先订阅",
  优先钱包: "优先钱包",
  "优化服务流程与资源调度，减少请求卡顿和超时，适配高频率、高并发的企业使用场景。": "优化服务流程与资源调度，减少请求卡顿和超时，适配高频率、高并发的企业使用场景。",
  优化流程提升业务成功率: "优化流程提升业务成功率",
  优化链路支撑业务运行: "优化链路支撑业务运行",
  优惠: "优惠",
  ...
  余额地址: "余额地址",
  余额返利: "余额返利",
  "余额返利直接返到邀请人的钱包余额；套餐返利会正常执行套餐分组升级": "余额返利直接返到邀请人的钱包余额；套餐返利会正常执行套餐分组升级",
  "余额返利直接返到邀请人钱包；套餐返利会按套餐自身规则执行分组升级": "余额返利直接返到邀请人钱包；套餐返利会按套餐自身规则执行分组升级",
  作废: "作废",
  作废于: "作废于",
  "作废后该订阅将立即失效，历史记录不受影响。是否继续？": "作废后该订阅将立即失效，历史记录不受影响。是否继续？",
  作用域: "作用域",
  "作用域：包含分组": "作用域：包含分组",
  "作用域：包含模型名称": "作用域：包含模型名称",
  ...
  "你可以随时在「个人设置 - 已授权应用」中解除该应用的授权。": "你可以随时在「个人设置 - 已授权应用」中解除该应用的授权。",
  "你还没有处理{{type}}模型（{{count}}个）。是否仅提交当前已勾选内容？_one": "你还没有处理{{type}}模型（{{count}}个）。是否仅提交当前已勾选内容？_one",
  "你还没有处理{{type}}模型（{{count}}个）。是否仅提交当前已勾选内容？_other": "你还没有处理{{type}}模型（{{count}}个）。是否仅提交当前已勾选内容？",
  你还没有授权任何应用: "你还没有授权任何应用",
  佣金余额: "佣金余额",
  "佣金支出 / 净流入": "佣金支出 / 净流入",
  佣金流水: "佣金流水",
  佣金订单数: "佣金订单数",
  ...
  使用分组: "使用分组",
  使用原生额度输入: "使用原生额度输入",
  使用尾帧图时必须同时提供首帧图: "使用尾帧图时必须同时提供首帧图",
  使用日志: "使用日志",
  使用模式: "使用模式",
  使用系统默认比例: "使用系统默认比例",
  使用统计: "使用统计",
  ...
  "例如 10 表示新用户首充成功后，代理可获得实付金额的 10%": "例如 10 表示新用户首充成功后，代理可获得实付金额的 10%",
  "例如 901": "例如 901",
  ...
  "例如：sk_xxx 或 rk_xxx，留空表示保持当前不变": "例如：sk_xxx 或 rk_xxx，留空表示保持当前不变",
  "例如：STO_xxx": "例如：STO_xxx",
  "例如：sub、id、data.user.id": "例如：sub、id、data.user.id",
  "例如：whsec_xxx，留空表示保持当前不变": "例如：whsec_xxx，留空表示保持当前不变",
  "例如：分组设置错误导致请求失败": "例如：分组设置错误导致请求失败",
  "例如：基础套餐": "例如：基础套餐",
  "例如：微信群昵称": "例如：微信群昵称",
  "例如：清理工具参数，避免上游校验错误": "例如：清理工具参数，避免上游校验错误",
  ...
  保存代理分销默认配置: "保存代理分销默认配置",
  保存修改: "保存修改",
  保存内容审查配置: "保存内容审查配置",
  保存分组倍率设置: "保存分组倍率设置",
  保存分组相关设置: "保存分组相关设置",
  "保存后不会回显，请填写当前环境对应的 API 私钥": "保存后不会回显，请填写当前环境对应的 API 私钥",
  "保存后不会回显，请填写当前环境对应的 Stripe API 密钥": "保存后不会回显，请填写当前环境对应的 Stripe API 密钥",
  "保存后不会回显，请填写测试环境对应的 API 密钥": "保存后不会回显，请填写测试环境对应的 API 密钥",
  "保存后不会回显，请填写测试环境对应的 API 私钥": "保存后不会回显，请填写测试环境对应的 API 私钥",
  "保存后不会回显，请填写生产环境对应的 API 密钥": "保存后不会回显，请填写生产环境对应的 API 密钥",
  "保存后不会回显，请填写生产环境对应的 API 私钥": "保存后不会回显，请填写生产环境对应的 API 私钥",
  保存备用码: "保存备用码",
  ...
  保存预览: "保存预览",
  保存额度设置: "保存额度设置",
  "保护密钥、数据和权限边界": "保护密钥、数据和权限边界",
  保持登录: "保持登录",
  "保持登录状态（可刷新访问）": "保持登录状态（可刷新访问）",
  保留: "保留",
  保留最近N个文件: "保留最近N个文件",
  保留最近N天: "保留最近N天",
  ...
  保留文件数: "保留文件数",
  信息: "信息",
  "信息不足，无法给出预估（缺少画面尺寸或该分辨率未配置价格）": "信息不足，无法给出预估（缺少画面尺寸或该分辨率未配置价格）",
  修复数据库一致性: "修复数据库一致性",
  修改为: "修改为",
  修改子渠道优先级: "修改子渠道优先级",
  修改子渠道权重: "修改子渠道权重",
  ...
  修改绑定: "修改绑定",
  修改要求已提交: "修改要求已提交",
  "修改要求已提交，等待操作员判断。资料在批准前保持锁定。": "修改要求已提交，等待操作员判断。资料在批准前保持锁定。",
  倍率: "倍率",
  倍率与优惠: "倍率与优惠",
  倍率信息: "倍率信息",
  ...
  倍率模式: "倍率模式",
  "倍率模式（默认）": "倍率模式（默认）",
  "倍率用于计费乘数，勾选「用户可选」后用户可在创建令牌时选择该分组": "倍率用于计费乘数，勾选「用户可选」后用户可在创建令牌时选择该分组",
  倍率类型: "倍率类型",
  值: "值",
  "假设再加两个分组 default 和 vip，但不勾选用户可选：": "假设再加两个分组 default 和 vip，但不勾选用户可选：",
  偏好设置: "偏好设置",
  停止测试: "停止测试",
  停止重试: "停止重试",
  停用: "停用",
  ...
  "允许的时长范围：{{min}} - {{max}} 秒": "允许的时长范围：{{min}} - {{max}} 秒",
  允许的端口: "允许的端口",
  ...
  充值确认: "充值确认",
  充值类型: "充值类型",
  "充值类计划对每次充值生效，订阅类计划仅首次生效": "充值类计划对每次充值生效，订阅类计划仅首次生效",
  充值订单: "充值订单",
  充值记录和状态查询: "充值记录和状态查询",
  充值账单: "充值账单",
  充值金额: "充值金额",
  ...
  全部类型: "全部类型",
  全部退出: "全部退出",
  "全面适配 Web 开发、小程序、APP、政企系统、第三方平台对接等各类场景，支持多协议与多数据格式，无缝衔接各类业务系统。": "全面适配 Web 开发、小程序、APP、政企系统、第三方平台对接等各类场景，支持多协议与多数据格式，无缝衔接各类业务系统。",
  公告: "公告",
  公告内容: "公告内容",
  公告已更新: "公告已更新",
  公告更新失败: "公告更新失败",
  公告类型: "公告类型",
  共: "共",
  "共 {{count}} 个密钥_one": "共 {{count}} 个密钥_one",
  "共 {{count}} 个密钥_other": "共 {{count}} 个密钥",
  "共 {{count}} 个模型": "共 {{count}} 个模型",
  "共 {{count}} 个模型_one": "共 {{count}} 个模型_one",
  "共 {{count}} 个模型_other": "共 {{count}} 个模型",
  "共 {{count}} 条日志_one": "共 {{count}} 条日志_one",
  ...
  "关闭后客服将不再处理该案件，协助码也会停止使用。": "关闭后客服将不再处理该案件，协助码也会停止使用。",
  ...
  "内置接口鉴权、访问限流、异常拦截、数据加密等多重安全机制，精准拦截恶意请求，规范接口访问规则，全方位守护企业接口数据与业务安全。": "内置接口鉴权、访问限流、异常拦截、数据加密等多重安全机制，精准拦截恶意请求，规范接口访问规则，全方位守护企业接口数据与业务安全。",
  "内联图片总大小不能超过 {{limit}}": "内联图片总大小不能超过 {{limit}}",
  "内联图片总大小不能超过 45 MB": "内联图片总大小不能超过 45 MB",
  最优可用: "最优可用",
  最低: "最低",
  最低充值数量: "最低充值数量",
  ...
  最后登录: "最后登录",
  最后请求: "最后请求",
  "最多上传 {{count}} 张参考图_one": "最多上传 {{count}} 张参考图_one",
  "最多上传 {{count}} 张参考图_other": "最多上传 {{count}} 张参考图",
  最多只能指定一张尾帧图: "最多只能指定一张尾帧图",
  最多只能指定一张首帧图: "最多只能指定一张首帧图",
  "最多添加 {{limit}} 个参考视频": "最多添加 {{limit}} 个参考视频",
  "最多添加 {{limit}} 个参考音频": "最多添加 {{limit}} 个参考音频",
  "最多添加 {{limit}} 张参考图": "最多添加 {{limit}} 张参考图",
  最大GPU数量: "最大GPU数量",
  最大可用: "最大可用",
  最大条目数: "最大条目数",
  最大赠送额度: "最大赠送额度",
  ...
  减少: "减少",
  减少敏感配置暴露: "减少敏感配置暴露",
  "减少重复开发，快速进入生产环境": "减少重复开发，快速进入生产环境",
  凭证已刷新: "凭证已刷新",
  函数: "函数",
  分佣比例: "分佣比例",
  分佣订单数: "分佣订单数",
  ...
  分组与模型定价设置: "分组与模型定价设置",
  分组价格: "分组价格",
  "分组价格 = 官方价格 × 分组倍率 ÷ 7": "分组价格 = 官方价格 × 分组倍率 ÷ 7",
  分组倍率: "分组倍率",
  "分组倍率 {{ratio}} × 换算 {{rate}} = 相对官方价 {{effective}}": "分组倍率 {{ratio}} × 换算 {{rate}} = 相对官方价 {{effective}}",
  分组倍率设置: "分组倍率设置",
  ...
  分组名: "分组名",
  分组名称: "分组名称",
  分组名称到倍率的映射: "分组名称到倍率的映射",
  分组描述: "分组描述",
  "分组是用于控制计费倍率和模型访问权限的核心概念。每个用户属于一个分组，每个令牌也可以指定使用某个分组。": "分组是用于控制计费倍率和模型访问权限的核心概念。每个用户属于一个分组，每个令牌也可以指定使用某个分组。",
  分组特殊倍率: "分组特殊倍率",
  分组特殊可用分组: "分组特殊可用分组",
  分组相关设置: "分组相关设置",
  分组管理: "分组管理",
  ...
  "删除后无法恢复，且无返利记录的计划才允许删除": "删除后无法恢复，且无返利记录的计划才允许删除",
  '删除后无法恢复，确定要删除模型 "{{name}}" 吗？': '删除后无法恢复，确定要删除模型 "{{name}}" 吗？',
  删除失败: "删除失败",
  删除密钥失败: "删除密钥失败",
  "删除已选 {{selected}} / {{total}}": "删除已选 {{selected}} / {{total}}",
  删除成功: "删除成功",
  删除所选: "删除所选",
  删除所选令牌: "删除所选令牌",
  删除所选通道: "删除所选通道",
  ...
  动态计费: "动态计费",
  "勾选后，该分组会出现在用户创建令牌时的下拉菜单中。未勾选的分组只能由管理员分配，用户自己无法选择。": "勾选后，该分组会出现在用户创建令牌时的下拉菜单中。未勾选的分组只能由管理员分配，用户自己无法选择。",
  包含: "包含",
  ...
  匹配模式: "匹配模式",
  匹配类型: "匹配类型",
  "区分邀请返利与代理分销带来的充值与激励支出。": "区分邀请返利与代理分销带来的充值与激励支出。",
  区域: "区域",
  升级分组: "升级分组",
  协助码: "协助码",
  "协助码只用于客服定位你的案件，不能用于登录。协助码在 {{hours}} 小时后失效，可随时重新生成。": "协助码只用于客服定位你的案件，不能用于登录。协助码在 {{hours}} 小时后失效，可随时重新生成。",
  协助码已失效: "协助码已失效",
  协助码已更新: "协助码已更新",
  协助请求已创建: "协助请求已创建",
  单GPU小时费率: "单GPU小时费率",
  ...
  单位地址: "单位地址",
  单位电话: "单位电话",
  "单张图片上限 {{limit}}": "单张图片上限 {{limit}}",
  "单张图片大小不能超过 {{limit}}": "单张图片大小不能超过 {{limit}}",
  "单张图片大小不能超过 10 MB": "单张图片大小不能超过 10 MB",
  单条影片价格预估: "单条影片价格预估",
  占比: "占比",
  卡片视图: "卡片视图",
  危险: "危险",
  "历史数据已自动按年/月/日/小时汇总，今日尾段实时计算。": "历史数据已自动按年/月/日/小时汇总，今日尾段实时计算。",
  历史消耗: "历史消耗",
  原价: "原价",
  "原价，和普通用户一样": "原价，和普通用户一样",
  原因: "原因",
  "原因：": "原因：",
  原始额度: "原始额度",
  原密码: "原密码",
  ...
  参照生视频: "参照生视频",
  参考图: "参考图",
  "参考图（可选，最多 {{count}} 张）_one": "参考图（可选，最多 {{count}} 张）_one",
  "参考图（可选，最多 {{count}} 张）_other": "参考图（可选，最多 {{count}} 张）",
  "参考图（可选）": "参考图（可选）",
  "参考图已上传，本次将调用图生视频流程": "参考图已上传，本次将调用图生视频流程",
  "参考影片时长（秒）": "参考影片时长（秒）",
  参考生成: "参考生成",
  "参考视频（可选）": "参考视频（可选）",
  "参考视频链接（https）": "参考视频链接（https）",
  "参考视频链接必须是 https 链接": "参考视频链接必须是 https 链接",
  参考素材上限: "参考素材上限",
  参考素材生视频: "参考素材生视频",
  "参考音频（可选）": "参考音频（可选）",
  "参考音频链接（https）": "参考音频链接（https）",
  "参考音频链接必须是 https 链接": "参考音频链接必须是 https 链接",
  参考音频需要与参考图或参考视频一起使用: "参考音频需要与参考图或参考视频一起使用",
  友情链接: "友情链接",
  发布日期: "发布日期",
  发布时间: "发布时间",
  发放奖励: "发放奖励",
  ...
  发起协助请求: "发起协助请求",
  "发起协助请求后会得到一个协助码，请在微信群把协助码提供给客服。": "发起协助请求后会得到一个协助码，请在微信群把协助码提供给客服。",
  发送: "发送",
  发送失败: "发送失败",
  取消: "取消",
  取消全选: "取消全选",
  "取消后所选充值订单会重新变为可开票，申请记录与对话会保留。": "取消后所选充值订单会重新变为可开票，申请记录与对话会保留。",
  取消失败: "取消失败",
  取消开票申请: "取消开票申请",
  取消申请: "取消申请",
  取消选择: "取消选择",
  ...
  "只有配置了规则的组合才会覆盖，未配置的组合仍使用令牌分组的基础倍率。": "只有配置了规则的组合才会覆盖，未配置的组合仍使用令牌分组的基础倍率。",
  可以: "可以",
  "可以根据用户分组增减令牌可选的分组范围。例如 vip 用户额外开放 premium 分组，或移除某个分组的选择权。": "可以根据用户分组增减令牌可选的分组范围。例如 vip 用户额外开放 premium 分组，或移除某个分组的选择权。",
  "可以根据用户分组设置不同的计费倍率。例如 vip 用户使用 standard 令牌时倍率从 1.0 降为 0.8。": "可以根据用户分组设置不同的计费倍率。例如 vip 用户使用 standard 令牌时倍率从 1.0 降为 0.8。",
  可信: "可信",
  "可勾选需要执行的变更：新增会加入渠道模型列表，删除会从渠道模型列表移除。": "可勾选需要执行的变更：新增会加入渠道模型列表，删除会从渠道模型列表移除。",
  可参与次数: "可参与次数",
  "可参与次数按“单个邀请人”累计命中的不同被邀请用户数计算": "可参与次数按“单个邀请人”累计命中的不同被邀请用户数计算",
  可否选取: "可否选取",
  "可在设置页面设置关于内容，支持 HTML & Markdown": "可在设置页面设置关于内容，支持 HTML & Markdown",
  "可填写打款渠道、流水号或备注": "可填写打款渠道、流水号或备注",
  ...
  可选值: "可选值",
  可配置独立密钥管理: "可配置独立密钥管理",
  "各渠道成功率 / 失败率": "各渠道成功率 / 失败率",
  各渠道消耗额度: "各渠道消耗额度",
  "合计：{{total}}": "合计：{{total}}",
  "合计：文字部分 {{textTotal}} + 音频部分 {{audioTotal}} = {{total}}": "合计：文字部分 {{textTotal}} + 音频部分 {{audioTotal}} = {{total}}",
  "同一用户可以有多条记录，同一个模型出现在多条记录里也会正常生效。": "同一用户可以有多条记录，同一个模型出现在多条记录里也会正常生效。",
  "同优先级下，充值按更高金额门槛命中；套餐按更贵的触发套餐命中。": "同优先级下，充值按更高金额门槛命中；套餐按更贵的触发套餐命中。",
  同官方价: "同官方价",
  同时满足: "同时满足",
  同时重置消息: "同时重置消息",
  同步: "同步",
  ...
  "启用后将使用 Waffo 沙盒环境": "启用后将使用 Waffo 沙盒环境",
  启用图片生成审查: "启用图片生成审查",
  启用密钥失败: "启用密钥失败",
  启用屏蔽词过滤功能: "启用屏蔽词过滤功能",
  启用性能监控: "启用性能监控",
  ...
  "启用首充赠送时，赠送比例必须大于 0": "启用首充赠送时，赠送比例必须大于 0",
  启用首次充值赠送: "启用首次充值赠送",
  启用验证: "启用验证",
  周: "周",
  ...
  "命中多个充值门槛时，会按更高门槛的计划优先": "命中多个充值门槛时，会按更高门槛的计划优先",
  命中档位: "命中档位",
  命中活动: "命中活动",
  命中率: "命中率",
  ...
  固定阶梯: "固定阶梯",
  "国家/地区": "国家/地区",
  "国家/地区信息将用于适用法律法规、监管要求、平台合规策略及模型服务范围的判定。": "国家/地区信息将用于适用法律法规、监管要求、平台合规策略及模型服务范围的判定。",
  "国家/地区信息已更新": "国家/地区信息已更新",
  "国家/地区变更保存后将即时用于模型服务范围判定；提交不真实、不完整或无法核验的信息，平台可依据规则及适用法律法规采取进一步限制措施。": "国家/地区变更保存后将即时用于模型服务范围判定；提交不真实、不完整或无法核验的信息，平台可依据规则及适用法律法规采取进一步限制措施。",
  "图 {{images}} / 视频 {{videos}} / 音频 {{audios}}": "图 {{images}} / 视频 {{videos}} / 音频 {{audios}}",
  图像生成: "图像生成",
  图标: "图标",
  ...
  "图标文件不能超过 100KB，请压缩后重新上传": "图标文件不能超过 100KB，请压缩后重新上传",
  图混合: "图混合",
  "图片/音频价格（可选）": "图片/音频价格（可选）",
  图片倍率: "图片倍率",
  ...
  图片生成失败: "图片生成失败",
  图片生成完成: "图片生成完成",
  "图片生成审查（作用于 /pg 和 /v1 的 images/generations、images/edits）": "图片生成审查（作用于 /pg 和 /v1 的 images/generations、images/edits）",
  图片生成模型: "图片生成模型",
  ...
  "图片输入 {{tokens}} tokens / 1M tokens * {{symbol}}{{price}}": "图片输入 {{tokens}} tokens / 1M tokens * {{symbol}}{{price}}",
  ...
  图生文: "图生文",
  图生视频: "图生视频",
  "在 Stripe 后台创建价格后获得": "在 Stripe 后台创建价格后获得",
  ...
  在线充值活动: "在线充值活动",
  在默认列表基础上新增一个分组: "在默认列表基础上新增一个分组",
  "场景：站点提供两个价格档位，用户可以按需选择": "场景：站点提供两个价格档位，用户可以按需选择",
  "场景：站点有 standard 和 premium 两个用户可选分组。希望 vip 用户额外看到 exclusive 分组，同时不再看到 standard 分组": "场景：站点有 standard 和 premium 两个用户可选分组。希望 vip 用户额外看到 exclusive 分组，同时不再看到 standard 分组",
  "场景：站点有 standard（倍率 1.0）和 premium（倍率 0.5）两个分组，希望 vip 用户使用 standard 令牌时也能享受折扣": "场景：站点有 standard（倍率 1.0）和 premium（倍率 0.5）两个分组，希望 vip 用户使用 standard 令牌时也能享受折扣",
  "场景：设置自动选择优先级": "场景：设置自动选择优先级",
  "坚持企业级服务标准，保障每一次操作稳定高效": "坚持企业级服务标准，保障每一次操作稳定高效",
  ...
  "填写后覆盖当前测试环境 API 密钥，留空表示保持当前不变": "填写后覆盖当前测试环境 API 密钥，留空表示保持当前不变",
  "填写后覆盖当前测试环境 Webhook 公钥，留空表示保持当前不变": "填写后覆盖当前测试环境 Webhook 公钥，留空表示保持当前不变",
  "填写后覆盖当前测试环境私钥，留空表示保持当前不变": "填写后覆盖当前测试环境私钥，留空表示保持当前不变",
  "填写后覆盖当前生产环境 API 密钥，留空表示保持当前不变": "填写后覆盖当前生产环境 API 密钥，留空表示保持当前不变",
  "填写后覆盖当前生产环境 Webhook 公钥，留空表示保持当前不变": "填写后覆盖当前生产环境 Webhook 公钥，留空表示保持当前不变",
  "填写后覆盖当前生产环境私钥，留空表示保持当前不变": "填写后覆盖当前生产环境私钥，留空表示保持当前不变",
  "填写后覆盖当前私钥，留空表示保持当前不变": "填写后覆盖当前私钥，留空表示保持当前不变",
  "填写带https的域名，逗号分隔": "填写带https的域名，逗号分隔",
  "填写平台域名，例如：www.tokenrouter.tech": "填写平台域名，例如：www.tokenrouter.tech",
  "填写服务器地址后自动生成：": "填写服务器地址后自动生成：",
  "填写测试环境 Waffo 公钥，Base64 或 PEM 内容均可": "填写测试环境 Waffo 公钥，Base64 或 PEM 内容均可",
  "填写生产环境 Waffo 公钥，Base64 或 PEM 内容均可": "填写生产环境 Waffo 公钥，Base64 或 PEM 内容均可",
  ...
  复充佣金: "复充佣金",
  复充分成比例: "复充分成比例",
  复充指该被邀请用户首充之后的后续成功充值订单: "复充指该被邀请用户首充之后的后续成功充值订单",
  复制: "复制",
  复制代码: "复制代码",
  复制令牌: "复制令牌",
  复制令牌失败: "复制令牌失败",
  "复制以下提示词发送给 LLM（如 ChatGPT / Claude），让它帮你设计计费表达式": "复制以下提示词发送给 LLM（如 ChatGPT / Claude），让它帮你设计计费表达式",
  复制全部: "复制全部",
  复制名称: "复制名称",
  复制失败: "复制失败",
  ...
  "如果你对接的是上游One API或者TokenRouter等转发项目，请使用OpenAI类型，不要使用此类型，除非你知道你在做什么。": "如果你对接的是上游One API或者TokenRouter等转发项目，请使用OpenAI类型，不要使用此类型，除非你知道你在做什么。",
  "如果用户请求中包含系统提示词，则使用此设置拼接到用户的系统提示词前面": "如果用户请求中包含系统提示词，则使用此设置拼接到用户的系统提示词前面",
  "如果这里没有你想要的令牌，请点击右上角的「快速创建令牌」新建。": "如果这里没有你想要的令牌，请点击右上角的「快速创建令牌」新建。",
  ...
  安全合规可控: "安全合规可控",
  安全提醒: "安全提醒",
  "安全是 {{name}} 的基础能力，而不是附加功能。": "安全是 {{name}} 的基础能力，而不是附加功能。",
  "安全稳定 · 简洁高效 · 服务企业团队": "安全稳定 · 简洁高效 · 服务企业团队",
  安全设置: "安全设置",
  安全配置: "安全配置",
  安全验证: "安全验证",
  安全验证级别: "安全验证级别",
  安装指南: "安装指南",
  完成: "完成",
  "完成从原型验证到生产部署的完整 AI 接口调用流程。": "完成从原型验证到生产部署的完整 AI 接口调用流程。",
  完成初始化: "完成初始化",
  完成时间: "完成时间",
  ...
  官方价: "官方价",
  官方价格: "官方价格",
  官方价格为上游配置的原始美元基础价: "官方价格为上游配置的原始美元基础价",
  价格均已含税: "价格均已含税",
  "官方价格按 $1 = ￥7 折算": "官方价格按 $1 = ￥7 折算",
  官方文档: "官方文档",
  官方模型同步: "官方模型同步",
  官方说明: "官方说明",
  定价模式: "定价模式",
  ...
  实付金额: "实付金额",
  "实付金额：": "实付金额：",
  "实付金额（{{currency}}） = 官方价格（USD） × 分组倍率 × 当前换算（{{rate}} {{currency}}/USD）": "实付金额（{{currency}}） = 官方价格（USD） × 分组倍率 × 当前换算（{{rate}} {{currency}}/USD）",
  "实时记录接口调用次数、响应状态、异常日志等数据，可视化看板直观展示运行状态，助力快速排查问题、持续优化业务。": "实时记录接口调用次数、响应状态、异常日志等数据，可视化看板直观展示运行状态，助力快速排查问题、持续优化业务。",
  实时调用监控统计: "实时调用监控统计",
  实际: "实际",
  "实际下载尺寸以模型或渠道返回的图片为准，NewAPI 不会压缩或重绘图片": "实际下载尺寸以模型或渠道返回的图片为准，NewAPI 不会压缩或重绘图片",
  "实际尺寸：{{size}}": "实际尺寸：{{size}}",
  "实际尺寸：加载后显示": "实际尺寸：加载后显示",
  实际模型: "实际模型",
  实际环境: "实际环境",
  实际用量: "实际用量",
  ...
  实际请求体: "实际请求体",
  实际额度: "实际额度",
  "审查失败时放行（fallback）": "审查失败时放行（fallback）",
  审计信息: "审计信息",
  客服协助: "客服协助",
  "客服协助功能当前未开放，暂时无法在网站提交请求，请留意后续开放通知。": "客服协助功能当前未开放，暂时无法在网站提交请求，请留意后续开放通知。",
  客服处理中: "客服处理中",
  容器: "容器",
  容器ID: "容器ID",
  "容器创建失败: ": "容器创建失败: ",
  ...
  密钥输入方式: "密钥输入方式",
  密钥隔离: "密钥隔离",
  "密钥隔离、权限管控、日志追踪": "密钥隔离、权限管控、日志追踪",
  "密钥隔离、权限配置、日志审计": "密钥隔离、权限配置、日志审计",
  密钥预览: "密钥预览",
  ...
  对外运营模式: "对外运营模式",
  对应代理分销已入账佣金: "对应代理分销已入账佣金",
  "对比：不勾选「用户可选」的场景": "对比：不勾选「用户可选」的场景",
  对比项: "对比项",
  对象清理规则: "对象清理规则",
  导入: "导入",
  ...
  "将令牌配置到 CC Switch": "将令牌配置到 CC Switch",
  将使用匹配分组: "将使用匹配分组",
  将删除: "将删除",
  ...
  "将把当前编辑中的模型 {{name}} 的价格配置，批量应用到已勾选的 {{count}} 个模型。_one": "将把当前编辑中的模型 {{name}} 的价格配置，批量应用到已勾选的 {{count}} 个模型。_one",
  "将把当前编辑中的模型 {{name}} 的价格配置，批量应用到已勾选的 {{count}} 个模型。_other": "将把当前编辑中的模型 {{name}} 的价格配置，批量应用到已勾选的 {{count}} 个模型。",
  "将清除所有保存的配置并恢复默认设置，此操作不可撤销。是否继续？": "将清除所有保存的配置并恢复默认设置，此操作不可撤销。是否继续？",
  将清除选定时间之前的所有日志: "将清除选定时间之前的所有日志",
  "将立即退出除当前设备外的所有登录，其它设备需要重新登录。": "将立即退出除当前设备外的所有登录，其它设备需要重新登录。",
  ...
  展开更多: "展开更多",
  展示价格: "展示价格",
  "嵌套映射：用户分组 → 使用分组 → 倍率": "嵌套映射：用户分组 → 使用分组 → 倍率",
  工具标识: "工具标识",
  工具调用定价: "工具调用定价",
  工单管理: "工单管理",
  左侧边栏个人设置: "左侧边栏个人设置",
  "已上传参考图，本次将调用图片编辑接口": "已上传参考图，本次将调用图片编辑接口",
  "已为 {{count}} 个模型设置{{type}}_one": "已为 {{count}} 个模型设置{{type}}_one",
  ...
  "已删除 {{count}} 个令牌！_one": "已删除 {{count}} 个令牌！_one",
  "已删除 {{count}} 个令牌！_other": "已删除 {{count}} 个令牌！",
  "已删除 {{count}} 条失效兑换码_one": "已删除 {{count}} 条失效兑换码_one",
  "已删除 {{count}} 条失效兑换码_other": "已删除 {{count}} 条失效兑换码",
  "已删除 ${data} 个通道！": "已删除 ${data} 个通道！",
  "已删除所有禁用渠道，共计 ${data} 个": "已删除所有禁用渠道，共计 ${data} 个",
  已删除消息及其回复: "已删除消息及其回复",
  "已加载 {{loaded}}/{{total}} 个分组": "已加载 {{loaded}}/{{total}} 个分组",
  已勾选: "已勾选",
  "已勾选 {{count}} 个模型": "已勾选 {{count}} 个模型",
  "已勾选 {{count}} 个模型_one": "已勾选 {{count}} 个模型_one",
  "已勾选 {{count}} 个模型_other": "已勾选 {{count}} 个模型",
  已发起支付: "已发起支付",
  ...
  已填充策略模板: "已填充策略模板",
  已处理: "已处理",
  "已处理上游模型更新：加入 {{added}} 个，删除 {{removed}} 个，本次忽略 {{ignored}} 个，当前已忽略模型 {{totalIgnored}} 个": "已处理上游模型更新：加入 {{added}} 个，删除 {{removed}} 个，本次忽略 {{ignored}} 个，当前已忽略模型 {{totalIgnored}} 个",
  已备份: "已备份",
  已复制: "已复制",
  ...
  "已将模型 {{name}} 的价格配置批量应用到 {{count}} 个模型_one": "已将模型 {{name}} 的价格配置批量应用到 {{count}} 个模型_one",
  "已将模型 {{name}} 的价格配置批量应用到 {{count}} 个模型_other": "已将模型 {{name}} 的价格配置批量应用到 {{count}} 个模型",
  已开启: "已开启",
  ...
  已授权应用: "已授权应用",
  已提交: "已提交",
  "已提交，等待操作员核对": "已提交，等待操作员核对",
  已提出修改要求: "已提出修改要求",
  已提现佣金: "已提现佣金",
  已支付金额: "已支付金额",
  "已新增 {{count}} 个模型：{{list}}_one": "已新增 {{count}} 个模型：{{list}}_one",
  "已新增 {{count}} 个模型：{{list}}_other": "已新增 {{count}} 个模型：{{list}}",
  "已显示缓存状态，正在刷新": "已显示缓存状态，正在刷新",
  ...
  已注销: "已注销",
  已消耗额度: "已消耗额度",
  "已消费，但暂未命中返利计划": "已消费，但暂未命中返利计划",
  已消费用户数: "已消费用户数",
  已添加: "已添加",
  "已添加 {{count}} 个模板_one": "已添加 {{count}} 个模板_one",
  "已添加 {{count}} 个模板_other": "已添加 {{count}} 个模板",
  已添加到白名单: "已添加到白名单",
  "已清理 {{count}} 个日志文件，释放 {{size}}": "已清理 {{count}} 个日志文件，释放 {{size}}",
  "已清理 {{count}} 个日志文件，释放 {{size}}_one": "已清理 {{count}} 个日志文件，释放 {{size}}_one",
  ...
  已退出该设备: "已退出该设备",
  已退款: "已退款",
  "已退款但已开票，需人工核对": "已退款但已开票，需人工核对",
  "已选分组（拖拽调整优先级）": "已选分组（拖拽调整优先级）",
  "已选合计（预览）": "已选合计（预览）",
  "已选择 {{count}} 个模型_one": "已选择 {{count}} 个模型_one",
  ...
  平台: "平台",
  平台价格数据格式不正确: "平台价格数据格式不正确",
  平台地址格式不正确: "平台地址格式不正确",
  "平台将在合规审核通过后予以处理；审核完成前，原登记信息持续有效。提交不真实、不完整或无法核验的材料，平台有权驳回申请，并依据平台规则及适用法律法规采取进一步限制措施。": "平台将在合规审核通过后予以处理；审核完成前，原登记信息持续有效。提交不真实、不完整或无法核验的材料，平台有权驳回申请，并依据平台规则及适用法律法规采取进一步限制措施。",
  平均: "平均",
  平均RPM: "平均RPM",
  平均TPM: "平均TPM",
  平均延迟: "平均延迟",
  ...
  开: "开",
  开发者: "开发者",
  "开启「默认使用 auto 分组」后，新建令牌和初始令牌都会自动设为 auto。": "开启「默认使用 auto 分组」后，新建令牌和初始令牌都会自动设为 auto。",
  ...
  "开启后，图片生成页面仅会展示此模型，不再依赖模型名称关键字判断": "开启后，图片生成页面仅会展示此模型，不再依赖模型名称关键字判断",
  ...
  "开启后，模型名称会参与 cache key（不同模型隔离）。": "开启后，模型名称会参与 cache key（不同模型隔离）。",
  "开启后，视频生成页面仅会展示此模型，不再依赖模型名称关键字判断": "开启后，视频生成页面仅会展示此模型，不再依赖模型名称关键字判断",
  ...
  "开启后创建令牌默认选择auto分组，初始令牌也将设为auto": "开启后创建令牌默认选择auto分组，初始令牌也将设为auto",
  开启后未登录用户无法访问模型广场: "开启后未登录用户无法访问模型广场",
  开启后检测到新增模型会自动加入当前渠道模型列表: "开启后检测到新增模型会自动加入当前渠道模型列表",
  开启后由后端定时任务检测该渠道上游模型变化: "开启后由后端定时任务检测该渠道上游模型变化",
  开启后由模型同时生成配音与音效: "开启后由模型同时生成配音与音效",
  "开启后该渠道不会参与任何并发竞速，但在竞速全部失败时仍可作为兜底通道被尝试": "开启后该渠道不会参与任何并发竞速，但在竞速全部失败时仍可作为兜底通道被尝试",
  开启后该渠道的请求不会被注入全局系统提示词: "开启后该渠道的请求不会被注入全局系统提示词",
  开启批量操作: "开启批量操作",
  开始: "开始",
  开始同步: "开始同步",
  ...
  "开票功能当前未开放。": "开票功能当前未开放。",
  开票合计: "开票合计",
  "开票合计由所选充值订单的支付金额自动计算，不能手动填写。": "开票合计由所选充值订单的支付金额自动计算，不能手动填写。",
  开票处理中: "开票处理中",
  开票对话: "开票对话",
  开票状态: "开票状态",
  开票申请详情: "开票申请详情",
  ...
  "当令牌分组设为 auto 时，系统按列表顺序依次选择可用分组。排在前面的优先级更高。": "当令牌分组设为 auto 时，系统按列表顺序依次选择可用分组。排在前面的优先级更高。",
  ...
  "当前代理分销仅针对新用户通过代理邀请码注册后产生的钱包充值订单生效，购买套餐不参与该分销。": "当前代理分销仅针对新用户通过代理邀请码注册后产生的钱包充值订单生效，购买套餐不参与该分销。",
  "当前代理资格已停用，仅保留历史佣金与流水展示，后续不会再产生新的分销收益": "当前代理资格已停用，仅保留历史佣金与流水展示，后续不会再产生新的分销收益",
  当前令牌没有相容分组: "当前令牌没有相容分组",
  当前价格: "当前价格",
  当前余额: "当前余额",
  当前值: "当前值",
  "当前值不是合法 JSON，无法格式化": "当前值不是合法 JSON，无法格式化",
  当前充值已满足活动条件: "当前充值已满足活动条件",
  当前充值暂未满足活动条件: "当前充值暂未满足活动条件",
  当前入口状态: "当前入口状态",
  "当前分组为 auto，会自动选择最优分组，当一个组不可用时自动降级到下一个组（熔断机制）": "当前分组为 auto，会自动选择最优分组，当一个组不可用时自动降级到下一个组（熔断机制）",
  "当前分组暂无可用模型，请切换分组或联系管理员配置": "当前分组暂无可用模型，请切换分组或联系管理员配置",
  当前分组没有可用的图片模型: "当前分组没有可用的图片模型",
  当前分组没有可用的视频模型: "当前分组没有可用的视频模型",
  当前剩余: "当前剩余",
  "当前参数覆盖不是合法的 JSON": "当前参数覆盖不是合法的 JSON",
  当前参考素材组合不被该模型支持: "当前参考素材组合不被该模型支持",
  当前可提现佣金: "当前可提现佣金",
  当前周期: "当前周期",
  当前周期暂无成功充值: "当前周期暂无成功充值",
  "当前尺寸：{{size}}": "当前尺寸：{{size}}",
  当前提示: "当前提示",
  ...
  当前时间: "当前时间",
  当前暂无可抽奖项: "当前暂无可抽奖项",
  当前暂无可用邀请福利: "当前暂无可用邀请福利",
  "当前未启用，需要时再打开即可。": "当前未启用，需要时再打开即可。",
  当前来源汇率: "当前来源汇率",
  "当前查看的分组为：{{group}}，{{comparison}}": "当前查看的分组为：{{group}}，{{comparison}}",
  ...
  当前版本: "当前版本",
  当前状态: "当前状态",
  "当前环境共用同一商户 ID": "当前环境共用同一商户 ID",
  "当前用户将继承后台代理分销的默认首充/复充比例。": "当前用户将继承后台代理分销的默认首充/复充比例。",
  当前登录账号: "当前登录账号",
  当前登记地区: "当前登记地区",
  当前盈利: "当前盈利",
  当前绑定: "当前绑定",
  ...
  "当前设置类型: ": "当前设置类型: ",
  "当前账号未开通代理分销，管理员启用后会在这里展示邀请码、分销用户与佣金流水": "当前账号未开通代理分销，管理员启用后会在这里展示邀请码、分销用户与佣金流水",
  "当前账户暂不支持用户自行变更国家/地区信息。如确需申请变更，请通过工单提交正式申请，并提供足以证明您当前实际所在国家/地区或主体归属地的真实、完整、有效佐证材料。": "当前账户暂不支持用户自行变更国家/地区信息。如确需申请变更，请通过工单提交正式申请，并提供足以证明您当前实际所在国家/地区或主体归属地的真实、完整、有效佐证材料。",
  当前账户未开通代理分销: "当前账户未开通代理分销",
  当前跟随系统: "当前跟随系统",
  当前邀请福利: "当前邀请福利",
  "当前金额未达到 Waffo Pancake 的最低充值要求": "当前金额未达到 Waffo Pancake 的最低充值要求",
  当前额度: "当前额度",
  "当某个分组的用户使用另一个分组的令牌时，可设置特殊倍率覆盖基础倍率。例如：vip 分组的用户使用 default 分组时倍率为 0.5": "当某个分组的用户使用另一个分组的令牌时，可设置特殊倍率覆盖基础倍率。例如：vip 分组的用户使用 default 分组时倍率为 0.5",
  "当模型没有设置价格时仍接受调用，仅当您信任该网站时使用，可能会产生高额费用": "当模型没有设置价格时仍接受调用，仅当您信任该网站时使用，可能会产生高额费用",
  "当用户请求中已有系统提示词时，会优先拼接此内容；当用户未提供系统提示词时，会自动注入该内容": "当用户请求中已有系统提示词时，会优先拼接此内容；当用户未提供系统提示词时，会自动注入该内容",
  "当运行通道全部测试时，超过此时间将自动禁用通道": "当运行通道全部测试时，超过此时间将自动禁用通道",
  "当钱包或订阅剩余额度低于此数值时，系统将通过选择的方式发送通知": "当钱包或订阅剩余额度低于此数值时，系统将通过选择的方式发送通知",
  "影片补全 tokens": "影片补全 tokens",
  影片计费: "影片计费",
  待使用收益: "待使用收益",
  待处理: "待处理",
  待支付单数: "待支付单数",
  ...
  "快速响应，高效运行": "快速响应，高效运行",
  快速开始: "快速开始",
  "快速开始、API 参考、整合教学与控制台指南。": "快速开始、API 参考、整合教学与控制台指南。",
  快速选择: "快速选择",
  忽略: "忽略",
  "思考中...": "思考中...",
  思考内容转换: "思考内容转换",
  ...
  "您可以在此自行更新国家/地区信息；如未填写，则默认视为未申报。请确保所填信息真实、准确、有效。": "您可以在此自行更新国家/地区信息；如未填写，则默认视为未申报。请确保所填信息真实、准确、有效。",
  ...
  扩展价格: "扩展价格",
  扫描二维码: "扫描二维码",
  "扫码加入微信群，与大家一起交流使用经验": "扫码加入微信群，与大家一起交流使用经验",
  扫码支付: "扫码支付",
  批量创建: "批量创建",
  ...
  批量检测失败: "批量检测失败",
  "批量检测完成：渠道 {{channels}} 个，新增 {{add}} 个，删除 {{remove}} 个，失败 {{fails}} 个": "批量检测完成：渠道 {{channels}} 个，新增 {{add}} 个，删除 {{remove}} 个，失败 {{fails}} 个",
  ...
  抽奖活动: "抽奖活动",
  抽奖活动未开启: "抽奖活动未开启",
  "抽奖活动火热进行中，充值之余别忘了参与抽奖赢取奖励！": "抽奖活动火热进行中，充值之余别忘了参与抽奖赢取奖励！",
  抽奖记录: "抽奖记录",
  "拉取中...": "拉取中...",
  拉取价格: "拉取价格",
  拉取平台价格失败: "拉取平台价格失败",
  ...
  "拒绝提示模板（可选）": "拒绝提示模板（可选）",
  拦截原因: "拦截原因",
  "拦截返回消息（inject_message）": "拦截返回消息（inject_message）",
  "按 1 美元对应的站内价格填写": "按 1 美元对应的站内价格填写",
  "按 Cron 表达式定时执行 JS 自动化脚本": "按 Cron 表达式定时执行 JS 自动化脚本",
  按K显示单位: "按K显示单位",
  "按上游 usage.completion_tokens 结算": "按上游 usage.completion_tokens 结算",
  按下单数与已成功订单数计算: "按下单数与已成功订单数计算",
  按价格字段筛选: "按价格字段筛选",
  按价格设置: "按价格设置",
  按倍率类型筛选: "按倍率类型筛选",
  按倍率设置: "按倍率设置",
  按分组与模型估算输入输出成本: "按分组与模型估算输入输出成本",
  按后续成功充值实付金额计算: "按后续成功充值实付金额计算",
  按国家或地区限制模型可见性与调用权限: "按国家或地区限制模型可见性与调用权限",
  按完成支付时间落在当前周期内统计: "按完成支付时间落在当前周期内统计",
  "按实付人民币校验，填 0 表示不限制": "按实付人民币校验，填 0 表示不限制",
  "按应用、令牌、模型的顺序选择后，将配置导入 CC Switch。": "按应用、令牌、模型的顺序选择后，将配置导入 CC Switch。",
  "按当前用户分组归档成功充值收入。": "按当前用户分组归档成功充值收入。",
  按成功充值订单口径统计: "按成功充值订单口径统计",
  "按成功日志与错误日志的数量口径计算。": "按成功日志与错误日志的数量口径计算。",
  "按成功消费日志汇总各渠道的额度消耗。": "按成功消费日志汇总各渠道的额度消耗。",
  "按成功消费日志统计模型调用次数。": "按成功消费日志统计模型调用次数。",
  "按所选日期范围联动查看模型调用、延迟、分组收入、拉新贡献和缓存效率。": "按所选日期范围联动查看模型调用、延迟、分组收入、拉新贡献和缓存效率。",
  按新用户首次充值实付金额计算: "按新用户首次充值实付金额计算",
  "按日志中的分组字段统计各分组消耗额度。": "按日志中的分组字段统计各分组消耗额度。",
  "按日志响应时间计算各渠道平均延迟和长尾延迟。": "按日志响应时间计算各渠道平均延迟和长尾延迟。",
  "按日期连续展示当前周期的消费走势。": "按日期连续展示当前周期的消费走势。",
  按模型倍率和分组倍率折算: "按模型倍率和分组倍率折算",
  按次: "按次",
  ...
  按次价格: "按次价格",
  按次计费: "按次计费",
  "按消费 / 错误日志去重统计": "按消费 / 错误日志去重统计",
  "按消费日志中的缓存命中 token 统计": "按消费日志中的缓存命中 token 统计",
  按消费日志口径统计: "按消费日志口径统计",
  "按消费日志统计缓存命中、缓存创建与节省额度。": "按消费日志统计缓存命中、缓存创建与节省额度。",
  "按渠道聚合成功与错误请求，查看稳定性差异。": "按渠道聚合成功与错误请求，查看稳定性差异。",
  "按照如下格式输入：AccessKey|SecretAccessKey|Region": "按照如下格式输入：AccessKey|SecretAccessKey|Region",
  按用户创建和首次支付时间统计: "按用户创建和首次支付时间统计",
  "按真实概率抽奖，未配置满 100% 的部分会自动计入无奖区。": "按真实概率抽奖，未配置满 100% 的部分会自动计入无奖区。",
  "按近几天代理用户的下单与支付结果生成统计视图，成功率按下单数与成功单数计算": "按近几天代理用户的下单与支付结果生成统计视图，成功率按下单数与成功单数计算",
  "按选定周期内的成功消费额度排序。": "按选定周期内的成功消费额度排序。",
  按量: "按量",
  按量计费: "按量计费",
  "按量计费下需要先填写输入价格，才能保存其它价格项。": "按量计费下需要先填写输入价格，才能保存其它价格项。",
  "按页面显示额度判断，保存时自动换算，0 表示不限制": "按页面显示额度判断，保存时自动换算，0 表示不限制",
  "按页面显示额度封顶，保存时自动换算，0 表示不限制": "按页面显示额度封顶，保存时自动换算，0 表示不限制",
  ...
  接收发票邮箱: "接收发票邮箱",
  "控制代理资格、分销比例以及查看当前佣金汇总": "控制代理资格、分销比例以及查看当前佣金汇总",
  控制台: "控制台",
  控制台区域: "控制台区域",
  ...
  "推荐使用（用户可选）": "推荐使用（用户可选）",
  描述: "描述",
  "描述你要生成的画面，例如：赛博朋克城市夜景，霓虹灯，电影感，超清细节": "描述你要生成的画面，例如：赛博朋克城市夜景，霓虹灯，电影感，超清细节",
  "描述你要生成的视频，例如：镜头缓慢推进雨夜街道，一只橘猫回头望向镜头，电影感光影": "描述你要生成的视频，例如：镜头缓慢推进雨夜街道，一只橘猫回头望向镜头，电影感光影",
  提交: "提交",
  提交和跟进自己的工单: "提交和跟进自己的工单",
  提交失败: "提交失败",
  提交开票申请: "提交开票申请",
  提交时间: "提交时间",
  提交结果: "提交结果",
  ...
  搜索文档: "搜索文档",
  "搜索文档、接口路径、模型名…": "搜索文档、接口路径、模型名…",
  "搜索文档内容…": "搜索文档内容…",
  搜索无结果: "搜索无结果",
  搜索日志内容: "搜索日志内容",
  搜索条件: "搜索条件",
  "搜索标题、正文、接口路径…": "搜索标题、正文、接口路径…",
  搜索模型: "搜索模型",
  "搜索模型...": "搜索模型...",
  搜索模型名称: "搜索模型名称",
  搜索模型失败: "搜索模型失败",
  搜索渠道名称或地址: "搜索渠道名称或地址",
  "搜索用户名、昵称或邮箱": "搜索用户名、昵称或邮箱",
  "搜索用户名、邮箱或来源订单号": "搜索用户名、邮箱或来源订单号",
  "搜索用户名、邮箱或订单号": "搜索用户名、邮箱或订单号",
  搜索结果: "搜索结果",
  搜索聊天应用名称: "搜索聊天应用名称",
  "搜索规则（描述 / 类型 / 路径 / 来源 / 目标）": "搜索规则（描述 / 类型 / 路径 / 来源 / 目标）",
  ...
  支付信息: "支付信息",
  支付地址: "支付地址",
  "支付处理中，可稍后刷新订阅状态": "支付处理中，可稍后刷新订阅状态",
  "支付处理中，可稍后在充值记录查看状态": "支付处理中，可稍后在充值记录查看状态",
  支付失败: "支付失败",
  "支付失败，请重新发起充值": "支付失败，请重新发起充值",
  "支付失败，请重新发起购买": "支付失败，请重新发起购买",
  支付完成单数: "支付完成单数",
  "支付完成后用户跳转的页面，留空则自动使用 服务器地址 + /console/topup": "支付完成后用户跳转的页面，留空则自动使用 服务器地址 + /console/topup",
  支付宝: "支付宝",
  支付宝扫码支付: "支付宝扫码支付",
  支付成功率: "支付成功率",
  支付方式: "支付方式",
  ...
  "支持使用 {prompt} 占位原始提示词": "支持使用 {prompt} 占位原始提示词",
  ...
  支持备份: "支持备份",
  "支持多个标记，使用换行、逗号、分号或竖线分隔。模型输出包含任一标记时将记录审查结果。": "支持多个标记，使用换行、逗号、分号或竖线分隔。模型输出包含任一标记时将记录审查结果。",
  ...
  "支持文生视频、首尾帧、参考图与参考视频/音频": "支持文生视频、首尾帧、参考图与参考视频/音频",
  支持的分辨率: "支持的分辨率",
  支持的图像模型: "支持的图像模型",
  支持的时长: "支持的时长",
  支持的生成模式: "支持的生成模式",
  "支持的生成模式：{{modes}}": "支持的生成模式：{{modes}}",
  支持的画面比例: "支持的画面比例",
  支持的输出格式: "支持的输出格式",
  "支持精确匹配；使用 regex: 开头可按正则匹配。": "支持精确匹配；使用 regex: 开头可按正则匹配。",
  "支持自定义请求限流、频率控制、黑白名单配置，灵活管控接口访问流量，避免恶意请求与突发流量冲击，保障业务有序平稳运行。": "支持自定义请求限流、频率控制、黑白名单配置，灵活管控接口访问流量，避免恶意请求与突发流量冲击，保障业务有序平稳运行。",
  ...
  "文+图生图": "文+图生图",
  文件上传: "文件上传",
  "文件搜索 {{count}} 次 * {{symbol}}{{price}} / 1K 次": "文件搜索 {{count}} 次 * {{symbol}}{{price}} / 1K 次",
  ...
  "文字价格 {{textPrice}} + 音频价格 {{audioPrice}} * {{ratioType}} {{ratio}} = {{symbol}}{{total}}": "文字价格 {{textPrice}} + 音频价格 {{audioPrice}} * {{ratioType}} {{ratio}} = {{symbol}}{{total}}",
  ...
  文心一言: "文心一言",
  "文本生成内容审查（命中输出标记时记录审查结果）": "文本生成内容审查（命中输出标记时记录审查结果）",
  文档: "文档",
  文档中心: "文档中心",
  文档加载失败: "文档加载失败",
  文档地址: "文档地址",
  ...
  新增封禁: "新增封禁",
  新增封禁记录: "新增封禁记录",
  "新增已选 {{selected}} / {{total}}": "新增已选 {{selected}} / {{total}}",
  新增平台对比: "新增平台对比",
  新增成功: "新增成功",
  新增支付方式: "新增支付方式",
  新增条件: "新增条件",
  新增模型: "新增模型",
  新增用户: "新增用户",
  "新增用户按创建时间统计，首充用户按首次支付时间统计，活跃用户按日志去重统计。": "新增用户按创建时间统计，首充用户按首次支付时间统计，活跃用户按日志去重统计。",
  新增规则: "新增规则",
  新增订阅: "新增订阅",
  新增邀请计划: "新增邀请计划",
  新密码: "新密码",
  ...
  "无条件（兜底档）": "无条件（兜底档）",
  "无法加载文档内容，请稍后重试": "无法加载文档内容，请稍后重试",
  "无法发起 Passkey 注册": "无法发起 Passkey 注册",
  "无法复制到剪贴板，请手动复制": "无法复制到剪贴板，请手动复制",
  "无法复制到剪贴板，请重试": "无法复制到剪贴板，请重试",
  "无法构建搜索索引，请稍后重试": "无法构建搜索索引，请稍后重试",
  无法添加图片: "无法添加图片",
  无法获取容器详情: "无法获取容器详情",
  "无法获取模型 {{model}} 的能力契约，暂时无法生成": "无法获取模型 {{model}} 的能力契约，暂时无法生成",
  无法获取用户信息: "无法获取用户信息",
  无法读取剪贴板: "无法读取剪贴板",
  无生效: "无生效",
  无结果: "无结果",
  ...
  无限制: "无限制",
  无限额度: "无限额度",
  "无需复杂部署与繁琐配置，开箱即用的可视化操作后台适配各类开发场景，降低企业运维与人力成本。": "无需复杂部署与繁琐配置，开箱即用的可视化操作后台适配各类开发场景，降低企业运维与人力成本。",
  日: "日",
  日志: "日志",
  日志导出成功: "日志导出成功",
  日志已下载: "日志已下载",
  ...
  时长: "时长",
  "时长（秒）": "时长（秒）",
  "时长必须在 {{min}} - {{max}} 秒之间": "时长必须在 {{min}} - {{max}} 秒之间",
  时间: "时间",
  时间信息: "时间信息",
  时间条件: "时间条件",
  时间粒度: "时间粒度",
  ...
  是否检测上游模型更新: "是否检测上游模型更新",
  "是否确认充值？": "是否确认充值？",
  是否自动同步上游模型更新: "是否自动同步上游模型更新",
  是否自动禁用: "是否自动禁用",
  ...
  显示调试: "显示调试",
  晚上好: "晚上好",
  "普通按量/按次直接填价格就行；如果价格要跟请求参数或请求头联动，请切到表达式/阶梯计费。": "普通按量/按次直接填价格就行；如果价格要跟请求参数或请求头联动，请切到表达式/阶梯计费。",
  普通环境变量: "普通环境变量",
  普通用户: "普通用户",
  ...
  暂无成功模型: "暂无成功模型",
  暂无抽奖券: "暂无抽奖券",
  "暂无支付方式，点击上方按钮新增": "暂无支付方式，点击上方按钮新增",
  暂无数据: "暂无数据",
  "暂无数据，点击下方按钮添加键值对": "暂无数据，点击下方按钮添加键值对",
  "暂无文档 Space。管理员可在控制台文档工作室创建并发布。": "暂无文档 Space。管理员可在控制台文档工作室创建并发布。",
  暂无日志: "暂无日志",
  暂无日志可下载: "暂无日志可下载",
  暂无日志可复制: "暂无日志可复制",
  暂无机密环境变量: "暂无机密环境变量",
  ...
  暂无系统公告: "暂无系统公告",
  暂无缺失模型: "暂无缺失模型",
  "暂无自动分组，点击下方按钮添加": "暂无自动分组，点击下方按钮添加",
  "暂无自定义 OAuth 提供商": "暂无自定义 OAuth 提供商",
  "暂无规则，点击下方按钮添加": "暂无规则，点击下方按钮添加",
  暂无订阅套餐: "暂无订阅套餐",
  暂无订阅记录: "暂无订阅记录",
  暂无记录: "暂无记录",
  暂无请求数据: "暂无请求数据",
  ...
  暂无项目: "暂无项目",
  暂无预填组: "暂无预填组",
  暂时还没有代理佣金流水: "暂时还没有代理佣金流水",
  暂时还没有代理充值流水: "暂时还没有代理充值流水",
  暂时还没有代理邀请用户: "暂时还没有代理邀请用户",
  暂时还没有邀请用户: "暂时还没有邀请用户",
  暂时还没有邀请额度流水: "暂时还没有邀请额度流水",
  暴露倍率接口: "暴露倍率接口",
  更多: "更多",
  更多信息请参考: "更多信息请参考",
  更多参数请参考: "更多参数请参考",
  ...
  服务器日志管理: "服务器日志管理",
  服务显示名称: "服务显示名称",
  "未上传参考图时，默认调用文生图接口": "未上传参考图时，默认调用文生图接口",
  "未上传参考图时，默认调用文生视频流程": "未上传参考图时，默认调用文生视频流程",
  未中: "未中",
  未中奖: "未中奖",
  未中奖次数: "未中奖次数",
  未产生佣金: "未产生佣金",
  ...
  本地计费: "本地计费",
  本月获得: "本月获得",
  "本次未中奖，再接再厉": "本次未中奖，再接再厉",
  "本次未中奖，再试一次": "本次未中奖，再试一次",
  本站: "本站",
  "本站来源使用该汇率，外部平台可在下方单独配置。": "本站来源使用该汇率，外部平台可在下方单独配置。",
  "本站汇率（CNY/USD）": "本站汇率（CNY/USD）",
  ...
  "来自能力契约 {{profile}} 修订 {{revision}}": "来自能力契约 {{profile}} 修订 {{revision}}",
  "某些配置更改可能需要几分钟才能生效。": "某些配置更改可能需要几分钟才能生效。",
  查单地址: "查单地址",
  查看: "查看",
  "查看 Codex 帐号信息与用量": "查看 Codex 帐号信息与用量",
  ...
  查看和筛选充值记录: "查看和筛选充值记录",
  查看图片: "查看图片",
  查看图片和文本审查结果: "查看图片和文本审查结果",
  查看图片和文本的审查记录: "查看图片和文本的审查记录",
  查看密钥: "查看密钥",
  查看并退出你账户当前的登录设备: "查看并退出你账户当前的登录设备",
  查看开票: "查看开票",
  查看当前可用的所有模型: "查看当前可用的所有模型",
  "查看当前邀请福利，管理邀请列表，并追踪邀请额度流水": "查看当前邀请福利，管理邀请列表，并追踪邀请额度流水",
  "查看所有可用的AI模型供应商，包括众多知名供应商的模型。": "查看所有可用的AI模型供应商，包括众多知名供应商的模型。",
  "查看抽奖券、参与抽奖和中奖记录": "查看抽奖券、参与抽奖和中奖记录",
  查看接口文档: "查看接口文档",
  查看日志: "查看日志",
  查看来源: "查看来源",
  查看渠道密钥: "查看渠道密钥",
  查看登录会话: "查看登录会话",
  查看示例: "查看示例",
  查看该应用对你账户的用量: "查看该应用对你账户的用量",
  查看详情: "查看详情",
  "查看邀请码、邀请用户、充值流水和佣金流水": "查看邀请码、邀请用户、充值流水和佣金流水",
  查询: "查询",
  查询视频任务状态失败: "查询视频任务状态失败",
  标准价格: "标准价格",
  标签: "标签",
  "标签不能为空！": "标签不能为空！",
  标签信息: "标签信息",
  ...
  样本数: "样本数",
  核对中: "核对中",
  "核心优势 · 为什么选择 {{name}}": "核心优势 · 为什么选择 {{name}}",
  "核心功能 · 一站式企业服务": "核心功能 · 一站式企业服务",
  核心概念: "核心概念",
  核心配置: "核心配置",
  ...
  "根据相关法律法规，您所在的国家/地区不受支持，我们无法为您提供相关服务。": "根据相关法律法规，您所在的国家/地区不受支持，我们无法为您提供相关服务。",
  格式: "格式",
  格式化: "格式化",
  "格式化 JSON": "格式化 JSON",
  格式正确: "格式正确",
  ...
  检测失败: "检测失败",
  "检测完成：新增 {{add}} 个，删除 {{remove}} 个": "检测完成：新增 {{add}} 个，删除 {{remove}} 个",
  检测超时: "检测超时",
  概率: "概率",
  概览: "概览",
  模型: "模型",
  "模型 {{model}} 的能力契约不可用": "模型 {{model}} 的能力契约不可用",
  ...
  模型封禁: "模型封禁",
  模型广场: "模型广场",
  模型广场尚未配置可用的供应商和分组: "模型广场尚未配置可用的供应商和分组",
  ...
  止: "止",
  正则替换: "正则替换",
  正在加载分组计价规则: "正在加载分组计价规则",
  "正在加载可用部署位置...": "正在加载可用部署位置...",
  "正在加载模型...": "正在加载模型...",
  "正在加载模型能力契约，请稍候": "正在加载模型能力契约，请稍候",
  "正在加载模型能力契约...": "正在加载模型能力契约...",
  "正在加载签到状态...": "正在加载签到状态...",
  "正在同步上游价格，请稍候": "正在同步上游价格，请稍候",
  "正在同步价格，请稍候": "正在同步价格，请稍候",
  "正在处理，请稍候": "正在处理，请稍候",
  "正在处理大内容...": "正在处理大内容...",
  "正在批量处理，请稍候": "正在批量处理，请稍候",
  "正在批量检测，请稍候": "正在批量检测，请稍候",
  "正在抽奖...": "正在抽奖...",
  正在提交: "正在提交",
  "正在构建搜索索引…": "正在构建搜索索引…",
  "正在构造请求体预览...": "正在构造请求体预览...",
  ...
  "正在跳转...": "正在跳转...",
  正常: "正常",
  "正常情况下，令牌的计费倍率由令牌所选的分组决定。特殊倍率可以根据「用户所在分组」进一步覆盖这个倍率。": "正常情况下，令牌的计费倍率由令牌所选的分组决定。特殊倍率可以根据「用户所在分组」进一步覆盖这个倍率。",
  ...
  此修改将不可逆: "此修改将不可逆",
  "此对话仅用于开票沟通，与普通工单完全分开。": "此对话仅用于开票沟通，与普通工单完全分开。",
  "此授权请求已失效或过期，请返回应用重新发起授权": "此授权请求已失效或过期，请返回应用重新发起授权",
  ...
  此支付方式最高充值金额为: "此支付方式最高充值金额为",
  "此时用户创建令牌时只能看到 standard 和 premium：": "此时用户创建令牌时只能看到 standard 和 premium：",
  ...
  "每个充值单位对应的 USD 金额，默认 1.0": "每个充值单位对应的 USD 金额，默认 1.0",
  "每个分组代表一个价格档位。管理员创建分组后，可以选择哪些档位对用户开放自选。": "每个分组代表一个价格档位。管理员创建分组后，可以选择哪些档位对用户开放自选。",
  "每个对比项都可选择来源（本站/外部平台），再分别选择分组和模型进行可视化对比。各来源按自己的汇率计算。": "每个对比项都可选择来源（本站/外部平台），再分别选择分组和模型进行可视化对比。各来源按自己的汇率计算。",
  "每个档位可设置 0~2 个条件（对 len、p 和 c），最后一档为兜底档无需条件。len 为输入上下文总长度（含缓存），推荐用于阶梯条件。": "每个档位可设置 0~2 个条件（对 len、p 和 c），最后一档为兜底档无需条件。len 为输入上下文总长度（含缓存），推荐用于阶梯条件。",
  "每个档位可设置 0~2 个条件（对 p 和 c），最后一档为兜底档无需条件。": "每个档位可设置 0~2 个条件（对 p 和 c），最后一档为兜底档无需条件。",
  每个模型使用其最低可用分组倍率: "每个模型使用其最低可用分组倍率",
  ...
  "比较模型价格，按供应商、分组和能力快速找到适合你的模型。": "比较模型价格，按供应商、分组和能力快速找到适合你的模型。",
  永不过期: "永不过期",
  永久: "永久",
  ...
  汇率: "汇率",
  沙盒模式: "沙盒模式",
  "沙盒环境 RSA 私钥 Base64 (PKCS#8 DER)": "沙盒环境 RSA 私钥 Base64 (PKCS#8 DER)",
  "沙盒环境 Waffo API 密钥": "沙盒环境 Waffo API 密钥",
  "沙盒环境 Waffo 公钥 Base64 (X.509 DER)": "沙盒环境 Waffo 公钥 Base64 (X.509 DER)",
  没有匹配的佣金流水: "没有匹配的佣金流水",
  没有匹配的充值流水: "没有匹配的充值流水",
  没有匹配的字段: "没有匹配的字段",
  没有匹配的文档: "没有匹配的文档",
  ...
  没有可用模型: "没有可用模型",
  "没有找到与“{{query}}”相关的内容": "没有找到与“{{query}}”相关的内容",
  没有找到匹配的模型: "没有找到匹配的模型",
  "没有找到可用于 {{app}} 的模型分组": "没有找到可用于 {{app}} 的模型分组",
  ...
  "注销成功!": "注销成功!",
  活动: "活动",
  活动优惠以支付完成时系统配置为准: "活动优惠以支付完成时系统配置为准",
  活动到期时间: "活动到期时间",
  活跃: "活跃",
  活跃文件: "活跃文件",
  活跃用户: "活跃用户",
  ...
  满: "满",
  "满足任一条件（OR）": "满足任一条件（OR）",
  "满足条件时，整单价格乘以 X；如果有多条同时命中，会继续相乘。": "满足条件时，整单价格乘以 X；如果有多条同时命中，会继续相乘。",
  演示站点: "演示站点",
  演示站点模式: "演示站点模式",
  ...
  生产环境: "生产环境",
  "生产环境 RSA 私钥 Base64 (PKCS#8 DER)": "生产环境 RSA 私钥 Base64 (PKCS#8 DER)",
  "生产环境 Waffo API 密钥": "生产环境 Waffo API 密钥",
  "生产环境 Waffo 公钥 Base64 (X.509 DER)": "生产环境 Waffo 公钥 Base64 (X.509 DER)",
  ...
  生效: "生效",
  生效中: "生效中",
  "用于“1M输入（含缓存）”估算，示例：0.95。": "用于“1M输入（含缓存）”估算，示例：0.95。",
  "用于API调用的身份验证令牌，请妥善保管": "用于API调用的身份验证令牌，请妥善保管",
  用于切换当前下单和回调校验所使用的环境: "用于切换当前下单和回调校验所使用的环境",
  用于唯一标识用户的字段路径: "用于唯一标识用户的字段路径",
  "用于校验 Stripe Webhook 签名，保存后不会回显": "用于校验 Stripe Webhook 签名，保存后不会回显",
  "用于校验测试环境的 Waffo Pancake Webhook 签名": "用于校验测试环境的 Waffo Pancake Webhook 签名",
  "用于校验测试环境的 Waffo 回调签名": "用于校验测试环境的 Waffo 回调签名",
  "用于校验生产环境的 Waffo Pancake Webhook 签名": "用于校验生产环境的 Waffo Pancake Webhook 签名",
  "用于校验生产环境的 Waffo 回调签名": "用于校验生产环境的 Waffo 回调签名",
  ...
  用户分组的联动作用: "用户分组的联动作用",
  用户分组配置: "用户分组配置",
  "用户创建令牌 → 选择分组下拉框：": "用户创建令牌 → 选择分组下拉框：",
  "用户创建令牌时选择的分组，决定该令牌的实际计费倍率。一个用户可以创建多个令牌，使用不同分组。": "用户创建令牌时选择的分组，决定该令牌的实际计费倍率。一个用户可以创建多个令牌，使用不同分组。",
  用户协议: "用户协议",
  用户协议已更新: "用户协议已更新",
  用户协议更新失败: "用户协议更新失败",
  用户单次最少可充值的美元数量: "用户单次最少可充值的美元数量",
  用户可选: "用户可选",
  用户可选分组: "用户可选分组",
  "用户可选分组的名称和描述（只包含勾选了用户可选的分组）": "用户可选分组的名称和描述（只包含勾选了用户可选的分组）",
  用户名: "用户名",
  用户名字段: "用户名字段",
  "用户名字段（可选）": "用户名字段（可选）",
  用户名或邮箱: "用户名或邮箱",
  用户名称: "用户名称",
  "用户在充值页面看到的支付方式名称，例如：Credit Card": "用户在充值页面看到的支付方式名称，例如：Credit Card",
  用户工单处理: "用户工单处理",
  ...
  "用量统计、模型选择、成本优化": "用量统计、模型选择、成本优化",
  用量范围: "用量范围",
  由全站货币展示设置统一控制: "由全站货币展示设置统一控制",
  "由管理员分配，决定用户身份等级（如 default、vip）。": "由管理员分配，决定用户身份等级（如 default、vip）。",
  由订阅抵扣: "由订阅抵扣",
  申请已取消: "申请已取消",
  申请开票: "申请开票",
  申请编号: "申请编号",
  "画面 {{width}}×{{height}}，计费时长 {{seconds}} 秒，预估影片补全 tokens {{tokens}}": "画面 {{width}}×{{height}}，计费时长 {{seconds}} 秒，预估影片补全 tokens {{tokens}}",
  "画面 {{width}}×{{height}}，预估影片补全 tokens {{tokens}}": "画面 {{width}}×{{height}}，预估影片补全 tokens {{tokens}}",
  画面比例: "画面比例",
  界面语言和其他个人偏好: "界面语言和其他个人偏好",
  留空使用系统临时目录: "留空使用系统临时目录",
  "留空则使用 /console/topup?show_history=true": "留空则使用 /console/topup?show_history=true",
  留空则使用账号绑定的邮箱: "留空则使用账号绑定的邮箱",
  留空则使用默认回调地址: "留空则使用默认回调地址",
  "留空则使用默认端点；支持 {path, method}": "留空则使用默认端点；支持 {path, method}",
  留空则保持原有密钥: "留空则保持原有密钥",
  "留空则自动使用 服务器地址 + /api/waffo/webhook": "留空则自动使用 服务器地址 + /api/waffo/webhook",
  留空则自动使用当前站点的默认充值页地址: "留空则自动使用当前站点的默认充值页地址",
  留空则自动使用当前站点的默认回调地址: "留空则自动使用当前站点的默认回调地址",
  "留空则默认使用服务器地址，注意不能携带http://或者https://": "留空则默认使用服务器地址，注意不能携带http://或者https://",
  "留空时默认使用服务器地址作为回调地址，填写后将覆盖默认值": "留空时默认使用服务器地址作为回调地址，填写后将覆盖默认值",
  "留空表示保留当前密钥，仅在需要更换时重新填写": "留空表示保留当前密钥，仅在需要更换时重新填写",
  留空表示长期有效: "留空表示长期有效",
  "登 录": "登 录",
  登录: "登录",
  登录会话: "登录会话",
  ...
  "直接追加（和添加类似，但无前缀）": "直接追加（和添加类似，但无前缀）",
  相关: "相关",
  相关产品入口: "相关产品入口",
  相关文档: "相关文档",
  相关项目: "相关项目",
  ...
  "确定要仅检测全部渠道上游模型更新吗？（不执行新增/删除）": "确定要仅检测全部渠道上游模型更新吗？（不执行新增/删除）",
  ...
  "确定要删除所选的 {{count}} 个令牌吗？_one": "确定要删除所选的 {{count}} 个令牌吗？_one",
  "确定要删除所选的 {{count}} 个令牌吗？_other": "确定要删除所选的 {{count}} 个令牌吗？",
  "确定要删除所选的 {{count}} 个模型吗？_one": "确定要删除所选的 {{count}} 个模型吗？_one",
  ...
  "确定要启用此用户吗？": "确定要启用此用户吗？",
  "确定要对全部渠道执行上游模型更新吗？": "确定要对全部渠道执行上游模型更新吗？",
  "确定要提升此用户吗？": "确定要提升此用户吗？",
  ...
  确认删除模型: "确认删除模型",
  "确认删除该分组？": "确认删除该分组？",
  "确认删除该分组的所有规则？": "确认删除该分组的所有规则？",
  "确认删除该规则？": "确认删除该规则？",
  "确认删除该邀请计划？": "确认删除该邀请计划？",
  "确认删除这条模型封禁记录？": "确认删除这条模型封禁记录？",
  确认取消密码登录: "确认取消密码登录",
  "确认后会从可提现佣金扣减，并累计到已提现佣金，同时写入代理佣金流水。": "确认后会从可提现佣金扣减，并累计到已提现佣金，同时写入代理佣金流水。",
  确认启用: "确认启用",
  确认密码: "确认密码",
  确认导入配置: "确认导入配置",
  确认延长: "确认延长",
  ...
  "示例：claude-opus-4-8 输入价，官方 ￥35.00，Claude lite（特价） ￥3.50": "示例：claude-opus-4-8 输入价，官方 ￥35.00，Claude lite（特价） ￥3.50",
  "示例：官方 {{officialPrice}} × {{groupRatio}} × {{rate}} {{currency}}/USD = {{payable}}": "示例：官方 {{officialPrice}} × {{groupRatio}} × {{rate}} {{currency}}/USD = {{payable}}",
  "示例：官方 {{officialPrice}} × {{groupRatio}} × {{rate}} {{currency}}/USD = {{payable}}（优惠 {{adjustmentPercent}}%）": "示例：官方 {{officialPrice}} × {{groupRatio}} × {{rate}} {{currency}}/USD = {{payable}}（优惠 {{adjustmentPercent}}%）",
  "示例：官方 {{officialPrice}} × {{groupRatio}} × {{rate}} {{currency}}/USD = {{payable}}（加价 {{adjustmentPercent}}%）": "示例：官方 {{officialPrice}} × {{groupRatio}} × {{rate}} {{currency}}/USD = {{payable}}（加价 {{adjustmentPercent}}%）",
  视频: "视频",
  视频Remix: "视频 Remix",
  视频不可用: "视频不可用",
  视频任务已提交: "视频任务已提交",
  "视频任务已提交，系统会每 5 秒自动查询一次结果": "视频任务已提交，系统会每 5 秒自动查询一次结果",
  "视频已完成，但未返回可播放地址": "视频已完成，但未返回可播放地址",
  视频扩展: "视频扩展",
  ...
  "签到成功！获得": "签到成功！获得",
  签到设置: "签到设置",
  "简化接口调用，赋能业务高效运转": "简化接口调用，赋能业务高效运转",
  "简单来说：同一个令牌分组，不同等级的用户可以享受不同的价格。": "简单来说：同一个令牌分组，不同等级的用户可以享受不同的价格。",
  简洁: "简洁",
  ...
  管理员: "管理员",
  管理员分配的优惠分组: "管理员分配的优惠分组",
  管理员分配的基础分组: "管理员分配的基础分组",
  管理员区域: "管理员区域",
  管理员可视化报表中心: "管理员可视化报表中心",
  管理员尚未配置需要展示的分组: "管理员尚未配置需要展示的分组",
  管理员尚未配置需要展示的套餐: "管理员尚未配置需要展示的套餐",
  管理员尚未配置需要展示的模型: "管理员尚未配置需要展示的模型",
  管理员暂时未设置任何关于内容: "管理员暂时未设置任何关于内容",
  管理员暂未配置微信群二维码: "管理员暂未配置微信群二维码",
  ...
  管理员未开启支付宝充值: "管理员未开启支付宝充值",
  "管理员未开启支付宝充值！": "管理员未开启支付宝充值！",
  "管理员未开启聚合支付！": "管理员未开启聚合支付！",
  管理员未设置用户可选分组: "管理员未设置用户可选分组",
  "管理员给用户分配的分组（如 vip）不仅决定用户身份，还会影响后续两个功能：": "管理员给用户分配的分组（如 vip）不仅决定用户身份，还会影响后续两个功能：",
  "管理员设置了外部链接，点击下方按钮访问": "管理员设置了外部链接，点击下方按钮访问",
  管理员账号: "管理员账号",
  "管理员账号已经初始化过，请继续设置其他参数": "管理员账号已经初始化过，请继续设置其他参数",
  管理已获得你账户访问权限的第三方应用: "管理已获得你账户访问权限的第三方应用",
  ...
  "类型（常用）": "类型（常用）",
  粘贴图片失败: "粘贴图片失败",
  "粘贴图片链接（http/https）": "粘贴图片链接（http/https）",
  精确: "精确",
  精选: "精选",
  系统: "系统",
  ...
  索引: "索引",
  紧凑列表: "紧凑列表",
  "纯字符串会直接覆盖整条请求头，或者点击“查看 JSON 示例”按 token 规则处理。": "纯字符串会直接覆盖整条请求头，或者点击“查看 JSON 示例”按 token 规则处理。",
  累计佣金: "累计佣金",
  累计充值金额: "累计充值金额",
  累计奖励: "累计奖励",
  累计抽奖: "累计抽奖",
  ...
  累计获得: "累计获得",
  累计贡献佣金: "累计贡献佣金",
  "累计返利 {{quota}}（共 {{count}} 次）": "累计返利 {{quota}}（共 {{count}} 次）",
  "累计返利 {{quota}}（共 {{count}} 次）_one": "累计返利 {{quota}}（共 {{count}} 次）_one",
  "累计返利 {{quota}}（共 {{count}} 次）_other": "累计返利 {{quota}}（共 {{count}} 次）",
  累计邀请奖励: "累计邀请奖励",
  累进阶梯: "累进阶梯",
  线路描述: "线路描述",
  组列表: "组列表",
  ...
  "终态以上游 usage.completion_tokens 为准": "终态以上游 usage.completion_tokens 为准",
  终止中: "终止中",
  终止请求中: "终止请求中",
  绑定: "绑定",
  ...
  统一接入: "统一接入",
  统一服务接入: "统一服务接入",
  "统一服务流程，减少重复适配": "统一服务流程，减少重复适配",
  统一的: "统一的",
  "统一社会信用代码／纳税人识别号": "统一社会信用代码／纳税人识别号",
  统计Tokens: "统计Tokens",
  统计周期内代理用户创建的充值订单: "统计周期内代理用户创建的充值订单",
  统计周期内完成支付的成功金额: "统计周期内完成支付的成功金额",
  统计已重置: "统计已重置",
  统计次数: "统计次数",
  统计视图: "统计视图",
  统计额度: "统计额度",
  ...
  自动填入: "自动填入",
  自动时长: "自动时长",
  "自动时长将以 -1 发送，由模型自行决定": "自动时长将以 -1 发送，由模型自行决定",
  自动检测: "自动检测",
  自动模式: "自动模式",
  ...
  "自动表示由模型决定分辨率，不发送尺寸参数": "自动表示由模型决定分辨率，不发送尺寸参数",
  自动选择: "自动选择",
  自动重试状态码: "自动重试状态码",
  ...
  解绑成功: "解绑成功",
  "解除后 {{name}} 将立即失去对你账户的访问权限，其已签发的令牌会全部失效。": "解除后 {{name}} 将立即失去对你账户的访问权限，其已签发的令牌会全部失效。",
  解除授权: "解除授权",
  解除授权失败: "解除授权失败",
  触发套餐: "触发套餐",
  触发条件: "触发条件",
  ...
  "计算费用中...": "计算费用中...",
  计费: "计费",
  "计费乘数，倍率越低费用越低。例如倍率 0.5 表示半价。": "计费乘数，倍率越低费用越低。例如倍率 0.5 表示半价。",
  计费凭证: "计费凭证",
  计费开始: "计费开始",
  计费摘要: "计费摘要",
  计费方式: "计费方式",
  ...
  订阅结算: "订阅结算",
  订阅说明: "订阅说明",
  "订阅购买成功，已生效": "订阅购买成功，已生效",
  认证方式: "认证方式",
  "让 AI 接口接入更简单": "让 AI 接口接入更简单",
  "让企业数字服务像使用普通云服务一样简单。我们将接入流程、安全策略和用量统计整合为统一平台，让团队专注产品创新和业务增长。": "让企业数字服务像使用普通云服务一样简单。我们将接入流程、安全策略和用量统计整合为统一平台，让团队专注产品创新和业务增长。",
  讯飞星火: "讯飞星火",
  ...
  访问容器: "访问容器",
  访问限制: "访问限制",
  "该供应商会连同参考影片时长一起计费。": "该供应商会连同参考影片时长一起计费。",
  "该供应商提供多种AI模型，适用于不同的应用场景。": "该供应商提供多种AI模型，适用于不同的应用场景。",
  该入口仅用于一次性余额充值: "该入口仅用于一次性余额充值",
  该分类下没有可用模型: "该分类下没有可用模型",
  该分组下暂无可展示的模型: "该分组下暂无可展示的模型",
  "该分辨率不在模型能力契约内，不会被提供": "该分辨率不在模型能力契约内，不会被提供",
  "该分辨率没有已知的画面尺寸，请手动填写宽高，否则无法给出预估。": "该分辨率没有已知的画面尺寸，请手动填写宽高，否则无法给出预估。",
  该域名已存在于白名单中: "该域名已存在于白名单中",
  该套餐下暂无可展示的模型: "该套餐下暂无可展示的模型",
  "该套餐未配置 Creem": "该套餐未配置 Creem",
  "该套餐未配置 Stripe": "该套餐未配置 Stripe",
  "该应用可以代表你发起 AI 请求，产生的费用将从你的账户余额中扣除。": "该应用可以代表你发起 AI 请求，产生的费用将从你的账户余额中扣除。",
  该应用将获得以下权限: "该应用将获得以下权限",
  该应用暂无登录会话: "该应用暂无登录会话",
  "该数据可能不可信，请谨慎使用": "该数据可能不可信，请谨慎使用",
  该文档可能已被移动或删除: "该文档可能已被移动或删除",
  "该服务器地址将影响支付回调地址以及默认首页展示的地址，请确保正确配置": "该服务器地址将影响支付回调地址以及默认首页展示的地址，请确保正确配置",
  "该模型不支持：{{list}}": "该模型不支持：{{list}}",
  "该模型不支持{{mode}}": "该模型不支持{{mode}}",
  "该模型不支持仅用参考音频生成，请再添加一张参考图或一个参考视频": "该模型不支持仅用参考音频生成，请再添加一张参考图或一个参考视频",
  该模型不支持没有参考图的参考视频生成: "该模型不支持没有参考图的参考视频生成",
  "该模型在{{mode}}下不接受参考图": "该模型在{{mode}}下不接受参考图",
  "该模型存在固定价格与倍率计费方式冲突，请确认选择": "该模型存在固定价格与倍率计费方式冲突，请确认选择",
  "该模型的参考生成至少需要 {{limit}} 张参考图，仅提供参考视频或音频不被支持": "该模型的参考生成至少需要 {{limit}} 张参考图，仅提供参考视频或音频不被支持",
  ...
  该渠道暂无可处理的上游模型更新: "该渠道暂无可处理的上游模型更新",
  该渠道未开启上游模型更新检测: "该渠道未开启上游模型更新检测",
  ...
  请先新增模型或从左侧列表选择一个模型: "请先新增模型或从左侧列表选择一个模型",
  ...
  "请在 Waffo 后台获取 API 密钥、商户 ID 以及 RSA 密钥对，并配置回调地址。": "请在 Waffo 后台获取 API 密钥、商户 ID 以及 RSA 密钥对，并配置回调地址。",
  "请在系统设置页面编辑分组倍率以添加新的分组：": "请在系统设置页面编辑分组倍率以添加新的分组：",
  请填写完整的产品信息: "请填写完整的产品信息",
  请填写完整的管理员账号信息: "请填写完整的管理员账号信息",
  请填写密钥: "请填写密钥",
  请填写封禁原因: "请填写封禁原因",
  "请填写当前环境对应的 Product ID": "请填写当前环境对应的 Product ID",
  "请填写当前环境对应的 Store ID": "请填写当前环境对应的 Store ID",
  "请填写当前环境对应的商户 ID": "请填写当前环境对应的商户 ID",
  请填写抬头名称: "请填写抬头名称",
  请填写接收发票的邮箱: "请填写接收发票的邮箱",
  ...
  "请求体超过该模型的 {{limit}} 字节上限，请减少或压缩参考素材": "请求体超过该模型的 {{limit}} 字节上限，请减少或压缩参考素材",
  请求参数: "请求参数",
  请求参数无效: "请求参数无效",
  请求发生错误: "请求发生错误",
  "请求发生错误: ": "请求发生错误: ",
  ...
  请求头覆盖: "请求头覆盖",
  "请求尺寸：{{size}}": "请求尺寸：{{size}}",
  "请求尺寸是发送给模型的目标值，实际输出以模型或渠道返回为准": "请求尺寸是发送给模型的目标值，实际输出以模型或渠道返回为准",
  请求并计费模型: "请求并计费模型",
  ...
  "请至少选择一个模型！": "请至少选择一个模型！",
  请至少选择一个渠道: "请至少选择一个渠道",
  请至少选择一笔在线充值订单: "请至少选择一笔在线充值订单",
  请说明需要修改的内容: "请说明需要修改的内容",
  ...
  '请输入 JSON 格式的密钥内容，例如：\n{\n  "type": "service_account",\n  "project_id": "your-project-id",\n  "private_key_id": "...",\n  "private_key": "...",\n  "client_email": "...",\n  "client_id": "...",\n  "auth_uri": "...",\n  "token_uri": "...",\n  "auth_provider_x509_cert_url": "...",\n  "client_x509_cert_url": "..."\n}': `请输入 JSON 格式的密钥内容，例如：
{
  ...
  "请输入密钥！": "请输入密钥！",
  请输入密钥前缀或尾号: "请输入密钥前缀或尾号",
  "请输入封禁原因，用户会直接看到这段原因": "请输入封禁原因，用户会直接看到这段原因",
  请输入延长时长: "请输入延长时长",
  请输入总额度: "请输入总额度",
  请输入您的密码: "请输入您的密码",
  请输入您的手机号或用户名: "请输入您的手机号或用户名",
...
支持使用模型映射格式
{
  ...
  "请选择您所在的国家/地区": "请选择您所在的国家/地区",
  请选择支付方式: "请选择支付方式",
  请选择日志记录时间: "请选择日志记录时间",
  请选择有效的结束时间: "请选择有效的结束时间",
  请选择模型: "请选择模型",
  "请选择模型。": "请选择模型。",
  请选择消息优先级: "请选择消息优先级",
  请选择渠道类型: "请选择渠道类型",
  ...
  费用预估: "费用预估",
  资料已锁定: "资料已锁定",
  "资料已锁定，提出要求不会自动解锁；操作员判断后才会重新开放修改。": "资料已锁定，提出要求不会自动解锁；操作员判断后才会重新开放修改。",
  "资料已锁定，无法直接修改。如需更改请点击「提出修改要求」，由操作员判断后重新开放。": "资料已锁定，无法直接修改。如需更改请点击「提出修改要求」，由操作员判断后重新开放。",
  资料版本历史: "资料版本历史",
  资源中心: "资源中心",
  资源消耗: "资源消耗",
  赠送余额: "赠送余额",
  ...
  软错误: "软错误",
  "轻量化易用，低成本落地": "轻量化易用，低成本落地",
  较早: "较早",
  输入: "输入",
  "输入 {{input}} tokens / 1M tokens * {{symbol}}{{price}}": "输入 {{input}} tokens / 1M tokens * {{symbol}}{{price}}",
  "输入 {{price}} / 1M tokens": "输入 {{price}} / 1M tokens",
  "输入 $/1M tokens": "输入 $/1M tokens",
  ...
  返回错误: "返回错误",
  返套餐: "返套餐",
  "这个公式比较复杂，下面的简化表单没法完整还原，请在表达式编辑模式下修改。": "这个公式比较复杂，下面的简化表单没法完整还原，请在表达式编辑模式下修改。",
  ...
  "这是受信任的官方应用，正在为你继续授权...": "这是受信任的官方应用，正在为你继续授权...",
  ...
  "这里配置 Waffo 下展示给用户的 Card、Apple Pay、Google Pay 等子支付方式。": "这里配置 Waffo 下展示给用户的 Card、Apple Pay、Google Pay 等子支付方式。",
  "这里配置代理用户的默认首充和复充分成比例。单个用户如关闭“使用系统默认比例”，则以用户自身设置为准。": "这里配置代理用户的默认首充和复充分成比例。单个用户如关闭“使用系统默认比例”，则以用户自身设置为准。",
  进入此档额外收费: "进入此档额外收费",
  进度: "进度",
  进行中: "进行中",
  ...
  退出会话失败: "退出会话失败",
  退出其他所有设备: "退出其他所有设备",
  "退出后该次登录将立即失效，其令牌会被吊销，需要重新登录。": "退出后该次登录将立即失效，其令牌会被吊销，需要重新登录。",
  "退出后该设备需要重新登录才能访问你的账户。": "退出后该设备需要重新登录才能访问你的账户。",
  退出设备: "退出设备",
  退出设备失败: "退出设备失败",
  退款: "退款",
  "适合任务类等按次收费模型。": "适合任务类等按次收费模型。",
  ...
  "适用于统一下单返回 payUrl 的聚合支付网关。当前接入包含：下单、异步回调验签和充值入账。": "适用于统一下单返回 payUrl 的聚合支付网关。当前接入包含：下单、异步回调验签和充值入账。",
  "适配 -thinking、-thinking-预算数字 和 -nothinking 后缀": "适配 -thinking、-thinking-预算数字、-nothinking 以及 -low/-medium/-high 后缀",
  "适配个人开发调试、中小企业业务对接、政企项目系统集成、企业应用集成与高并发业务调度等多元场景。": "适配个人开发调试、中小企业业务对接、政企项目系统集成、企业应用集成与高并发业务调度等多元场景。",
  "选择 premium 创建的令牌，调用 API 时费用为 standard 的 50%。": "选择 premium 创建的令牌，调用 API 时费用为 standard 的 50%。",
  选择使用分组: "选择使用分组",
  选择充值套餐: "选择充值套餐",
  选择充值额度: "选择充值额度",
  选择分组: "选择分组",
  "选择分组，可多选并拖拽调整优先级": "选择分组，可多选并拖拽调整优先级",
  选择同步来源: "选择同步来源",
  选择同步渠道: "选择同步渠道",
  选择同步语言: "选择同步语言",
  选择容器: "选择容器",
  ...
  通知邮箱: "通知邮箱",
  通知配置: "通知配置",
  "通过 {{name}} 快速构建稳定、安全、可扩展的 AI 应用。": "通过 {{name}} 快速构建稳定、安全、可扩展的 AI 应用。",
  ...
  "通过统一入口管理业务接入、权限与运行状态，适配常见企业应用场景。": "通过统一入口管理业务接入、权限与运行状态，适配常见企业应用场景。",
  ...
  邀请获得额度: "邀请获得额度",
  邀请计划: "邀请计划",
  "邀请计划会在被邀请用户每次充值时向其邀请人返利（仅返利一层，订阅购买仍仅首次）。": "邀请计划会在被邀请用户每次充值时向其邀请人返利（仅返利一层，订阅购买仍仅首次）。",
  邀请返利: "邀请返利",
  邀请返利规则配置: "邀请返利规则配置",
  邀请链接: "邀请链接",
  邀请链接已复制: "邀请链接已复制",
  ...
  "配置 Waffo 充值时可用的支付方式，保存后在充值页面展示给用户。": "配置 Waffo 充值时可用的支付方式，保存后在充值页面展示给用户。",
  "配置 WeChat Server": "配置 WeChat Server",
  "配置：": "配置：",
  配置价: "配置价",
  "配置到 CC Switch": "配置到 CC Switch",
  "配置各工具的调用价格（$/1K次调用）。按次计费模型不额外收取工具费用。": "配置各工具的调用价格（$/1K次调用）。按次计费模型不额外收取工具费用。",
  "配置后会在所有渠道请求中统一拼接到系统提示词前，可用于全局内容过滤": "配置后会在所有渠道请求中统一拼接到系统提示词前，可用于全局内容过滤",
  "配置后的效果：": "配置后的效果：",
  配置和消息已全部重置: "配置和消息已全部重置",
  配置套餐的有效时长: "配置套餐的有效时长",
  "配置如何从用户信息 API 响应中提取用户数据，支持 JSONPath 语法": "配置如何从用户信息 API 响应中提取用户数据，支持 JSONPath 语法",
  "配置密钥、权限和项目": "配置密钥、权限和项目",
  配置导入成功: "配置导入成功",
  ...
  "配置计划名称、启用状态、优先级和备注": "配置计划名称、启用状态、优先级和备注",
  配置说明: "配置说明",
  配置邮箱域名白名单: "配置邮箱域名白名单",
  配置链接已复制: "配置链接已复制",
  "采用多重容错与负载均衡机制，支持 7×24 小时不间断服务运行，有效规避单点故障风险，保障企业服务持续稳定。": "采用多重容错与负载均衡机制，支持 7×24 小时不间断服务运行，有效规避单点故障风险，保障企业服务持续稳定。",
  重启部署失败: "重启部署失败",
  重命名部署: "重命名部署",
  重复提交: "重复提交",
  重复的键名: "重复的键名",
  ...
  重新生成: "重新生成",
  重新生成协助码: "重新生成协助码",
  "重新生成后，旧的协助码会立即失效，请把新的协助码提供给客服。": "重新生成后，旧的协助码会立即失效，请把新的协助码提供给客服。",
  重新生成备用码: "重新生成备用码",
  重新生成备用码失败: "重新生成备用码失败",
  ...
  键名: "键名",
  '键的前缀 +: 表示添加，-: 表示移除，无前缀表示追加。值为分组描述（移除时填 "remove"）。': '键的前缀 +: 表示添加，-: 表示移除，无前缀表示追加。值为分组描述（移除时填 "remove"）。',
  镜像仓库密码: "镜像仓库密码",
  镜像仓库用户名: "镜像仓库用户名",
  镜像仓库配置: "镜像仓库配置",
  镜像地址: "镜像地址",
  ...
  项目操作按钮组: "项目操作按钮组",
  预估: "预估",
  "预估 = 宽 × 高 × 帧率 × 时长 ÷ 1024 得到影片补全 tokens，再乘以所选费率。仅供参考，实际以上游返回的 usage.completion_tokens 结算。": "预估 = 宽 × 高 × 帧率 × 时长 ÷ 1024 得到影片补全 tokens，再乘以所选费率。仅供参考，实际以上游返回的 usage.completion_tokens 结算。",
  预估总费用: "预估总费用",
  预估环境: "预估环境",
  ...
  首充分成比例: "首充分成比例",
  首充用户: "首充用户",
  "首充赠送最大额度不能小于 0": "首充赠送最大额度不能小于 0",
  "首充赠送比例不能小于 0": "首充赠送比例不能小于 0",
  首充赠送结束时间: "首充赠送结束时间",
  "首充赠送起充额度不能小于 0": "首充赠送起充额度不能小于 0",
  "首单已消费，但未命中返利计划": "首单已消费，但未命中返利计划",
  首单状态: "首单状态",
  首尾帧生成: "首尾帧生成",
  首尾生视频: "首尾生视频",
  首帧: "首帧",
  "首帧/尾帧图不能与参考图混用": "首帧/尾帧图不能与参考图混用",
  "首帧/尾帧图不能与参考视频或参考音频同时使用": "首帧/尾帧图不能与参考视频或参考音频同时使用",
  首帧生成: "首帧生成",
  首帧生视频: "首帧生视频",
  首页: "首页",
  首页内容: "首页内容",
...
如果您坚持开启该功能，即代表您作出以下确认：`,
  ...
  "默认使用 USD 结算": "默认使用 USD 结算",
  默认使用auto分组: "默认使用auto分组",
  默认使用系统名称: "默认使用系统名称",
  ...
  默认复充分成比例: "默认复充分成比例",
  默认异步回调地址: "默认异步回调地址",
  "默认情况下，所有用户创建令牌时看到的可选分组列表是一样的（即「用户可选」列勾选的分组）。": "默认情况下，所有用户创建令牌时看到的可选分组列表是一样的（即「用户可选」列勾选的分组）。",
  默认折叠侧边栏: "默认折叠侧边栏",
  默认比例: "默认比例",
  默认测试模型: "默认测试模型",
  默认用户消息: "你好",
  默认补全倍率: "默认补全倍率",
  默认首充分成比例: "默认首充分成比例",
  "首字之后的平均输出速度：输出 tokens / (用时 - 首字)": "首字之后的平均输出速度：输出 tokens / (用时 - 首字)",
  "首字之后的平均输出速度：输出 tokens / (用时 - 首字)。用时仅精确到秒，因此极短的请求无法给出速度。": "首字之后的平均输出速度：输出 tokens / (用时 - 首字)。用时仅精确到秒，因此极短的请求无法给出速度。",
  收起计费凭证: "收起计费凭证",
  展开计费凭证: "展开计费凭证",
  "关闭后客服将不再处理该案件，协助定位码也会停止使用。": "关闭后客服将不再处理该案件，协助定位码也会停止使用。",
  协助定位码: "协助定位码",
  "协助码仅用于客服定位案件，不能用于登录；案件关闭后停止使用，永久案件编号仍可用于历史查询。客服收到协助码后，才能在客服后台定位案件并查看已授权的协助案件及其允许的资料进行排查。客服协助不是网站内的在线客服，网站不提供即时聊天，实际沟通请在微信群完成。": "协助码仅用于客服定位案件，不能用于登录；案件关闭后停止使用，永久案件编号仍可用于历史查询。客服收到协助码后，才能在客服后台定位案件并查看已授权的协助案件及其允许的资料进行排查。客服协助不是网站内的在线客服，网站不提供即时聊天，实际沟通请在微信群完成。",
  协助定位码已更新: "协助定位码已更新",
  "遇到问题请先在网站提交“请求协助”，提交后会取得永久案件编号和六位协助码（协助定位码），请将该码带到微信群发给客服。": "遇到问题请先在网站提交“请求协助”，提交后会取得永久案件编号和六位协助码（协助定位码），请将该码带到微信群发给客服。",
  处理截止时间: "处理截止时间",
  案件编号: "案件编号",
  "客服协助与工单是两个不同功能，客服协助不是在线客服，也不是工单对话；如需正式提交和跟进工单，请使用工单功能。请在下方描述问题，提交后将协助码带到微信群发给客服。": "客服协助与工单是两个不同功能，客服协助不是在线客服，也不是工单对话；如需正式提交和跟进工单，请使用工单功能。请在下方描述问题，提交后将协助码带到微信群发给客服。",
  重新生成协助定位码: "重新生成协助定位码",
  "重新生成后，旧的协助定位码会立即停止使用；永久案件编号不会改变。": "重新生成后，旧的协助定位码会立即停止使用；永久案件编号不会改变。"
}, o = {
  translation: e
};
export {
